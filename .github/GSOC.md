...
- **Learn About Software Development Beyond Just Code.** To be a great open-source contributor, it helps to understand more than just writing code. Knowing about common practices like code reviews, and how developers feel about them, is valuable. This article on developer feelings about code reviews is a good example: "[Comments on 'Predicting Developers' Negative Feelings about Code Review'](https://roman--ivanov-blogspot-com.translate.goog/?_x_tr_sl=auto&_x_tr_tl=en&_x_tr_hl=en)".
