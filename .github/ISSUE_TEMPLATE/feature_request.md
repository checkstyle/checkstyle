...
Imagine you something new (Check, property, new behavior) that you requesting already
implemented and you just report bug that feature does not work. Please report it
