...
package com.puppycrawl.tools.checkstyle.checks.numericalprefixesinfixessuffixescharactercase;

public class InputNumericalPrefixesInfixesSuffixesCharacterCaseCheck {
    ...
    int ok1 = 0x1F; // ok, because here 'F' is a hexadecimal digit, not a numeric suffix.
    double ok2 = 123.456;
    double ok3 = 1 / 5432.0;
    double ok4 = 0x1E2.2p2d; // ok, because here 'E' is a hexadecimal digit, not a numeric infix.
}
