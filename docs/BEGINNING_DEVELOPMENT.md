...
- [Before Developmen](#before-development)
...
- Fork Checkstyle upstream project. As it is described
...
[Eclipse IDE](http://localhost:63342/ExpectedSarifLoggerEmpty.sarif/target/site/eclipse.html),
[NetBeans IDE](http://localhost:63342/ExpectedSarifLoggerEmpty.sarif/target/site/netbeans.html),
[IntelliJ IDEA IDE](http://localhost:63342/ExpectedSarifLoggerEmpty.sarif/target/site/idea.html)
