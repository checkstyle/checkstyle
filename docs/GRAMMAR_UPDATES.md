...
- **Lexer**: A lexer is a program that performs lexical analysis. It takes the
  ...
  defined [here](https://github.com/checkstyle/checkstyle/blob/main/src/main/resources/com/puppycrawl/tools/checkstyle/grammar/java/JavaLanguageLexer.g4).
- **Parser**: A parser is a program that performs syntax analysis. It takes the
  ...
  is
  defined [here](https://github.com/checkstyle/checkstyle/blob/main/src/main/resources/com/puppycrawl/tools/checkstyle/grammar/java/JavaLanguageParser.g4).
...
- **JavaAstVisitor**: A visitor that we use to traverse the parse tree and build
  ...
  visitors [here](https://github.com/checkstyle/checkstyle/blob/main/src/main/java/com/puppycrawl/tools/checkstyle/JavaAstVisitor.java).
...
new [TokenType](https://github.com/checkstyle/checkstyle/blob/main/src/main/java/com/puppycrawl/tools/checkstyle/api/TokenTypes.java)
...
analyzed. You
can find our AST
tests [here](https://github.com/checkstyle/checkstyle/tree/main/src/test/java/com/puppycrawl/tools/checkstyle/grammar).
...
find the tests
[here](https://github.com/checkstyle/checkstyle/blob/main/.ci/check-performance-regression.sh) and
the CI job
[here](https://github.com/checkstyle/checkstyle/blob/main/.github/workflows/check-performance-regression.yml).
...
tool described [here](https://github.com/checkstyle/contribution/tree/main/checkstyle-tester#antlr-regression-report).
This report compares the behavior of the updated grammar against the current baseline (the `main`
