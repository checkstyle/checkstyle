...
- **Lexer**: A lexer is a program that performs lexical analysis. It takes the
  ...
  defined [here][JavaLanguageLexer]
- **Parser**: A parser is a program that performs syntax analysis. It takes the
  ...
  is
  defined [here][JavaLanguageParser]
...
will use the `when`
expression as an example: [JEP 441][jep-441].
...
find the tests
[here][performance-regression-script] and the CI job
[here][check-performance-regression]
...
tool described [here][antlr-regression-report]
...
https://github.com/checkstyle/checkstyle/blob/master/.ci/check-performance-regression.sh

[tokenType]:
https://github.com/checkstyle/checkstyle/blob/master/src/main/java/com/puppycrawl/tools/checkstyle/api/TokenTypes.java
[JavaLanguageLexer]:
https://github.com/checkstyle/checkstyle/blob/master/src/main/resources/com/puppycrawl/tools/checkstyle/grammar/java/JavaLanguageLexer.g4
[JavaLanguageParser]:
https://github.com/checkstyle/checkstyle/blob/master/src/main/resources/com/puppycrawl/tools/checkstyle/grammar/java/JavaLanguageParser.g4
[JavaAstVisitor]:
https://github.com/checkstyle/checkstyle/blob/master/src/main/java/com/puppycrawl/tools/checkstyle/JavaAstVisitor.java
[checkstyle-grammar]:
https://github.com/checkstyle/checkstyle/tree/master/src/test/java/com/puppycrawl/tools/checkstyle/grammar
[check-performance-regression]:
https://github.com/checkstyle/checkstyle/blob/master/.github/workflows/check-performance-regression.yml
[antlr-regression-report]:
https://github.com/checkstyle/contribution/tree/master/checkstyle-tester#antlr-regression-report
