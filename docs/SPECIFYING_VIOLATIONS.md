...
**Example from [`src/test/resources/com/puppycrawl/tools/checkstyle/checks/naming/typename/InputTypeName2.java`](https://github.com/checkstyle/checkstyle/blob/e9e67c42120524ea613d960af4e443375e37e799/src/test/resources/com/puppycrawl/tools/checkstyle/checks/naming/typename/InputTypeName2.java#L15):**
...
Take `AvoidStaticImport` as an example. Go to its [page](https://checkstyle.org/checks/imports/avoidstaticimport.html#AvoidStaticImport),
scroll all the way to ['Violation Messages'](https://checkstyle.org/checks/imports/avoidstaticimport.html#Violation_Messages),
