...
public class Example2 {
  ...
  // violation below, 'Line is longer than 80 characters (found 88).'
  /**
   * This javadoc is really long long long long long long long long long long long long.
   * ThisJavadocCommentIsAReallyLongWordThatExceedsDefaultLineLimitOfHundredCharactersButWillNotGiveErrorDueToIgnorePattern.
   *
   * @param s1 string 1
   * @param s2 string 2
   * @param s3 string 3
