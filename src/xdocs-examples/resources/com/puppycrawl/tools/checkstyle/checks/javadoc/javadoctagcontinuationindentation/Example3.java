...
class Example3 {
   ...
   * @serialData
   * <code> // violation 'Line continuation .* expected level should be 4'
   * out.writeByte(1); // violation 'Line continuation .* expected level should be 4'
   * out.writeInt(nanos); // violation 'Line continuation .* expected level should be 4'
   * </code> // violation 'Line continuation .* expected level should be 4'
   */
