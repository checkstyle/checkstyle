...
class Example3 {
  ...
  private static int BadStatic = 2;
  // ok above, because private variable is excluded in pattern
  public static int good_static = 2;
  // ok above, because matching with the specified format
  ...
  // ok above, because package variable is excluded in pattern
}
// xdoc section -- end
