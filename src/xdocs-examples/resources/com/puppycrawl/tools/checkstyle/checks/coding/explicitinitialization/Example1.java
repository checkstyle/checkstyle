...
public class Example1 {
  private int intField1 = 0; // violation 'explicitly initialized'
  private int intField2 = 1;
  private int intField3;

  private char charField1 = '\0'; // violation 'explicitly initialized'
  private char charField2 = 'b';
  private char charField3;

  private boolean boolField1 = false; // violation 'explicitly initialized'
  private boolean boolField2 = true;
  private boolean boolField3;

  private Object objField1 = null; // violation 'explicitly initialized'
  private Object objField2 = new Object();
  private Object objField3;

  private int arrField1[] = null; // violation 'explicitly initialized'
