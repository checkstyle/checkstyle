...
// violation 8 lines below '<p> tag should be preceded with an empty line'
// xdoc section -- start
// violation 8 lines below 'tag should be placed immediately before the first word'
// violation 10 lines below 'tag should be placed immediately before the first word'
/**
 * No tag
 *
