...
class Example5 extends SuperClass {
  ...
  static int GLOBAL_COUNTER; // violation 'no more than '1' consecutive capital letters'
  final Set<String> stringsFOUND = new HashSet<>(); // violation 'no more than '1' consecutive capital letters'
  int firstNum;
