...
public class Example2 {
  ...
  public void secondMethod() { // violation, 'Method length is 6 lines (max allowed is 4).'
    int index = 0;   // line 2
    if (index < 5) { // line 3
      index++;     // line 4
    }                // line 5
  ...
  public void thirdMethod() { // violation, 'Method length is 5 lines (max allowed is 4).'
