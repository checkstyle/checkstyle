...
class Example1 {
  ...
  // violation 9 lines above 'Invalid '@return' tag for 'field2'.'
  // violation 8 lines above 'Invalid '@param' tag for 'field2'.'
  // violation 7 lines above 'Invalid '@throws' tag for 'field2'.'
  ...
  interface MyInterface {
     ...
     */
    int INT_FIELD = 0;
    // violation 5 lines above 'Invalid '@return' tag for 'INT_FIELD'.'
