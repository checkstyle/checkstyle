...
class Example1 {
  ...
  // violation 6 lines above 'Invalid '@return' tag for 'field2'.'
  // violation 6 lines above 'Invalid '@param' tag for 'field2'.'
  // violation 6 lines above 'Invalid '@throws' tag for 'field2'.'
  // violation 6 lines above 'Invalid '@exception' tag for 'field2'.'
  ...
  interface MyInterface {
     ...
     */
    int INT_FIELD = 0;
    // violation 4 lines above 'Invalid '@return' tag for 'INT_FIELD'.'
    // violation 4 lines above 'Invalid '@param' tag for 'INT_FIELD'.'
  }
}
// xdoc section - end
