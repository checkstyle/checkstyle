...
class Example1 {
  ...
  @Test
  public void f$oo() {}
  // violation above, 'Test method name 'f\$oo' is not valid. Each segment must start with a lowercase letter, min 2 chars, avoid single lowercase letter followed by uppercase, and contain only letters, digits, or underscores.'
