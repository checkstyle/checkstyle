...
public class GoogleNonConstantFieldNameCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "19:7: " + getCheckMessage(MSG_KEY_INVALID_FORMAT, "Foo"),
            "22:7: " + getCheckMessage(MSG_KEY_INVALID_FORMAT, "f"),
            "25:7: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "gradle_9_5_1"),
            "28:7: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "foo_bar"),
            "31:7: " + getCheckMessage(MSG_KEY_INVALID_FORMAT, "foo$bar"),
            "34:7: " + getCheckMessage(MSG_KEY_INVALID_FORMAT, "fO"),
        };
