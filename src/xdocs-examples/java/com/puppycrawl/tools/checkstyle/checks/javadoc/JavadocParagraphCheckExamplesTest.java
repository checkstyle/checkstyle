...
public class JavadocParagraphCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            ...
            "31:6: " + getCheckMessage(MSG_PRECEDED_BLOCK_TAG, "pre"),
            "38:6: " + getCheckMessage(MSG_REDUNDANT_PARAGRAPH),
    ...
    public void testExample2() throws Exception {
        final String[] expected = {
            ...
            "45:6: " + getCheckMessage(MSG_MISPLACED_TAG),
            "45:6: " + getCheckMessage(MSG_REDUNDANT_PARAGRAPH),
            "54:5: " + getCheckMessage(MSG_TAG_AFTER),
        };
