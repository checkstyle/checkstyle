...
public class PreferJavadocInlineTagsCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "14:14: " + getCheckMessage(MSG_KEY, "{@code ...}", "<code>"),
            "20:10: " + getCheckMessage(MSG_KEY, "{@link ...}", "<a href=\"#...\">"),
            "28:10: " + getCheckMessage(MSG_KEY, "{@literal <}", "&lt;"),
            "28:15: " + getCheckMessage(MSG_KEY, "{@literal >}", "&gt;"),
            "44:6: " + getCheckMessage(MSG_KEY, "{@snippet ...}", "<pre>"),
        };
