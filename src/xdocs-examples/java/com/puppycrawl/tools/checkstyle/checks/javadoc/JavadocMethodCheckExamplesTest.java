...
public class JavadocMethodCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            ...
            "17:30: " + getCheckMessage(MSG_EXPECTED_TAG, "@param", "p1"),
            "25: " + getCheckMessage(MSG_RETURN_EXPECTED, "@return"),
            "31:24: " + getCheckMessage(MSG_EXPECTED_TAG, "@param", "p1"),
        };
    ...
    public void testExample4() throws Exception {
        final String[] expected = {
            ...
            "19:30: " + getCheckMessage(MSG_EXPECTED_TAG, "@param", "p1"),
            "33:24: " + getCheckMessage(MSG_EXPECTED_TAG, "@param", "p1"),
        };
