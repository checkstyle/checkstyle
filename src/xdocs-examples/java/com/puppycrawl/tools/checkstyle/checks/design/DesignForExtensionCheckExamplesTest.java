...
public class DesignForExtensionCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            ...
            "44:3: " + getCheckMessage(MSG_KEY, "Example1", "toString"),
        };
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            ...
            "38:3: " + getCheckMessage(MSG_KEY, "Example3", "m7"),
            "45:3: " + getCheckMessage(MSG_KEY, "Example3", "m8"),
            "48:3: " + getCheckMessage(MSG_KEY, "Example3", "toString"),
        };
    ...
    public void testExample4() throws Exception {
        final String[] expected = {
            ...
            "39:3: " + getCheckMessage(MSG_KEY, "Example4", "m7"),
            "48:3: " + getCheckMessage(MSG_KEY, "Example4", "toString"),
        };
