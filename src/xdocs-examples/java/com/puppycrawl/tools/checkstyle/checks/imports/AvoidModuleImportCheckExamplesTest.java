...
public class AvoidModuleImportCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            ...
            "16:1: " + getCheckMessage(MSG_KEY, "java.sql"),
        };
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            "18:1: " + getCheckMessage(MSG_COUNT, 1),
        };
