...
public class MethodLengthCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        ...
        final String[] expected = {
            ...
            "44:5: " + getCheckMessage(MSG_KEY, 5, max, "MyBadRecord"),
        };
    ...
    public void testExample2() throws Exception {
        ...
        final String[] expected = {
            "25:3: " + getCheckMessage(MSG_KEY, 6, max, "firstMethod"),
            "38:3: " + getCheckMessage(MSG_KEY, 5, max, "thirdMethod"),
        };
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            "37:3: " + getCheckMessage(MSG_KEY, 6, 4, "thirdMethod"),
        };
