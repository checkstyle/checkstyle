...
public class EmptyLineSeparatorExamplesTest extends AbstractModuleTestSupport {
    ...
    public void testExample2() throws Exception {
        final String[] expected = {
            "20:3: " + getCheckMessage(MSG_SHOULD_BE_SEPARATED, "VARIABLE_DEF"),
            "27:3: " + getCheckMessage(MSG_SHOULD_BE_SEPARATED, "METHOD_DEF"),
        };
    ...
    public void testExample5() throws Exception {
        final String[] expected = {
            ...
            "24:3: " + getCheckMessage(MSG_SHOULD_BE_SEPARATED, "VARIABLE_DEF"),
            "31:3: " + getCheckMessage(MSG_SHOULD_BE_SEPARATED, "METHOD_DEF"),
            "32:19: " + getCheckMessage(MSG_MULTIPLE_LINES_INSIDE),
        };
