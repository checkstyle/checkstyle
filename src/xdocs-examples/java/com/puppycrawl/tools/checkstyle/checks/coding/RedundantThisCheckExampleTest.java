...
public class RedundantThisCheckExampleTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample2() throws Exception {
        final String[] expected = {
            "16:5: " + getCheckMessage(MSG_KEY_VARIABLE, "name"),
            "21:5: " + getCheckMessage(MSG_KEY_VARIABLE, "age"),
        };
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            "18:5: " + getCheckMessage(MSG_KEY_VARIABLE, "name"),
            "23:5: " + getCheckMessage(MSG_KEY_VARIABLE, "age"),
            "28:5: " + getCheckMessage(MSG_KEY_METHOD, "show"),
        };
