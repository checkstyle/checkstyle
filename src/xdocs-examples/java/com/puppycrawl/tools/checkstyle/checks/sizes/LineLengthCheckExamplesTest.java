...
public class LineLengthCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "11: " + getCheckMessage(MSG_KEY, 80, 84),
            "18: " + getCheckMessage(MSG_KEY, 80, 92),
        };
    ...
    public void testExample5() throws Exception {
        final String[] expected = {
            "10: " + getCheckMessage(MSG_KEY, 60, 64),
            "14: " + getCheckMessage(MSG_KEY, 60, 84),
            "21: " + getCheckMessage(MSG_KEY, 60, 92),
        };
