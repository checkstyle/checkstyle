...
public class GenericWhitespaceCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "25:9: " + getCheckMessage(MSG_WS_NOT_PRECEDED, "<"),
            "35:24: " + getCheckMessage(MSG_WS_ILLEGAL_FOLLOW, ">"),
            "36:9: " + getCheckMessage(MSG_WS_FOLLOWED, "<"),
            "40:18: " + getCheckMessage(MSG_WS_PRECEDED, "<"),
            "44:33: " + getCheckMessage(MSG_WS_PRECEDED, ">"),
        };
