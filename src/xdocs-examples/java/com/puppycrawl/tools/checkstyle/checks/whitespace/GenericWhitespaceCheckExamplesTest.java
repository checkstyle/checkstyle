...
public class GenericWhitespaceCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            ...
            "34:24: " + getCheckMessage(MSG_WS_ILLEGAL_FOLLOW, ">"),
            "35:9: " + getCheckMessage(MSG_WS_FOLLOWED, "<"),
            "39:18: " + getCheckMessage(MSG_WS_PRECEDED, "<"),
            "43:33: " + getCheckMessage(MSG_WS_PRECEDED, "<"),
        };
