...
public class ClassTypeParameterNameCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        ...
        final String[] expected = {
            ...
            "19:18: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "LISTENER", pattern),
            "21:18: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "RequestT", pattern),
        };
    ...
    public void testExample2() throws Exception {
        ...
        final String[] expected = {
            "15:18: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "T", pattern),
            "17:18: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "t", pattern),
            "19:18: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "abc", pattern),
            "23:18: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "RequestT", pattern),
        };
    ...
    public void testExample3() throws Exception {
        ...
        final String[] expected = {
            "17:18: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "t", pattern),
            "19:18: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "abc", pattern),
            "21:18: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "LISTENER", pattern),
        };
