...
public class RedundantImportCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "17:8: " + getCheckMessage(MSG_SAME, "com.puppycrawl.tools.checkstyle.checks.imports.redundantimport.*"),
            "18:8: " + getCheckMessage(MSG_LANG, "java.lang.String"),
            "20:8: " + getCheckMessage(MSG_DUPLICATE, 19, "java.util.Scanner"),
        };
