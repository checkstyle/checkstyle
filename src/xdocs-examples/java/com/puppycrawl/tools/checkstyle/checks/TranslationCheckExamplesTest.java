...
public class TranslationCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        ...
        final File[] propertyFiles = {
            new File(getPath("Example1/messages.properties")),
            new File(getPath("Example1/messages_fr.properties")),
            new File(getPath("Example1/messages_ja.properties")),
        };

        expected.put(getPath("Example1/messages_fr.properties"),
                List.of("1: " + getCheckMessage(MSG_KEY, "age"),
                "1: " + getCheckMessage(MSG_KEY, "cancel"),
                "1: " + getCheckMessage(MSG_KEY, "hello")));
        expected.put(getPath("Example1/messages_ja.properties"),
                List.of("1: " + getCheckMessage(MSG_KEY, "cancel"),
                "1: " + getCheckMessage(MSG_KEY, "name"),
                "1: " + getCheckMessage(MSG_KEY, "hello")));
        expected.put(getPath("Example1/messages.properties"),
                List.of("1: " + getCheckMessage(MSG_KEY, "age"),
                "1: " + getCheckMessage(MSG_KEY, "name"),
