...
public class ConstantNameCheckExamplesTest extends AbstractModuleTestSupport {
    ...
    public void testExample2() throws Exception {
        final String format = "^log(ger)?$|^[A-Z][A-Z0-9]*(_[A-Z0-9]+)*$";

        final String[] expected = {
            "17:20: " + getCheckMessage(MSG_INVALID_PATTERN, "third_Constant3", format),
            "18:28: " + getCheckMessage(MSG_INVALID_PATTERN, "fourth_Const4", format),
            "21:20: " + getCheckMessage(MSG_INVALID_PATTERN, "loggerMYSELF", format),
            "23:30: " + getCheckMessage(MSG_INVALID_PATTERN, "myselfConstant", format),
        };
