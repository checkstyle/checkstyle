...
public class ConstantNameCheckExamplesTest extends AbstractModuleTestSupport {
    ...
    public void testExample2() throws Exception {
        ...
        final String[] expected = {
            "17:20: " + getCheckMessage(MSG_INVALID_PATTERN, "third_Constant3", pattern),
            "18:28: " + getCheckMessage(MSG_INVALID_PATTERN, "fourth_Const4", pattern),
            "21:20: " + getCheckMessage(MSG_INVALID_PATTERN, "loggerMYSELF", pattern),
            "23:30: " + getCheckMessage(MSG_INVALID_PATTERN, "myselfConstant", pattern),
        };
