...
public class InappropriateJavadocBlockTagsOnPackageCheckExamplesTest
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "16:1: " + getCheckMessage(MSG_INAPPROPRIATE_TAG, "param", "package"),
            "16:1: " + getCheckMessage(MSG_INAPPROPRIATE_TAG, "return", "package"),
        };
