...
public class ModuleImportOrderCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            ...
            "18:1: " + getCheckMessage(MSG_POSITION, "java.logging"),
        };
    ...
    public void testExample2() throws Exception {
        final String[] expected = {
            "17:1: " + getCheckMessage(MSG_SEPARATION, "java.util.List"),
        };
    ...
    public void testExample3() throws Exception {
        ...
        verifyWithInlineXmlConfig(getNonCompilablePath("Example3.java"), expected);
    }
