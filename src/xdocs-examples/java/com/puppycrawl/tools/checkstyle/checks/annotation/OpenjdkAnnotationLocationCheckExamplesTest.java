...
public class OpenjdkAnnotationLocationCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "33:5: " + getCheckMessage(MSG_KEY_ANNOTATION_ALONE_OR_SAME, "Deprecated"),
            "33:17: " + getCheckMessage(MSG_KEY_ANNOTATION_ALONE_OR_SAME, "SafeVarargs"),
            "41:5: " + getCheckMessage(MSG_KEY_ANNOTATION_ON_TARGET_LINE, "Nonnull"),
            "41:14: " + getCheckMessage(MSG_KEY_ANNOTATION_ON_TARGET_LINE, "Deprecated"),
        };
