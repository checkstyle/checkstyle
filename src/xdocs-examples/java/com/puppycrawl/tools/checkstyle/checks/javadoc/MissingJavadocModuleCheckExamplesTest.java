...
public class MissingJavadocModuleCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "10:1: " + getCheckMessage(MSG_MODULE_JAVADOC_MISSING),
        };
    ...
    public void testUseCase1() throws Exception {
        verifyWithInlineConfigParser(getNonCompilablePath("UseCase1.java"),
