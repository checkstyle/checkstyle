...
public class LambdaBodyLengthExamplesTest extends AbstractModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "10:19: " + getCheckMessage(MSG_KEY, 11, DEFAULT_MAX),
            "22:20: " + getCheckMessage(MSG_KEY, 11, DEFAULT_MAX),
        };
    ...
    public void testExample2() throws Exception {
        ...
        final String[] expected = {
            "11:19: " + getCheckMessage(MSG_KEY, 6, max),
            "18:20: " + getCheckMessage(MSG_KEY, 6, max),
        };
