...
public class AbstractClassNameCheckExamplesTest extends AbstractModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "11:3: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "Second", DEFAULT_PATTERN),
            "12:3: " + getCheckMessage(MSG_NO_ABSTRACT_CLASS_MODIFIER, "AbstractThird",
                DEFAULT_PATTERN),
            "14:3: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "GeneratorFifth",
                    DEFAULT_PATTERN),
        };
    ...
    public void testExample4() throws Exception {
        ...
        final String[] expected = {
            "12:3: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "AbstractFirst", pattern),
            "13:3: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "Second", pattern),
            "17:3: " + getCheckMessage(MSG_NO_ABSTRACT_CLASS_MODIFIER, "GeneratorSixth",
                pattern),
        };
