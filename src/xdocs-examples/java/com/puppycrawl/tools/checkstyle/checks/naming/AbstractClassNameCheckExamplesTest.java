...
public class AbstractClassNameCheckExamplesTest extends AbstractModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "14:3: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "Second", DEFAULT_PATTERN),
            "15:3: " + getCheckMessage(MSG_NO_ABSTRACT_CLASS_MODIFIER, "AbstractThird",
                DEFAULT_PATTERN),
            "17:3: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "GeneratorFifth",
                    DEFAULT_PATTERN),
        };
    ...
    public void testExample4() throws Exception {
        ...
        final String[] expected = {
            "13:3: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "AbstractFirst", format),
            "14:3: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "Second", format),
