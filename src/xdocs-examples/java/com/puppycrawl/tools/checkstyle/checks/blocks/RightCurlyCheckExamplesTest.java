...
public class RightCurlyCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    /**
     * Creates a new {@code RightCurlyCheckExamplesTest} instance.
     */
    public RightCurlyCheckExamplesTest() {
        // no code by default
    }
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            ...
            "26:21: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 21),
            "29:5: " + getCheckMessage(MSG_KEY_LINE_SAME, "}", 5),
        };
