...
public class PatternVariableNameCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        ...
        final String[] expected = {
            "15:34: " + getCheckMessage(MSG_INVALID_PATTERN, "STRING", pattern),
        };
    ...
    public void testExample2() throws Exception {
        ...
        final String[] expected = {
            "17:34: " + getCheckMessage(MSG_INVALID_PATTERN, "STR", pattern),
        };
    ...
    public void testExample3() throws Exception {
        ...
        final String[] expected = {
            "17:34: " + getCheckMessage(MSG_INVALID_PATTERN, "s", pattern),
        };
