...
public class EmptyLineWrappingInBlockExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "13:16: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE, "{"),
            "20:1: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE, "}"),
        };
    ...
    public void testExample2() throws Exception {
        final String[] expected = {
            "16:16: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE, "{"),
        };
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            "23:1: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE, "}"),
        };
    ...
    public void testExample4() throws Exception {
        final String[] expected = {
            "23:3: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_NO, "}"),
        };
