...
public class IllegalIdentifierNameCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample2() throws Exception {
        ...
        final String[] expected = {
            "18:9: " + getCheckMessage(MSG_INVALID_PATTERN, "var", format),
            "19:9: " + getCheckMessage(MSG_INVALID_PATTERN, "record", format),
            "20:12: " + getCheckMessage(MSG_INVALID_PATTERN, "yield", format),
            "22:12: " + getCheckMessage(MSG_INVALID_PATTERN, "Record", format),
            "22:27: " + getCheckMessage(MSG_INVALID_PATTERN, "record", format),
            "29:9: " + getCheckMessage(MSG_INVALID_PATTERN, "open", format),
            "30:12: " + getCheckMessage(MSG_INVALID_PATTERN, "transitive", format),
        };
