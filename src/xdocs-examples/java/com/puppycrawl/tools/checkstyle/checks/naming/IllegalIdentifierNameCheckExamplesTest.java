...
public class IllegalIdentifierNameCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        ...
        final String[] expected = {
            "14:7: " + getCheckMessage(MSG_INVALID_PATTERN, "var", format),
            "15:7: " + getCheckMessage(MSG_INVALID_PATTERN, "record", format),
            "16:10: " + getCheckMessage(MSG_INVALID_PATTERN, "yield", format),
            "19:10: " + getCheckMessage(MSG_INVALID_PATTERN, "Record", format),
            "21:19: " + getCheckMessage(MSG_INVALID_PATTERN, "record", format),
        };
    ...
    public void testExample2() throws Exception {
        ...
        final String[] expected = {
            "17:7: " + getCheckMessage(MSG_INVALID_PATTERN, "var", format),
