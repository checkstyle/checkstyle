...
public class ReturnCountCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample2() throws Exception {
        final String[] expected = {
            ...
            "27:5: " + getCheckMessage(MSG_KEY, 4, 2),
            "45:5: " + getCheckMessage(MSG_KEY_VOID, 1, 0),
        };
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            "28:5: " + getCheckMessage(MSG_KEY, 4, 2),
        };
    ...
    public void testExample4() throws Exception {
        final String[] expected = {
            "28:5: " + getCheckMessage(MSG_KEY, 4, 3),
        };
    ...
    public void testExample5() throws Exception {
        final String[] expected = {
            ...
            "36:5: " + getCheckMessage(MSG_KEY, 4, 2),
            "44:42: " + getCheckMessage(MSG_KEY, 2, 1),
        };
