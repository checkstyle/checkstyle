...
public class LocalVariableNameCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample4() throws Exception {
        ...
        final String[] expected = {
            ...
            "23:13: " + getCheckMessage(MSG_INVALID_PATTERN, "a", pattern),
            "26:13: " + getCheckMessage(MSG_INVALID_PATTERN, "I", pattern),
            "30:16: " + getCheckMessage(MSG_INVALID_PATTERN, "a", pattern),
            "33:16: " + getCheckMessage(MSG_INVALID_PATTERN, "A", pattern),
        };
