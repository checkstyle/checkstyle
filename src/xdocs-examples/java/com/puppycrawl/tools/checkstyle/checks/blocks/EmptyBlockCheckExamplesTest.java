...
public class EmptyBlockCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            ...
            "28:18: " + getCheckMessage(MSG_KEY_BLOCK_NO_STATEMENT, "case"),
            "32:16: " + getCheckMessage(MSG_KEY_BLOCK_NO_STATEMENT, "case"),
            "33:17: " + getCheckMessage(MSG_KEY_BLOCK_NO_STATEMENT, "case"),
        };
