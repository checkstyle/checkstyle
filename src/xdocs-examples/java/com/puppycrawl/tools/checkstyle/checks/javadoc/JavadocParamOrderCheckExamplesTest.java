...
public class JavadocParamOrderCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "19:6: " + getCheckMessage(MSG_KEY, "first"),
            "31:8: " + getCheckMessage(MSG_KEY, "name"),
        };
