...
public class ParenPadExamplesTest extends AbstractModuleTestSupport {
    @Override
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "13:8: " + getCheckMessage(MSG_WS_FOLLOWED, "("),
            "16:25: " + getCheckMessage(MSG_WS_PRECEDED, ")"),
            "24:11: " + getCheckMessage(MSG_WS_FOLLOWED, "("),
        };
