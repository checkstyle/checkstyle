...
public class AbbreviationAsWordInNameExamplesTest extends AbstractModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "22:7: " + getCheckMessage(MSG_KEY, "CURRENT_COUNTER", DEFAULT_EXPECTED_CAPITAL_COUNT),
    ...
    public void testExample3() throws Exception {
        ...
        final String[] expected = {
            "18:7: " + getCheckMessage(MSG_KEY, "secondNUM", expectedCapitalCount),
            "20:14: " + getCheckMessage(MSG_KEY, "fourthNUm", expectedCapitalCount),
        };
    ...
    public void testExample4() throws Exception {
        ...
        final String[] expected = {
            "19:7: " + getCheckMessage(MSG_KEY, "secondMYNum", expectedCapitalCount),
            "20:7: " + getCheckMessage(MSG_KEY, "thirdNUM", expectedCapitalCount),
            "23:10: " + getCheckMessage(MSG_KEY, "firstXML", expectedCapitalCount),
        };
    ...
    public void testExample5() throws Exception {
        ...
        final String[] expected = {
            "17:7: " + getCheckMessage(MSG_KEY, "counterXYZ", expectedCapitalCount),
    ...
    public void testExample6() throws Exception {
        ...
        final String[] expected = {
            "17:7: " + getCheckMessage(MSG_KEY, "counterXYZ", expectedCapitalCount),
            "18:13: " + getCheckMessage(MSG_KEY, "customerID", expectedCapitalCount),
            "20:20: " + getCheckMessage(MSG_KEY, "MAX_ALLOWED", expectedCapitalCount),
        };
