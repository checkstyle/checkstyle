...
public class TypeBodyPaddingExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "14:23: " + getCheckMessage(MSG_START_REQUIRED),
        };
    ...
    public void testExample2() throws Exception {
        final String[] expected = {
            "16:23: " + getCheckMessage(MSG_START_REQUIRED),
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            "23:1: " + getCheckMessage(MSG_END_REQUIRED),
        };
    ...
    public void testExample6() throws Exception {
        final String[] expected = {
            "16:23: " + getCheckMessage(MSG_START_REQUIRED),
            "18:22: " + getCheckMessage(MSG_START_REQUIRED),
        };
