...
public class TypeBodyPaddingExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample6() throws Exception {
        final String[] expected = {
            "18:15: " + getCheckMessage(MSG_AFTER_LCURLY),
            "20:3: " + getCheckMessage(MSG_BEFORE_RCURLY),
        };
    ...
    public void testExample7() throws Exception {
        final String[] expected = {
            "19:17: " + getCheckMessage(MSG_AFTER_LCURLY),
            "21:5: " + getCheckMessage(MSG_BEFORE_RCURLY),
        };
    ...
    public void testExample8() throws Exception {
        final String[] expected = {
            "21:21: " + getCheckMessage(MSG_AFTER_LCURLY),
            "23:1: " + getCheckMessage(MSG_BEFORE_RCURLY),
        };
