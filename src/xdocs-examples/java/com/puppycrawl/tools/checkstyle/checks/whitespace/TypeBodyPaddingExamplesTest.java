...
public class TypeBodyPaddingExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "12:16: " + getCheckMessage(MSG_AFTER_LCURLY),
            "14:1: " + getCheckMessage(MSG_BEFORE_RCURLY),
        };
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            "14:16: " + getCheckMessage(MSG_AFTER_LCURLY),
    ...
    public void testExample4() throws Exception {
        final String[] expected = {
            "16:1: " + getCheckMessage(MSG_BEFORE_RCURLY),
        };
    ...
    public void testExample6() throws Exception {
        final String[] expected = {
            "16:15: " + getCheckMessage(MSG_AFTER_LCURLY),
            "18:3: " + getCheckMessage(MSG_BEFORE_RCURLY),
        };
    ...
    public void testExample7() throws Exception {
        final String[] expected = {
            "17:17: " + getCheckMessage(MSG_AFTER_LCURLY),
    ...
    public void testExample8() throws Exception {
        final String[] expected = {
            "18:21: " + getCheckMessage(MSG_AFTER_LCURLY),
