...
public class JavadocBlockTagLocationCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        final String[] expected = {
            "17: " + getCheckMessage(MSG_BLOCK_TAG_LOCATION, "return"),
        };
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            "19: " + getCheckMessage(MSG_BLOCK_TAG_LOCATION, "return"),
            "21: " + getCheckMessage(MSG_BLOCK_TAG_LOCATION, "noinspection"),
        };
