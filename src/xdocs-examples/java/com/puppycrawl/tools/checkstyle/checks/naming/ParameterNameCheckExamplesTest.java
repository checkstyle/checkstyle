...
public class ParameterNameCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample5() throws Exception {
        final String[] expected = {
            "25:30: " + getCheckMessage(MSG_INVALID_PATTERN,  AccessModifierOption.PROTECTED, "V2", "^[a-z]([a-z0-9][a-zA-Z0-9]*)?$"),
            "27:27: " + getCheckMessage(MSG_INVALID_PATTERN, AccessModifierOption.PROTECTED, "b", "^[a-z][a-z0-9][a-zA-Z0-9]*$"),
        };
