...
public class ImportOrderCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample3() throws Exception {
        final String[] expected = {
            "22:1: " + getCheckMessage(MSG_SEPARATED_IN_GROUP, "java.io.File"),
    ...
    public void testExample4() throws Exception {
        final String[] expected = {
            ...
            "26:1: " + getCheckMessage(MSG_ORDERING, "javax.swing.JComponent"),
        };
    ...
    public void testExample8() throws Exception {
        final String[] expected = {
            "19:1: " + getCheckMessage(MSG_ORDERING, "java.util.Collections.emptyList"),
            "20:1: " + getCheckMessage(MSG_ORDERING, "java.lang.Math.sin"),
            "21:1: " + getCheckMessage(MSG_ORDERING, "java.lang.Math.abs"),
    ...
    public void testExample10() throws Exception {
        final String[] expected = {
            "18:1: " + getCheckMessage(MSG_SEPARATION, "javax.swing.WindowConstants.EXIT_ON_CLOSE"),
            "19:1: " + getCheckMessage(MSG_SEPARATION,
