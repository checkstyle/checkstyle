...
public class ImportOrderCheckExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample4() throws Exception {
        final String[] expected = {
            ...
            "26:1: " + getCheckMessage(MSG_SEPARATED_IN_GROUP, "java.net.URL"),
            "28:1: " + getCheckMessage(MSG_ORDERING, "javax.swing.JComponent"),
            "29:1: " + getCheckMessage(MSG_ORDERING, "com.neurologic.http.HttpClient"),
        };
