...
public class SuppressionXpathSingleFilterExamplesTest extends AbstractExamplesModuleTestSupport {
    ...
    public void testExample1() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(getPath("Example1.java"), expectedWithoutFilter, expectedWithFilter);
    }
    ...
    public void testExample2() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(getPath("Example2.java"), expectedWithoutFilter, expectedWithFilter);
    }
    ...
    public void testExample3() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(getPath("Example3.java"), expectedWithoutFilter, expectedWithFilter);
    }
    ...
    public void testExample4() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(getPath("Example4.java"), expectedWithoutFilter, expectedWithFilter);
    ...
    public void testExample5() throws Exception {
        final String[] expectedWithoutFilter = {
            ...
            "17:10: " + getCheckMessage(RedundantModifierCheck.class,
                    RedundantModifierCheck.MSG_KEY, "static"),
            "17:17: " + getCheckMessage(RedundantModifierCheck.class,
                    RedundantModifierCheck.MSG_KEY, "final"),
        };
        final String[] expectedWithFilter = {};

        verifyFilterWithInlineConfigParser(getPath("Example5.java"), expectedWithoutFilter, expectedWithFilter);
    }
    ...
    public void testExample7() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(getPath("Example7.java"), expectedWithoutFilter, expectedWithFilter);
    }
    ...
    public void testExample8() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(getPath("Example8.java"), expectedWithoutFilter, expectedWithFilter);
    }
    ...
    public void testExample9() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(getPath("Example9.java"), expectedWithoutFilter, expectedWithFilter);
    }
    ...
    public void testExample11() throws Exception {
        final String[] expectedWithoutFilter = {
            "24:5: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE,
                    "age", ""),
