...
@Suite.SuiteClasses( {AccessResultTest.class, AvoidStarImportTest.class,
    GuardTest.class, IllegalImportCheckTest.class,
    ImportControlCheckTest.class, ImportControlLoaderTest.class,
    ImportOrderCheckTest.class, PkgControlTest.class,
    RedundantImportCheckTest.class, UnusedImportsCheckTest.class})
