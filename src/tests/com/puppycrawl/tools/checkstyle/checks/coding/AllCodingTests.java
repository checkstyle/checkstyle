...
@Suite.SuiteClasses( {ArrayTrailingCommaCheckTest.class,
    ...
    NestedTryDepthCheckTest.class, PackageDeclarationCheckTest.class,
    ParameterAssignmentCheckTest.class, RedundantThrowsCheckTest.class,
    RequireThisCheckTest.class, ReturnCountCheckTest.class,
