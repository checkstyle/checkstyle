...
record Parallelogram(int x, int y, double z) implements Rhombus{
    ...
    strictfp public final record Trapeziod(int x, int y, double z)implements Rhombus { // violation
    }
}
