...
public class InputPatternVariableAssignmentCheck1 {
    public void testAssignment(Object obj) {
        ...
        if (obj instanceof Rectangle(ColoredPoint x, ColoredPoint y)) {
            ...
            y = new ColoredPoint(3, 4, "blue"); // violation, "Assignment of pattern variable 'y' is not allowed."
        }
        ...
        if (obj instanceof Rectangle(ColoredPoint(int x1, ColoredPoint(int y1,int y2, String d), String c), int x)) {
            c = "red";   // violation, "Assignment of pattern variable 'c' is not allowed."
        }
        if (obj instanceof Rectangle(ColoredPoint(int x1,int x2,String c), ColoredPoint(int y1,int y2, String d))) {
            c = "red";   // violation, "Assignment of pattern variable 'c' is not allowed."
        }
    }
}
