...
import static java.io.File.createTempFile; // violation 'Import statement for 'java.io.File.createTempFile' is in the wrong order. Should be in the 'STATIC' group, expecting not assigned imports.*'
