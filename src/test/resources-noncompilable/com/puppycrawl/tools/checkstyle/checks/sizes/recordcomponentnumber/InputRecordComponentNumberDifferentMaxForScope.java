 ...
 *
 */
public class InputRecordComponentNumberDifferentMaxForScope {
    ...
    private record TestRecord2(int x, int y){ // ok

    }

    private record TestRecord3(String str, int x, int y){ // ok

    }

    record TestRecord4(Node node, // ok
                              Point x,
                              Point y,
                              int translation,
                              Shape square){
