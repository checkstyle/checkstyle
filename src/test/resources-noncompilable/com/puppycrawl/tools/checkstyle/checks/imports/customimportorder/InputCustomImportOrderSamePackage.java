...
import java.util.*; // violation 'Wrong lexicographical order for 'java.util.*' import. Should be before 'java.util.StringTokenizer''
...
import com.puppycrawl.tools.*; // violation 'Wrong lexicographical order for 'com.puppycrawl.tools.*' import. Should be before 'java.util.StringTokenizer''
...
import com.*; // violation 'Wrong lexicographical order for 'com.*' import. Should be before 'java.util.StringTokenizer''
import org.apache.*;
