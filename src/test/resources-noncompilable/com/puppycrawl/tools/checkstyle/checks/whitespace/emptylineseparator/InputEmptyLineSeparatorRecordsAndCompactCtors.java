...
public class InputEmptyLineSeparatorRecordsAndCompactCtors {
    ...
    record MyRecord1(String foo) { // violation ''RECORD_DEF' should be separated from previous line'
        ...
        MyRecord1(int x){this("string");} // violation ''CTOR_DEF' should be separated from previous line'
        static{} // violation ''STATIC_INIT' should be separated from previous line'
    }
    record InBetween2(int x, int y) {} // violation ''RECORD_DEF' should be separated from previous line'
    ...
    record recordCompactCtors1(){
        void method1(){}
        public recordCompactCtors1{} // violation ''COMPACT_CTOR_DEF' should be separated from previous line'
        void method2(){} // violation ''METHOD_DEF' should be separated from previous line'
    }

    record recordCompactCtors2(){
        public static final int X = 1;
        public recordCompactCtors2{} // violation ''COMPACT_CTOR_DEF' should be separated from previous line'
        public static final int Y = 1; // violation ''VARIABLE_DEF' should be separated from previous line'
    }
