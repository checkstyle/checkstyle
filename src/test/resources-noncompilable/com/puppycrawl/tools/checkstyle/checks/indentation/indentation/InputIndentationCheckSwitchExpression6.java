...
public class InputIndentationCheckSwitchExpression6 {                         //indent:0 exp:0
    ...
    private void run() {                                                      //indent:4 exp:4
            ...
            do {                                                              //indent:12 exp:12
                ...
                case 1:                                                       //indent:16 exp:16
                    try {                                                     //indent:20 exp:20
                        new InputIndentationCheckSwitchExpression6();         //indent:24 exp:24
                ...
                case 3, 4:                                                    //indent:16 exp:16
                    try {                                                     //indent:20 exp:20
                        ...
                        if (i == 2 || i == 4) {                               //indent:24 exp:24
                            ...
                            } catch (InputIndentationCheckSwitchExpression6   //indent:28 exp:28
                                             .ResultException ex) {           //indent:45 exp:45
                                yield ex.result;                              //indent:32 exp:32
                            }                                                 //indent:28 exp:28
                        } else {                                              //indent:24 exp:24
                            yield true;                                       //indent:28 exp:28
                        }                                                     //indent:24 exp:24
                    }                                                         //indent:20 exp:20
        ...
        {                                                                     //indent:8 exp:8
            String s = "";                                                    //indent:12 exp:12
            Object o = switch (s) {                                           //indent:12 exp:12
                default -> s != null && s == s;                               //indent:16 exp:16
            };                                                                //indent:12 exp:12
            if (!(Boolean) o) {                                               //indent:12 exp:12
                throw new IllegalStateException();                            //indent:16 exp:16
            }                                                                 //indent:12 exp:12
        }                                                                     //indent:8 exp:8
    }                                                                         //indent:4 exp:4
