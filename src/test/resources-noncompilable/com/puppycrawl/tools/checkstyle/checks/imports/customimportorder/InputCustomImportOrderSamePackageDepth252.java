...
import java.util.concurrent.locks.LockSupport;  // violation 'Import statement for 'java.util.concurrent.locks.LockSupport' is in the wrong order. Should be in the 'SAME_PACKAGE' group, expecting not assigned imports.*'
