        ...
        public InputFinalLocalVariableCheckSwitchAssignment() throws Exception {
            ...
            c = switch (a) {
                ...
                default -> switch (b) {
                    ...
                    default -> 2; }; // violation ''}' at column 35 should be alone on a line'
            }; // ok
        }
        ...
        public void foo() throws Exception {
            ...
            c = switch (a) {
                case 0 -> switch (b) {
                    case 0 -> 1;
                    case 1 -> 2;
                    default -> 3; }; // violation ''}' at column 35 should be alone on a line'
                default -> 1; }; // violation ''}' at column 31 should be alone on a line'
        }
    }
}
...
class InputExecutableStatementCountRecords {
    ...
    private final int field = id(switch (value) {
        ...
        // violation above ''}' at column 55 should be alone on a line'
