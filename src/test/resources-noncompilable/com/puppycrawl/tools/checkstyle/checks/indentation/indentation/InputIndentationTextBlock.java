...
"""                                                           //indent:0 exp:12 warn
    ...
    public static String format(String block);                //indent:4 exp:4
    public class LOG {                                        //indent:4 exp:4
        public void warn(String block, String example){       //indent:8 exp:8
        }                                                     //indent:8 exp:8
        String getNumberOfErrors() {                          //indent:8 exp:8
        }                                                     //indent:8 exp:8
    }                                                         //indent:4 exp:4
}                                                             //indent:0 exp:0
