...
public class InputWhitespaceAfterAnnotation {
    ...
    void test5(String @AnnoType[]... param) {}
    // violation above ''AnnoType' is not followed by whitespace'

    void test6(String @AnnoType [] ... param) {}

    void test7(String @Size(max = 10)... names) {}
    // violation above '')' is not followed by whitespace'

    void test8(String @Size(max = 10) ... names) {}

    public String @NonNull[] @AnnoType[] test9() {
        // 2 violations above:
    ...
    public String @NonNull2 [] @AnnoType [] test10() {
        return null;
    }
    ...
    public void test13(final char @AnnotationAfterTest []a) {}

    public void test14(final char @AnnotationAfterTest[]a) {}
    // violation above ''AnnotationAfterTest' is not followed by whitespace'

    public @AnnotationAfterTest String @AnnoType [] test15() {
