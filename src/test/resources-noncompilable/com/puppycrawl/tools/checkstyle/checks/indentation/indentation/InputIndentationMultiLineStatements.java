...
public class InputIndentationMultiLineStatements {                     //indent:0 exp:0
  ...
  int testMultiLineifCondition(int newState, int tableName) { //indent:2 exp:2
  ...
  private String test5() {                                             //indent:2 exp:2
    final String simpleProperty = """s""";                                         //indent:4 exp:4
    return //indent:4 exp:4
      """ def newInstance = params.instance; //indent:6 exp:8 warn
  ...
  private String test6() {                                             //indent:2 exp:2
    final String simplePropertyUpdateScript = """s""";                             //indent:4 exp:4
    return //indent:4 exp:4
