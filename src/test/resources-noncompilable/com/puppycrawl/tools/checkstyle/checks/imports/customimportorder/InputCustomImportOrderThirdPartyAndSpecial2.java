...
import static javax.swing.WindowConstants.*; // violation 'Extra separation in import group before .*WindowConstants.*''


import java.awt.Button; // violation '.*Button' should be separated from previous import group by one line.'
import java.awt.Frame;


import java.awt.Dialog; // violation 'Extra separation in import group before .*Dialog''
import java.io.File;
...
import org.apache.commons.collections.*; // violation 'Extra separation in import group before .*collections.*''

import com.puppycrawl.tools.checkstyle.checks.imports.AbstractImportControl; // SAME_PACKAGE(6)


import com.puppycrawl.tools.checkstyle.checks.imports.AbstractImportRule; // violation 'Extra separation in import group before .*AbstractImportRule''
