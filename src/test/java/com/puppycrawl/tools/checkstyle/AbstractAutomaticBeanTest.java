...
public class AbstractAutomaticBeanTest {
    @Test
    public void configureNoSuchAttribute() {
    ...
    @Test
    public void configureNoSuchAttribute2() {
        final TestBean testBean = new TestBean();
        final DefaultConfiguration conf = new DefaultConfiguration("testConf");
    ...
    @Test
    public void setupChildFromBaseClass() throws Exception {
        final TestBean testBean = new TestBean();
    ...
    @Test
    public void setupInvalidChildFromBaseClass() {
        final TestBean testBean = new TestBean();
    ...
    @Test
    public void contextualizeInvocationTargetException() {
        final TestBean testBean = new TestBean();
    ...
    @Test
    public void contextualizeConversionException() {
        final TestBean testBean = new TestBean();
        final DefaultContext context = new DefaultContext();
    ...
    @Test
    public void registerIntegralTypes() throws Exception {
    ...
    @Test
    public void beanConverters() throws Exception {
    ...
    @Test
    public void beanConvertersUri2() throws Exception {
        final ConverterBean bean = new ConverterBean();
        final DefaultConfiguration config = new DefaultConfiguration("bean");
    ...
    @Test
    public void beanConvertersUri3() {
        final ConverterBean bean = new ConverterBean();
        final DefaultConfiguration config = new DefaultConfiguration("bean");
    ...
    @Test
    public void beanConverterPatternArray() throws Exception {
        final ConverterBean bean = new ConverterBean();
        final DefaultConfiguration config = new DefaultConfiguration("bean");
    ...
    @Test
    public void beanConverterPatternArraySingleElement() throws Exception {
        final ConverterBean bean = new ConverterBean();
        final DefaultConfiguration config = new DefaultConfiguration("bean");
    ...
    @Test
    public void beanConverterPatternArrayEmptyString() throws Exception {
        final ConverterBean bean = new ConverterBean();
        final DefaultConfiguration config = new DefaultConfiguration("bean");
