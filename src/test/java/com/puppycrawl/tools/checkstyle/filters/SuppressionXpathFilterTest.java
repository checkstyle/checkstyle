...
class SuppressionXpathFilterTest extends AbstractModuleTestSupport {
    ...
    @Test
    void xpathSuppression2() throws Exception {
        final String pattern = "[^a-zA-z0-9]*";
        final String[] expected = {
    ...
    @Test
    void xpathSuppression3() throws Exception {
        final String pattern = "[^a-zA-z0-9]*";
        final String[] expected = {
            "18:14: " + getCheckMessage(IllegalTokenTextCheck.class, MSG_KEY, pattern),
        };
    ...
    @Test
    void xpathSuppression4() throws Exception {
        final String[] suppressed = {
            "20:29: " + getCheckMessage(ConstantNameCheck.class,
                                        MSG_INVALID_PATTERN, "bad_name", PATTERN),
        };
