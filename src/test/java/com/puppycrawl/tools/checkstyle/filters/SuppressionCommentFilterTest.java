...
public class SuppressionCommentFilterTest
    ...
    private static @NonNull TreeWalkerAuditEvent getTreeWalkerAuditEvent(FileContents mockContents,
                                                                   File file, DetailAST rootAst) {
        ...
        return new TreeWalkerAuditEvent(
                mockContents, file.getAbsolutePath(), violation, rootAst);
    }
