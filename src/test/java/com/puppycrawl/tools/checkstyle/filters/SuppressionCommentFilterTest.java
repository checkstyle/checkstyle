...
public class SuppressionCommentFilterTest
    ...
    public void testCachingByFileContentsInstance() throws Exception {
        ...
        // due to caching second execution should not do parsing of comments in file
        // so exception is not expected and it means that filter file content caching is working
        assertWithMessage("should accept").that(filter.accept(event)).isTrue();
    }
