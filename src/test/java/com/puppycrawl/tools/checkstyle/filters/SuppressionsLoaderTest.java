...
public class SuppressionsLoaderTest extends AbstractPathTestSupport {
    ...
    @Test
    public void noSuppressions() throws Exception {
        final FilterSet fc =
    ...
    @Test
    public void loadFromMalformedUrl() {
        try {
    ...
    @Test
    public void loadFromNonExistentUrl() {
        try {
            SuppressionsLoader.loadSuppressions("http://^%$^* %&% %^&");
            assertWithMessage("exception expected").fail();
        }
    ...
    @Test
    public void multipleSuppression() throws Exception {
        final FilterSet fc =
    ...
    @Test
    public void badInt() throws Exception {
    ...
    @Test
    public void unableToFindSuppressions() {
    ...
    @Test
    public void unableToReadSuppressions() {
        final String sourceName = "InputSuppressionsLoaderNone.xml";
    ...
    @Test
    public void noCheckNoId() throws Exception {
    ...
    @Test
    public void noCheckYesId() throws Exception {
    ...
    @Test
    public void settingModuleId() throws Exception {
        final FilterSet fc =
    ...
    @Test
    public void xpathSuppressions() throws Exception {
    ...
    @Test
    public void xpathInvalidFileFormat() throws Exception {
    ...
    @Test
    public void xpathNoCheckNoId() throws Exception {
        final String fn =
    ...
    @Test
    public void xpathNoCheckYesId() throws Exception {
