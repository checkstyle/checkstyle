...
public class SuppressByMessageFilterTest extends AbstractModuleTestSupport {
    ...
    public void testDefault() throws Exception {
        ...
        final String[] expectedViolations = {
            "18:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "a", ""),
            "19:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "b", ""),
            "20:9: " + getCheckMessage(RequireThisCheck.class, MSG_METHOD, "foo", ""),
            "24:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "c", ""),
        };
