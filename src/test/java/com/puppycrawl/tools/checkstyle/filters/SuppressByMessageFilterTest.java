...
public class SuppressByMessageFilterTest extends AbstractModuleTestSupport {
    ...
    public void testDefault() throws Exception {
        ...
        final String[] expectedViolations = {
            "20:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "a", ""),
            "21:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "b", ""),
            "22:9: " + getCheckMessage(RequireThisCheck.class, MSG_METHOD, "foo", ""),
            "26:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "c", ""),
        };
    ...
    private void verifySuppressed(DefaultConfiguration config, String fileName,
        ...
        verify(checkerConfig,
                fileName,
                removeSuppressed(expectedViolations));
