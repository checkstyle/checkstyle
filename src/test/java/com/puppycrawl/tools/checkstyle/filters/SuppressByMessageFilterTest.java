...
public class SuppressByMessageFilterTest extends AbstractModuleTestSupport {
    ...
    public void testDefault() throws Exception {
        ...
        final String[] expectedViolations = {
            "22:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "a", ""),
            "23:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "b", ""),
            "24:9: " + getCheckMessage(RequireThisCheck.class, MSG_METHOD, "foo", ""),
            "28:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "c", ""),
        };
    ...
    public void testMatchNothing() throws Exception {
        ...
        final String[] expectedViolations = {
            "17:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "a", ""),
            "18:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "b", ""),
            "19:9: " + getCheckMessage(RequireThisCheck.class, MSG_METHOD, "foo", ""),
            "23:9: " + getCheckMessage(RequireThisCheck.class, MSG_VARIABLE, "c", ""),
        };
    ...
    private void verifySuppressed(DefaultConfiguration config, String fileName,
        ...
        verifyFilterWithInlineConfigParser(fileName, expectedViolations);
    }
}
