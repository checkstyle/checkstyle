...
public class SuppressFilterElementTest {
    ...
    public void testDecideByColumnWhenColumnsIsNull() {
        ...
        assertWithMessage("Filter should reject when column filter is null but file/check match")
    ...
    public void testDecideByLineAndColumnWhenBothAreNull() {
        ...
        assertWithMessage("Filter should reject when both filters null but file/check match")
                .that(suppressFilter.accept(ev))
                .isFalse();
    }
