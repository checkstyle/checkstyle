...
public class SuppressFilterElementTest {
    ...
    public void testDecideByColumnWhenColumnsIsNull() {
        ...
        // This means isLineAndColumnMatching should return true when both lineFilter
        // and columnFilter are null
        final SuppressFilterElement filterWithNullColumns =
                new SuppressFilterElement("Test", "Test", null, null, null, null);
        // Event should be rejected because file and check match, and both line
        // and column filters are null
