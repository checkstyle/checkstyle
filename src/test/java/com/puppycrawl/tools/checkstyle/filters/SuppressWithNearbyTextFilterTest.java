...
public class SuppressWithNearbyTextFilterTest
    ...
    @Test
    public void testNearbyTextFormat() throws Exception {
        final DefaultConfiguration filterCfg =
            createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("nearbyTextFormat", "cs (\\w+)");
        ...
        verifySuppressed(
            "InputSuppressWithNearbyTextFilterNearbyTextFormat.css",
    ...
    public void testCheckFormat() throws Exception {
        ...
        verifySuppressed(
            "InputSuppressWithNearbyTextFilterCheckFormat.bash",
            removeSuppressed(violationMessages, suppressed),
            filterCfg, lineLengthCheckCfg, regexpSinglelineCheckCfg
        );
    }
    ...
    public void testMessageFormat() throws Exception {
        ...
        verifySuppressed(
                "InputSuppressWithNearbyTextFilterMessageFormat.xml",
                removeSuppressed(violationMessages, suppressed),
                filterCfg, lineLengthCheckCfg, regexpSinglelineCheckCfg
        );
    }
    ...
    public void testIdFormat() throws Exception {
        ...
        verifySuppressed(
                "InputSuppressWithNearbyTextFilterIdFormat.html",
                removeSuppressed(violationMessages, suppressed),
                filterCfg, lineLengthCheckCfg, regexpSinglelineCheckCfg
        );
    }
    ...
    public void testVariableCheckFormatAndInfluenceFormat() throws Exception {
        final DefaultConfiguration filterCfg =
            createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("nearbyTextFormat", "SUPPRESS CHECKSTYLE (\\w+) - ([+-]\\d+) Lines");
        ...
        verifySuppressed(
            "InputSuppressWithNearbyTextFilter"
                    + "VariableNearbyTextFormatAndInfluenceFormat.xml",
            removeSuppressed(violationMessages, suppressed),
