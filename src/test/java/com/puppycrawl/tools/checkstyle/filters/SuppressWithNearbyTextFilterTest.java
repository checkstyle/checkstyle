...
public class SuppressWithNearbyTextFilterTest
    ...
    public void testInfluenceFormatPositive3() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(
            getPath("InputSuppressWithNearbyTextFilterInfluenceFormatPositive3.sql"),
            violationMessages, removeSuppressed(violationMessages, suppressedMessages)
        );
    }
    ...
    public void testInfluenceFormatNegative2() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(
            getPath("InputSuppressWithNearbyTextFilterInfluenceFormatNegative2.yml"),
            violationMessages, removeSuppressed(violationMessages, suppressedMessages)
        );
    }
    ...
    public void testInvalidCheckPattern() throws Exception {
        final String[] violationAndSuppressedMessages = {
            "18: " + getLineLengthCheckMessage(80, 87),
        };
    ...
    public void testInvalidInfluenceFormat() throws Exception {
        ...
        try {
            verifyFilterWithInlineConfigParser(
                getPath("InputSuppressWithNearbyTextFilterInvalidInfluenceFormat.txt"),
                violationAndSuppressedMessages
            );
            assertWithMessage("CheckstyleException is expected").fail();
        }
            ...
            assertWithMessage("Invalid exception message")
                ...
                .isEqualTo("unable to parse influence"
                        + " from 'SUPPRESS CHECKSTYLE aaaaaaaaa' using a!b");
        }
    }
