...
public class SuppressWithNearbyTextFilterTest
    ...
    public void testNearbyTextPattern() throws Exception {
        final DefaultConfiguration filterCfg =
            createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("nearbyTextPattern", "cs (\\w+)");
        ...
        final String[] violationMessages = {
            ...
            "27: " + getLineLengthCheckMessage(expectedLineLength, 94),
            "32: " + getLineLengthCheckMessage(expectedLineLength, 91),
            "32: " + getRegexpSinglelineCheckMessage(),
            "37: " + getLineLengthCheckMessage(expectedLineLength, 91),
            "42: " + getRegexpSinglelineCheckMessage(),
            "47: " + getLineLengthCheckMessage(expectedLineLength, 93),
            "52: " + getRegexpSinglelineCheckMessage(),
            "56: " + getLineLengthCheckMessage(expectedLineLength, 95),
        };
        ...
        verifySuppressed(
            "InputSuppressWithNearbyTextFilterNearbyTextPattern.css",
    ...
    public void testCheckPattern() throws Exception {
        final DefaultConfiguration filterCfg =
            createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("checkPattern", ".*Line.*");
        ...
        final String[] violationMessages = {
            "15: " + getRegexpSinglelineCheckMessage(),
            "27: " + getLineLengthCheckMessage(expectedLineLength, 89),
            "28: " + getRegexpSinglelineCheckMessage(),
            "34: " + getLineLengthCheckMessage(expectedLineLength, 87),
        };
    ...
    public void testMessagePattern() throws Exception {
        final DefaultConfiguration filterCfg =
                createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("messagePattern", ".*longer.*");
        ...
        final String[] violationMessages = {
            "15: " + getRegexpSinglelineCheckMessage(),
            "32: " + getRegexpSinglelineCheckMessage(),
            "37: " + getLineLengthCheckMessage(expectedLineLength, 98),
            "41: " + getLineLengthCheckMessage(expectedLineLength, 96),
        };
        ...
        verifySuppressed(
                "InputSuppressWithNearbyTextFilterMessagePattern.xml",
                removeSuppressed(violationMessages, suppressed),
                filterCfg, lineLengthCheckCfg, regexpSinglelineCheckCfg
        );
    }
    ...
    public void testIdPattern() throws Exception {
        final DefaultConfiguration filterCfg =
                createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("idPattern", "ignoreMe");
        ...
        verifySuppressed(
                "InputSuppressWithNearbyTextFilterIdPattern.html",
                removeSuppressed(violationMessages, suppressed),
                filterCfg, lineLengthCheckCfg, regexpSinglelineCheckCfg
        );
    }
    ...
    public void testInfluenceFormatPositive3() throws Exception {
        ...
        verifySuppressed(
            "InputSuppressWithNearbyTextFilterInfluenceFormatPositive3.sql",
            removeSuppressed(violationMessages, suppressed),
            filterCfg, lineLengthCheckCfg, regexpSinglelineCheckCfg
        );
    }
    ...
    public void testInfluenceFormatNegative2() throws Exception {
        ...
        verifySuppressed(
            "InputSuppressWithNearbyTextFilterInfluenceFormatNegative2.yml",
            removeSuppressed(violationMessages, suppressed),
            filterCfg, lineLengthCheckCfg, regexpSinglelineCheckCfg
        );
    }
    ...
    @Test
    public void testVariableCheckPatternAndInfluenceFormat() throws Exception {
        final DefaultConfiguration filterCfg =
            createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("nearbyTextPattern", "SUPPRESS CHECKSTYLE (\\w+) - ([+-]\\d+) Lines");
        filterCfg.addProperty("checkPattern", "$1");
        filterCfg.addProperty("influenceFormat", "$2");
        ...
        verifySuppressed(
            "InputSuppressWithNearbyTextFilter"
                    + "VariableNearbyTextPatternAndInfluenceFormat.xml",
            removeSuppressed(violationMessages, suppressed),
    ...
    public void testInvalidCheckPattern() throws Exception {
        final DefaultConfiguration filterCfg =
            createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("checkPattern", "a![b");
    ...
    public void testInvalidIdPattern() throws Exception {
        final DefaultConfiguration filterCfg =
            createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("idPattern", "a![b");
    ...
    public void testInvalidMessagePattern() throws Exception {
        final DefaultConfiguration filterCfg =
            createModuleConfig(SuppressWithNearbyTextFilter.class);
        filterCfg.addProperty("messagePattern", "a![b");
    ...
    public void testEqualsAndHashCodeOfSuppressionClass() throws ClassNotFoundException {
        final Class<?> suppressionClass = TestUtil.getInnerClassType(
                SuppressWithNearbyTextFilter.class, "Suppression");
