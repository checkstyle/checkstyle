...
public class SuppressWithNearbyTextFilterTest
    ...
    @Test
    public void testRowInfluencePositive3() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(
            getPath("InputSuppressWithNearbyTextFilterRowInfluencePositive3.sql"),
            violationMessages, removeSuppressed(violationMessages, suppressedMessages)
        );
    }

    @Test
    public void testRowInfluenceNegative2() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(
            getPath("InputSuppressWithNearbyTextFilterRowInfluenceNegative2.yml"),
            violationMessages, removeSuppressed(violationMessages, suppressedMessages)
        );
    }

    @Test
    public void testVariableCheckPatternAndRowInfluence() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(
            getPath("InputSuppressWithNearbyTextFilter"
                    + "VariableNearbyTextPatternAndRowInfluence.xml"),
            violationMessages, removeSuppressed(violationMessages, suppressedMessages)
        );
    }
    ...
    @Test
    public void testInvalidRowInfluence() throws Exception {
        final String[] violationAndSuppressedMessages = {
            "18: " + getLineLengthCheckMessage(80, 93),
        };
        ...
        try {
            verifyFilterWithInlineConfigParser(
                getPath("InputSuppressWithNearbyTextFilterInvalidRowInfluence.txt"),
                violationAndSuppressedMessages
            );
            assertWithMessage("CheckstyleException is expected").fail();
        }
