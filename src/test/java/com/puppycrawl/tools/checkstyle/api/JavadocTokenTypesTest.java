...
public class JavadocTokenTypesTest {
    ...
    public void testTokenValues() {
        ...
        assertEquals(msg, 43, JavadocTokenTypes.CODE_LITERAL);
        assertEquals(msg, 44, JavadocTokenTypes.DOC_ROOT_LITERAL);
        assertEquals(msg, 46, JavadocTokenTypes.LINK_LITERAL);
        assertEquals(msg, 45, JavadocTokenTypes.INHERIT_DOC_LITERAL);
        assertEquals(msg, 47, JavadocTokenTypes.LINKPLAIN_LITERAL);
        assertEquals(msg, 48, JavadocTokenTypes.LITERAL_LITERAL);
        assertEquals(msg, 49, JavadocTokenTypes.VALUE_LITERAL);
        assertEquals(msg, 28, JavadocTokenTypes.PACKAGE_CLASS);
        assertEquals(msg, 29, JavadocTokenTypes.HASH);
        assertEquals(msg, 31, JavadocTokenTypes.MEMBER);
        assertEquals(msg, 32, JavadocTokenTypes.LEFT_BRACE);
        assertEquals(msg, 33, JavadocTokenTypes.RIGHT_BRACE);
        assertEquals(msg, 34, JavadocTokenTypes.ARGUMENT);
        assertEquals(msg, 35, JavadocTokenTypes.COMMA);
        assertEquals(msg, 27, JavadocTokenTypes.STRING);
        assertEquals(msg, 41, JavadocTokenTypes.CLASS_NAME);
        ...
        assertEquals(msg, 37, JavadocTokenTypes.FIELD_NAME);
        assertEquals(msg, 39, JavadocTokenTypes.FIELD_TYPE);
        assertEquals(msg, 90, JavadocTokenTypes.HTML_TAG_NAME);
        assertEquals(msg, 5, JavadocTokenTypes.START);
        assertEquals(msg, 55, JavadocTokenTypes.SLASH);
        assertEquals(msg, 53, JavadocTokenTypes.END);
        assertEquals(msg, 54, JavadocTokenTypes.SLASH_END);
        assertEquals(msg, 56, JavadocTokenTypes.EQUALS);
        assertEquals(msg, 92, JavadocTokenTypes.ATTR_VALUE);
        assertEquals(msg, 57, JavadocTokenTypes.P_HTML_TAG_NAME);
        assertEquals(msg, 58, JavadocTokenTypes.LI_HTML_TAG_NAME);
        assertEquals(msg, 59, JavadocTokenTypes.TR_HTML_TAG_NAME);
        assertEquals(msg, 60, JavadocTokenTypes.TD_HTML_TAG_NAME);
        assertEquals(msg, 61, JavadocTokenTypes.TH_HTML_TAG_NAME);
        assertEquals(msg, 62, JavadocTokenTypes.BODY_HTML_TAG_NAME);
        assertEquals(msg, 63, JavadocTokenTypes.COLGROUP_HTML_TAG_NAME);
        assertEquals(msg, 64, JavadocTokenTypes.DD_HTML_TAG_NAME);
        assertEquals(msg, 65, JavadocTokenTypes.DT_HTML_TAG_NAME);
        assertEquals(msg, 66, JavadocTokenTypes.HEAD_HTML_TAG_NAME);
        assertEquals(msg, 67, JavadocTokenTypes.HTML_HTML_TAG_NAME);
        assertEquals(msg, 68, JavadocTokenTypes.OPTION_HTML_TAG_NAME);
        assertEquals(msg, 69, JavadocTokenTypes.TBODY_HTML_TAG_NAME);
        assertEquals(msg, 70, JavadocTokenTypes.TFOOT_HTML_TAG_NAME);
        assertEquals(msg, 71, JavadocTokenTypes.THEAD_HTML_TAG_NAME);
        assertEquals(msg, 72, JavadocTokenTypes.AREA_HTML_TAG_NAME);
        assertEquals(msg, 73, JavadocTokenTypes.BASE_HTML_TAG_NAME);
        assertEquals(msg, 74, JavadocTokenTypes.BASEFONT_HTML_TAG_NAME);
        assertEquals(msg, 75, JavadocTokenTypes.BR_HTML_TAG_NAME);
        assertEquals(msg, 76, JavadocTokenTypes.COL_HTML_TAG_NAME);
        assertEquals(msg, 77, JavadocTokenTypes.FRAME_HTML_TAG_NAME);
        assertEquals(msg, 78, JavadocTokenTypes.HR_HTML_TAG_NAME);
        assertEquals(msg, 79, JavadocTokenTypes.IMG_HTML_TAG_NAME);
        assertEquals(msg, 80, JavadocTokenTypes.INPUT_HTML_TAG_NAME);
        assertEquals(msg, 81, JavadocTokenTypes.ISINDEX_HTML_TAG_NAME);
        assertEquals(msg, 82, JavadocTokenTypes.LINK_HTML_TAG_NAME);
        assertEquals(msg, 83, JavadocTokenTypes.META_HTML_TAG_NAME);
        assertEquals(msg, 84, JavadocTokenTypes.PARAM_HTML_TAG_NAME);
        assertEquals(msg, 85, JavadocTokenTypes.EMBED_HTML_TAG_NAME);
        assertEquals(msg, 86, JavadocTokenTypes.KEYGEN_HTML_TAG_NAME);
        assertEquals(msg, 87, JavadocTokenTypes.SOURCE_HTML_TAG_NAME);
        assertEquals(msg, 88, JavadocTokenTypes.TRACK_HTML_TAG_NAME);
        assertEquals(msg, 89, JavadocTokenTypes.WBR_HTML_TAG_NAME);
        assertEquals(msg, 2, JavadocTokenTypes.HTML_COMMENT_START);
        assertEquals(msg, 94, JavadocTokenTypes.HTML_COMMENT_END);
