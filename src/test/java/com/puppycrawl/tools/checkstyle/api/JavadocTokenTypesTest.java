...
public class JavadocTokenTypesTest {
    ...
    public void testTokenValues() {
        ...
        assertEquals(msg, 92, JavadocTokenTypes.HTML_TAG_NAME);
        ...
        assertEquals(msg, 94, JavadocTokenTypes.ATTR_VALUE);
        ...
        assertEquals(msg, 89, JavadocTokenTypes.SOURCE_HTML_TAG_NAME);
        assertEquals(msg, 90, JavadocTokenTypes.TRACK_HTML_TAG_NAME);
        assertEquals(msg, 91, JavadocTokenTypes.WBR_HTML_TAG_NAME);
        assertEquals(msg, 2, JavadocTokenTypes.HTML_COMMENT_START);
        assertEquals(msg, 96, JavadocTokenTypes.HTML_COMMENT_END);
