...
public class AbstractFileSetCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void processSequential() throws Exception {
        final DummyFileSetCheck check = new DummyFileSetCheck();
    ...
    @Test
    public void notProcessed() throws Exception {
     ...
     */
    @Test
    public void setExtensionThrowsExceptionWhenTheyAreNull() {
        final DummyFileSetCheck check = new DummyFileSetCheck();
        try {
    ...
    @Test
    public void lineColumnLog() throws Exception {
    ...
    @Test
    public void getMessageDispatcher() {
        final DummyFileSetCheck check = new DummyFileSetCheck();
    ...
    @Test
    public void multiFileFireErrors() throws Exception {
     ...
     */
    @Test
    public void copiedArrayIsReturned() {
        final DummyFileSetCheck check = new DummyFileSetCheck();
        check.setFileExtensions(".tmp");
