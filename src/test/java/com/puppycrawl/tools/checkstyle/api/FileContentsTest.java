...
public class FileContentsTest {
    ...
    public void testReportMarkdownCommentSingleLine() {
        final List<String> lines = Arrays.asList("/// markdown comment");
        final FileContents fileContents = new FileContents(
                new FileText(new File("filename"), lines));
        final String content = "markdown comment";
        final int startLineNo = 1;
        final int startColNo = 0;
        final int endLineNo = 1;
        final int endColNo = 19;
        fileContents.reportMarkdownComment(startLineNo, startColNo, endLineNo, endColNo);
    ...
    public void testUnmodifiableGetMarkdownComments() {
        ...
        final FileContents fileContents = new FileContents(
                new FileText(new File("filename"), lines));
        fileContents.reportMarkdownComment(1, 0, 1, 18);
