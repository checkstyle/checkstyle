...
public class TestInputViolationTest {
    ...
    public void testToRegexWithSpecialCharactersOutsideQuotes() {
        final TestInputViolation violation = new TestInputViolation(12, "message (with) {special} [brackets]");
    ...
    public void testToRegexWithMultipleQuotedBlocks() {
        ...
        assertWithMessage("Regex should escape characters outside multiple \\Q...\\E blocks but not inside")
                .that(violation.toRegex())
                .isEqualTo("2:(?:\\d+:)?\\s.*before \\Q^[a-z]\\E middle \\Q(test)\\E after \\(parenthesis\\).*");
    }
    ...
    public void testToRegexWithUnmatchedQuotes() {
        ...
        final TestInputViolation violation2 = new TestInputViolation(4, "unmatched \\E(parenthesis)");
