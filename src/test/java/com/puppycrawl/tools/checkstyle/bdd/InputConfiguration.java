...
public final class InputConfiguration {
    ...
    public static DefaultConfiguration createConfiguration() {
        // to be implemented
    ...
    public static final class Builder {
        ...
        public Builder withDefaultProperties(Map<String, String> nonDefaultPropertiesMap) {
            if (nonDefaultPropertiesMap != null) {
                defaultProperties.putAll(nonDefaultPropertiesMap);
            }
