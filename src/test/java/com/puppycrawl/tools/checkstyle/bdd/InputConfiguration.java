...
public final class InputConfiguration {
    ...
    public static final class Builder {
        ...
        public Builder withCheckName(String inputCheckName) {
            checkName = inputCheckName;
            return this;
        }

        public Builder withDefaultProperties(Map<String, String> defaultPropertiesMap) {
            if (defaultPropertiesMap != null) {
                defaultProperties.putAll(defaultPropertiesMap);
            }

            return this;
        }

        public Builder withNonDefaultProperties(Map<String, String> nonDefaultPropertiesMap) {
            if (nonDefaultPropertiesMap != null) {
                nonDefaultProperties.putAll(nonDefaultPropertiesMap);
            }

            return this;
        }

        public Builder withViolationList(List<String> violationList) {
