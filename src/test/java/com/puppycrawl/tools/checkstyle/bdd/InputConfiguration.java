...
public final class InputConfiguration {
    ...
    public static class Builder {
        ...
        public Builder withDefaultProperties(Map<String, String> nonDefaultProperties) {
            if (nonDefaultProperties != null) {
                this.defaultProperties.putAll(nonDefaultProperties);
            }
        ...
        public Builder withNonDefaultProperties(Map<String, String> nonDefaultPropertiesMap) {
            if (nonDefaultPropertiesMap != null) {
                this.nonDefaultProperties.putAll(nonDefaultPropertiesMap);
            }
