...
public class SuppressionFileGeneratorAuditListenerTest {
     ...
     * which is not possible to get from the CLI run test in {@link MainTest.java}.
     */
    @Test
     ...
     *     in {@link SuppressionFileGeneratorAuditListener}.
     */
    @Test
     ...
     * which is not supported by OutputStream {@link System.out} and
     * {@link Files.newOutputStream} used in {@link Main.java}.
     */
    @Test
