...
public class MainFrameModelTest extends AbstractModuleTestSupport {
    ...
    @Test
    void openFileNonExistentFile() throws Exception {
    ...
    @Test
    void openFileNonCompilableFile() throws Exception {
    ...
    @Test
    void shouldNotAcceptNonExistentFile() throws Exception {
        final File nonExistentFile = new File(getPath(FILE_NAME_NON_EXISTENT));
    ...
    @Test
    void openFileForUnknownParseMode() throws Exception {
        final File javaFile = new File(getPath(FILE_NAME_TEST_DATA));
