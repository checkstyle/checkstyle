...
public class JavadocLeadingAsteriskAlignCheckTest extends AbstractModuleTestSupport {
    ...
    public void testIndentationZero() throws Exception {
        final String[] expected = {
            ...
            "58:4: " + getCheckMessage(JavadocLeadingAsteriskAlignCheck.class, MSG_KEY, 1, 4),
            "59:4: " + getCheckMessage(JavadocLeadingAsteriskAlignCheck.class, MSG_KEY, 1, 4),
        };
    ...
    @Test
    public void testIndentationNegative() throws Exception {
        final String[] expected = {
            "22:6: " + getCheckMessage(JavadocLeadingAsteriskAlignCheck.class, MSG_KEY, 1, -2),
            "23:6: " + getCheckMessage(JavadocLeadingAsteriskAlignCheck.class, MSG_KEY, 1, -2),
        };

        final String filePath =
                getPath("InputJavadocLeadingAsteriskAlignIndentationNegative.java");
        verifyWithInlineConfigParser(filePath, expected);
    }
    ...
    public void testIndentationWithTabs() throws Exception {
        final String[] expected = {
            "23:6: " + getCheckMessage(JavadocLeadingAsteriskAlignCheck.class, MSG_KEY, 1, 0),
            "24:6: " + getCheckMessage(JavadocLeadingAsteriskAlignCheck.class, MSG_KEY, 1, 0),
        };

        final String filePath = getPath("InputJavadocLeadingAsteriskAlignIndentationTabs.java");
        verifyWithInlineConfigParser(filePath, expected);
    }
