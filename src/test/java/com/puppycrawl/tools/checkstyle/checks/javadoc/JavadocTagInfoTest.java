...
public class JavadocTagInfoTest {
    ...
    public void testSerialField() {
        ...
        ////
        final DetailAstImpl invalidNode = new DetailAstImpl();
        invalidNode.setType(TokenTypes.METHOD_DEF); // Not VARIABLE_DEF
    
        // Build valid child structure (TYPE -> ARRAY_DECLARATOR -> "ObjectStreamField")
    ...
    public void testSerialData() {
        ...
        for (int type : invalidTypes) {
            ast.setType(type);
            astChild.setText("writeObject"); // Valid name but invalid node
