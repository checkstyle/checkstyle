...
public class NestedForDepthCheckTest extends AbstractModuleTestSupport {
     ...
     */
    @Test
    public void testNestedForDepthTwoLevel() throws Exception {
        ...
        verifyWithInlineConfigParser(
                getPath("InputNestedForDepthTwoLevel.java"),
               expected);
    }
     ...
     */
    @Test
    public void testNestedForDepthFourLevel() throws Exception {

        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;

        verifyWithInlineConfigParser(
                getPath("InputNestedForDepthFourLevel.java"),
               expected);
    }
