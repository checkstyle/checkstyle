...
public class SuppressWarningsHolderTest extends AbstractModuleTestSupport {
    ...
    public void testGetAllAnnotationValuesWrongArg() {
        ...
        try {
            TestUtil.invokeMethodDefault(holder, "getAllAnnotationValues", parent);
            assertWithMessage("Exception expected").fail();
        }
    ...
    public void testGetAnnotationValuesWrongArg() {
        ...
        try {
            TestUtil.invokeMethodDefault(holder, "getAnnotationValues", methodDef);
            assertWithMessage("Exception expected").fail();
        }
        catch (ReflectiveOperationException exc) {
            assertWithMessage("Error type is unexpected")
    ...
    public void testGetAnnotationTargetWrongArg() {
        ...
        try {
            TestUtil.invokeMethodDefault(holder, "getAnnotationTarget", methodDef);
            assertWithMessage("Exception expected").fail();
        }
        catch (ReflectiveOperationException exc) {
            assertWithMessage("Error type is unexpected")
