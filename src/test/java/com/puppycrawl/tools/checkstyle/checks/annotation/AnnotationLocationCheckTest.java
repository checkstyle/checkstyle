...
class AnnotationLocationCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    void incorrectOne() throws Exception {
    ...
    @Test
    void incorrectTwo() throws Exception {
        final String[] expected = {
    ...
    @Test
    void incorrectAllTokensOne() throws Exception {
        final String[] expected = {
    ...
    @Test
    void incorrectAllTokensTwo() throws Exception {
        final String[] expected = {
    ...
    @Test
    void withParametersOne() throws Exception {
        final String[] expected = {
    ...
    @Test
    void withParametersTwo() throws Exception {
        final String[] expected = {
    ...
    @Test
    void annotationLocationOnLocalAndPatternVariables() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
