...
public class TypeBodyPaddingCheckTest extends AbstractModuleTestSupport {
    ...
    public void testEmptyNotAllowed1() throws Exception {
        final String[] expected = {
            "14:44: " + getCheckMessage(MSG_START_REQUIRED),
            "15:1: " + getCheckMessage(MSG_END_REQUIRED),
        };
    ...
    public void testEmptyNotAllowed2() throws Exception {
        final String[] expected = {
            "14:44: " + getCheckMessage(MSG_START_REQUIRED),
            "14:45: " + getCheckMessage(MSG_END_REQUIRED),
        };
    ...
    public void testStarting() throws Exception {
        final String[] expected = {
            "14:33: " + getCheckMessage(MSG_START_REQUIRED),
        };
    ...
    public void testBoth() throws Exception {
        final String[] expected = {
            "14:39: " + getCheckMessage(MSG_START_REQUIRED),
    ...
    public void testCommentStart() throws Exception {
        final String[] expected = {
            "13:47: " + getCheckMessage(MSG_START_REQUIRED),
        };
    ...
    public void testInner() throws Exception {
        final String[] expected = {
            "18:17: " + getCheckMessage(MSG_START_REQUIRED),
        };
