...
public class NoGetMessageInCatchThrowCheckTest extends AbstractModuleTestSupport {
    ...
    public void testMultipleCatches() throws Exception {
        final String[] expected = {
            ...
            "38:13: " + getCheckMessage(MSG_KEY, "ex"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testOnlyOneViolationReported() throws Exception {
        ...
        verifyWithInlineConfigParser(
                getPath("InputNoGetMessageInCatchThrowMultipleThrows.java"),
                expected);
    }
    ...
    public void testNonMethodCalls() throws Exception {
        final String[] expected = {};
        verifyWithInlineConfigParser(
                getPath("InputNoGetMessageInCatchThrowNonMethodCalls.java"),
                expected);
    }
    ...
    public void testSiblingTraversal() throws Exception {
        final String[] expected = {
            "19:13: " + getCheckMessage(
                NoGetMessageInCatchThrowCheck.MSG_KEY, "ex"),
        };
        verifyWithInlineConfigParser(
                getPath("InputNoGetMessageInCatchThrowSiblingTraversal.java"),
                expected);
    }
