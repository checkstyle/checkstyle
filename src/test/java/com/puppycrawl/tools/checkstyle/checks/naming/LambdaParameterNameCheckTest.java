...
public class LambdaParameterNameCheckTest extends AbstractModuleTestSupport {
    ...
    public void testParametersInLambda() throws Exception {
        ...
        final String[] expected = {
            ...
            "17:66: " + getCheckMessage(MSG_INVALID_PATTERN, "st", pattern),
            "19:65: " + getCheckMessage(MSG_INVALID_PATTERN, "s1", pattern),
            "19:69: " + getCheckMessage(MSG_INVALID_PATTERN, "s2", pattern),
            "21:80: " + getCheckMessage(MSG_INVALID_PATTERN, "s", pattern),
        };
