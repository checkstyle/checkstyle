...
public class PreferCodeOrSnippetJavadocInlineTagCheckTest extends AbstractModuleTestSupport {
    ...
    public void testPreTag() throws Exception {
        final String[] expected = {
            "14:8: " + getCheckMessage(MSG_KEY_SINGLE_LINE, "pre"),
            "30:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "pre"),
            "54:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "pre"),
            "57:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "pre"),
        };
    ...
    public void testCodeTag() throws Exception {
        final String[] expected = {
            "14:8: " + getCheckMessage(MSG_KEY_SINGLE_LINE, "code"),
            "30:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "code"),
            "54:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "code"),
            "57:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "code"),
            "67:8: " + getCheckMessage(MSG_KEY_SINGLE_LINE, "code"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testMixTags() throws Exception {
        final String[] expected = {
            "14:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "pre"),
            "31:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "pre"),
            "48:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "code"),
            "65:8: " + getCheckMessage(MSG_KEY_MULTI_LINE, "pre"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testCompactSourceFile() throws Exception {
        final String[] expected = {
            "12:4: " + getCheckMessage(MSG_KEY_SINGLE_LINE, "pre"),
            "19:4: " + getCheckMessage(MSG_KEY_SINGLE_LINE, "code"),
            "36:4: " + getCheckMessage(MSG_KEY_MULTI_LINE, "pre"),
        };
        verifyWithInlineConfigParser(
