...
public class PreferCodeOrSnippetJavadocInlineTagCheckTest extends AbstractModuleTestSupport {
    ...
    public void testPreTag() throws Exception {
        final String[] expected = {
            "14: " + getCheckMessage(MSG_KEY_SINGLE_LINE),
            "30: " + getCheckMessage(MSG_KEY_MULTI_LINE),
            "54: " + getCheckMessage(MSG_KEY_MULTI_LINE),
            "57: " + getCheckMessage(MSG_KEY_MULTI_LINE),
        };
    ...
    public void testMixTags() throws Exception {
        final String[] expected = {
            "14: " + getCheckMessage(MSG_KEY_MULTI_LINE),
            "31: " + getCheckMessage(MSG_KEY_MULTI_LINE),
            "48: " + getCheckMessage(MSG_KEY_MULTI_LINE),
            "65: " + getCheckMessage(MSG_KEY_MULTI_LINE),
        };
        verifyWithInlineConfigParser(
    ...
    public void testCompactSourceFile() throws Exception {
        final String[] expected = {
            "12: " + getCheckMessage(MSG_KEY_SINGLE_LINE),
            "19: " + getCheckMessage(MSG_KEY_SINGLE_LINE),
            "36: " + getCheckMessage(MSG_KEY_MULTI_LINE),
        };
        verifyWithInlineConfigParser(
