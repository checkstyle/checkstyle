...
import static com.puppycrawl.tools.checkstyle.checks.whitespace.ArrayBracketWhitespaceCheck.MSG_WS_NOT_PRECEDED;
...
public class ArrayBracketWhitespaceCheckTest extends AbstractModuleTestSupport {
    ...
    public void testRightBracketFollowedByExceptionCharacters() throws Exception {
        final String[] expected = {
            ...
            "119:23: " + getCheckMessage(MSG_WS_FOLLOWED, "]"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testBoundaryConditions() throws Exception {
        ...
        verifyWithInlineConfigParser(
                getPath("InputArrayBracketWhitespaceBoundary.java"), expected);
    }
    ...
    public void testAnnotatedArrayDeclarations() throws Exception {
        final String[] expected = {
            "23:33: " + getCheckMessage(MSG_WS_NOT_PRECEDED, "["),
            "25:51: " + getCheckMessage(MSG_WS_NOT_PRECEDED, "["),
        };
        verifyWithInlineConfigParser(
    ...
    public void testCompact() throws Exception {
        final String[] expected = {
            ...
            "10:27: " + getCheckMessage(MSG_WS_PRECEDED, "["),
        };
        verifyWithInlineConfigParser(
                getNonCompilablePath("compact/InputArrayBracketWhitespaceCompact.java"), expected);
    }
