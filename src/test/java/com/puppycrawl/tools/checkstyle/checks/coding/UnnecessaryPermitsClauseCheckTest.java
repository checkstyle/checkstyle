...
public class UnnecessaryPermitsClauseCheckTest extends AbstractModuleTestSupport {
    ...
    public void testInnerClasses() throws Exception {
        final String[] expected = {
            "11:31: " + getCheckMessage(MSG_KEY),
            "21:38: " + getCheckMessage(MSG_KEY),
            "37:31: " + getCheckMessage(MSG_KEY),
        };
    ...
    @Test
    public void testRecordsAndEnums() throws Exception {
        final String[] expected = {
            "13:39: " + getCheckMessage(MSG_KEY),
            "20:37: " + getCheckMessage(MSG_KEY),
        };

        verifyWithInlineConfigParser(
            getPath("InputUnnecessaryPermitsClauseRecordsAndEnums.java"),
            expected);
    }
