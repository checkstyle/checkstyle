...
public class JavadocNoErrorInThrowsTagCheckTest extends AbstractModuleTestSupport {
    ...
    public void testIncorrect() throws Exception {
        final String[] expected = {
            ...
            "36:8: " + getCheckMessage(MSG_KEY, "OutOfMemoryError", "@throws"),
            "46:8: " + getCheckMessage(MSG_KEY, "StackOverflowError", "@exception"),
            "56:8: " + getCheckMessage(MSG_KEY, "com.example.CustomError", "@throws"),
        };
