...
public class JavadocParagraphCheckTest extends AbstractModuleTestSupport {
    ...
    public void testAllowNewlineParagraph() throws Exception {
        ...
        final String[] expected = {
            "9: " + getCheckMessage(MSG_LINE_BEFORE),
            "10: " + getCheckMessage(MSG_LINE_BEFORE),
            "16: " + getCheckMessage(MSG_LINE_BEFORE),
            "25: " + getCheckMessage(MSG_LINE_BEFORE),
            "34: " + getCheckMessage(MSG_LINE_BEFORE),
            "34: " + getCheckMessage(MSG_REDUNDANT_PARAGRAPH),
            "35: " + getCheckMessage(MSG_LINE_BEFORE),
            "36: " + getCheckMessage(MSG_LINE_BEFORE),
            "37: " + getCheckMessage(MSG_LINE_BEFORE),
            "41: " + getCheckMessage(MSG_LINE_BEFORE),
            "47: " + getCheckMessage(MSG_REDUNDANT_PARAGRAPH),
            "52: " + getCheckMessage(MSG_LINE_BEFORE),
            "53: " + getCheckMessage(MSG_LINE_BEFORE),
            "63: " + getCheckMessage(MSG_REDUNDANT_PARAGRAPH),
            "64: " + getCheckMessage(MSG_TAG_AFTER),
            "72: " + getCheckMessage(MSG_LINE_BEFORE),
            "77: " + getCheckMessage(MSG_LINE_BEFORE),
            "83: " + getCheckMessage(MSG_TAG_AFTER),
            "84: " + getCheckMessage(MSG_TAG_AFTER),
        };
