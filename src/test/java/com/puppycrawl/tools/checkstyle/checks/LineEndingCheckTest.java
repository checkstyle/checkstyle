...
public class LineEndingCheckTest extends AbstractModuleTestSupport {
    ...
    private static DefaultConfiguration getLfConfig() {
        return createModuleConfig(LineEndingCheck.class);
    }

    private static DefaultConfiguration getCrlfConfig() {
        final DefaultConfiguration checkConfig = createModuleConfig(LineEndingCheck.class);
        checkConfig.addProperty("lineEnding", "crlf");
        return checkConfig;
    }

    private static DefaultConfiguration getCrConfig() {
        final DefaultConfiguration checkConfig = createModuleConfig(LineEndingCheck.class);
