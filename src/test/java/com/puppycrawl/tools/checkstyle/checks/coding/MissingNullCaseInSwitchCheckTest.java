...
public class MissingNullCaseInSwitchCheckTest extends
    ...
    @Test
    void missingNullCaseInSwitchWithPattern() throws Exception {
    ...
    @Test
    void missingNullCaseInSwitchWithPattern2() throws Exception {
        final String[] expected = {
    ...
    @Test
    void missingNullCaseInSwitchWithRecordPattern() throws Exception {
        final String[] expected = {
            "12:9: " + getCheckMessage(MSG_KEY),
    ...
    @Test
    void missingNullCaseInSwitchWithStringLiterals() throws Exception {
        final String[] expected = {
            "12:9: " + getCheckMessage(MSG_KEY),
    ...
    @Test
    void missingNullCaseInSwitchWithPrimitives() throws Exception {
