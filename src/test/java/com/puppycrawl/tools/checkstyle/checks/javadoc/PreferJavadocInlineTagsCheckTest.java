...
public class PreferJavadocInlineTagsCheckTest extends AbstractModuleTestSupport {
    ...
    public void testPreferJavadocInlineTagsAnchorTag() throws Exception {
        final String[] expected = {
            ...
            "95:14: " + getCheckMessage(MSG_KEY, "{@link ...}", "<a href=\"#...\">"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testPreferJavadocInlineTagsAngleBracketEntities() throws Exception {
        final String[] expected = {
            ...
            "31:8: " + getCheckMessage(MSG_KEY, "{@literal <}", "&lt;"),
            "31:13: " + getCheckMessage(MSG_KEY, "{@literal >}", "&gt;"),
            "38:8: " + getCheckMessage(MSG_KEY, "{@literal >}", "&gt;"),
            "47:11: " + getCheckMessage(MSG_KEY, "{@literal <}", "&lt;"),
            "47:16: " + getCheckMessage(MSG_KEY, "{@literal >}", "&gt;"),
            "54:11: " + getCheckMessage(MSG_KEY, "{@literal >}", "&gt;"),
        };
    ...
    public void testPreferJavadocInlineTagsCheckForPre() throws Exception {
        final String[] expected = {
            "14:4: " + getCheckMessage(MSG_KEY, "{@snippet ...}", "<pre>"),
            "26:8: " + getCheckMessage(MSG_KEY, "{@snippet ...}", "<pre>"),
            "36:8: " + getCheckMessage(MSG_KEY, "{@snippet ...}", "<pre>"),
            "46:8: " + getCheckMessage(MSG_KEY, "{@snippet ...}", "<pre>"),
        };
    ...
    public void testEdgeCases() throws Exception {
        final String[] expected = {
            "75:8: " + getCheckMessage(MSG_KEY, "{@snippet ...}", "<pre>"),
        };
        verifyWithInlineConfigParser(
