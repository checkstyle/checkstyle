...
public class GenericWhitespaceCheckTest
    ...
    @Test
    void beforeCtorInvocation() throws Exception {
        final String[] expected = {
    ...
    @Test
    void afterNew() throws Exception {
        final String[] expected = {
    ...
    @Test
    void beforeRecordHeader() throws Exception {
        final String[] expected = {
    ...
    @Test
    void tabAndMissingSpace() throws Exception {
        final String[] expected = {
