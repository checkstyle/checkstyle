...
public class OpenjdkAnnotationLocationCheckTest extends AbstractModuleTestSupport {
    ...
    public void testAnnotation2() throws Exception {
        final String[] expected = {
            ...
            "54:5: " + getCheckMessage(MSG_KEY_ANNOTATION_ALONE_OR_SAME, "MyAnnotation13"),
            "68:5: " + getCheckMessage(MSG_KEY_ANNOTATION_ON_TARGET_LINE, "MyAnnotation11"),
            "72:5: " + getCheckMessage(MSG_KEY_ANNOTATION_ON_TARGET_LINE, "MyAnnotation11"),
        };
    ...
    public void testAnnotation4() throws Exception {
        final String[] expected = {
            ...
            "28:5: " + getCheckMessage(MSG_KEY_ANNOTATION_ALONE_OR_SAME, "Annotation"),
            "28:17: " + getCheckMessage(MSG_KEY_ANNOTATION_ALONE_OR_SAME, "Annotation"),
        };
    ...
    public void testAnnotationCompact() throws Exception {
        final String[] expected = {
            "21:1: " + getCheckMessage(MSG_KEY_ANNOTATION_ALONE_OR_SAME, "SuppressWarnings"),
            "25:1: " + getCheckMessage(MSG_KEY_ANNOTATION_ON_TARGET_LINE, "Deprecated"),
            "45:1: " + getCheckMessage(MSG_KEY_ANNOTATION_ALONE_OR_SAME, "Special"),
        };
