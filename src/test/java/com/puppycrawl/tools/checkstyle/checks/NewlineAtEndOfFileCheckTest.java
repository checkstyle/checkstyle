...
public class NewlineAtEndOfFileCheckTest
    ...
    public void testNoNewlineWithLfSeparatorLogsSpecificMessage() throws Exception {
        ...
        verifyWithInlineConfigParser(checkConfig, getPath("InputNewlineAtEndOfFileNoNewline.java"), expected);
    }
    ...
    public void testNoNewlineWithCrSeparatorLogsSpecificMessage() throws Exception {
        ...
        verify(checkConfig, getPath("InputNewlineAtEndOfFileNoNewline.java"), expected);
    }
