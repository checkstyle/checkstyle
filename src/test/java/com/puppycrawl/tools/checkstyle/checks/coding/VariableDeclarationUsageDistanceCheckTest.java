...
public class VariableDeclarationUsageDistanceCheckTest extends
    ...
    public void testValidateBetweenScopesOption() throws Exception {
        ...
        verify(checkConfig, getPath("InputVariableDeclarationUsageDistanceScopesO.java"), expected);
    }
    ...
    public void testIgnoreFinalOption() throws Exception {
        ...
        verify(checkConfig, getPath("InputVariableDeclarationUsageDistanceFinalO.java"), expected);
    }
    ...
    public void testDefaultConfiguration() throws Exception {
        ...
        verify(checkConfig, getPath("InputVariableDeclarationUsageDistanceDConfig.java"), expected);
    }
