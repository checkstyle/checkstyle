...
public class VariableDeclarationUsageDistanceCheckTest extends
    ...
    public void testGeneralLogic2() throws Exception {
        final String[] expected = {
            "20:9: " + getCheckMessage(MSG_KEY, "first", 5, 1),
            "32:9: " + getCheckMessage(MSG_KEY, "allInvariants", 2, 1),
        };
        verifyWithInlineConfigParser(
    ...
    public void testVariableDeclarationUsageDistanceTryResources() throws Exception {
        final String[] expected = {
            "18:9: " + getCheckMessage(MSG_KEY, "a", 2, 1),
            "19:9: " + getCheckMessage(MSG_KEY, "b", 2, 1),
        };

        verifyWithInlineConfigParser(
                getPath("InputVariableDeclarationUsageDistanceTryResources.java"),
                expected);
    }
