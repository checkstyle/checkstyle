...
public class EqualsAvoidNullCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void equalsWithDefault() throws Exception {
    ...
    @Test
    public void equalsWithoutEqualsIgnoreCase() throws Exception {
    ...
    @Test
    public void equalsOnTheSameLine() throws Exception {
    ...
    @Test
    public void equalsNested() throws Exception {
    ...
    @Test
    public void equalsSuperClass() throws Exception {
    ...
    @Test
    public void inputEqualsAvoidNullEnhancedInstanceof() throws Exception {
    ...
    @Test
    public void equalsAvoidNullTextBlocks() throws Exception {
    ...
    @Test
    public void equalAvoidNull() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void equalAvoidNullRecordPattern() throws Exception {
        final String[] expected = {
