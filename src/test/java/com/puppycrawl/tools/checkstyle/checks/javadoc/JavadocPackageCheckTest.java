...
public class JavadocPackageCheckTest
    ...
    public void testModuleInfoFile() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
                getNonCompilablePath("moduleinfo/default/module-info.java"),
                expected);
    }
    ...
    public void testModuleInfoDoesNotSkipSiblingJavaFile() throws Exception {
        ...
        final List<String> expectedFromSibling = List.of(
                "1: " + getCheckMessage(MSG_PACKAGE_INFO));
        verifyWithInlineConfigParser(
                getNonCompilablePath("moduleinfo/withfile/module-info.java"),
                getNonCompilablePath(
                        "moduleinfo/withfile/InputJavadocPackageModuleInfoWithFile.java"),
