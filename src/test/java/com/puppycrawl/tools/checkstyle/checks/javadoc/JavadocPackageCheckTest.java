...
public class JavadocPackageCheckTest
    ...
    public void testBoth() throws Exception {
        ...
        verify(createChecker(checkConfig),
            getPath("bothfiles" + File.separator + "InputJavadocPackageBothFilesIgnored.java"),
            getPath("bothfiles" + File.separator + "InputJavadocPackageBothFilesIgnored.java"), expected);
    }
