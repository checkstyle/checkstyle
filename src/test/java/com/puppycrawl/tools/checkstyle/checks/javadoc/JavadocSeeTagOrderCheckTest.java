...
public class JavadocSeeTagOrderCheckTest extends AbstractModuleTestSupport {
    ...
    public void testIncorrect2() throws Exception {
        final String[] expected = {
            ...
            "79:8: " + getCheckMessage(MSG_KEY, "#InputJavadocSeeTagOrderIncorrect2()",
                    "#getValue()"),
            "99:8: " + getCheckMessage(MSG_KEY, "OtherClass#OtherClass()",
                    "OtherClass#method()"),
        };
    ...
    public void testIncorrect3() throws Exception {
        final String[] expected = {
            "19:8: " + getCheckMessage(MSG_KEY, "java.util.ArrayList#ArrayList()",
                    "java.util.ArrayList#size()"),
        };

        verifyWithInlineConfigParser(
                getPath("InputJavadocSeeTagOrderIncorrect3.java"), expected);
    }
