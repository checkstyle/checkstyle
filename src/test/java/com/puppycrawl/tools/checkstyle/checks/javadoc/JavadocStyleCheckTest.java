...
public class JavadocStyleCheckTest
    ...
    @Test
    public void testDefaultSettingsOne()
            throws Exception {
        ...
        verifyWithInlineConfigParser(
                getPath("InputJavadocStyleOne.java"), expected);
    }

    @Test
    public void testDefaultSettingsTwo()
            throws Exception {
        final String[] expected = {
        ...
        verifyWithInlineConfigParser(
            getPath("InputJavadocStyleTwo.java"), expected);
    }

    @Test
    public void testDefaultSettingsThree()
            throws Exception {
        final String[] expected = {
        ...
        verifyWithInlineConfigParser(
            getPath("InputJavadocStyleThree.java"), expected);
    }

    @Test
    public void testDefaultSettingsFour()
            throws Exception {
        final String[] expected = {
        ...
        verifyWithInlineConfigParser(
            getPath("InputJavadocStyleFour.java"), expected);
    }
