...
public class AnnotatedDeclarationVisibilityCheckTest
    ...
    public void testSamePackageAnnotation() throws Exception {
        ...
        verifyWithInlineConfigParser(
            getNonCompilablePath("InputAnnotatedDeclarationVisibilitySamePackage.java"),
            expected);
    }
    ...
    public void testImportsClearedOnBeginTree() throws Exception {
        final String[] expected = {
            "20:5: " + getCheckMessage(MSG_KEY, "private"),
            "24:5: " + getCheckMessage(MSG_KEY, "public"),
        };
        verifyWithInlineConfigParser(
            getPath("InputAnnotatedDeclarationVisibilityClearedImport1.java"),
            getNonCompilablePath("InputAnnotatedDeclarationVisibilityClearedImport2.java"),
                expected);
    }
    ...
    public void testCompactSourceFile() throws Exception {
        final String[] expected = {
            "20:1: " + getCheckMessage(MSG_KEY, "public"),
            "27:1: " + getCheckMessage(MSG_KEY, "private"),
        };
    ...
    public void testCompactSourceFileCustom() throws Exception {
        final String[] expected = {
            ...
            "25:1: " + getCheckMessage(MSG_KEY, "public"),
            "29:1: " + getCheckMessage(MSG_KEY, "package-private"),
        };
