...
public class ParameterNameCheckTest
    ...
    @Test
    public void testTrimPropertyInConfig() throws Exception {
        final String pattern = "^h$";
        final String[] expected = {
            "14:56: " + getCheckMessage(MSG_INVALID_PATTERN, "parameter1", pattern),
            "18:31: " + getCheckMessage(MSG_INVALID_PATTERN, "parameter2", pattern),
        };
        verifyWithInlineConfigParser(
                getPath("InputParameterNameAccessModifierChecker.java"), expected);
    }
