...
class MethodParamPadCheckTest
    ...
    @Test
    void methodParamPadCheckConstructors() throws Exception {
        final String[] expected = {
    ...
    @Test
    void recordPattern() throws Exception {
        final String[] expected = {
    ...
    @Test
    void recordPattern2() throws Exception {
        final String[] expected = {
