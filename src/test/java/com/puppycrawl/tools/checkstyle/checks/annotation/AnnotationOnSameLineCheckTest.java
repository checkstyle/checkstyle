...
public class AnnotationOnSameLineCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void testAnnotationOnSameLineCheckAcceptableTokensOnMethodAndVar() throws Exception {
        final String[] expected = {
        ...
        verifyWithInlineConfigParser(
                getPath("InputAnnotationOnSameLineCheckAcceptableTokensOnMethodAndVar.java"), expected);
    }
