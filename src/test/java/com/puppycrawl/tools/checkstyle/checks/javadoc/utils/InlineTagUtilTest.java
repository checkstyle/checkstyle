...
public class InlineTagUtilTest {
    ...
    public void testBadInputExtractInlineTagsLineFeed() {
        try {
            ...
            assertWithMessage("Unexpected error message").that(ex.getMessage().contains("newline"))
                    .isTrue();
        }
    }
    ...
    public void testBadInputExtractInlineTagsCarriageReturn() {
        try {
            ...
            assertWithMessage("Invalid error message").that(ex.getMessage().contains("newline"))
                    .isTrue();
        }
    }
