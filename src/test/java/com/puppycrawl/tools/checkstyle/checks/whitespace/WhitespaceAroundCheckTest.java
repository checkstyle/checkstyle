...
public class WhitespaceAroundCheckTest
    ...
    @Test
    public void keywordsAndOperators()
            throws Exception {
    ...
    @Test
    public void bracesInMethodsAndConstructors()
            throws Exception {
        final String[] expected = {
            "53:9: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, "while"),
            "70:9: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, "for"),
    ...
    @Test
    public void genericsTokensAreFlagged()
            throws Exception {
        final String[] expected = {
    ...
    @Test
    public void allowDoubleBraceInitialization() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void ignoreEnhancedForColon() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void emptyTypes() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void emptyLoops() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void switchWhitespaceAround() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void switchExpressionWhitespaceAround() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
    ...
    @Test
    public void doWhileWhitespaceAround() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void allowEmptyTypesIsSetToFalseAndNonEmptyClasses() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void allowEmptyTypesIsSetToTrueAndNonEmptyClasses() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void notAllowEmptyLambdaExpressionsByDefault() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void allowEmptyLambdaExpressionsWithAllowEmptyLambdaParameter() throws Exception {
        final String[] expected = {
            "32:28: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, "{"),
            "32:30: " + getCheckMessage(MSG_WS_NOT_PRECEDED, "}"),
            "33:28: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, "{"),
    ...
    @Test
    public void whitespaceAroundLambda() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void whitespaceAroundEmptyCatchBlock() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
    ...
    @Test
    public void whitespaceAroundVarargs() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void whitespaceAroundRecords()
            throws Exception {
        final String[] expected = {
    ...
    @Test
    public void whitespaceAroundAllowEmptyCompactCtors()
            throws Exception {
        final String[] expected = {
            "26:23: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, "{"),
            "26:24: " + getCheckMessage(MSG_WS_NOT_PRECEDED, "}"),
    ...
    @Test
    public void whitespaceAroundRecordsAllowEmptyTypes()
            throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
    ...
    @Test
    public void whitespaceAroundAllTokens() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void whitespaceAroundAfterEmoji() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void whitespaceAroundAfterPermitsList() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void whitespaceAroundUnnamedPatterns() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
    ...
    @Test
    public void switchCasesParens() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void switchCasesParensWithAllowEmptySwitchBlockStatements() throws Exception {
