...
public class UnusedTryResourceShouldBeUnnamedCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedTryResourceShouldBeUnnamed2() throws Exception {
        final String[] expected = {
            ...
            "30:14: " + getCheckMessage(MSG_UNUSED_TRY_RESOURCE, "b"),
            "48:18: " + getCheckMessage(MSG_UNUSED_TRY_RESOURCE, "a"),
            "69:18: " + getCheckMessage(MSG_UNUSED_TRY_RESOURCE, "a"),
            "88:14: " + getCheckMessage(MSG_UNUSED_TRY_RESOURCE, "a"),
        };
        verifyWithInlineConfigParser(
