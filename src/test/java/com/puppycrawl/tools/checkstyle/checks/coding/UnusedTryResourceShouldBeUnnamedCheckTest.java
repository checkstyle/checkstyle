...
public class UnusedTryResourceShouldBeUnnamedCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedTryResourceShouldBeUnnamed() throws Exception {
        final String[] expected = {
            ...
            "76:18: " + getCheckMessage(MSG_UNUSED_TRY_RESOURCE, "autoCloseable2"),
        };
    ...
    public void testUnusedTryResourceShouldBeUnnamedNested2() throws Exception {
        final String[] expected = {
            "18:26: " + getCheckMessage(MSG_UNUSED_TRY_RESOURCE, "b"),
            "22:34: " + getCheckMessage(MSG_UNUSED_TRY_RESOURCE, "d"),
        ...
        verifyWithInlineConfigParser(
                getNonCompilablePath("InputUnusedTryResourceShouldBeUnnamedNested2.java"),
                expected);
    }
