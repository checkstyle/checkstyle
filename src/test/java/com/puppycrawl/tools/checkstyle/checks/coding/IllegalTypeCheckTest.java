...
public class IllegalTypeCheckTest extends AbstractModuleTestSupport {
    ...
    public void testIllegalTypeWithUnnamedVariables() throws Exception {
        final String[] expected = {
            ...
            "83:14: " + getCheckMessage(MSG_KEY, "Point"),
            "84:14: " + getCheckMessage(MSG_KEY, "Point"),
            "88:25: " + getCheckMessage(MSG_KEY, "Point"),
            "89:22: " + getCheckMessage(MSG_KEY, "ColoredPoint"),
            "89:46: " + getCheckMessage(MSG_KEY, "ColoredPoint"),
        };
        verifyWithInlineConfigParser(
