...
public class IllegalTypeCheckTest extends AbstractModuleTestSupport {
    ...
    public void testIllegalTypeWithUnnamedVariables() throws Exception {
        final String[] expected = {
            ...
            "86:14: " + getCheckMessage(MSG_KEY, "Point"),
            "87:14: " + getCheckMessage(MSG_KEY, "Point"),
            "91:25: " + getCheckMessage(MSG_KEY, "Point"),
            "92:22: " + getCheckMessage(MSG_KEY, "ColoredPoint"),
            "92:46: " + getCheckMessage(MSG_KEY, "ColoredPoint"),
        };
        verifyWithInlineConfigParser(
