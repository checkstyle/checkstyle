...
public class IllegalTypeCheckTest extends AbstractModuleTestSupport {
    ...
    public void testIllegalTypeWithUnnamedVariables() throws Exception {
        final String[] expected = {
            ...
            "92:14: " + getCheckMessage(MSG_KEY, "Point"),
            "93:14: " + getCheckMessage(MSG_KEY, "Point"),
            "97:25: " + getCheckMessage(MSG_KEY, "Point"),
            "98:22: " + getCheckMessage(MSG_KEY, "ColoredPoint"),
            "98:46: " + getCheckMessage(MSG_KEY, "ColoredPoint"),
        };
        verifyWithInlineConfigParser(
