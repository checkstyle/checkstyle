...
public class JavaNCSSCheckTest extends AbstractModuleTestSupport {
    ...
    public void testRecordsAndCompactCtors() throws Exception {
        ...
        final String[] expected = {
            ...
            "14:1: " + getCheckMessage(MSG_CLASS, 87, 3),
            ...
            "149:5: " + getCheckMessage(MSG_RECORD, 12, 4),
            "150:9: " + getCheckMessage(MSG_METHOD, 11, 7),
            "164:5: " + getCheckMessage(MSG_CLASS, 12, 3),
            "165:9: " + getCheckMessage(MSG_METHOD, 11, 7),
        };
