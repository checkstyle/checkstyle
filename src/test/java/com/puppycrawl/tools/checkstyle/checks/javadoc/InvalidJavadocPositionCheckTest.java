...
public class InvalidJavadocPositionCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void testInvalidJavadocPositionCompactSourceFile() throws Exception {
        final String[] expected = {
            "42:1: " + getCheckMessage(MSG_KEY),
            "48:5: " + getCheckMessage(MSG_KEY),
            "65:9: " + getCheckMessage(MSG_KEY),
        };
    ...
    public void testInvalidJavadocPositionOpenModuleInfo() throws Exception {
        ...
        verifyWithInlineConfigParser(
            getNonCompilablePath("openmodule/module-info.java"), expected);
    }
    ...
    public void testInvalidJavadocPositionAnnotatedModuleInfo() throws Exception {
        ...
        verifyWithInlineConfigParser(
            getNonCompilablePath("annotatedmodule/module-info.java"), expected);
    }
