...
public class RedundantModifierCheckTest
    ...
    @Test
    public void classesInsideOfInterfaces() throws Exception {
    ...
    @Test
    public void staticMethodInInterface()
            throws Exception {
    ...
    @Test
    public void enumConstructorIsImplicitlyPrivate() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void innerTypeInInterfaceIsImplicitlyStatic() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void notPublicClassConstructorHasNotPublicModifier() throws Exception {
    ...
    @Test
    public void nestedClassConsInPublicInterfaceHasValidPublicModifier() throws Exception {
    ...
    @Test
    public void nestedStaticEnum() throws Exception {
        final String[] expected = {
            "12:5: " + getCheckMessage(MSG_KEY, "static"),
    ...
    @Test
    public void finalInAnonymousClass()
            throws Exception {
        final String[] expected = {
    ...
    @Test
    public void finalInTryWithResource() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void finalInAbstractMethods() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void enumStaticMethodsInPublicClass() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void annotationOnEnumConstructor() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void privateMethodInPrivateClass() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void tryWithResourcesBlock() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void nestedDef() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void strictfpWithVersionBeforeJava9() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void strictfpWithOldVersion() throws Exception {
        final String[] expected = {
            "25:5: " + getCheckMessage(MSG_KEY, "abstract"),
            "27:9: " + getCheckMessage(MSG_KEY, "public"),
            "27:16: " + getCheckMessage(MSG_KEY, "static"),
    ...
    @Test
    public void strictfpWithJava17() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void strictfpWithDefaultVersion() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void finalUnnamedVariablesWithDefaultVersion() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void finalUnnamedVariablesWithOldVersion() throws Exception {
        final String[] expected = {
