...
public class JavadocLinkWellKnownApiCheckTest extends AbstractModuleTestSupport {
    ...
    public void testDefault() throws Exception {
        final String[] expected = {
            ...
            "40:13: " + getCheckMessage(MSG_WELL_KNOWN_API, "String"),
            "46:13: " + getCheckMessage(MSG_WELL_KNOWN_PACKAGE, "java.lang.Class"),
            "52:13: " + getCheckMessage(MSG_WELL_KNOWN_PACKAGE, "java.lang.Class"),
        };
    ...
    public void testCustomProperties() throws Exception {
        final String[] expected = {
            "23:13: " + getCheckMessage(MSG_WELL_KNOWN_API, "Integer"),
            "29:13: " + getCheckMessage(MSG_WELL_KNOWN_API, "Object"),
            "35:13: " + getCheckMessage(MSG_WELL_KNOWN_PACKAGE, "java.util.List"),
            "41:13: " + getCheckMessage(MSG_WELL_KNOWN_PACKAGE, "java.io.File"),
        };
        verifyWithInlineConfigParser(
