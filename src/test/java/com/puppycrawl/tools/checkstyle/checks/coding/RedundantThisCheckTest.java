...
public class RedundantThisCheckTest extends AbstractModuleTestSupport {
    ...
    public void testInnerClassAndLimitation() throws Exception {
        final String[] expected = {
                "24:17: " + getCheckMessage(MSG_VARIABLE, "x"),
                "29:13: " + getCheckMessage(MSG_VARIABLE, "x"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testFieldsInExpressions() throws Exception {
        final String[] expected = {
                "40:28: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "id", ""),
                "41:28: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "42:28: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "43:26: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "44:26: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "45:25: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "46:25: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "47:26: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "48:26: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "49:33: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "b", ""),
                "50:36: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "b", ""),
                "51:26: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "52:26: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "53:28: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "54:26: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "55:26: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "56:26: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
                "57:31: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "b", ""),
                "58:32: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "b", ""),
                "60:38: " + getCheckMessage(RedundantThisCheck.MSG_VARIABLE, "length", ""),
        };
        verifyWithInlineConfigParser(
    ...
    public void testRecordsAndCompactCtors() throws Exception {
        final String[] expected = {
                "32:17: " + getCheckMessage(RedundantThisCheck.MSG_METHOD, "method1", ""),
                "70:17: " + getCheckMessage(RedundantThisCheck.MSG_METHOD, "method1", ""),
        };
        verifyWithInlineConfigParser(
    ...
    public void testExtendedMethod() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
                getPath("InputRedundantThisExtendedMethod.java"), expected);
    }
