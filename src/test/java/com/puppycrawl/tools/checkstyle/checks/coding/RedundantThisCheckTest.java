...
public class RedundantThisCheckTest extends AbstractModuleTestSupport {
    ...
    public void testRedundantThisWithInstanceVariable2() throws Exception {
        final String[] expected = {
            ...
            "19:9: " + getCheckMessage(MSG_KEY_VARIABLE, "name"),
            "21:28: " + getCheckMessage(MSG_KEY_VARIABLE, "name"),
        };
    ...
    public void testRedundantThisNested() throws Exception {
        final String[] expected = {
            ...
            "29:13: " + getCheckMessage(MSG_KEY_VARIABLE, "x"),
        };
    ...
    public void testRedundantThisChained() throws Exception {
        final String[] expected = {
            "17:13: " + getCheckMessage(MSG_KEY_VARIABLE, "name"),
            "20:13: " + getCheckMessage(MSG_KEY_VARIABLE, "email"),
            "27:28: " + getCheckMessage(MSG_KEY_VARIABLE, "name"),
            "27:48: " + getCheckMessage(MSG_KEY_VARIABLE, "email"),
        };
