...
public class EmptyLineSeparatorCheckTest
    ...
    public void testMultipleLinesEmptyWithJavadoc2() throws Exception {
        ...
        final String[] expected = {
            "25:3: " + getCheckMessage(MSG_MULTIPLE_LINES, "/*"),
            "35:3: " + getCheckMessage(MSG_MULTIPLE_LINES, "/*"),
            "46:5: " + getCheckMessage(MSG_MULTIPLE_LINES, "/*"),
            "57:5: " + getCheckMessage(MSG_MULTIPLE_LINES, "/*"),
        };
        verifyWithInlineXmlConfig(
