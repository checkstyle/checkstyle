...
public class GoogleMemberNameCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void testInvalidStaticMemberNames() throws Exception {
        final String[] expected = {
            "10:16: " + getCheckMessage(MSG_KEY_INVALID_FORMAT, "Foo"),
            "13:16: " + getCheckMessage(MSG_KEY_INVALID_FORMAT, "f"),
            "16:16: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "foo_bar"),
            "19:16: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "gradle_9_5_1"),
            "22:24: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "_bad"),
            "25:23: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "CONSTANT_LIKE"),
        };
        verifyWithInlineConfigParser(
                getPath("InputGoogleMemberNameStaticInvalid.java"), expected);
    }
    ...
    public void testInnerClasses() throws Exception {
        final String[] expected = {
            ...
            "28:20: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "Static_Bad"),
        };
        verifyWithInlineConfigParser(
    ...
    @Test
    public void testStaticNonFinalValid() throws Exception {
        final String[] expected = {};
        verifyWithInlineConfigParser(
                getPath("InputGoogleMemberNameStaticNonFinalValid.java"), expected);
    }

    @Test
    public void testMixedModifiers() throws Exception {
        final String[] expected = {
            "13:16: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "Static_Bad"),
