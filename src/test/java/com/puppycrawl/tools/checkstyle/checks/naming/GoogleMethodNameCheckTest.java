...
public class GoogleMethodNameCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void testMethodsWithoutAnnotation() throws Exception {
        final String[] expected = {
            "11:17: " + getCheckMessage(MSG_KEY_UNDERSCORE_TEST, "test_naming_"),
            "16:17: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "test_Foo"),
            "21:17: " + getCheckMessage(MSG_KEY_UNDERSCORE_TEST, "test_2"),
            "26:17: " + getCheckMessage(MSG_KEY_FORMAT_REGULAR, "Test"),
        };
        verifyWithInlineConfigParser(
                getPath("InputGoogleMethodNameTestMethodsWithoutAnnotation.java"),
                expected
        );
    }
