...
public class GoogleMethodNameCheckTest extends AbstractModuleTestSupport {
    ...
    public void testInvalidRegularMethodNames() throws Exception {
        final String[] expected = {
            ...
            "48:10: " + getCheckMessage(MSG_KEY_FORMAT_REGULAR, "f$bar"),
            "51:10: " + getCheckMessage(MSG_KEY_UNDERSCORE_REGULAR,
                    "transferMoney_deductsFromSource"),
            "54:10: " + getCheckMessage(MSG_KEY_UNDERSCORE_REGULAR, "foo_bar_baz"),
            "57:10: " + getCheckMessage(MSG_KEY_UNDERSCORE_REGULAR, "foo123_456_"),
            "60:10: " + getCheckMessage(MSG_KEY_FORMAT_REGULAR, "fO"),
            "63:10: " + getCheckMessage(MSG_KEY_UNDERSCORE_REGULAR, "xY_z"),
            "65:10: " + getCheckMessage(MSG_KEY_FORMAT_REGULAR, "mName"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testInvalidTestMethodNames() throws Exception {
        final String[] expected = {
            ...
            "60:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "test_foo"),
            "64:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "login_fails"),
            "68:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "testFoo_fA"),
            "72:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "aggregate_on_bi"),
            "76:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "test_login"),
            "80:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "testFoo_bar"),
            "84:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST,
                    "aggregate_on_bi_element_predicate"),
            "88:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "testLogin_succeeds"),
            "92:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "test_loginFails"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testInsideInterface() throws Exception {
        final String[] expected = {
            ...
            "26:18: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "testFoo_bar"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testInsideRecord() throws Exception {
        final String[] expected = {
            ...
            "18:10: " + getCheckMessage(MSG_KEY_FORMAT_REGULAR, "mName"),
            "25:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "login_fails"),
        };
        verifyWithInlineConfigParser(
