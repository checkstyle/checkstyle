...
public class GoogleMethodNameCheckTest extends AbstractModuleTestSupport {
    ...
    public void testInvalidRegularMethodNames() throws Exception {
        final String[] expected = {
            ...
            "97:10: " + getCheckMessage(MSG_KEY_CHARACTER_USAGE, "foo$bar"),
            "100:10: " + getCheckMessage(MSG_KEY_FORMAT_REGULAR, "fooBAR"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testInvalidTestMethodNames() throws Exception {
        final String[] expected = {
            ...
            "80:10: " + getCheckMessage(MSG_KEY_CHARACTER_USAGE, "foo$bar"),
            "84:10: " + getCheckMessage(MSG_KEY_FORMAT_TEST, "fooBAR"),
        };
        verifyWithInlineConfigParser(
