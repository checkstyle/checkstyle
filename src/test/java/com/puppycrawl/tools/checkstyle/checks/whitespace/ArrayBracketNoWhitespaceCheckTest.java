...
public class ArrayBracketNoWhitespaceCheckTest extends AbstractModuleTestSupport {
    ...
    public void testDefault() throws Exception {
        final String[] expected = {
            ...
            "101:28: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, "]"),
    ...
    public void testDeclarations() throws Exception {
        final String[] expected = {
            ...
            "111:13: " + getCheckMessage(MSG_WS_NOT_PRECEDED, "["),
            "115:14: " + getCheckMessage(MSG_WS_FOLLOWED, "["),
            "115:16: " + getCheckMessage(MSG_WS_PRECEDED, "]"),
        };
        verifyWithInlineConfigParser(
