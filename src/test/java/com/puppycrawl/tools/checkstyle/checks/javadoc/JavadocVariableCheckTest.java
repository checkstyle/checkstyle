...
public class JavadocVariableCheckTest
    ...
    @Test
    public void testStaticFieldVisibilityRestriction() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY; // No violations expected
        
        verifyWithInlineConfigParser(
                getPath("InputJavadocVariableProtectedInPublicClass.java"),
                expected);
    }
