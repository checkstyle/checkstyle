...
public class JavadocVariableCheckTest
    ...
    public void testAccessModifiersPublicProtected() throws Exception {
        ...
        checkConfig.addAttribute(
            "accessModifiers",
            AccessModifierOption.PROTECTED.toString() + "," + AccessModifierOption.PUBLIC.toString()
        );
        final String[] expected = {
            "5:5: " + getCheckMessage(MSG_JAVADOC_MISSING),
            "6:5: " + getCheckMessage(MSG_JAVADOC_MISSING),
    ...
    public void testAccessModifiersPrivatePackage() throws Exception {
        ...
        checkConfig.addAttribute(
            "accessModifiers",
            AccessModifierOption.PRIVATE.toString() + "," + AccessModifierOption.PACKAGE.toString()
        );
        final String[] expected = {
            "7:5: " + getCheckMessage(MSG_JAVADOC_MISSING),
            "8:5: " + getCheckMessage(MSG_JAVADOC_MISSING),
