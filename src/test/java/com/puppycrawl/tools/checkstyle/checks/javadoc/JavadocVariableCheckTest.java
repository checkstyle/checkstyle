...
public class JavadocVariableCheckTest
    ...
    /**
     * Test that when given an array, it creates its own instance of
     * the array and is not re-using and possible overwriting the given one.
     * Without this, pitest creates a new mutation on {@code Arrays.copyOf}.
     *
    ...
    public void testCloneInAccessModifiersProperty() throws Exception {
        ...
        final JavadocVariableCheck check = new JavadocVariableCheck();
        ...
        assertWithMessage("check creates its own instance of access modifier array")
            .that(System.identityHashCode(
                TestUtil.getClassDeclaredField(JavadocVariableCheck.class, "accessModifiers")
                    .get(check)))
