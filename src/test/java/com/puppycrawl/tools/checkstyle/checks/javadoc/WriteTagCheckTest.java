...
public class WriteTagCheckTest extends AbstractModuleTestSupport {
    ...
    public void testMissingFormat() throws Exception {
        ...
        checkConfig.addAttribute("tag", "@author");
        final String[] expected = {
            "8: " + getCheckMessage(MSG_WRITE_TAG, "@author", "Daniel Grenner"),
        };
    ...
    public void testTagIncomplete() throws Exception {
        ...
        checkConfig.addAttribute("tagFormat", "\\S");
        final String[] expected = {
            "10: " + getCheckMessage(MSG_WRITE_TAG, "@incomplete",
    ...
    public void testDoubleTag() throws Exception {
        ...
        checkConfig.addAttribute("tagFormat", "\\S");
        final String[] expected = {
            "11: " + getCheckMessage(MSG_WRITE_TAG, "@doubletag", "first text"),
            "12: " + getCheckMessage(MSG_WRITE_TAG, "@doubletag", "second text"),
        };
    ...
    public void testEmptyTag() throws Exception {
        ...
        final String[] expected = {
            "13: " + getCheckMessage(MSG_WRITE_TAG, "@emptytag", ""),
        };
    ...
    public void testMissingTag() throws Exception {
        ...
        final String[] expected = {
            "14: " + getCheckMessage(MSG_MISSING_TAG, "@missingtag"),
        };
    ...
    public void testMethod() throws Exception {
        ...
        final String[] expected = {
            "20: " + getCheckMessage(MSG_WRITE_TAG, "@todo", "Add a constructor comment"),
            "31: " + getCheckMessage(MSG_WRITE_TAG, "@todo", "Add a comment"),
        };
    ...
    public void testRegularExError() throws Exception {
        ...
        final String[] expected = {
            "9: " + getCheckMessage(MSG_TAG_FORMAT, "@author", "ABC"),
        };
    ...
    public void testEnumsAndAnnotations() throws Exception {
        ...
        final String[] expected = {
            "18: " + getCheckMessage(MSG_WRITE_TAG, "@incomplete", "This enum needs more code... // violation"),
