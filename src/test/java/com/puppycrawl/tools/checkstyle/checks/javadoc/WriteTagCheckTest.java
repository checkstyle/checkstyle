...
public class WriteTagCheckTest extends AbstractModuleTestSupport {
    ...
    public void testWriteTagRecordsAndCompactCtors() throws Exception {
        final String[] expected = {
            ...
            "24: " + getCheckMessage(MSG_WRITE_TAG, "@incomplete", "// violation"),
            "32: " + getCheckMessage(MSG_MISSING_TAG, "@incomplete"),
            "36: " + getCheckMessage(MSG_WRITE_TAG, "@incomplete", "// violation"),
            "43: " + getCheckMessage(MSG_MISSING_TAG, "@incomplete"),
            "47: " + getCheckMessage(MSG_WRITE_TAG, "@incomplete", "// violation"),
            "55: " + getCheckMessage(MSG_MISSING_TAG, "@incomplete"),
            "57: " + getCheckMessage(MSG_MISSING_TAG, "@incomplete"),
            "61: " + getCheckMessage(MSG_WRITE_TAG, "@incomplete", "// violation"),
        };
