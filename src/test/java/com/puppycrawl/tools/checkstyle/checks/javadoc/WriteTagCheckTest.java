...
public class WriteTagCheckTest extends AbstractModuleTestSupport {
    ...
    public void testDoubleTag() throws Exception {
        final String[] expected = {
            "20: " + getCheckMessage(MSG_WRITE_TAG, "@doubletag", "first text"),
            "21: " + getCheckMessage(MSG_WRITE_TAG, "@doubletag", "second text"),
        };
        verifyWithInlineConfigParserTwice(
    ...
    public void testEmptyTag() throws Exception {
        final String[] expected = {
            "22: " + getCheckMessage(MSG_WRITE_TAG, "@emptytag", ""),
        };
        verifyWithInlineConfigParserTwice(
    ...
    public void testMissingTag() throws Exception {
        final String[] expected = {
            "22: " + getCheckMessage(MSG_MISSING_TAG, "@missingtag"),
        };
        verifyWithInlineConfigParserTwice(
    ...
    public void testSeverity() throws Exception {
        final String[] expected = {
            "18: " + getCheckMessage(MSG_WRITE_TAG, "@author", "Daniel Grenner"),
        };
        verifyWithInlineConfigParserTwice(
    ...
    public void testRegularExError() throws Exception {
        final String[] expected = {
            "17: " + getCheckMessage(MSG_TAG_FORMAT, "@author", "ABC"),
        };
        verifyWithInlineConfigParserTwice(
    ...
    public void testTagTypeAuthor() throws Exception {
        final String[] expected = {
            "17: " + getCheckMessage(MSG_WRITE_TAG, "@author",
    ...
    public void testTagTypeDeprecated() throws Exception {
        final String[] expected = {
            "17: " + getCheckMessage(MSG_WRITE_TAG, "@deprecated",
                "{@systemProperty x}"),
        };
        verifyWithInlineConfigParserTwice(
    ...
    public void testTagTypeThrows() throws Exception {
        final String[] expected = {
            "20: " + getCheckMessage(MSG_WRITE_TAG, "@throws",
                "IOException   when {@code i} is {@value Integer#MAX_VALUE}"),
        };
        verifyWithInlineConfigParserTwice(
