...
public class WriteTagCheckTest extends AbstractModuleTestSupport {
     ...
     * This test needs to use a forbidden api <code>ByteArrayOutputStream#toString()</code>
    ...
    public void testResetSeverityLevel() throws Exception {
        ...
        // logs severity levels are between square brackets [] and are not at the end of the line
        final Pattern severityPattern = Pattern.compile("\\[(\\w+)][^\\n]");
