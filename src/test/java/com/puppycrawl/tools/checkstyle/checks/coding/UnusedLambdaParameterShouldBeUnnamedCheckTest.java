...
class UnusedLambdaParameterShouldBeUnnamedCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    void singleLambdaParameter() throws Exception {
    ...
    @Test
    void multipleLambdaParameters() throws Exception {
        final String[] expected = {
