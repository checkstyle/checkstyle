...
public class UnnecessaryFullyQualifiedTypeCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void testTypeConflictingImport() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
            getNonCompilablePath("InputUnnecessaryFullyQualifiedTypeConflictingImport.java"),
            expected);
    }
    ...
    @Test
    public void testPackageNameStateClearedBetweenFiles() throws Exception {
        final String fileName1 =
                getPath("InputUnnecessaryFullyQualifiedTypePackageStateFirst.java");
        final String fileName2 =
                getNonCompilablePath("InputUnnecessaryFullyQualifiedTypePackageStateTwo.java");
        final List<String> expectedFirst = Collections.emptyList();
        final List<String> expectedSecond = Collections.emptyList();
        verifyWithInlineConfigParser(fileName1, fileName2, expectedFirst, expectedSecond);
