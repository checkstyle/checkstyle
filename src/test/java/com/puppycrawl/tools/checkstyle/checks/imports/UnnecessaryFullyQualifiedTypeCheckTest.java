...
public class UnnecessaryFullyQualifiedTypeCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void testOnDemandObserverCollision() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
            getNonCompilablePath("InputUnnecessaryFullyQualifiedTypeDemandObserverCollision.java"),
            expected);
    }

    @Test
    public void testOnDemandImportAwtCollisionNotFlagged() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
                getNonCompilablePath(
                        "InputUnnecessaryFullyQualifiedTypeAwtOnDemandCollision.java"),
                expected);
    }

    @Test
    public void testOnDemandImportLibraryCollisionNotFlagged() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
                getNonCompilablePath(
                        "InputUnnecessaryFullyQualifiedTypeOnDemandLibraryCollision.java"),
                expected);
    }
