...
public class AbbreviationAsWordInNameCheckTest extends AbstractModuleTestSupport {
    ...
    public void testTypeNamesForZeroPermittedCapitalLetter() throws Exception {
        ...
        final String[] expectedPart2 = {
            "20:13: " + getWarningMessage("userID", expectedCapitalCount),
            "29:16: " + getWarningMessage("VALUE", expectedCapitalCount),
            "33:23: " + getWarningMessage("VALUE", expectedCapitalCount),
            "37:22: " + getWarningMessage("VALUE", expectedCapitalCount),
            "41:29: " + getWarningMessage("VALUE", expectedCapitalCount),
        };
        verifyWithInlineConfigParser(
