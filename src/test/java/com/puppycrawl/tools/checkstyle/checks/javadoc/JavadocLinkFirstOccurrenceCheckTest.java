...
public class JavadocLinkFirstOccurrenceCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void testMemberFqn() throws Exception {
        final String[] expected = {
            "13:12: " + getCheckMessage(MSG_KEY, "java.util.List#add(Object)"),
        };
        verifyWithInlineConfigParser(
                getPath("InputJavadocLinkFirstOccurrenceMemberFqn.java"), expected);
    }
    ...
    public void testClearStateBetweenFiles() throws Exception {
        ...
        verify(createChecker(createModuleConfig(JavadocLinkFirstOccurrenceCheck.class)),
                new File[] {
