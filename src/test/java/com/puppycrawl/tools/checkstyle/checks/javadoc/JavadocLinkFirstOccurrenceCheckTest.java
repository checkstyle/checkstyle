...
public class JavadocLinkFirstOccurrenceCheckTest extends AbstractModuleTestSupport {
    ...
    public void testDefault() throws Exception {
        final String[] expected = {
            ...
            "96:15: " + getCheckMessage(MSG_KEY, "String"),
            "97:20: " + getCheckMessage(MSG_KEY, "String"),
            "106:13: " + getCheckMessage(MSG_KEY, "String"),
            "107:13: " + getCheckMessage(MSG_KEY, "Object"),
            "113:34: " + getCheckMessage(MSG_KEY, "String"),
        };
