...
import static com.puppycrawl.tools.checkstyle.checks.javadoc.JavadocTypeCheck.MSG_MISSING_PARAM_TAG;
...
public class JavadocTypeCheckTest extends AbstractModuleTestSupport {
    ...
    public void testPkg() throws Exception {
        final String[] expected = {
            "53:5: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<T>"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testScopes() throws Exception {
        final String[] expected = {
            "18:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<T>"),
            "137:5: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<T>"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testTypeParameters() throws Exception {
        final String[] expected = {
            ...
            "26:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<C456>"),
            "61:8: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "<C>"),
            "64:5: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<B>"),
    ...
    public void testAllowedAnnotationsNotAllowed() throws Exception {
        ...
        final String[] expected = {
            "38:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<T>"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testJavadocTypeParamDescriptionWithAngularTags() throws Exception {
        final String[] expected = {
            ...
            "52:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<U>"),
    ...
    public void testJavadocTypeRecordParamDescriptionWithAngularTags() throws Exception {
        final String[] expected = {
            ...
            "59:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<U>"),
            "64:4: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "region"),
            "66:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "a"),
            "80:4: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "e"),
            "82:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "c"),
        };
    ...
    public void testJavadocTypeRecordComponents2() throws Exception {
        ...
        final String[] expected = {
            "44:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<X>"),
            "49:4: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "x"),
            "61:4: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "notMyString"),
            "64:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "myString"),
            "64:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "myInt"),
            "69:4: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "x"),
            "71:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "myList"),
            "78:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "X"),
            "82:4: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "notMyString"),
            "85:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<T>"),
            "85:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "myInt"),
            "85:1: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "myString"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testJavadocType() throws Exception {
        final String[] expected = {
            "28:5: " + getCheckMessage(MSG_MISSING_PARAM_TAG, "@param", "<T>"),
        };
        verifyWithInlineConfigParser(
