...
public class JavadocTypeCheckTest extends AbstractModuleTestSupport {
    ...
    public void testAnnotationsInCodeBlock3() throws Exception {
        final String[] expected = {
            ...
            "71:4: " + getCheckMessage(MSG_UNKNOWN_TAG, "aftersinglebrace"),
            "79:4: " + getCheckMessage(MSG_UNKNOWN_TAG, "afterclosedbrace"),
            "87:4: " + getCheckMessage(MSG_UNKNOWN_TAG, "afteremptycode"),
        };
        verifyWithInlineConfigParser(
