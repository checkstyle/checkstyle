...
public class JavadocTypeCheckTest extends AbstractModuleTestSupport {
    ...
    public void testAuthorRegularEx()
        ...
        final String[] expected = {
            ...
            "49:1: " + getCheckMessage(MSG_MISSING_TAG, "@author"),
            "76:1: " + getCheckMessage(MSG_MISSING_TAG, "@author"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testAuthorRegularExError()
        ...
        final String[] expected = {
            ...
            "55:1: " + getCheckMessage(MSG_MISSING_TAG, "@author"),
            "64:1: " + getCheckMessage(MSG_TAG_FORMAT, "@author", "ABC"),
            "82:1: " + getCheckMessage(MSG_MISSING_TAG, "@author"),
            "91:1: " + getCheckMessage(MSG_TAG_FORMAT, "@author", "ABC"),
