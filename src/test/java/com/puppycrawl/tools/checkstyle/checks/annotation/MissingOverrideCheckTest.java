...
public class MissingOverrideCheckTest extends AbstractModuleTestSupport {
    ...
    public void testBadOverrideFromObject() throws Exception {
        ...
        InputConfiguration inputConfiguration = BddParser.parse(getInputFile(inputFileName));
        DefaultConfiguration parsedConfig = inputConfiguration.createConfiguration();
