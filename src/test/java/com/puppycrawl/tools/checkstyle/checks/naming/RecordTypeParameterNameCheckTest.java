...
public class RecordTypeParameterNameCheckTest extends AbstractModuleTestSupport {
    ...
    public void testClassFooName()
        ...
        final String[] expected = {
            "13:47: " + getCheckMessage(MSG_INVALID_PATTERN, "notfoo", pattern),
            "20:15: " + getCheckMessage(MSG_INVALID_PATTERN, "alsoNotfoo", pattern),
            "41:19: " + getCheckMessage(MSG_INVALID_PATTERN, "againNotfoo", pattern),
        };
        verify(checkConfig,
