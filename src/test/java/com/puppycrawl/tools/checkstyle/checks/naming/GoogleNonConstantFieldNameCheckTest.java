...
public class GoogleNonConstantFieldNameCheckTest extends AbstractModuleTestSupport {
    ...
    public void testNonConstantFieldNameInvalid() throws Exception {
        final String[] expected = {
            ...
            "19:16: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "foo__bar"),
            "22:19: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "gradle_9_5_1"),
            "25:15: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "jdk_9_0_392"),
            "28:25: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "guava_33_4_5"),
            "31:17: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "a_1"),
            "34:9: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "guava33_4_5_"),
            "37:23: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "guava33__4_5"),
            "40:22: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "guava33_4_a"),
    ...
    public void testNonConstantFieldNameMixedModifiers() throws Exception {
        final String[] expected = {
            "25:15: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "Final_Instance"),
            "28:22: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "Public_Final"),
            "31:23: " + getCheckMessage(MSG_KEY_INVALID_FORMAT, "mPrivateFinal"),
            "34:25: " + getCheckMessage(MSG_KEY_INVALID_FORMAT, "f"),
            "42:9: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "Instance_Bad"),
            "45:16: " + getCheckMessage(MSG_KEY_INVALID_UNDERSCORE, "Public_Bad"),
