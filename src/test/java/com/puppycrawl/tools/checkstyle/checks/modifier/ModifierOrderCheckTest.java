...
public class ModifierOrderCheckTest
    ...
    public void testCompactSourceFile() throws Exception {
        final String[] expected = {
            "15:8: " + getCheckMessage(MSG_MODIFIER_ORDER, "private"),
            "22:7: " + getCheckMessage(MSG_ANNOTATION_ORDER, "@Deprecated"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testCompactSourceFileCustom() throws Exception {
        final String[] expected = {
            "13:9: " + getCheckMessage(MSG_MODIFIER_CUSTOM_ORDER, "final"),
            "20:7: " + getCheckMessage(MSG_ANNOTATION_ORDER, "@Deprecated"),
        };
        verifyWithInlineConfigParser(
                getNonCompilablePath("compact/InputModifierOrderCompactSourceFileCustom.java"),
                expected);
    }
    ...
    @Test
    public void testCustomSameAsDefault() throws Exception {
        final String[] expected = {
            "14:12: " + getCheckMessage(MSG_MODIFIER_ORDER, "private"),
        };
        verifyWithInlineConfigParser(
                getPath("InputModifierOrderCustomSameAsDefault.java"), expected);
    }
