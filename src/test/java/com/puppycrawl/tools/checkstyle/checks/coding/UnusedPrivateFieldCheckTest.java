...
class UnusedPrivateFieldCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedPrivateField() throws Exception {
        final String[] expected = {
            "12:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
            "20:30: " + getCheckMessage(MSG_PRIVATE_FIELD, "CONSTANT"),
            "26:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "innerUnused"),
            "31:24: " + getCheckMessage(MSG_PRIVATE_FIELD, "field"),
            "33:23: " + getCheckMessage(MSG_PRIVATE_FIELD, "field2"),
            "49:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "x"),
        };
    ...
    public void testUnusedPrivateFieldNames() throws Exception {
        final String[] expected = {
            "12:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "value"),
            "29:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "data"),
            "55:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "i"),
    ...
    public void testUnusedPrivateFieldScope() throws Exception {
        final String[] expected = {
            "20:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "count"),
            "28:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "size"),
            "33:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "flag"),
            "44:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "limit"),
            "46:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "index"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testUnusedPrivateField2() throws Exception {
        final String[] expected = {
            "12:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
            "14:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "anotherUnused"),
            "16:20: " + getCheckMessage(MSG_PRIVATE_FIELD, "yetAnother"),
            "25:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "field"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testUnusedPrivateFieldThis() throws Exception {
        final String[] expected = {
            "24:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "value"),
            "30:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "count"),
            "43:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "flag"),
            "51:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "data"),
            "60:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "size"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testUnusedPrivateFieldAnnotationLombok() throws Exception {
        final String[] expected = {
            "17:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
    ...
    @Test
    public void testUnusedPrivateFieldQualifiedThis() throws Exception {
        final String[] expected = {
            "15:29: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
        };
        verifyWithInlineConfigParser(
                getPath("InputUnusedPrivateFieldQualifiedThis.java"),
                expected);
    }
    ...
    public void testUnusedPrivateFieldAnnotationNotIgnored() throws Exception {
        final String[] expected = {
            "15:20: " + getCheckMessage(MSG_PRIVATE_FIELD, "service"),
            "17:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
        };
        verifyWithInlineConfigParser(
    ...
    @Test
    public void testUnusedPrivateFieldUnresolvable() throws Exception {
        final String[] expected = {
            "15:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "field"),
        };
        verifyWithInlineConfigParser(
                getNonCompilablePath("InputUnusedPrivateFieldQualifiedThisUnresolvable.java"),
                expected);
    }
    ...
    public void testUnusedPrivateFieldAnnotationMultiple() throws Exception {
        final String[] expected = {
            "25:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testUnusedPrivateFieldAnnotationSecondOfMultiple() throws Exception {
        final String[] expected = {
            "19:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
        };
        verifyWithInlineConfigParser(
    ...
    @Test
    public void testUnusedPrivateFieldIgnoredFieldNamesCustom() throws Exception {
        final String[] expected = {
            "16:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
        };
        verifyWithInlineConfigParser(
                getPath("InputUnusedPrivateFieldIgnoredFieldNamesCustom.java"), expected);
    }
    ...
    public void testUnusedPrivateFieldAnnotation() throws Exception {
        final String[] expected = {
            "14:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
        };
        verifyWithInlineConfigParser(
    ...
    @Test
    public void testUnusedPrivateFieldIgnored() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
                getNonCompilablePath("compact/InputUnusedPrivateFieldIgnored.java"),
                expected);
    }
    ...
    public void testUnusedPrivateFieldEmpty() throws Exception {
        final String[] expected = {
            "14:26: " + getCheckMessage(MSG_PRIVATE_FIELD, "obj"),
            "20:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "value"),
            "22:32: " + getCheckMessage(MSG_PRIVATE_FIELD, "r"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testStateClearedWithinSingleFile() throws Exception {
        final String[] expected = {
            "11:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "a"),
        };
        verifyWithInlineConfigParser(
    ...
    @Test
    public void testUnusedPrivateFieldLambdaScope() throws Exception {
        final String[] expected = {
            "21:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
            "38:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "size"),
        };
        verifyWithInlineConfigParser(
                getPath("InputUnusedPrivateFieldLambdaScope.java"), expected);
    }

    @Test
    public void testUnusedPrivateFieldDeclarationNameCollision() throws Exception {
        final String[] expected = {
            "12:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "myClass"),
            "15:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "myInterface"),
            "18:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "myEnum"),
            "21:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "myRecord"),
            "24:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "myAnnotation"),
        };
        verifyWithInlineConfigParser(
                getPath("InputUnusedPrivateFieldDeclarationNameCollision.java"), expected);
    }

    @Test
    public void testUnusedPrivateFieldForCatchScope() throws Exception {
        final String[] expected = {
            "38:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "unused"),
        };

        verifyWithInlineConfigParser(
                getPath("InputUnusedPrivateFieldForCatchScope.java"), expected);
    }

    @Test
    public void testUnusedPrivateFieldOuterUsed() throws Exception {
        final String[] expected = {
            "16:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "value"),
            "26:25: " + getCheckMessage(MSG_PRIVATE_FIELD, "x"),
            "36:29: " + getCheckMessage(MSG_PRIVATE_FIELD, "unusedField"),
        };

        verifyWithInlineConfigParser(
                getPath("InputUnusedPrivateFieldOuterUsed.java"), expected);
    }

    @Test
    public void testUnusedPrivateFieldOuterUnused() throws Exception {
        final String[] expected = {
            "12:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "value"),
        };

        verifyWithInlineConfigParser(
                getPath("InputUnusedPrivateFieldOuterUnused.java"), expected);
    }

    @Test
    public void testUnusedPrivateFieldDotAccessForms() throws Exception {
        final String[] expected = {
            "24:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "objField"),
            "26:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "shared"),
            "60:21: " + getCheckMessage(MSG_PRIVATE_FIELD, "middleField"),
            "79:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "shadowTarget"),
        };

        verifyWithInlineConfigParser(
                getPath("InputUnusedPrivateFieldDotAccessForms.java"), expected);
    }

    @Test
    public void testUnusedPrivateFieldLocalVarType() throws Exception {
        final String[] expected = {
            "11:17: " + getCheckMessage(MSG_PRIVATE_FIELD, "value"),
        };
        verifyWithInlineConfigParser(
                getPath("InputUnusedPrivateFieldLocalVarType.java"), expected);
    }
    ...
    public void testClearStateVariables() {
        ...
        TestUtil.setInternalState(check, "enclosingTypeNames", usedFieldsStack);
        check.beginTree(null);
        final Deque<?> clearedStack = (Deque<?>) TestUtil.getInternalState(check,
                "enclosingTypeNames", Deque.class);
    ...
    @Test
    public void testClearStateFieldUsages() {
        final UnusedPrivateFieldCheck check = new UnusedPrivateFieldCheck();
        final List<Object> usages = new ArrayList<>();
        usages.add(new Object());
        TestUtil.setInternalState(check, "fieldUsages", usages);
        check.beginTree(null);
        final List<?> cleared = (List<?>)
                TestUtil.getInternalState(check, "fieldUsages", List.class);
        assertWithMessage("fieldUsages state is not cleared on beginTree")
                .that(cleared).isEmpty();
    }

    @Test
    public void testClearStateFieldTypedUsages() {
        final UnusedPrivateFieldCheck check = new UnusedPrivateFieldCheck();
        final List<Object> usages = new ArrayList<>();
        usages.add(new Object());
        TestUtil.setInternalState(check, "typedUsages", usages);
        check.beginTree(null);
        final List<?> cleared = (List<?>)
                TestUtil.getInternalState(check, "typedUsages", List.class);
        assertWithMessage("fieldUsages state is not cleared on beginTree")
                .that(cleared).isEmpty();
    }

    @Test
    public void testClearStatePrivateFieldsByType() {
        final UnusedPrivateFieldCheck check = new UnusedPrivateFieldCheck();
        final Map<Object, Object> map = new HashMap<>();
        map.put("clear", new Object());
        TestUtil.setInternalState(check, "privateFieldsByType", map);
        check.beginTree(null);
        final Map<?, ?> cleared = (Map<?, ?>)
                TestUtil.getInternalState(check, "privateFieldsByType", Map.class);
        assertWithMessage("privateFieldsByType state is not cleared on beginTree")
                .that(cleared).isEmpty();
    }
