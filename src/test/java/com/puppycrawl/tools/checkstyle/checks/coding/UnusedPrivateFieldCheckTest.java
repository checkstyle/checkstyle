...
public class UnusedPrivateFieldCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedprivatefield() throws Exception {
        final String[] expected = {
            ...
            "30:5: " + getCheckMessage(MSG_PRIVATE_FIELD,"notfield"),
        };
  ...
  @Test
  public void testUnusedPrivateFieldDisabledViaConfig() throws Exception {
    final DefaultConfiguration checkConfig =
            new DefaultConfiguration(UnusedPrivateFieldCheck.class.getName());
    checkConfig.addProperty("checkUnusedPrivateField", "false");

    final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;

    verify(
            checkConfig,
            getPath("InputUnusedPrivateField.java"),
            expected
    );
}
