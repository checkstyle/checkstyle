...
public class AvoidOutdatedUsageCheckTest extends AbstractModuleTestSupport {
    ...
    public void collectors() throws Exception {
        final String[] expected = {
            "20:9: " + getCheckMessage(MSG_OUTDATED_API_USAGE, TO_LIST),
            "21:20: " + getCheckMessage(MSG_OUTDATED_API_USAGE, TO_LIST),
            "24:20: " + getCheckMessage(MSG_OUTDATED_API_USAGE, TO_LIST),
            "25:20: " + getCheckMessage(MSG_OUTDATED_API_USAGE, TO_LIST),
            "26:9: " + getCheckMessage(MSG_OUTDATED_API_USAGE, TO_LIST),
            "38:20: " + getCheckMessage(MSG_OUTDATED_API_USAGE, TO_LIST),
        };
