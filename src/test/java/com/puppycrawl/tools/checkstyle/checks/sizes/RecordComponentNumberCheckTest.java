...
public class RecordComponentNumberCheckTest extends AbstractModuleTestSupport {
    ...
    public void testRecordComponentNumberMax1() throws Exception {
        final DefaultConfiguration checkConfig =
                createModuleConfig(RecordComponentNumberCheck.class);
        checkConfig.addAttribute("maxPrivate", "1");
        checkConfig.addAttribute("maxPackage", "1");
        checkConfig.addAttribute("maxProtected", "1");
    ...
    public void testRecordComponentNumberMax20() throws Exception {
        final DefaultConfiguration checkConfig =
                createModuleConfig(RecordComponentNumberCheck.class);
        checkConfig.addAttribute("maxPrivate", "20");
        checkConfig.addAttribute("maxPackage", "20");
        checkConfig.addAttribute("maxProtected", "20");
        checkConfig.addAttribute("maxPublic", "20");
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
    ...
    public void testRecordComponentNumberDifferentMaxForScope() throws Exception {
        final DefaultConfiguration checkConfig =
                createModuleConfig(RecordComponentNumberCheck.class);
        checkConfig.addAttribute("maxPrivate", "2");
        checkConfig.addAttribute("maxPackage", "1");
        checkConfig.addAttribute("maxProtected", "3");
        checkConfig.addAttribute("maxPublic", "5");
