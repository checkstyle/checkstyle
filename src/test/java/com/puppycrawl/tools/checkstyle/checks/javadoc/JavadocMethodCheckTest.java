...
public class JavadocMethodCheckTest extends AbstractModuleTestSupport {
    ...
    public void testJavadocMethodInReferenceTest() throws Exception {
        final String[] expected = {
            "23:8: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "x"),
            "31:8: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "x"),
            "35:42: " + getCheckMessage(MSG_EXPECTED_TAG, "@param", "a"),
            "38:8: " + getCheckMessage(MSG_UNUSED_TAG, "@param", "<X>"),
        };
        verifyWithInlineConfigParser(
