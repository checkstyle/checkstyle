...
public class JavadocMethodCheckTest extends AbstractModuleTestSupport {
    ...
    public void testJavadocMethodAboveComments() throws Exception {
        final String[] expected = {
            ...
            "54:32: " + getCheckMessage(MSG_EXPECTED_TAG, "@throws", "Exception"),
            "64:33: " + getCheckMessage(MSG_EXPECTED_TAG, "@throws", "Exception"),
            "73:33: " + getCheckMessage(MSG_EXPECTED_TAG, "@throws", "Exception"),
            "82:33: " + getCheckMessage(MSG_EXPECTED_TAG, "@throws", "Exception"),
        };
        verifyWithInlineConfigParser(
