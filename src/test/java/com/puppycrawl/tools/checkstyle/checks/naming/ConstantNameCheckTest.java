...
public class ConstantNameCheckTest
    ...
    @Test
    public void accessControlTuning()
            throws Exception {
    ...
    @Test
    public void interfaceAndAnnotation()
            throws Exception {
    ...
    @Test
    public void intoInterface() throws Exception {
    ...
    @Test
    public void intoInterfaceExcludePublic() throws Exception {
