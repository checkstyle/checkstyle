...
public class DeclarationOrderCheckTest
    ...
    public void testDefault() throws Exception {
        ...
        final String[] expected = {
            ...
            "66:5: " + getCheckMessage(MSG_CONSTRUCTOR),
            "92:5: " + getCheckMessage(MSG_INSTANCE),
            "104:9: " + getCheckMessage(MSG_ACCESS),
            "112:9: " + getCheckMessage(MSG_STATIC),
            "118:5: " + getCheckMessage(MSG_ACCESS),
            "123:5: " + getCheckMessage(MSG_ACCESS),
            "128:5: " + getCheckMessage(MSG_ACCESS),
            "131:5: " + getCheckMessage(MSG_ACCESS),
            "137:5: " + getCheckMessage(MSG_STATIC),
            "144:9: " + getCheckMessage(MSG_ACCESS),
            "155:9: " + getCheckMessage(MSG_STATIC),
            "164:5: " + getCheckMessage(MSG_CONSTRUCTOR),
            "190:5: " + getCheckMessage(MSG_INSTANCE),
    ...
    public void testOnlyModifiers() throws Exception {
        ...
        final String[] expected = {
            ...
            "194:9: " + getCheckMessage(MSG_ACCESS),
        };
    ...
    public void testForwardReference() throws Exception {
        ...
        final String[] expected = {
            ...
            "64:5: " + getCheckMessage(MSG_ACCESS),
        };
