...
public class DeclarationOrderCheckTest
    ...
    public void testParents() {
        ...
        final SortedSet<Violation> messages1 = check.getMessages();

        assertEquals(0, messages1.size(), "No exception messages expected");

        check.visitToken(ctor);
        final SortedSet<Violation> messages2 = check.getMessages();
    ...
    public void testImproperToken() {
        ...
        final SortedSet<Violation> messages = check.getMessages();
