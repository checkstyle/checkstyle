...
public class AnnotatedMethodVisibilityModifierCheckTest
    ...
    public void testSamePackageAnnotation() throws Exception {
        ...
        verifyWithInlineConfigParser(
            getNonCompilablePath("InputAnnotatedMethodVisibilityModifierSamePackage.java"),
            expected);
    }
    ...
    public void testImportsClearedOnBeginTree() throws Exception {
        ...
        verifyWithInlineConfigParser(
            getPath("InputAnnotatedMethodVisibilityModifierClearedImport1.java"),
            getNonCompilablePath("InputAnnotatedMethodVisibilityModifierClearedImport2.java"),
                expected);
    }
