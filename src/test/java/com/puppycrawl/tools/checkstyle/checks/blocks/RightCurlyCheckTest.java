...
public class RightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testCaseBlocksInSwitchStatementAlone2() throws Exception {
        final String[] expected = {
            ...
            "81:34: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 34),
            "82:23: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 23),
            "84:34: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 34),
            "93:16: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 16),
            "101:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
            "98:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
            "114:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
        };
        verifyWithInlineConfigParser(
    ...
    public void testCaseBlocksInSwitchStatementAloneOrSingle2() throws Exception {
        final String[] expected = {
            ...
            "96:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
            "99:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
            "113:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
        };
        verifyWithInlineConfigParser(
    ...
    public void testCaseBlocksInSwitchStatementSame2() throws Exception {
        final String[] expected = {
            ...
            "115:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
        };
        verifyWithInlineConfigParser(
