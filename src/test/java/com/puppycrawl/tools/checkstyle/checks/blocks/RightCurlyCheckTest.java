...
public class RightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testAloneOrSingleLine() throws Exception {
        final String[] expected = {
            "73:26: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 26),
            "87:42: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 42),
            "90:18: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 18),
            "98:30: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 30),
            "102:77: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 77),
            "110:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "112:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "123:75: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 75),
            "125:77: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 77),
            "125:93: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 93),
            "127:77: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 77),
            "129:64: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 64),
            "129:80: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 80),
            "135:37: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 37),
            "142:37: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 37),
            "157:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "164:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "164:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
            ...
            "180:75: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 75),
            "180:76: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 76),
            "180:77: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 77),
            "192:27: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 27),
            "198:24: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 24),
            "201:24: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 24),
            "204:24: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 24),
            ...
            "226:39: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 39),
            "234:24: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 24),
            "246:30: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 30),
            "252:29: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 29),
            "252:38: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 38),
        };
        verifyWithInlineConfigParser(
    ...
    public void testTryWithResourceAloneSingle() throws Exception {
        final String[] expected = {
            "27:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "41:15: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 15),
