...
public class RightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testSwitchExpression() throws Exception {
        final String[] expected = {
            "22:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
            ...
            "110:96: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 96),
        };
        verifyWithInlineConfigParser(
    ...
    public void testSwitchExpression2() throws Exception {
        final String[] expected = {
            "20:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
    ...
    public void testSwitchExpression4() throws Exception {
        final String[] expected = {
            "90:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "110:7: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 7),
        };
        verifyWithInlineConfigParser(
    ...
    public void testSwitchExpression5() throws Exception {
        final String[] expected = {
            "32:35: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 35),
            "62:35: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 35),
            "63:31: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 31),
            "82:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "101:55: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 55),
        };
        verifyWithInlineConfigParser(
