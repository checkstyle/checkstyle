...
public class RightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testRightCurlyFollowedBySemicolonHasLineBreakAfter() throws Exception {
        final String[] expected = {
            ...
            "32:10: " + getCheckMessage(MSG_KEY_LINE_BREAK_AFTER, ";", 10),
            "39:10: " + getCheckMessage(MSG_KEY_LINE_BREAK_AFTER, ";", 10),
            "48:10: " + getCheckMessage(MSG_KEY_LINE_BREAK_AFTER, ";", 10),
            "53:10: " + getCheckMessage(MSG_KEY_LINE_BREAK_AFTER, ";", 10),
        };
        verifyWithInlineConfigParser(
