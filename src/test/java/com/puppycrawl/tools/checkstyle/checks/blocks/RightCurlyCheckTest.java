...
public class RightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testRightCurlyWithEmoji() throws Exception {
        final String[] expected = {
            ...
            "67:50: " + getCheckMessage(MSG_KEY_LINE_BREAK_BEFORE, "}", 50),
            "76:44: " + getCheckMessage(MSG_KEY_LINE_BREAK_BEFORE, "}", 44),
            "81:41: " + getCheckMessage(MSG_KEY_LINE_BREAK_BEFORE, "}", 41),
    ...
    public void testRightCurlyWithEmojiAloneOrSingleLine() throws Exception {
        final String[] expected = {
            ...
            "30:47: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 47),
