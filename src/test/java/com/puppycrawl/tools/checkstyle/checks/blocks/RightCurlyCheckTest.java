...
public class RightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testWithAnnotations() throws Exception {
        final String[] expected = {
            ...
            "207:10: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 10),
            "211:54: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 54),
            "211:55: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 55),
            "214:75: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 75),
            "214:76: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 76),
            "214:77: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 77),
            "218:76: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 76),
            "226:27: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 27),
            "230:31: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 31),
            "233:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "235:29: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 29),
            "238:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "241:30: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 30),
            "244:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "247:39: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 39),
            "249:56: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 56),
            "252:24: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 24),
            "262:29: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 29),
            "264:40: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 40),
            "268:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "271:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "273:61: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 61),
        };
        verifyWithInlineConfigParser(
