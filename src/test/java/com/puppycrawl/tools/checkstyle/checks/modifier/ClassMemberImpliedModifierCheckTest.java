...
public class ClassMemberImpliedModifierCheckTest
    ...
    @Test
    public void methodsOnClass() throws Exception {
    ...
    @Test
    public void methodsOnClassNoImpliedStaticEnum() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void methodsOnClassNoImpliedStaticInterface() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void methodsOnClassNoViolationsChecked() throws Exception {
    ...
    @Test
    public void methodsOnInterface() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void classMemberImpliedModifierRecords() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void classMemberImpliedModifierNoViolationRecords() throws Exception {
        final String[] expected = {
            "16:5: " + getCheckMessage(MSG_KEY, "static"),
            "20:5: " + getCheckMessage(MSG_KEY, "static"),
            "33:9: " + getCheckMessage(MSG_KEY, "static"),
