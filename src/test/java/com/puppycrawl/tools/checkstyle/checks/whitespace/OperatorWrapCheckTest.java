...
class OperatorWrapCheckTest
    ...
    @Test
    void instanceOfOperator() throws Exception {
        final String[] expected = {
    ...
    @Test
    void instanceOfOperatorEndOfLine() throws Exception {
        final String[] expected = {
