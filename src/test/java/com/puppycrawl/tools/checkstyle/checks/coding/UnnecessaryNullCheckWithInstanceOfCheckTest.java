...
public class UnnecessaryNullCheckWithInstanceOfCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceof() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofClass() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofConditions() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofNested() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofLambda() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofSwitch() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofTernary() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofTryCatch() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofTryVariable() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofPattern() throws Exception {
    ...
    @Test
    void unnecessaryNullCheckWithInstanceofPair() throws Exception {
