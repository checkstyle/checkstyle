...
public class WhitespaceAfterCheckTest
    ...
    public void testWhitespaceAfterAnnotation() throws Exception {
        final String[] expected = {
            ...
            "69:33: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, "AnnotationAfterTest"),
            "75:17: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, "AnnotationAfterTest"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testWhitespaceAfterAnnotation2() throws Exception {
        final String[] expected = {
            ...
            "49:26: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, ")"),
            "50:26: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, ")"),
            "51:26: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, ")"),
            "58:39: " + getCheckMessage(MSG_WS_NOT_FOLLOWED, ")"),
        };
        verifyWithInlineConfigParser(
