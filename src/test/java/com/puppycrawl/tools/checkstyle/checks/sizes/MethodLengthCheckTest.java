...
public class MethodLengthCheckTest extends AbstractModuleTestSupport {
    ...
    public void testRecordsAndCompactCtors() throws Exception {
        ...
        final String[] expected = {
            "25:9: " + getCheckMessage(MSG_KEY, 5, max, "MyTestRecord2"),
            "34:9: " + getCheckMessage(MSG_KEY, 5, max, "foo"),
            "42:9: " + getCheckMessage(MSG_KEY, 6, max, "MyTestRecord4"),
            "63:9: " + getCheckMessage(MSG_KEY, 13, max, "m"),
            "66:17: " + getCheckMessage(MSG_KEY, 8, max, "R76"),
            "80:5: " + getCheckMessage(MSG_KEY, 8, max, "textBlock"),
        };

        verifyWithInlineConfigParser(
                getNonCompilablePath("InputMethodLengthCompactCtorsAndTextBlocks.java"),
                expected);
    }
