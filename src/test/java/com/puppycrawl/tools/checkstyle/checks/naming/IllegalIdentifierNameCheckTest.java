...
public class IllegalIdentifierNameCheckTest extends AbstractModuleTestSupport {
    ...
    public void testIllegalIdentifierNameDefault() throws Exception {
        ...
        final String format = "(?i)^(?!(record|yield|var|_.+)$).+$";
        ...
        final String[] expected = {
            ...
            "71:16: " + getCheckMessage(MSG_INVALID_PATTERN, "_string", format),
            };
    ...
    public void testIllegalIdentifierNameOpenTransitive() throws Exception {
        ...
        checkConfig.addAttribute("format",
            "(?i)^(?!(record|yield|var|open|transitive)$).+$");

        final String format = "(?i)^(?!(record|yield|var|open|transitive)$).+$";
    ...
    @Test
    public void testIllegalIdentifierNameParamterReciever() throws Exception {
        final DefaultConfiguration checkConfig =
            createModuleConfig(IllegalIdentifierNameCheck.class);
