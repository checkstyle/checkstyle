...
public class IllegalIdentifierNameCheckTest extends AbstractModuleTestSupport {
    ...
    public void testIllegalIdentifierNameWhen() throws Exception {
        ...
        final String[] expected = {
            ...
            "23:26: " + getCheckMessage(MSG_INVALID_PATTERN, "when", format),
            "32:29: " + getCheckMessage(MSG_INVALID_PATTERN, "when", format),
            "41:13: " + getCheckMessage(MSG_INVALID_PATTERN, "when", format),
            "47:26: " + getCheckMessage(MSG_INVALID_PATTERN, "when", format),
            "53:22: " + getCheckMessage(MSG_INVALID_PATTERN, "when", format),
            "63:12: " + getCheckMessage(MSG_INVALID_PATTERN, "when", format),
