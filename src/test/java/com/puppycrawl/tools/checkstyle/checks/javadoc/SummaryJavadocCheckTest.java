...
public class SummaryJavadocCheckTest extends AbstractModuleTestSupport {
    ...
    public void testSetForbiddenSummaryFragmentsAllBranches() throws Exception {
        ...
        Assertions.assertEquals("abc[a-z]", result1.pattern(), "Pattern should match 'abc[a-z]'");
        ...
        Assertions.assertEquals("abc|[a-z]|def", result2.pattern(), "Pattern should match 'abc|[a-z]|def'");
        ...
        Assertions.assertEquals("[a-z]", result3.pattern(), "Pattern should match '[a-z]'");
        ...
        Assertions.assertEquals("randomPattern", result4.pattern(), "Pattern should match 'randomPattern'");
    }

    @Test
    public void testSetForbiddenSummaryFragmentsMutantKillingBranches() throws Exception {
        final SummaryJavadocCheck check = new SummaryJavadocCheck();
        ...
        final Pattern patternEquals = Pattern.compile(inlineTagSuffix.substring(1));
