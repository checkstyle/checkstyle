...
public class HandlerFactoryTest {
    ...
    public void testClearCreatedHandlers() {
        final HandlerFactory handlerFactory = new HandlerFactory();
        final Map<DetailAST, AbstractExpressionHandler> createdHandlers =
                TestUtil.getInternalStateMapDetailASTHandler(
                        handlerFactory, "createdHandlers"
                );
        final DetailAstImpl detailAst = new DetailAstImpl();
        final AbstractExpressionHandler expressionHandler = new EmptyExpressionHandler();
        createdHandlers.put(detailAst, expressionHandler);
    ...
    public static final class EmptyExpressionHandler extends AbstractExpressionHandler {

        private EmptyExpressionHandler() {
