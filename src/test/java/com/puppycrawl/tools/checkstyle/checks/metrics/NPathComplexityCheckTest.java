...
public class NPathComplexityCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void calculation3() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void integerOverflow() throws Exception {
    ...
    @Test
    public void statefulFieldsClearedOnBeginTree1() {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void statefulFieldsClearedOnBeginTree2() {
        final DetailAstImpl ast = new DetailAstImpl();
    ...
    @Test
    public void statefulFieldsClearedOnBeginTree3() throws Exception {
        final NPathComplexityCheck check = new NPathComplexityCheck();
    ...
    @Test
    public void npathComplexityRecords() throws Exception {
        final int max = 1;
    ...
    @Test
    public void npathComplexitySwitchExpression() throws Exception {
    ...
    @Test
    public void branchVisited() throws Exception {
    ...
    @Test
    public void whenExpression() throws Exception {
     ...
     */
    @Test
    public void tokenEndIsAfterSameLineColumn() throws Exception {
        final NPathComplexityCheck check = new NPathComplexityCheck();
    ...
    @Test
    public void visitTokenBeforeExpressionRange() {
        // Create first ast
