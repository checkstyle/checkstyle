...
public class UnnecessaryTypeArgumentsWithRecordPatternCheckTest extends AbstractModuleTestSupport {
    ...
    public void testGetAcceptableTokens() {
        final UnnecessaryTypeArgumentsWithRecordPatternCheck check =
            new UnnecessaryTypeArgumentsWithRecordPatternCheck();
    ...
    public void testUnnecessaryTypeArgumentsWithRecordPatternMultiple() throws Exception {
        final String[] expected = {
            ...
            "38:22: " + getCheckMessage(MSG_KEY),
            "58:37: " + getCheckMessage(MSG_KEY),
        };
        verifyWithInlineConfigParser(getPath(
    ...
    @Test
    public void testUnnecessaryTypeArgumentsWithRecordPatternCompactSourceFile()
            throws Exception {
        final String[] expected = {
            "19:29: " + getCheckMessage(MSG_KEY),
            "31:18: " + getCheckMessage(MSG_KEY),
        };
        verifyWithInlineConfigParser(getNonCompilablePath(
            "compact/InputUnnecessaryTypeArgumentsWithRecordPatternCompact.java"), expected);
    }
