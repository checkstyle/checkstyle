...
public class EmptyLineWrappingInBlockCheckTest extends AbstractModuleTestSupport {
    ...
    public void testDefaultRequiresOneEmptyLineTopAndBottom() throws Exception {
        final String[] expected = {
            "15:44: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE),
            "21:1: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE),
            "23:43: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE),
            "29:1: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE),
        };
    ...
    public void testLiteralsDefaultConfig() throws Exception {
        ...
        final String[] expected = {
            ...
            "27:23: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE),
            "29:9: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE),
            "39:20: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE),
            "41:9: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE),
            "41:16: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE),
            "46:9: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE),
            "49:20: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE),
            "51:9: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE),
            "51:26: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE),
            "56:9: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE),
            "63:32: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE),
            "65:9: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE),
        };
        verifyWithInlineConfigParser(
    ...
    public void testModuleConfigNoEmptyLine() throws Exception {
        ...
        checkConfig.addProperty("topSeparator", "no_empty_line");
        checkConfig.addProperty("bottomSeparator", "no_empty_line");
        final String[] expected = {
            "11:55: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_NO),
            "19:1: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_NO),
        };
        verify(checkConfig, getPath("InputEmptyLineWrappingInBlockNoEmptyLine.java"), expected);
    }
