...
public class EmptyLineWrappingInBlockCheckTest extends AbstractModuleTestSupport {
    ...
    public void testEmptyBlockExpectsTopAndBottomOne() throws Exception {
        final String[] expected = {
            "12:54: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_TOP_ONE, "{"),
            "12:56: " + getCheckMessage(MSG_EMPTY_LINE_WRAPPING_BOTTOM_ONE, "}"),
        };
        verifyWithInlineConfigParser(
    ...
    @Test
    public void testEmptyBlockDefault() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
                getNonCompilablePath("compact/InputEmptyLineWrappingInBlockDefault.java"),
                expected);
    }

    @Test
    public void testEmptyBlockNonDefault() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
                getNonCompilablePath("compact/InputEmptyLineWrappingInBlockTopNonDefault.java"),
                expected);
    }
