...
public class MethodCountCheckTest extends AbstractModuleTestSupport {
    ...
    public void testCompactSourceFile() throws Exception {
        final String[] expected = {
            "14:1: " + getCheckMessage(MSG_MANY_METHODS, 5, 3),
        };
    ...
    public void testCompactSourceFileModifiers() throws Exception {
        final String[] expected = {
            "18:1: " + getCheckMessage(MSG_PACKAGE_METHODS, 2, 1),
            "18:1: " + getCheckMessage(MSG_PRIVATE_METHODS, 1, 0),
            "18:1: " + getCheckMessage(MSG_PROTECTED_METHODS, 1, 0),
            "18:1: " + getCheckMessage(MSG_PUBLIC_METHODS, 1, 0),
        };
    ...
    public void testCompactSourceFileWithType() throws Exception {
        final String[] expected = {
            "14:1: " + getCheckMessage(MSG_MANY_METHODS, 3, 2),
            "18:1: " + getCheckMessage(MSG_MANY_METHODS, 3, 2),
        };
    ...
    public void testCompactSourceFileInnerClasses() throws Exception {
        final String[] expected = {
            "14:1: " + getCheckMessage(MSG_MANY_METHODS, 2, 1),
            "18:5: " + getCheckMessage(MSG_MANY_METHODS, 2, 1),
        };
    ...
    public void testCompactSourceFileStatic() throws Exception {
        final String[] expected = {
            "14:1: " + getCheckMessage(MSG_PACKAGE_METHODS, 3, 1),
        };
