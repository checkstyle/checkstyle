...
public class MethodCountCheckTest extends AbstractModuleTestSupport {
    ...
    public void testThreesTwo() throws Exception {
        ...
        final String[] expected = {
            ...
            "15:1: " + getCheckMessage(MSG_PRIVATE_METHODS, 4, 3),
            "15:1: " + getCheckMessage(MSG_MANY_METHODS, 16, 3),
            "21:3: " + getCheckMessage(MSG_PROTECTED_METHODS, 4, 3),
            "21:3: " + getCheckMessage(MSG_MANY_METHODS, 4, 3),
            "57:3: " + getCheckMessage(MSG_PUBLIC_METHODS, 4, 3),
            "57:3: " + getCheckMessage(MSG_MANY_METHODS, 4, 3),
        };
