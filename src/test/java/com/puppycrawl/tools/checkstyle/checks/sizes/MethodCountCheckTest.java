...
public class MethodCountCheckTest extends AbstractModuleTestSupport {
    ...
    public void testInterfaceMemberScopeIsPublic() throws Exception {
        ...
        final String[] expected = {
            "14:5: " + getCheckMessage(MSG_PUBLIC_METHODS, 2, 1),
            "24:5: " + getCheckMessage(MSG_PUBLIC_METHODS, 2, 1),
        };

        verify(checkConfig, getPath("InputMethodCountInterfaceMemberScopeIsPublic.java"), expected);
    }
