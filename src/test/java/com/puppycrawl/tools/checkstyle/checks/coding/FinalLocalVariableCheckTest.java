...
public class FinalLocalVariableCheckTest
    ...
    public void testPatternVariables() throws Exception {
        final String[] expected = {
            ...
            "32:35: " + getCheckMessage(MSG_KEY, "s"),
            "38:35: " + getCheckMessage(MSG_KEY, "s"),
        };
        verifyWithInlineConfigParser(
    ...
    public void testPatternVariablesScope() throws Exception {
        final String[] expected = {
            ...
            "30:33: " + getCheckMessage(MSG_KEY, "r"),
            "34:34: " + getCheckMessage(MSG_KEY, "r"),
            "43:17: " + getCheckMessage(MSG_KEY, "b"),
            "43:44: " + getCheckMessage(MSG_KEY, "s"),
            "45:20: " + getCheckMessage(MSG_KEY, "s1"),
            "49:35: " + getCheckMessage(MSG_KEY, "s"),
            "52:20: " + getCheckMessage(MSG_KEY, "s1"),
            "57:20: " + getCheckMessage(MSG_KEY, "s1"),
            "64:38: " + getCheckMessage(MSG_KEY, "s"),
            "90:37: " + getCheckMessage(MSG_KEY, "s"),
            "91:16: " + getCheckMessage(MSG_KEY, "s1"),
            "95:35: " + getCheckMessage(MSG_KEY, "s"),
            "99:16: " + getCheckMessage(MSG_KEY, "s"),
            "107:16: " + getCheckMessage(MSG_KEY, "r"),
            "128:37: " + getCheckMessage(MSG_KEY, "s"),
            "133:16: " + getCheckMessage(MSG_KEY, "s"),
            "137:38: " + getCheckMessage(MSG_KEY, "s"),
            "140:16: " + getCheckMessage(MSG_KEY, "s"),
            "144:38: " + getCheckMessage(MSG_KEY, "s"),
            "147:16: " + getCheckMessage(MSG_KEY, "s"),
            "151:38: " + getCheckMessage(MSG_KEY, "s"),
            "154:16: " + getCheckMessage(MSG_KEY, "s"),
            "161:40: " + getCheckMessage(MSG_KEY, "s"),
            "162:16: " + getCheckMessage(MSG_KEY, "s"),
            "169:16: " + getCheckMessage(MSG_KEY, "s3"),
            "175:35: " + getCheckMessage(MSG_KEY, "s4"),
            "178:16: " + getCheckMessage(MSG_KEY, "s4"),
    ...
    public void testPatternVariablesScopeNonCompilable() throws Exception {
        final String[] expected = {
            "16:44: " + getCheckMessage(MSG_KEY, "s10"),
            "17:20: " + getCheckMessage(MSG_KEY, "s10"),
        };
