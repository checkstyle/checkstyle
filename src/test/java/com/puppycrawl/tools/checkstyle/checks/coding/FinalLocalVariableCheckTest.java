...
public class FinalLocalVariableCheckTest
    ...
    public void testFinalLocalVariableSwitchAssignment() throws Exception {
        final String[] expected = {
            "23:13: " + getCheckMessage(MSG_KEY, "a"),
            "46:13: " + getCheckMessage(MSG_KEY, "b"),
            "48:21: " + getCheckMessage(MSG_KEY, "x"),
            "74:16: " + getCheckMessage(MSG_KEY, "res"),
            "94:16: " + getCheckMessage(MSG_KEY, "res"),
        };
        verifyWithInlineConfigParser(
