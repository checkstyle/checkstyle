 ...
 *
 */
class UnnecessaryParenthesesCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    void whenExpressions() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unnecessaryParenthesesConditionalExpression() throws Exception {
        final String[] expected = {
