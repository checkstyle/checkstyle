...
public class UnnecessaryParenthesesCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void testCasts3() throws Exception {
        final String[] expected = {
            "31:49: " + getCheckMessage(MSG_EXPR),
            "41:18: " + getCheckMessage(MSG_EXPR),
            "46:34: " + getCheckMessage(MSG_EXPR),
            "50:26: " + getCheckMessage(MSG_EXPR),
            "55:50: " + getCheckMessage(MSG_EXPR),
            "61:29: " + getCheckMessage(MSG_EXPR),
            "66:13: " + getCheckMessage(MSG_ASSIGN),
        };
        verifyWithInlineConfigParser(
