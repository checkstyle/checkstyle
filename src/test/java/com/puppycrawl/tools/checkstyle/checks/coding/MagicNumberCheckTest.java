...
public class MagicNumberCheckTest
    ...
    public void testMagicNumber2() throws Exception {
        ...
        verifyWithInlineConfigParser(
                getPath("InputMagicNumber_11.java"), expected);
    }

    @Test
    public void testMagicNumber3() throws Exception {
        final String[] expected = {
            "63:21: " + getCheckMessage(MSG_KEY, "9"),
            "65:24: " + getCheckMessage(MSG_KEY, "5.5"),
            "66:23: " + getCheckMessage(MSG_KEY, "12.2f"),
            "67:50: " + getCheckMessage(MSG_KEY, "5"),
            "68:42: " + getCheckMessage(MSG_KEY, "3"),
            "69:44: " + getCheckMessage(MSG_KEY, "3"),
            "70:35: " + getCheckMessage(MSG_KEY, "8"),
            "71:53: " + getCheckMessage(MSG_KEY, "5"),
            "91:17: " + getCheckMessage(MSG_KEY, "5"),
            "94:21: " + getCheckMessage(MSG_KEY, "9"),
            "96:24: " + getCheckMessage(MSG_KEY, "5.5"),
            "97:23: " + getCheckMessage(MSG_KEY, "12.2f"),
            "98:50: " + getCheckMessage(MSG_KEY, "5"),
            "99:42: " + getCheckMessage(MSG_KEY, "3"),
            "100:44: " + getCheckMessage(MSG_KEY, "3"),
            "101:35: " + getCheckMessage(MSG_KEY, "8"),
            "102:53: " + getCheckMessage(MSG_KEY, "5"),
        };
        verifyWithInlineConfigParser(
                getPath("InputMagicNumber_12.java"), expected);
    }
}
