...
public class MagicNumberCheckTest
    ...
    @Test
    void ignoreNegativeOctalHex1() throws Exception {
        final String[] expected = {
            "57:26: " + getCheckMessage(MSG_KEY, "3_000"),
            "59:27: " + getCheckMessage(MSG_KEY, "3"),
            "59:31: " + getCheckMessage(MSG_KEY, "4"),
    ...
    @Test
    void ignoreNegativeOctalHex2() throws Exception {
        final String[] expected = {
            "22:14: " + getCheckMessage(MSG_KEY, "0xffffffffL"),
            "30:30: " + getCheckMessage(MSG_KEY, "+3"),
    ...
    @Test
    void ignoreNegativeOctalHex3() throws Exception {
        final String[] expected = {
            "22:16: " + getCheckMessage(MSG_KEY, "31"),
            "27:16: " + getCheckMessage(MSG_KEY, "42"),
            "32:16: " + getCheckMessage(MSG_KEY, "13"),
    ...
    @Test
    void ignoreHashCodeMethod2() throws Exception {
        final String[] expected = {
            "22:14: " + getCheckMessage(MSG_KEY, "0xffffffffL"),
    ...
    @Test
    void ignoreHashCodeMethod3() throws Exception {
        final String[] expected = {
            "27:16: " + getCheckMessage(MSG_KEY, "42"),
            "32:16: " + getCheckMessage(MSG_KEY, "13"),
            "36:15: " + getCheckMessage(MSG_KEY, "21"),
    ...
    @Test
    void magicNumberRecordsDefault()
            throws Exception {
        final String[] expected = {
    ...
    @Test
    void magicNumberIgnoreFieldDeclarationRecords()
            throws Exception {
        final String[] expected = {
            "21:11: " + getCheckMessage(MSG_KEY, "6"),
            "27:29: " + getCheckMessage(MSG_KEY, "8"),
    ...
    @Test
    void magicNumberIgnoreFieldDeclarationWithAnnotation()
            throws Exception {
        final String[] expected = {
    ...
    @Test
    void magicNumberInGuards() throws Exception {
        final String[] expected = {
    ...
    @Test
    void magicNumberWithUnnamedVariables() throws Exception {
        final String[] expected = {
    ...
    @Test
    void magicNumberWithOperatorsWithIgnoreFieldsTrue() throws Exception {
        final String[] expected = {
    ...
    @Test
    void magicNumberWithOperatorsWithIgnoreFieldsFalse() throws Exception {
        final String[] expected = {
            "54:25: " + getCheckMessage(MSG_KEY, "3"),
            "55:25: " + getCheckMessage(MSG_KEY, "3"),
            "56:26: " + getCheckMessage(MSG_KEY, "3"),
