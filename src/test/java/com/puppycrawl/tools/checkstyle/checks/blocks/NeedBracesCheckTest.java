...
public class NeedBracesCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void itWithAllowsOn() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void singleLineStatements() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void doNotAllowSingleLineLambda() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void singleLineCaseDefault() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void singleLineCaseDefault2() throws Exception {
    ...
    @Test
    public void singleLineCaseDefaultNoSingleLine() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void allowEmptyLoopBodyTrue() throws Exception {
        final String[] expected = {
            "106:9: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
        };
        verifyWithInlineConfigParser(
    ...
    @Test
    public void allowEmptyLoopBodyFalse() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void emptySingleLineDefaultStmt() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
    ...
    @Test
    public void needBracesSwitchExpressionNoSingleLine() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void needBracesSwitchExpression() throws Exception {
        final String[] expected = {
            "16:13: " + getCheckMessage(MSG_KEY_NEED_BRACES, "case"),
            "18:49: " + getCheckMessage(MSG_KEY_NEED_BRACES, "->"),
            "20:13: " + getCheckMessage(MSG_KEY_NEED_BRACES, "case"),
    ...
    @Test
    public void patternMatchingForSwitch() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void patternMatchingForSwitchAllowSingleLine() throws Exception {
        final String[] expected = {
            "17:13: " + getCheckMessage(MSG_KEY_NEED_BRACES, "case"),
            "21:13: " + getCheckMessage(MSG_KEY_NEED_BRACES, "case"),
            "26:13: " + getCheckMessage(MSG_KEY_NEED_BRACES, "case"),
    ...
    @Test
    public void needBracesSwitchExpressionAndLambda() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void needBracesSwitchExpressionAndLambdaAllowSingleLine() throws Exception {
        final String[] expected = {
            "27:24: " + getCheckMessage(MSG_KEY_NEED_BRACES, "->"),
