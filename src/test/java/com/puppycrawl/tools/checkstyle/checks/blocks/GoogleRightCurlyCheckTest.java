...
public class GoogleRightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testSwitchOldStyle() throws Exception {
        final String[] expected = {
            ...
            "71:23: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 23),
    ...
    public void testTypesRightCurly() throws Exception {
        final String[] expected = {
            "13:21: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 21),
            "21:6: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 6),
            "37:24: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 24),
            "43:33: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 33),
            "58:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "74:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
        };
