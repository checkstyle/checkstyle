...
public class GoogleRightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testTryCatchFinally() throws Exception {
        final String[] expected = {
            ...
            "43:17: " + getCheckMessage(MSG_KEY_LINE_SAME, "}", 17),
            "59:9: " + getCheckMessage(MSG_KEY_LINE_SAME, "}", 9),
            "63:9: " + getCheckMessage(MSG_KEY_LINE_SAME, "}", 9),
            "74:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "74:10: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 10),
            "91:9: " + getCheckMessage(MSG_KEY_LINE_SAME, "}", 9),
            "95:9: " + getCheckMessage(MSG_KEY_LINE_SAME, "}", 9),
            "108:53: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 53),
        };
    ...
    public void testSwitchOldStyle() throws Exception {
        final String[] expected = {
            ...
            "49:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "58:13: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "60:24: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "61:30: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 30),
            "63:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "73:23: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 23),
            "79:13: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
        };
    ...
    public void testTypesRightCurly() throws Exception {
        final String[] expected = {
            ...
            "32:33: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 33),
            "47:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "63:5: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "67:5: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "72:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "77:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "82:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "86:22: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "89:19: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
        };
    ...
    @Test
    public void testTypesWithComments() throws Exception {
        final String[] expected = {
            "17:28: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 28),
            "22:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "30:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "57:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "62:9: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 9),
            "68:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "76:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
        };
        verifyWithInlineConfigParser(
                getPath("InputGoogleRightCurlyBlocksWithComments.java"),
                expected);
    }
