...
public class GoogleRightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testSwitchOldStyle() throws Exception {
        final String[] expected = {
            ...
            "32:21: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "44:13: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 13),
            "56:21: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "59:21: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            ...
            "76:13: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
        };
    ...
    public void testTypesRightCurly() throws Exception {
        final String[] expected = {
            ...
            "76:18: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "80:21: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
        };
    ...
    public void testStaticAndInstanceInitializers() throws Exception {
        final String[] expected = {
            ...
            "33:5: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "34:7: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
        };
