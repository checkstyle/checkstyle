...
public class GoogleRightCurlyCheckTest extends AbstractModuleTestSupport {
    ...
    public void testMultiBlockStatements2() throws Exception {
        final String[] expected = {
            ...
            "58:29: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 29),
        };
    ...
    public void testSwitchOldStyle() throws Exception {
        final String[] expected = {
            ...
            "33:13: " + getCheckMessage(MSG_KEY_LINE_BREAK_AFTER, "}", 13),
            ...
            "78:13: " + getCheckMessage(MSG_KEY_LINE_BREAK_AFTER, "}", 13),
        };
    ...
    @Test
    public void testSwitchNewStyle2() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;

        verifyWithInlineConfigParser(
                getPath("InputGoogleRightCurlySwitchNewStyle2.java"),
                expected);
    }
    ...
    public void testTypesRightCurly() throws Exception {
        final String[] expected = {
            ...
            "40:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "52:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "68:5: " + getCheckMessage(MSG_KEY_LINE_BREAK_AFTER, "}", 5),
            "72:5: " + getCheckMessage(MSG_KEY_LINE_BREAK_AFTER, "}", 5),
            ...
            "92:5: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 5),
            "96:22: " + getCheckMessage(MSG_KEY_CONCISE_BLOCK),
            "105:34: " + getCheckMessage(MSG_KEY_LINE_ALONE, "}", 34),
        };
