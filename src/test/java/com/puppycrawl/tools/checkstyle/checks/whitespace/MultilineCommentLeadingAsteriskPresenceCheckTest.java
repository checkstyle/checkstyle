...
public class MultilineCommentLeadingAsteriskPresenceCheckTest
    ...
    public void testGetAcceptableTokens() {
        final MultilineCommentLeadingAsteriskPresenceCheck check =
            new MultilineCommentLeadingAsteriskPresenceCheck();
        final int[] actual = check.getAcceptableTokens();
        final int[] expected = new int[] {TokenTypes.BLOCK_COMMENT_BEGIN};

        assertNotNull(actual, "getAcceptableTokens should not return null");
        assertArrayEquals(expected, actual,
            "getAcceptableTokens should return BLOCK_COMMENT_BEGIN");
    }
