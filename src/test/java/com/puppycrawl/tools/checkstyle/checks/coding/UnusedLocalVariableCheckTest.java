...
public class UnusedLocalVariableCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedLocalVariable() throws Exception {
        final String[] expected = {
            ...
            "77:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "p"),
            "90:13: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "104:14: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "i"),
            "107:14: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "j"),
            "119:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "120:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
        };
