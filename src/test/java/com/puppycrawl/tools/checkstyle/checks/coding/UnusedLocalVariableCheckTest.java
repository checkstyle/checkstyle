...
public class UnusedLocalVariableCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedLocalVariable() throws Exception {
        final String[] expected = {
            ...
            "70:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
            "74:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "p"),
            "87:13: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "101:14: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "i"),
            "104:14: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "j"),
            "116:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "117:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
        };
