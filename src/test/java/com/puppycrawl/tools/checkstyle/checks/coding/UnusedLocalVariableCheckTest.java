...
class UnusedLocalVariableCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    void unusedLocalVar3() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unusedLocalVarNestedClasses4() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unusedLocalVarNestedClasses5() throws Exception {
        final String[] expected = {
            "12:5: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "13:5: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "ab"),
    ...
    @Test
    void unusedLocalVarNestedClasses6() throws Exception {
        final String[] expected = {
            "12:5: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "13:5: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "ab"),
        };
    ...
    @Test
    void unusedLocalVarNestedClasses7() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unusedLocalVarTestWarningSeverity() throws Exception {
    ...
    @Test
    void unusedLocalVarLambdas() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unusedLocalVariableLocalClasses() throws Exception {
        final String[] expected = {
            "14:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
    ...
    @Test
    void unusedLocalVariableSwitchStatement() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
    ...
    @Test
    void unusedLocalVariableSwitchStatement2() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unusedLocalVariableSwitchExpression() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unusedLocalVariableWithAllowUnnamed() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unusedLocalVariableWithAllowUnnamedFalse() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unusedLocalVarInAnonInnerClasses2() throws Exception {
        final String[] expected = {
    ...
    @Test
    void unusedLocalVarInAnonInnerClasses3() throws Exception {
        final String[] expected = {
