...
public class UnusedLocalVariableCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedLocalVariable() throws Exception {
        final String[] expected = {
            ...
            "106:14: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "i"),
            "109:14: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "j"),
            "121:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "122:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
        };
