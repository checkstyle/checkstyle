...
public class UnusedLocalVariableCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedLocalVariableNamedPatternVariable() throws Exception {
        final String[] expected = {
            "13:25: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "ignored"),
            "14:26: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "ignored2"),
            "20:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "x"),
            "21:38: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "ignored"),
        };
        verifyWithInlineConfigParser(
