...
public class UnusedLocalVariableCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedLocalVariable() throws Exception {
        final String[] expected = {
            ...
            "59:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
            "63:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "p"),
            "73:13: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "89:14: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "j"),
        };
    ...
    public void testChainedUnusedLocalVariable() throws Exception {
        final String[] expected = {
            ...
            "81:29: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "k"),
        };
        verifyWithInlineConfigParser(
