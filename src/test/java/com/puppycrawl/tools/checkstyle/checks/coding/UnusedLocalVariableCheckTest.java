...
public class UnusedLocalVariableCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedLocalVariable() throws Exception {
        final String[] expected = {
            "18:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "sameName"),
            "19:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
            "34:13: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
            "38:13: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "c"),
            "46:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "56:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
    ...
    public void testChainedUnusedLocalVariable() throws Exception {
        final String[] expected = {
            "20:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "a"),
            "21:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
            "27:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "p"),
            "34:26: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "s"),
