...
public class UnusedLocalVariableCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedLocalVariable() throws Exception {
        final String[] expected = {
            "16:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "sameName"),
            "17:9: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
            "32:13: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "b"),
            "36:13: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "c"),
