...
public class UnusedLocalVariableCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnusedLocalVariablePatternVariables() throws Exception {
        final String[] expected = {
            ...
            "39:22: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "c"),
            "40:22: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "r"),
            "75:18: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "s"),
            "94:28: " + getCheckMessage(MSG_UNUSED_LOCAL_VARIABLE, "s"),
        };
        verifyWithInlineConfigParser(
                getPath(
    ...
    public void testUnusedLocalVariablePatternVariablesAllowUnnamed() throws Exception {
        final String[] expected = {
            ...
            "39:28: " + getCheckMessage(MSG_UNUSED_NAMED_LOCAL_VARIABLE, "s"),
        };
        verifyWithInlineConfigParser(
                getPath(
