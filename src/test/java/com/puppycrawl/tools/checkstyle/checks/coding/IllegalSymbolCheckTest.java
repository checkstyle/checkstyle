...
public class IllegalSymbolCheckTest extends AbstractModuleTestSupport {
    ...
    public void testAsciiOnly() throws Exception {
        final String[] expected = {
            "12:18: " + getCheckMessage(MSG_KEY, "é"),
            "13:18: " + getCheckMessage(MSG_KEY, "•"),
        };
    ...
    public void testCharLiteral() throws Exception {
        final String[] expected = {
            "12:14: " + getCheckMessage(MSG_KEY, "é"),
        };
    ...
    @Test
    public void testInitParseSymbolCodesIsCalledAndPopulatesSets() throws Exception {
        final String[] expected = {
            "12:7: " + getCheckMessage(MSG_KEY, "😀"),
            "13:7: " + getCheckMessage(MSG_KEY, "🚀"),
        };
        verifyWithInlineConfigParser(
                getPath("InputIllegalSymbolDefaultStrong.java"), expected);
    }

    @Test
    public void testRangeStartEqualsEnd() throws Exception {
        final String[] expected = {
            "12:18: " + getCheckMessage(MSG_KEY, "✅"),
        };
        verifyWithInlineConfigParser(
                getPath("InputIllegalSymbolRangeStartEqualsEnd.java"), expected);
    }

    @Test
    public void testRangePartsAreTrimmed() throws Exception {
        final String[] expected = {
            "12:18: " + getCheckMessage(MSG_KEY, "✈"),
        };
        verifyWithInlineConfigParser(
                getPath("InputIllegalSymbolRangeTrimmed.java"), expected);
    }

    @Test
    public void testSymbolCodesWithSpacesAreTrimmed() throws Exception {
        final String[] expected = {
            "12:18: " + getCheckMessage(MSG_KEY, "✅"),
        };
        verifyWithInlineConfigParser(
                getPath("InputIllegalSymbolSpacedEntries.java"), expected);
    }
    ...
    public void testRangeBoundaries() throws Exception {
        ...
        verifyWithInlineConfigParser(
                getPath("InputIllegalSymbolRangeBoundaries.java"),
                expected);
    }

    @Test
    public void testMultipleIllegalSymbolsOnlyOneViolation() throws Exception {
        final String[] expected = {
            "12:18: " + getCheckMessage(MSG_KEY, "😀"),
        };

        verifyWithInlineConfigParser(
                getPath("InputIllegalSymbolMultipleInComment.java"),
                expected);
    }

    @Test
    public void testTrimmedCommaSeparatedValues() throws Exception {
        final String[] expected = {
            "12:18: " + getCheckMessage(MSG_KEY, "😀"),
        };

        verifyWithInlineConfigParser(
                getPath("InputIllegalSymbolTrimComma.java"),
                expected);
    }

    @Test
    public void testInvalidShortPrefix() {
        final IllegalSymbolCheck check = new IllegalSymbolCheck();

        final IllegalArgumentException ex0x = getExpectedThrowable(
                IllegalArgumentException.class,
                () -> check.setSymbolCodes("0x"));
        assertWithMessage("Wrong exception message for '0x' prefix")
                .that(ex0x.getMessage())
                .contains("Invalid");

        final IllegalArgumentException exu = getExpectedThrowable(
                IllegalArgumentException.class,
                () -> check.setSymbolCodes("U+"));
        assertWithMessage("Wrong exception message for 'U+' prefix")
                .that(exu.getMessage())
                .contains("Invalid");
    }
    ...
    public void testInvalidRangeFormats() {
        ...
        final IllegalArgumentException exMissingStart = getExpectedThrowable(
                IllegalArgumentException.class,
                () -> check.setSymbolCodes("-0x1234"));
        assertWithMessage("Exception message mismatch for missing range start")
                .that(exMissingStart.getMessage())
                .contains("Invalid range");

        final IllegalArgumentException exMissingEnd = getExpectedThrowable(
                IllegalArgumentException.class,
                () -> check.setSymbolCodes("0x1234-"));
        assertWithMessage("Exception message mismatch for missing range end")
                .that(exMissingEnd.getMessage())
                .contains("Invalid range");
    }

    @Test
    public void testSingleAndRangeOverlap() throws Exception {
        final String[] expected = {
            "12:18: " + getCheckMessage(MSG_KEY, "😀"),
        };

        verifyWithInlineConfigParser(
            getPath("InputIllegalSymbolSingleAndRange.java"),
            expected);
    }

    @Test
    public void testInvalidRangeOrder() {
        final IllegalSymbolCheck check = new IllegalSymbolCheck();

        final IllegalArgumentException exception = getExpectedThrowable(
                IllegalArgumentException.class,
                () -> check.setSymbolCodes("0x1F601-0x1F600"));
        assertWithMessage("Wrong message")
                .that(exception.getMessage())
                .contains("Range start must be <=");
    }

    @Test
    public void testSingleAndRangeOverlapBehaviour() throws Exception {
        final String[] expected = {
            "12:18: " + getCheckMessage(MSG_KEY, "😀"),
        };
