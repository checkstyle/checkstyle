...
public class IllegalSymbolCheckTest extends AbstractModuleTestSupport {
    ...
    public void testInvalidShortPrefix() {
        ...
        try {
            ...
            check.init();
            assertWithMessage("Exception expected for invalid prefix 0x")
                    .fail();
        }
        catch (IllegalArgumentException exception) {
            assertWithMessage("Wrong exception message")
        ...
        try {
            ...
            check.init();
            assertWithMessage("Exception expected for invalid prefix U+")
                    .fail();
        }
        catch (IllegalArgumentException exception) {
            assertWithMessage("Wrong exception message")
    ...
    public void testInvalidRangeFormats() {
        ...
        try {
            ...
            check.init();
            assertWithMessage("Expected exception for missing range start")
                    .fail();
        }
        catch (IllegalArgumentException exception) {
            assertWithMessage("Exception message mismatch")
                    .that(exception.getMessage())
        ...
        try {
            check.setSymbolCodes("0x1234-");
            check.init();
            assertWithMessage("Expected exception for missing range end")
                    .fail();
        }
        catch (IllegalArgumentException exception) {
            assertWithMessage("Exception message mismatch")
