...
public class PatternVariableAssignmentCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnnecessaryNullCheckWithInstanceof() throws Exception {
        ...
        final String[] expected = {
            "18:15: " + getCheckMessage(MSG_KEY, "s"),
            "22:15: " + getCheckMessage(MSG_KEY, "x"),
            "23:15: " + getCheckMessage(MSG_KEY, "y"),
            "26:15: " + getCheckMessage(MSG_KEY, "c"),
            "29:15: " + getCheckMessage(MSG_KEY, "c"),
            "32:15: " + getCheckMessage(MSG_KEY, "c"),
        };
