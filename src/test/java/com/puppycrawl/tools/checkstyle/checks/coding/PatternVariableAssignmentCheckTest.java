...
public class PatternVariableAssignmentCheckTest extends AbstractModuleTestSupport {
    ...
    public void testUnnecessaryNullCheckWithInstanceof() throws Exception {
        ...
        final String[] expected = {
            ...
            "27:13: " + getCheckMessage(MSG_KEY, "y"),
            "31:13: " + getCheckMessage(MSG_KEY, "c"),
            "35:13: " + getCheckMessage(MSG_KEY, "c"),
            "39:13: " + getCheckMessage(MSG_KEY, "c"),
            "44:21: " + getCheckMessage(MSG_KEY, "d"),
            "56:14: " + getCheckMessage(MSG_KEY, "f"),
        };
