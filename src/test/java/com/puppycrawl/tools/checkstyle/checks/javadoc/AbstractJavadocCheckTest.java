...
public class AbstractJavadocCheckTest extends AbstractModuleTestSupport {
    ...
    public static class JavadocCatchCheck extends AbstractJavadocCheck {
        ...
        private static final Set<String> VISITED_TOKENS = new HashSet<>();
        ...
        public void visitJavadocToken(DetailNode ast) {
            ...
            if (!VISITED_TOKENS.contains(tokenIdentifier)) {
                VISITED_TOKENS.add(tokenIdentifier);
    ...
    public static class TightHtmlTagCheck extends AbstractJavadocCheck {
