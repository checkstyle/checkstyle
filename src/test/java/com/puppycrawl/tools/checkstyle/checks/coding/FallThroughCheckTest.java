...
public class FallThroughCheckTest extends AbstractModuleTestSupport {
    ...
    public void testDefault() throws Exception {
        final String[] expected = {
            ...
            "505:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "507:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "509:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "511:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "513:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "515:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "517:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "519:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "521:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "523:15: " + getCheckMessage(MSG_FALL_THROUGH),
            "525:15: " + getCheckMessage(MSG_FALL_THROUGH),
    ...
    public void testLastCaseGroup() throws Exception {
        final String[] expected = {
            ...
            "394:12: " + getCheckMessage(MSG_FALL_THROUGH_LAST),
            "424:13: " + getCheckMessage(MSG_FALL_THROUGH),
            "432:9: " + getCheckMessage(MSG_FALL_THROUGH),
            "444:9: " + getCheckMessage(MSG_FALL_THROUGH),
            "454:9: " + getCheckMessage(MSG_FALL_THROUGH),
    ...
    public void testFallThrough() throws Exception {
        final String[] expected = {
            ...
            "35:10: " + getCheckMessage(MSG_FALL_THROUGH),
            "37:10: " + getCheckMessage(MSG_FALL_THROUGH),
            "39:10: " + getCheckMessage(MSG_FALL_THROUGH),
            "54:13: " + getCheckMessage(MSG_FALL_THROUGH),
            "67:13: " + getCheckMessage(MSG_FALL_THROUGH),
            "82:13: " + getCheckMessage(MSG_FALL_THROUGH),
            "96:13: " + getCheckMessage(MSG_FALL_THROUGH),
            "111:13: " + getCheckMessage(MSG_FALL_THROUGH),
        };
        verifyWithInlineConfigParser(
