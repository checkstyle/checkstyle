...
public class FallThroughCheckTest extends AbstractModuleTestSupport {
    ...
    public void testLastCaseGroup() throws Exception {
        final String[] expected = {
            ...
            "188:11: " + getCheckMessage(MSG_FALL_THROUGH),
            "378:11: " + getCheckMessage(MSG_FALL_THROUGH),
            "381:11: " + getCheckMessage(MSG_FALL_THROUGH),
            "383:40: " + getCheckMessage(MSG_FALL_THROUGH),
            "385:11: " + getCheckMessage(MSG_FALL_THROUGH_LAST),
            "425:13: " + getCheckMessage(MSG_FALL_THROUGH),
            "433:9: " + getCheckMessage(MSG_FALL_THROUGH),
            "445:9: " + getCheckMessage(MSG_FALL_THROUGH),
            "455:9: " + getCheckMessage(MSG_FALL_THROUGH),
            "492:9: " + getCheckMessage(MSG_FALL_THROUGH),
            "493:9: " + getCheckMessage(MSG_FALL_THROUGH),
        };
        verifyWithInlineConfigParser(
    ...
    public void testFallThrough7() throws Exception {
        final String[] expected = {
            ...
            "65:13: " + getCheckMessage(MSG_FALL_THROUGH),
            "112:13: " + getCheckMessage(MSG_FALL_THROUGH_LAST),
        };
        verifyWithInlineConfigParser(
