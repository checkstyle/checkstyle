...
public class RequireThisCheckTest extends AbstractModuleTestSupport {
    ...
    public void testPatternVariables() throws Exception {
        final String[] expected = {
            ...
            "52:34: " + getCheckMessage(MSG_VARIABLE, "p", ""),
            "53:13: " + getCheckMessage(MSG_VARIABLE, "p", ""),
            "76:14: " + getCheckMessage(MSG_VARIABLE, "p", ""),
            "81:14: " + getCheckMessage(MSG_VARIABLE, "s", ""),
            "103:22: " + getCheckMessage(MSG_VARIABLE, "p", ""),
            "106:23: " + getCheckMessage(MSG_VARIABLE, "s", ""),
