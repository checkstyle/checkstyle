...
public class RequireThisCheckTest extends AbstractModuleTestSupport {
    ...
    public void testPatternVariableHelperMethodsWithNull() throws Exception {
        final Set<?> trueBranch = TestUtil.invokeStaticMethod(
                getPatternVariableScopeSupportClass(), "getPatternVariablesInTrueBranch",
                Set.class, (Object) null);
        final Set<?> falseBranch = TestUtil.invokeStaticMethod(
                getPatternVariableScopeSupportClass(), "getPatternVariablesInFalseBranch",
                Set.class, (Object) null);
        final Set<?> introducedWhenTrue = TestUtil.invokeStaticMethod(
                getPatternVariableScopeSupportClass(), "getPatternVariablesIntroducedWhenTrue",
                Set.class, (Object) null);
        final Set<?> introducedWhenFalse = TestUtil.invokeStaticMethod(
                getPatternVariableScopeSupportClass(), "getPatternVariablesIntroducedWhenFalse",
                Set.class, (Object) null);
    ...
    public void testPatternVariableLogicalOperandAndSubtree() throws Exception {
        ...
        final DetailAST operand = TestUtil.invokeStaticMethod(
                getPatternVariableScopeSupportClass(), "getLogicalOperand",
        ...
        final boolean subtreeMatch = TestUtil.invokeStaticMethod(
                getPatternVariableScopeSupportClass(), "isInSubtree",
    ...
    public void testPatternVariablesDeclaredByRecordPatternWithBindingVariable()
        ...
        final Set<?> declared = TestUtil.invokeStaticMethod(
                getPatternVariableScopeSupportClass(), "getPatternVariablesDeclaredBy",
    ...
    private static Class<?> getPatternVariableScopeSupportClass() throws Exception {
        return Class.forName(RequireThisCheck.class.getName()
                + "$PatternVariableScopeSupport");
    }
}
