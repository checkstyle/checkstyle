...
public class RequireThisCheckTest extends AbstractModuleTestSupport {
    ...
    public void testValidateOnlyOverlappingFalse() throws Exception {
        final String[] expected = {
            "30:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "31:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal1", ""),
            "32:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal2", ""),
            "33:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal3", ""),
            "37:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal1", ""),
            "38:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal2", ""),
            ...
            "51:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal1", ""),
            "53:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "55:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal3", ""),
            "59:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal2", ""),
            "60:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal3", ""),
            "70:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal1", ""),
            "71:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal2", ""),
            "90:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "129:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "138:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "142:9: " + getCheckMessage(MSG_METHOD, "method1", ""),
            "178:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal1", ""),
            "179:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal2", ""),
            "180:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal3", ""),
            "182:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "186:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal1", ""),
            "187:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal2", ""),
            "188:9: " + getCheckMessage(MSG_VARIABLE, "fieldFinal3", ""),
            "190:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "195:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "199:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "220:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "227:29: " + getCheckMessage(MSG_VARIABLE, "booleanField", ""),
            "238:21: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "248:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "263:9: " + getCheckMessage(MSG_VARIABLE, "booleanField", ""),
            "272:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "280:18: " + getCheckMessage(MSG_METHOD, "addSuf2F", ""),
            "285:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "285:18: " + getCheckMessage(MSG_METHOD, "addSuf2F", ""),
            "311:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "350:9: " + getCheckMessage(MSG_VARIABLE, "field1", ""),
            "384:25: " + getCheckMessage(MSG_METHOD, "getAction", ""),
            "386:20: " + getCheckMessage(MSG_METHOD, "processAction", ""),
            "394:16: " + getCheckMessage(MSG_METHOD, "processAction", ""),
            "500:22: " + getCheckMessage(MSG_VARIABLE, "add", ""),
            "535:45: " + getCheckMessage(MSG_VARIABLE, "charset", ""),
            "551:13: " + getCheckMessage(MSG_VARIABLE, "charset", ""),
            "563:45: " + getCheckMessage(MSG_METHOD, "methodToInvoke", ""),
        };
        verifyWithInlineConfigParser(
