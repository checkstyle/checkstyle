...
import static com.puppycrawl.tools.checkstyle.checks.coding.TextBlockGoogleStyleFormattingCheck.MSG_TEXT_BLOCK_CONTENT;
...
public class TextBlockGoogleStyleFormattingCheckTest extends AbstractModuleTestSupport {
    ...
    public void testDefaultTextBlockFormat() throws Exception {
        final String[] expected = {
            ...
            "89:29: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "89:32: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "90:29: " + getCheckMessage(MSG_CLOSE_QUOTES_ERROR),
            "102:17: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "102:20: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "104:13: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "104:19: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "106:13: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
        };
    ...
    public void testDefaultTextBlockFormat1() throws Exception {
        final String[] expected = {
            ...
            "51:18: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormat2() throws Exception {
        final String[] expected = {
            ...
            "13:40: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "29:36: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "46:39: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "55:20: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "63:19: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "89:19: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "90:41: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "90:41: " + getCheckMessage(MSG_CLOSE_QUOTES_ERROR),
            "98:41: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "98:41: " + getCheckMessage(MSG_CLOSE_QUOTES_ERROR),
            "105:24: " + getCheckMessage(MSG_CLOSE_QUOTES_ERROR),
            "105:24: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
        };
    ...
    public void testDefaultTextBlockFormat3() throws Exception {
        final String[] expected = {
            ...
            "20:20: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "22:13: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "22:19: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "22:22: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "37:22: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "38:32: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "70:18: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormat4() throws Exception {
        final String[] expected = {
            ...
            "27:32: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "51:20: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "54:9: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "64:16: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "64:19: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormat5() throws Exception {
        final String[] expected = {
            "17:48: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testTextBlockGoogleStyleFormattingWithTabs() throws Exception {
        final String[] expected = {
            ...
            "25:27: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "41:69: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormatWithIf() throws Exception {
        final String[] expected = {
            ...
            "17:21: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "26:27: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "39:23: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "40:27: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "57:21: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "58:18: " + getCheckMessage(MSG_CLOSE_QUOTES_ERROR),
            "58:24: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "58:27: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "59:27: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "72:22: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "81:38: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "81:41: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "90:36: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "99:25: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "108:24: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormatWithNewKeyword() throws Exception {
        final String[] expected = {
            "13:45: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormatInCtor() throws Exception {
        final String[] expected = {
            ...
            "39:26: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "41:17: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "46:20: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "53:29: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "55:14: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
        };
        verifyWithInlineConfigParser(
    ...
    public void testDefaultTextBlockFormatIndentationOfContent() throws Exception {
        final String[] expected = {
            "13:16: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "27:20: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "49:20: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormatAnnotations() throws Exception {
        final String[] expected = {
            "60:27: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "60:30: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "68:19: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "68:22: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "70:1: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
        };
        verifyWithInlineConfigParser(
    ...
    public void testDefaultTextBlockFormat6() throws Exception {
        final String[] expected = {
            "31:16: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "48:20: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
        };
        verifyWithInlineConfigParser(
    ...
    @Test
    public void testTextBlockAsArguments() throws Exception {
        final String[] expected = {
            "14:13: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "16:18: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "25:18: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "27:23: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "35:21: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
        };
        verifyWithInlineConfigParser(
                getPath("InputTextBlockGoogleStyleFormattingTextBlockAsArgument.java"),
                expected
        );
    }
