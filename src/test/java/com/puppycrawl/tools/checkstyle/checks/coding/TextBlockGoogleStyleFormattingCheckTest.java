...
public class TextBlockGoogleStyleFormattingCheckTest extends AbstractModuleTestSupport {
    ...
    public void testTextBlockFormatNotVerticallyAligned() throws Exception {
        final String[] expected = {
            ...
            "62: " + getCheckMessage(MSG_LINE_INDENTATION),
    ...
    public void testDefaultTextBlockFormatIndentationOfContent() throws Exception {
        final String[] expected = {
            "13: " + getCheckMessage(MSG_LINE_INDENTATION),
            "14: " + getCheckMessage(MSG_LINE_INDENTATION),
            "26: " + getCheckMessage(MSG_LINE_INDENTATION),
    ...
    public void testTextBlockWithBlankLines() throws Exception {
        final String[] expected = {
            "47: " + getCheckMessage(MSG_LINE_INDENTATION),
        };
        verifyWithInlineConfigParser(
