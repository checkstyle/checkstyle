...
public class TextBlockGoogleStyleFormattingCheckTest extends AbstractModuleTestSupport {
    ...
    public void testDefaultTextBlockFormat1() throws Exception {
        final String[] expected = {
            ...
            "52:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormat2() throws Exception {
        final String[] expected = {
            ...
            "14:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "30:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "47:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "56:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "64:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "90:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormat3() throws Exception {
        final String[] expected = {
            ...
            "23:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "38:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "39:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "71:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormat4() throws Exception {
        final String[] expected = {
            ...
            "28:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "52:12: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "54:9: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "64:16: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "65:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "84:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "86:13: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "99:16: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "100:13: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormat5() throws Exception {
        final String[] expected = {
            "18:9: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testTextBlockGoogleStyleFormattingWithTabs() throws Exception {
        final String[] expected = {
            ...
            "26:33: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "42:65: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testTextBlockFormatNotVerticallyAligned() throws Exception {
        final String[] expected = {
            "28:17: " + getCheckMessage(MSG_VERTICALLY_UNALIGNED),
            "33:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormatWithIf() throws Exception {
        final String[] expected = {
            ...
            "18:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "41:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "58:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "58:18: " + getCheckMessage(MSG_CLOSE_QUOTES_ERROR),
            "58:24: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "59:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "60:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "73:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "81:38: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
            "82:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "91:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "100:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "109:17: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormatWithNewKeyword() throws Exception {
        final String[] expected = {
            "14:33: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormatInCtor() throws Exception {
        final String[] expected = {
            ...
            "53:16: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormatInAnnotations() throws Exception {
        final String[] expected = {
            ...
            "23:9: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            ...
            "34:9: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
    ...
    public void testDefaultTextBlockFormatIndentationOfContent() throws Exception {
        final String[] expected = {
            "14:6: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "28:6: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
            "50:6: " + getCheckMessage(MSG_TEXT_BLOCK_CONTENT),
