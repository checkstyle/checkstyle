...
public class TextBlockGoogleStyleFormattingCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    void defaultTextBlockFormat() throws Exception {
    ...
    @Test
    void defaultTextBlockFormat1() throws Exception {
        final String[] expected = {
    ...
    @Test
    void defaultTextBlockFormat2() throws Exception {
        final String[] expected = {
            "13:37: " + getCheckMessage(MSG_OPEN_QUOTES_ERROR),
    ...
    @Test
    void defaultTextBlockFormat3() throws Exception {
        final String[] expected = {
    ...
    @Test
    void defaultTextBlockFormat4() throws Exception {
        final String[] expected = {
    ...
    @Test
    void defaultTextBlockFormat5() throws Exception {
        final String[] expected = {
    ...
    @Test
    void textBlockGoogleStyleFormattingWithTabs() throws Exception {
        final String[] expected = {
    ...
    @Test
    void textBlockFormatNotVerticallyAligned() throws Exception {
        final String[] expected = {
    ...
    @Test
    void defaultTextBlockFormatWithIf() throws Exception {
        final String[] expected = {
    ...
    @Test
    void defaultTextBlockFormatWithNewKeyword() throws Exception {
        final String[] expected = {
    ...
    @Test
    void defaultTextBlockFormatInCtor() throws Exception {
        final String[] expected = {
    ...
    @Test
    void defaultTextBlockFormatInAnnotations() throws Exception {
        final String[] expected = {
    ...
    @Test
    void defaultTextBlockFormatIndentationOfContent() throws Exception {
        final String[] expected = {
    ...
    @Test
    void defaultTextBlockFormatAnnotations() throws Exception {
        final String[] expected = {
