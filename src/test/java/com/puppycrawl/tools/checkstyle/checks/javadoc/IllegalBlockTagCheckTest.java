...
public class IllegalBlockTagCheckTest extends AbstractModuleTestSupport {
    ...
    public void testTagPresence() throws Exception {
        final String[] expected = {
            "16: " + getCheckMessage(MSG_ILLEGAL_PATTERN, "todo"),
            "29: " + getCheckMessage(MSG_ILLEGAL_PATTERN, "todo"),
        };
    ...
    public void testIllegalPattern() throws Exception {
        final String[] expected = {
            "20: " + getCheckMessage(MSG_ILLEGAL_PATTERN, "somesince"),
            "28: " + getCheckMessage(MSG_ILLEGAL_PATTERN, "somesince"),
        };
