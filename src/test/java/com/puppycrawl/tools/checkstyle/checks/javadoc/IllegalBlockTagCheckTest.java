...
public class IllegalBlockTagCheckTest extends AbstractModuleTestSupport {
    ...
    public void testSetViolateExecutionOnNonTightHtml() {
        ...
        assertWithMessage("violateExecutionOnNonTightHtml should be true after setter")
                .that(TestUtil.getInternalState(
                        checkObj, "violateExecutionOnNonTightHtml", Boolean.class))
                .isTrue();
        checkObj.setViolateExecutionOnNonTightHtml(false);
        assertWithMessage("violateExecutionOnNonTightHtml should be false after setter")
                .that(TestUtil.getInternalState(
                        checkObj, "violateExecutionOnNonTightHtml", Boolean.class))
                .isFalse();
    }
