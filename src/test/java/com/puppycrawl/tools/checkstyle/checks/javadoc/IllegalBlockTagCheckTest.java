...
public class IllegalBlockTagCheckTest extends AbstractModuleTestSupport {
    ...
    public void testTagPresence() throws Exception {
        final String[] expected = {
            "17: " + getCheckMessage(MSG_ILLEGAL_PATTERN, "todo"),
            "30: " + getCheckMessage(MSG_ILLEGAL_PATTERN, "todo"),
        };
    ...
    public void testIllegalPattern() throws Exception {
        final String[] expected = {
            "21: " + getCheckMessage(MSG_ILLEGAL_PATTERN, "somesince"),
            "29: " + getCheckMessage(MSG_ILLEGAL_PATTERN, "somesince"),
        };
