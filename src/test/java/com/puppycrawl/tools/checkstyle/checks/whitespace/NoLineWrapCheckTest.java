...
public class NoLineWrapCheckTest
    ...
    public void testNoLineWrapModuleDef() throws Exception {
        ...
        verifyWithInlineConfigParser(
                getNonCompilablePath("wrapped/module-info.java"), expected);
    }
    ...
    public void testNoLineWrapModuleDefGood() throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
                getNonCompilablePath("unwrapped/module-info.java"), expected);
    }
    ...
    public void testNoLineWrapModuleDefWithAnnotationSkipFalse() throws Exception {
        ...
        verifyWithInlineConfigParser(
                getNonCompilablePath("strict/module-info.java"), expected);
    }
