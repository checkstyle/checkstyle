...
public class NoLineWrapCheckTest
    ...
    public void testAnnotationsLineWrapping()
        ...
        final String[] expected = {
            ...
            "34:3: " + getCheckMessage(MSG_KEY, "METHOD_DEF"),
            "39:1: " + getCheckMessage(MSG_KEY, "ENUM_DEF"),
            "43:1: " + getCheckMessage(MSG_KEY, "RECORD_DEF"),
            "47:5: " + getCheckMessage(MSG_KEY, "COMPACT_CTOR_DEF"),
        };
        verifyWithInlineConfigParser(
