...
public class CommentsIndentationCheckTest extends AbstractModuleTestSupport {
    ...
    public void testCommentIsInsideSwitchBlockTwo() throws Exception {
        final String[] expected = {
            "26:16: " + getCheckMessage(MSG_KEY_SINGLE, "120, 122", 15, "17, 12"),
            "36:9: " + getCheckMessage(MSG_KEY_SINGLE, 134, 8, 12),
            "49:5: " + getCheckMessage(MSG_KEY_SINGLE, 147, 4, 8),
            "67:19: " + getCheckMessage(MSG_KEY_SINGLE, "164, 166", 18, "16, 12"),
            "90:5: " + getCheckMessage(MSG_KEY_SINGLE, "207, 209", 4, "12, 12"),
            "93:23: " + getCheckMessage(MSG_KEY_SINGLE, "210, 214", 22, "16, 12"),
            "94:21: " + getCheckMessage(MSG_KEY_SINGLE, "210, 214", 20, "16, 12"),
            "95:18: " + getCheckMessage(MSG_KEY_SINGLE, "210, 214", 17, "16, 12"),
            "106:25: " + getCheckMessage(MSG_KEY_SINGLE, 97, 24, 20),
        };
    ...
    public void testCommentIsInsideSwitchBlockThree() throws Exception {
        final String[] expected = {
            "29:7: " + getCheckMessage(MSG_KEY_SINGLE, "236, 238", 6, "12, 12"),
            "76:12: " + getCheckMessage(MSG_KEY_BLOCK, "283, 287", 11, "16, 12"),
            "81:12: " + getCheckMessage(MSG_KEY_SINGLE, "288, 290", 11, "16, 12"),
            "108:25: " + getCheckMessage(MSG_KEY_SINGLE, 97, 24, 20),
        };
    ...
    public void testCommentIsInsideSwitchBlockFour() throws Exception {
        final String[] expected = {
            "18:25: " + getCheckMessage(MSG_KEY_SINGLE, 97, 24, 20),
            "52:1: " + getCheckMessage(MSG_KEY_SINGLE, "320", 0, "8"),
        };
    ...
    public void testCheckOnlySingleLineCommentsTwo() throws Exception {
        final String[] expected = {
            "22:34: " + getCheckMessage(MSG_KEY_SINGLE, 116, 33, 8),
        };
    ...
    public void testCheckOnlyBlockCommentsTwo() throws Exception {
        final String[] expected = {
            "42:13: " + getCheckMessage(MSG_KEY_BLOCK, 134, 12, 8),
            "48:5: " + getCheckMessage(MSG_KEY_BLOCK, 140, 4, 8),
            "55:5: " + getCheckMessage(MSG_KEY_BLOCK, 144, 4, 8),
        };
    ...
    public void testMultiblockStructuresTwo() throws Exception {
        final String[] expected = {
            "20:9: " + getCheckMessage(MSG_KEY_SINGLE, 123, 8, 12),
            "26:17: " + getCheckMessage(MSG_KEY_SINGLE, "129, 131", 16, "12, 8"),
            "31:1: " + getCheckMessage(MSG_KEY_SINGLE, "134, 136", 0, "12, 8"),
        };
