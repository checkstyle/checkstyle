...
public class CommentsIndentationCheckTest extends AbstractModuleTestSupport {
    ...
    public void testCommentIsInsideSwitchBlockTwo() throws Exception {
        final String[] expected = {
            ...
            "110:5: " + getCheckMessage(MSG_KEY_SINGLE, "207, 209", 4, "12, 12"),
            "113:23: " + getCheckMessage(MSG_KEY_SINGLE, "210, 214", 22, "16, 12"),
            "114:21: " + getCheckMessage(MSG_KEY_SINGLE, "210, 214", 20, "16, 12"),
            "115:18: " + getCheckMessage(MSG_KEY_SINGLE, "210, 214", 17, "16, 12"),
        };
    ...
    public void testCommentIsInsideSwitchBlockThree() throws Exception {
        final String[] expected = {
            ...
            "107:1: " + getCheckMessage(MSG_KEY_SINGLE, "320", 0, "8"),
        };
