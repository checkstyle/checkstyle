...
class CommentsIndentationCheckTest extends AbstractModuleTestSupport {
    ...
    @Test
    void commentIsAtTheEndOfBlockOne() throws Exception {
    ...
    @Test
    void commentIsAtTheEndOfBlockTwo() throws Exception {
        final String[] expected = {
    ...
    @Test
    void commentIsAtTheEndOfBlockThree() throws Exception {
        final String[] expected = {
    ...
    @Test
    void commentIsAtTheEndOfBlockFour() throws Exception {
        final String[] expected = {
    ...
    @Test
    void commentIsAtTheEndOfBlockFive() throws Exception {
        final String[] expected = {
    ...
    @Test
    void commentIsAtTheEndOfBlockSix() throws Exception {
        final String[] expected = {
    ...
    @Test
    void commentIsInsideSwitchBlockOne() throws Exception {
        final String[] expected = {
    ...
    @Test
    void commentIsInsideSwitchBlockTwo() throws Exception {
        final String[] expected = {
    ...
    @Test
    void commentIsInsideSwitchBlockThree() throws Exception {
        final String[] expected = {
            "18:25: " + getCheckMessage(MSG_KEY_SINGLE, 19, 24, 20),
    ...
    @Test
    void commentIsInsideSwitchBlockFour() throws Exception {
        final String[] expected = {
            "18:25: " + getCheckMessage(MSG_KEY_SINGLE, 19, 24, 20),
    ...
    @Test
    void surroundingCodeOne() throws Exception {
        final String[] expected = {
    ...
    @Test
    void surroundingCodeTwo() throws Exception {
        final String[] expected = {
    ...
    @Test
    void checkOnlyBlockCommentsOne() throws Exception {
        final String[] expected = {
    ...
    @Test
    void checkOnlyBlockCommentsTwo() throws Exception {
        final String[] expected = {
    ...
    @Test
    void multiblockStructuresOne() throws Exception {
        final String[] expected = {
    ...
    @Test
    void multiblockStructuresTwo() throws Exception {
        final String[] expected = {
