...
public class CommentsIndentationCheckTest extends AbstractModuleTestSupport {
    ...
    public void testCommentIsAtTheEndOfBlockTwo() throws Exception {
        final String[] expected = {
            ...
            "116:27: " + getCheckMessage(MSG_KEY_SINGLE, 114, 26, 8),
        };
    ...
    public void testCommentIsAtTheEndOfBlockFour() throws Exception {
        final String[] expected = {
            "22:10: " + getCheckMessage(MSG_KEY_SINGLE, 19, 9, 8),
            "28:1: " + getCheckMessage(MSG_KEY_SINGLE, 29, 0,4),
            "41:1: " + getCheckMessage(MSG_KEY_SINGLE, 38, 0, 8),
            "60:19: " + getCheckMessage(MSG_KEY_SINGLE, 57, 9, 8),
            "85:13: " + getCheckMessage(MSG_KEY_SINGLE, 87, 12, 8),
            "89:13: " + getCheckMessage(MSG_KEY_SINGLE, 87, 12, 8),
            "99:13: " + getCheckMessage(MSG_KEY_SINGLE, 98, 12, 8),
            "106:9: " + getCheckMessage(MSG_KEY_SINGLE, 108, 8, 10),
        };
    ...
    public void testCommentIsAtTheEndOfBlockFive() throws Exception {
        final String[] expected = {
            "62:1: " + getCheckMessage(MSG_KEY_SINGLE, 59, 0, 8),
            "77:11: " + getCheckMessage(MSG_KEY_SINGLE, 73, 10,8),
            "87:11: " + getCheckMessage(MSG_KEY_SINGLE, 81, 10, 8),
            "95:11: " + getCheckMessage(MSG_KEY_SINGLE, 91, 10, 8),
            "103:11: " + getCheckMessage(MSG_KEY_SINGLE, 99, 10, 8),
            "111:11: " + getCheckMessage(MSG_KEY_SINGLE, 107, 10, 8),
        };
    ...
    public void testCommentIsAtTheEndOfBlockSix() throws Exception {
        final String[] expected = {
            ...
            "82:5: " + getCheckMessage(MSG_KEY_SINGLE, 79, 0, 8),
