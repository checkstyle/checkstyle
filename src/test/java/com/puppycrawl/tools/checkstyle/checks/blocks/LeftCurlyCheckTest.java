...
public class LeftCurlyCheckTest extends AbstractModuleTestSupport {
     ...
     */
    @Test
    public void leftCurlyOptionValueOf() {
    ...
    @Test
    public void nlow() throws Exception {
        final String[] expected = {
            "17:1: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 1),
            "19:5: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 5),
            "23:5: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 5),
    ...
    @Test
    public void newline2() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void newline3() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void missingBraces() throws Exception {
        final String[] expected = {
            "17:1: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 1),
            "20:5: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 5),
    ...
    @Test
    public void defaultWithAnnotations() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void nlWithAnnotations() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void nlowWithAnnotations() throws Exception {
        final String[] expected = {
            "23:1: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 1),
            "27:5: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 5),
            "34:5: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 5),
    ...
    @Test
    public void lineBreakAfter() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void ignoreEnumsOptionTrue() throws Exception {
    ...
    @Test
    public void ignoreEnumsOptionFalse() throws Exception {
    ...
    @Test
    public void defaultLambda() throws Exception {
        final String[] expected = {
            "17:1: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 1),
    ...
    @Test
    public void newLineOptionWithLambda() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void eolSwitch() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void nlSwitch() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void nlowSwitch() throws Exception {
        final String[] expected = {
            "22:13: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 13),
        };
        verifyWithInlineConfigParser(
    ...
    @Test
    public void leftCurlySwitchExpressions() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void leftCurlySwitchExpressionsNewLine() throws Exception {
    ...
    @Test
    public void coverageIncrease() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void leftCurlyRecordsAndCompactCtors() throws Exception {
        final String[] expected = {
            "22:5: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 5),
            "24:9: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 9),
            "34:5: " + getCheckMessage(MSG_KEY_LINE_PREVIOUS, "{", 5),
    ...
    @Test
    public void leftCurlyWithEmoji() throws Exception {
        final String[] expected = {
    ...
    @Test
    public void leftCurlyWithEmojiNewLine() throws Exception {
        final String[] expected = {
            "18:32: " + getCheckMessage(MSG_KEY_LINE_NEW, "{", 32),
    ...
    @Test
    public void forEnumConstantDef() throws Exception {
        final String[] expected = {
