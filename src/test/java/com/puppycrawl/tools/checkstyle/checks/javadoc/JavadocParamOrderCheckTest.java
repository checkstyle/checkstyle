...
public class JavadocParamOrderCheckTest extends AbstractModuleTestSupport {
    ...
    public void testIncorrect() throws Exception {
        ...
        final String[] expected = {
            ...
            //"102: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "A"),
            "116: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "T"),
        };
    ...
    public void testParameterRecords() throws Exception {
        final DefaultConfiguration checkConfig = createModuleConfig(JavadocParamOrderCheck.class);
        final String[] expected = {
            "56: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "errors"),
            "77: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "str"),
            "79: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "node"),
        };
    ...
    public void testParameterDefs() throws Exception {
        ...
        final String[] expected = {
            ...
            "114: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "ID_JP"),
            "115: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "OP_JP"),
        };
