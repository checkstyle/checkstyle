...
public class JavadocParamOrderCheckTest extends AbstractModuleTestSupport {
    ...
    public void testParameterRecords() throws Exception {
        final DefaultConfiguration checkConfig = createModuleConfig(JavadocParamOrderCheck.class);
        final String[] expected = {
            "20: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "<address>"),
            "48: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "<brand"),
            "73: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "<TT>"),
        };
    ...
    public void testParameterDefs() throws Exception {
        ...
        final String[] expected = {
            ...
            "56: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "message"),
            "57: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "type"),
            "58: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "<V>"),
            "69: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "<EE>"),
            "79: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "<type>"),
            "105: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "<OP_JP>"),
            "118: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "<TT>"),
        };
