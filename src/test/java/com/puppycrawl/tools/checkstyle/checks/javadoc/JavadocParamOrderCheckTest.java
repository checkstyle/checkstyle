...
public class JavadocParamOrderCheckTest extends AbstractModuleTestSupport {
    ...
    public void testParameterDefs() throws Exception {
        ...
        final String[] expected = {
            ...
            "43: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "message"),
            "44: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "type"),
            "45: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "V"),
            "94: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "T"),
            "107: " + getCheckMessage(MSG_JAVADOC_TAG_ORDER, "Integer"),
        };
