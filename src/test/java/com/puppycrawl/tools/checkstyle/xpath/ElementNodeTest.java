...
public class ElementNodeTest extends AbstractPathTestSupport {
    ...
    public void testGetAttributeNumInt() throws Exception {
        ...
        assertEquals("Invalid token type", TokenTypes.NUM_INT, ((AbstractNode) nodes.get(0)).getTokenType());
    }
    ...
    public void testGetAttributeStringLiteral() throws Exception {
        ...
        assertEquals("Invalid token type", TokenTypes.STRING_LITERAL, ((AbstractNode) nodes.get(0)).getTokenType());
    }
