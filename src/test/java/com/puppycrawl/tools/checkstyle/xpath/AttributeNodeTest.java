...
public class AttributeNodeTest {
    ...
    public void testGetLineNumber() {
        final UnsupportedOperationException exc =
                getExpectedThrowable(UnsupportedOperationException.class, attributeNode::getLineNumber);
        assertWithMessage("Invalid exception message")
            .that(exc.getMessage())
            .isEqualTo("Operation is not supported");
    }
    ...
    public void testGetColumnNumber() {
        final UnsupportedOperationException exc =
                getExpectedThrowable(UnsupportedOperationException.class, attributeNode::getColumnNumber);
        assertWithMessage("Invalid exception message")
            .that(exc.getMessage())
            .isEqualTo("Operation is not supported");
    }
    ...
    public void testGetTokenType() {
        final UnsupportedOperationException exc =
                getExpectedThrowable(UnsupportedOperationException.class, attributeNode::getTokenType);
        assertWithMessage("Invalid exception message")
            .that(exc.getMessage())
            .isEqualTo("Operation is not supported");
    }
    ...
    public void testGetUnderlyingNode() {
        final UnsupportedOperationException exc =
                getExpectedThrowable(UnsupportedOperationException.class, attributeNode::getUnderlyingNode);
        assertWithMessage("Invalid exception message")
            .that(exc.getMessage())
            .isEqualTo("Operation is not supported");
    }
    ...
    public void testGetAllNamespaces() {
        final UnsupportedOperationException exc =
                getExpectedThrowable(UnsupportedOperationException.class, attributeNode::getAllNamespaces);
        assertWithMessage("Invalid exception message")
            .that(exc.getMessage())
            .isEqualTo("Operation is not supported");
    }
