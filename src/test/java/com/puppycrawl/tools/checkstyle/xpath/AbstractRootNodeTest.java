...
public class AbstractRootNodeTest extends AbstractModuleTestSupport {

    @Override
    protected String getPackageLocation() {
        return "com/puppycrawl/tools/checkstyle/xpath/abstractrootnode";
    }
    ...
    public void testAbstractRootNodeIteratorAxisDescendantOrSelf() throws Exception {
        ...
        verifyFilterWithInlineConfigParser(getPath("InputAbstractRootNode.java"),
