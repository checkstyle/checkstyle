...
public class ReverseDescendantIteratorTest extends AbstractIteratorTestSupport {

    @Test
    public void testCorrectOrder() {
        final NodeInfo startNode = findNode("CLASS_DEF");

        final ReverseDescendantIterator iterator = new ReverseDescendantIterator(startNode);
