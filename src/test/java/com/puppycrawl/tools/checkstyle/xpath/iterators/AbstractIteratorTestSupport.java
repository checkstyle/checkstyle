...
public abstract class AbstractIteratorTestSupport {
     ...
     */
    protected static NodeInfo findNode(String localPart) {
    ...
    private static DetailAST createTree() {
        ...
        createNode(methodDefNode, TokenTypes.PARAMETERS, 4, 33);
        createNode(methodDefNode, TokenTypes.SLIST, 4, 31);
