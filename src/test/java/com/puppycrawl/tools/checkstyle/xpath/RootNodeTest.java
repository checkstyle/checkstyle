...
public class RootNodeTest extends AbstractPathTestSupport {
    ...
    public void testGetConfiguration() {
        final UnsupportedOperationException exc =
                getExpectedThrowable(UnsupportedOperationException.class, rootNode::getConfiguration);
        assertWithMessage("Invalid exception message")
            .that(exc.getMessage())
            .isEqualTo("Operation is not supported");
    }
    ...
    public void testGetStringValueCs() {
        final UnsupportedOperationException exc =
                getExpectedThrowable(UnsupportedOperationException.class, rootNode::getUnicodeStringValue);
        assertWithMessage("Invalid exception message")
            .that(exc.getMessage())
            .isEqualTo("Operation is not supported");
    }
    ...
    public void testGetAllNamespaces() {
        final UnsupportedOperationException exc =
                getExpectedThrowable(UnsupportedOperationException.class, rootNode::getAllNamespaces);
        assertWithMessage("Invalid exception message")
            .that(exc.getMessage())
            .isEqualTo("Operation is not supported");
    }
