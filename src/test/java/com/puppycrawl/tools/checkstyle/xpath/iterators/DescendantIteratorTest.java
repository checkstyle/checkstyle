...
public class DescendantIteratorTest extends AbstractIteratorTestSupport {

    @Test
    public void testIncludeSelf() {
        final NodeInfo startNode = findNode("CLASS_DEF");

        final DescendantIterator iterator = new DescendantIterator(startNode, true);

        assertThat("Invalid node", iterator.next(), equalTo(startNode));
    ...
    public void testWithoutSelf() {
        ...
        final DescendantIterator iterator = new DescendantIterator(startNode, false);
