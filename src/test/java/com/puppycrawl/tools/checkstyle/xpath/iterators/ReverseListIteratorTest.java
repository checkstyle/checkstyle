...
public class ReverseListIteratorTest extends AbstractIteratorTestSupport {
    ...
    public void testCorrectOrder() {
        ...
        final ReverseListIterator iterator = new ReverseListIterator(nodes);
    ...
    public void testNullList() {
        ...
        final ReverseListIterator iterator = new ReverseListIterator(null);
