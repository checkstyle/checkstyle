...
import com.puppycrawl.tools.checkstyle.api.CheckstyleAST;
...
public class XpathMapperTest extends AbstractModuleTestSupport {
    ...
    private static DetailAST getSiblingByType(CheckstyleAST node, int type) {
