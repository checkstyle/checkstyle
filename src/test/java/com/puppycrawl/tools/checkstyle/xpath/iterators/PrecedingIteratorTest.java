...
public class PrecedingIteratorTest extends AbstractIteratorTestSupport {

    @Test
    public void testPrecedingNodes() {
        final NodeInfo startNode = findNode("SLIST");

        final PrecedingIterator iterator = new PrecedingIterator(startNode);
        ...
        assertThat("Invalid node", iterator.next(), equalTo(findNode("CLASS_DEF")));
        assertThat("Invalid node", iterator.next(), equalTo(findNode("ANNOTATIONS")));
        assertThat("Invalid node", iterator.next(), equalTo(findNode("ANNOTATION_DEF")));
        assertThat("Invalid node", iterator.next(), equalTo(findNode("PACKAGE_DEF")));
        assertThat("Invalid node", iterator.next(), equalTo(findNode("ROOT")));
