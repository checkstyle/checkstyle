...
public class XpathQueryGeneratorTest extends AbstractPathTestSupport {
    ...
    public void testEscapeCharacters() throws Exception {
        ...
        XpathQueryGenerator queryGeneratorOne = new XpathQueryGenerator(detailAst, lineNumberOne,
        ...
        XpathQueryGenerator queryGeneratorTwo = new XpathQueryGenerator(detailAst, lineNumberTwo,
