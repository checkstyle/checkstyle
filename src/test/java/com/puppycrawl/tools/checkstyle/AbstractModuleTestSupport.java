...
*                                              under {@link TreeWalker}.
    ...
    protected final void verifyFilterWithInlineConfigParser(Configuration aConfig,
        ...
        verifyViolations(aConfig, filePath, checkTestInputConfiguration);
        verify(parsedCheckConfig, filePath, expectedUnfiltered);
        final TestInputConfiguration filterTestInputConfiguration = InlineConfigParser.parseFilter(filePath);
