...
*                                              under {@link TreeWalker}.
    ...
    private void verifyViolations(Configuration config,
        ...
        final List<Integer> expectedViolationLines =
                actualViolations.getOrDefault(file, new ArrayList<>())
                        .stream()
     ...
     * @return map of actual violations.
     * @throws Exception if exception occurs during verification process.
     */
    private Map<String, List<String>> getActualViolationsForFile(Configuration config,
