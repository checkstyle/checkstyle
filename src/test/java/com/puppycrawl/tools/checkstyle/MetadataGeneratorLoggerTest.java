...
public class MetadataGeneratorLoggerTest {
    ...
    private final LocalizedMessage unexcpectedCloseMessage = new LocalizedMessage(
            Definitions.CHECKSTYLE_BUNDLE, getClass(),
                    "MetadataGeneratorLogger.unexcpectedClose");
    private final LocalizedMessage unexcpectedFlushMessage = new LocalizedMessage(
            Definitions.CHECKSTYLE_BUNDLE, getClass(),
                    "MetadataGeneratorLogger.unexcpectedFlush");
    ...
    public void testClose() throws IOException {
        try (CloseAndFlushTestByteArrayOutputStream outputStream =
            ...
            final String unexcpectedClose = unexcpectedCloseMessage.getMessage();
            assertWithMessage(unexcpectedClose)
    ...
    public void testFlushStreams() throws Exception {
        try (CloseAndFlushTestByteArrayOutputStream outputStream =
            ...
            final String unexcpectedFlush = unexcpectedFlushMessage.getMessage();
            assertWithMessage(unexcpectedFlush)
