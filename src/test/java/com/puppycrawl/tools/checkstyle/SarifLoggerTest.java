...
public class SarifLoggerTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void addErrorAtColumn1() throws Exception {
        final SarifLogger logger = new SarifLogger(outStream,
                OutputStreamOptions.CLOSE);
    ...
    @Test
    public void addErrorAtColumn0() throws Exception {
    ...
    @Test
    public void addErrorWithWarningLevel() throws Exception {
        final SarifLogger logger = new SarifLogger(outStream,
                OutputStreamOptions.CLOSE);
    ...
    @Test
     public void doubleError() throws Exception {
    ...
    @Test
    public void lineOnly() throws Exception {
    ...
    @Test
    public void addErrorWithSpaceInPath() throws Exception {
        final SarifLogger logger = new SarifLogger(outStream,
                OutputStreamOptions.CLOSE);
        logger.auditStarted(null);
        final Violation violation =
    ...
    @Test
    public void addErrorWithAbsoluteLinuxPath() throws Exception {
    ...
    @Test
    public void addErrorWithRelativeLinuxPath() throws Exception {
        final SarifLogger logger = new SarifLogger(outStream,
                OutputStreamOptions.CLOSE);
        logger.auditStarted(null);
        final Violation violation =
    ...
    @Test
    public void addErrorWithAbsoluteWindowsPath() throws Exception {
        final SarifLogger logger = new SarifLogger(outStream,
                OutputStreamOptions.CLOSE);
        logger.auditStarted(null);
        final Violation violation =
    ...
    @Test
    public void addErrorWithRelativeWindowsPath() throws Exception {
        final SarifLogger logger = new SarifLogger(outStream,
                OutputStreamOptions.CLOSE);
        logger.auditStarted(null);
        final Violation violation =
    ...
    @Test
    public void noCloseStream() throws Exception {
        final SarifLogger logger = new SarifLogger(outStream,
    ...
    @Test
    public void finishLocalSetup() throws Exception {
        final SarifLogger logger = new SarifLogger(outStream,
                OutputStreamOptions.CLOSE);
    ...
    @Test
    public void readResourceWithInvalidName() {
        try {
    ...
    @Test
    public void multipleRules() throws Exception {
    ...
    @Test
    public void moduleIdSuffix() throws Exception {
    ...
    @Test
    public void multipleMessageStrings() throws Exception {
    ...
    @Test
    public void escapedMessageText() throws Exception {
     ...
     */
    @Test
    public void getMessagesWithClassNotFoundException() throws Exception {
     ...
     */
    @Test
    public void getMessagesWithMissingResourceException() throws Exception {
        final SarifLogger logger = new SarifLogger(outStream, OutputStreamOptions.CLOSE);
     ...
     */
    @Test
    public void renderSeverityLevelAllLevels() throws Exception {
