...
public class SarifLoggerTest extends AbstractModuleTestSupport {
    ...
    public void testAddErrors() throws Exception {
        ...
        final LocalizedMessage message =
                new LocalizedMessage(1, 1,
                        ...
                        getClass(), "found an error");
        final AuditEvent ev = new AuditEvent(this, "Test.java", message);
        final LocalizedMessage message2 =
                new LocalizedMessage(1, 1,
                        "messages.properties", "ruleId2", null, SeverityLevel.IGNORE, null,
                        getClass(), "found another error");
        final AuditEvent ev2 = new AuditEvent(this, "Test.java", message2);
        logger.fileStarted(ev);
        logger.addError(ev);
        logger.fileFinished(ev);
    ...
    private static void verifyContent(String expectedOutputFile,
        ...
        final String actualContent = new String(actualOutputStream.toByteArray(),
