...
public class ScopeUtilTest {
    ...
    @Test
    public void testIsInScopeWithNoSurroundingScope() {
        final DetailAST ast = new DetailAstImpl();
        assertWithMessage("Should return false when there is no surrounding scope")
                .that(ScopeUtil.isInScope(ast, Scope.PUBLIC))
                .isFalse();
    }
