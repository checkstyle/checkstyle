...
public class AnnotationUtilTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void isProperUtilsClass() {
        try {
    ...
    @Test
    public void containsAnnotationNull() {
        try {
    ...
    @Test
    public void containsAnnotationNull2() {
        try {
            AnnotationUtil.containsAnnotation(null, "");
            assertWithMessage("IllegalArgumentException is expected").fail();
        }
    ...
    @Test
    public void containsAnnotationFalse() {
    ...
    @Test
    public void containsAnnotationFalse2() {
        final DetailAstImpl ast = new DetailAstImpl();
        ast.setType(1);
    ...
    @Test
    public void containsAnnotationTrue() {
        final DetailAstImpl ast = new DetailAstImpl();
        ast.setType(1);
        final DetailAstImpl ast2 = new DetailAstImpl();
        ast2.setType(TokenTypes.MODIFIERS);
    ...
    @Test
    public void annotationHolderNull() {
        try {
    ...
    @Test
    public void containsAnnotationWithNull() {
        try {
    ...
    @Test
    public void containsAnnotationListWithNullAst() {
        try {
    ...
    @Test
    public void containsAnnotationListWithNullList() {
    ...
    @Test
    public void containsAnnotationListWithEmptyList() {
        final DetailAST ast = new DetailAstImpl();
    ...
    @Test
    public void containsAnnotationListWithNoAnnotationNode() {
        final DetailAstImpl ast = new DetailAstImpl();
    ...
    @Test
    public void containsAnnotationListWithNoMatchingAnnotation() {
        final DetailAstImpl ast = new DetailAstImpl();
    ...
    @Test
    public void containsAnnotationWithStringFalse() {
        final DetailAstImpl astForTest = new DetailAstImpl();
        astForTest.setType(TokenTypes.PACKAGE_DEF);
        final DetailAstImpl child = new DetailAstImpl();
        final DetailAstImpl annotations = new DetailAstImpl();
    ...
    @Test
    public void containsAnnotationWithComment() {
        final DetailAstImpl astForTest = new DetailAstImpl();
        astForTest.setType(TokenTypes.PACKAGE_DEF);
        final DetailAstImpl child = new DetailAstImpl();
        final DetailAstImpl annotations = new DetailAstImpl();
