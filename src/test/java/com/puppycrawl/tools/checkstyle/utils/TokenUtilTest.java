...
public class TokenUtilTest {
    ...
    @Test
    public void testIsOfTypeTypesTrue() {
        ...
        final boolean result2 = TokenUtil.isOfType(astForTest, TokenTypes.LITERAL_TRY,
                                                   TokenTypes.LITERAL_CATCH,
                                                   TokenTypes.LITERAL_FINALLY,
                                                   TokenTypes.LITERAL_IF,
                                                   TokenTypes.LITERAL_ELSE);
    ...
    @Test
    public void testIsOfTypeTypesFalse() {
        final int type = TokenTypes.LITERAL_SWITCH;
        final DetailAstImpl astForTest = new DetailAstImpl();
    ...
    @Test
    public void testIsOfTypeFirstTrue() {
        final int type = TokenTypes.LITERAL_FOR;
        final DetailAstImpl astForTest = new DetailAstImpl();
        astForTest.setType(type);
        final boolean result1 = TokenUtil.isOfTypeOne(type, TokenTypes.LITERAL_FOR);
        final boolean result2 = TokenUtil.isOfTypeOne(astForTest, TokenTypes.LITERAL_FOR);
    ...
    @Test
    public void testIsOfTypeFirstFalse() {
        final int type = TokenTypes.LITERAL_CATCH;
        final DetailAstImpl astForTest1 = new DetailAstImpl();
        final DetailAstImpl astForTest2 = null;
        astForTest1.setType(type);
        final boolean result1 = TokenUtil.isOfTypeOne(type, TokenTypes.LITERAL_FOR);
        final boolean result2 = TokenUtil.isOfTypeOne(astForTest1, TokenTypes.LITERAL_FOR);
        final boolean result3 = TokenUtil.isOfTypeOne(astForTest2, TokenTypes.LITERAL_FOR);
    ...
    @Test
    public void testIsOfTypeSecondTrue() {
        final int type = TokenTypes.LITERAL_CATCH;
        final DetailAstImpl astForTest = new DetailAstImpl();
        astForTest.setType(type);
        final boolean result1 = TokenUtil.isOfTypeSecond(type, TokenTypes.LITERAL_IF,
                                                   TokenTypes.LITERAL_CATCH);
        final boolean result2 = TokenUtil.isOfTypeSecond(astForTest, TokenTypes.LITERAL_IF,
                                                   TokenTypes.LITERAL_CATCH);
    ...
    @Test
    public void testIsOfTypeSecondFalse() {
        final int type = TokenTypes.LITERAL_CATCH;
        final DetailAstImpl astForTest1 = new DetailAstImpl();
        final DetailAstImpl astForTest2 = null;
        astForTest1.setType(type);
        final boolean result1 = TokenUtil.isOfTypeSecond(type, TokenTypes.LITERAL_IF,
                                                   TokenTypes.LITERAL_ELSE);
        final boolean result2 = TokenUtil.isOfTypeSecond(astForTest1, TokenTypes.LITERAL_IF,
                                                   TokenTypes.LITERAL_ELSE);
        final boolean result3 = TokenUtil.isOfTypeSecond(astForTest2, TokenTypes.LITERAL_IF,
                                                   TokenTypes.LITERAL_ELSE);
    ...
    @Test
    public void testIsOfTypeThreeTrue() {
        final int type = TokenTypes.LITERAL_CATCH;
        final DetailAstImpl astForTest = new DetailAstImpl();
        astForTest.setType(type);
        final boolean result1 = TokenUtil.isOfTypeThird(type, TokenTypes.LITERAL_FOR,
                                                   TokenTypes.LITERAL_IF, TokenTypes.LITERAL_CATCH);
        final boolean result2 = TokenUtil.isOfTypeThird(astForTest, TokenTypes.LITERAL_FOR,
                                                   TokenTypes.LITERAL_IF, TokenTypes.LITERAL_CATCH);
    ...
    @Test
    public void testIsOfTypeThreeFalse() {
        final int type = TokenTypes.LITERAL_CATCH;
        final DetailAstImpl astForTest1 = new DetailAstImpl();
        final DetailAstImpl astForTest2 = null;
        astForTest1.setType(type);
        ...
        final boolean result2 = TokenUtil.isOfTypeThird(astForTest1, TokenTypes.LITERAL_FOR,
                                                   TokenTypes.LITERAL_IF, TokenTypes.LITERAL_ELSE);
        final boolean result3 = TokenUtil.isOfTypeThird(astForTest2, TokenTypes.LITERAL_FOR,
                                                   TokenTypes.LITERAL_IF, TokenTypes.LITERAL_ELSE);
    ...
    @Test
    public void testIsOfTypeFourTrue() {
        final int type = TokenTypes.LITERAL_CATCH;
        final DetailAstImpl astForTest = new DetailAstImpl();
        astForTest.setType(type);
        final boolean result1 = TokenUtil.isOfTypeFourth(type, TokenTypes.LITERAL_TRY,
                                                   TokenTypes.LITERAL_IF, TokenTypes.LITERAL_ELSE,
                                                   TokenTypes.LITERAL_CATCH);
        final boolean result2 = TokenUtil.isOfTypeFourth(astForTest, TokenTypes.LITERAL_TRY,
                                                   TokenTypes.LITERAL_IF, TokenTypes.LITERAL_ELSE,
                                                   TokenTypes.LITERAL_CATCH);
    ...
    @Test
    public void testIsOfTypeFourFalse() {
        final int type = TokenTypes.LITERAL_FOR;
        final DetailAstImpl astForTest1 = new DetailAstImpl();
        final DetailAstImpl astForTest2 = null;
        astForTest1.setType(type);
        final boolean result1 = TokenUtil.isOfTypeFourth(type, TokenTypes.LITERAL_TRY,
                                                   TokenTypes.LITERAL_IF, TokenTypes.LITERAL_ELSE,
                                                   TokenTypes.LITERAL_CATCH);
        final boolean result2 = TokenUtil.isOfTypeFourth(astForTest1, TokenTypes.LITERAL_TRY,
                                                   TokenTypes.LITERAL_IF, TokenTypes.LITERAL_ELSE,
                                                   TokenTypes.LITERAL_CATCH);
        final boolean result3 = TokenUtil.isOfTypeFourth(astForTest2, TokenTypes.LITERAL_TRY,
                                                   TokenTypes.LITERAL_IF, TokenTypes.LITERAL_ELSE,
                                                   TokenTypes.LITERAL_CATCH);
