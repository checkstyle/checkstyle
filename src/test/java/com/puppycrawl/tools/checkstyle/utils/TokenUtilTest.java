...
public class TokenUtilTest {
    ...
    public void testIsProperUtilsClass() throws ReflectiveOperationException {
        assertWithMessage("Constructor is not private")
                .that(isUtilsClassHasPrivateConstructor(TokenUtil.class, true)).isTrue();
    }
    ...
    public void testIsCommentType() {
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isCommentType(TokenTypes.SINGLE_LINE_COMMENT)).isTrue();
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isCommentType(TokenTypes.BLOCK_COMMENT_BEGIN)).isTrue();
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isCommentType(TokenTypes.BLOCK_COMMENT_END)).isTrue();
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isCommentType(TokenTypes.COMMENT_CONTENT)).isTrue();
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isCommentType("COMMENT_CONTENT")).isTrue();
    ...
    public void testIsTypeDeclaration() {
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isTypeDeclaration(TokenTypes.CLASS_DEF)).isTrue();
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isTypeDeclaration(TokenTypes.INTERFACE_DEF)).isTrue();
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isTypeDeclaration(TokenTypes.ANNOTATION_DEF)).isTrue();
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isTypeDeclaration(TokenTypes.ENUM_DEF)).isTrue();
        assertWithMessage("Should return true when valid type passed")
                .that(TokenUtil.isTypeDeclaration(TokenTypes.RECORD_DEF)).isTrue();
    }
    ...
    public void testIsBooleanLiteralType() {
        assertWithMessage("Result is not expected")
                .that(TokenUtil.isBooleanLiteralType(TokenTypes.LITERAL_TRUE)).isTrue();
        assertWithMessage("Result is not expected")
                .that(TokenUtil.isBooleanLiteralType(TokenTypes.LITERAL_FALSE)).isTrue();
