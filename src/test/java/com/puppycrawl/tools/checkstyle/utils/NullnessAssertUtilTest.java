...
public class NullnessAssertUtilTest {

    @Test
    public void testIsProperUtilsClass() throws ReflectiveOperationException {
        assertWithMessage("Constructor is not private")
                .that(isUtilsClassHasPrivateConstructor(NullnessAssertUtil.class))
                .isTrue();
    }
    ...
    public void testNotNullWithNonNullValue() {
        ...
        final String result = NullnessAssertUtil.notNull(value);
    ...
    public void testNotNullWithNullValue() {
        final AssertionError ex = getExpectedThrowable(AssertionError.class, () -> {
            NullnessAssertUtil.notNull(null);
        });
