...
public class JavadocUtilTest extends AbstractPathTestSupport {
    ...
    public void testGetContentOfInlineCustomTagWithHtml() throws Exception {
        final String testFile = getPath(
                "InputJavadocUtilInlineCustomTagWithHtml.java");
        final DetailAST root = JavaParser.parseFile(
                Paths.get(testFile).toFile(), JavaParser.Options.WITH_COMMENTS);
        final JavadocDetailNodeParser detailNodeParser = new JavadocDetailNodeParser();
        final DetailAST javadocCommentAst = root.getLastChild().getFirstChild().getFirstChild()
    ...
    @Test
    public void testGetContentOfInlineCustomTagWithEmptySummary() throws Exception {
        final String testFile = getPath(
                "InputJavadocUtilInlineCustomTagWithEmptySummary.java");
        final DetailAST root = JavaParser.parseFile(
                Paths.get(testFile).toFile(), JavaParser.Options.WITH_COMMENTS);
        final JavadocDetailNodeParser detailNodeParser = new JavadocDetailNodeParser();
        final DetailAST javadocCommentAst = root.getLastChild().getFirstChild().getFirstChild()
