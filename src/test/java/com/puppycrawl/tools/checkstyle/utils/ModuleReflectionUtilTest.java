...
public class ModuleReflectionUtilTest {
    ...
    @Test
    public void isCheckstyleModule() {
     ...
     */
    @Test
    public void getCheckStyleModules() throws Exception {
    ...
    @Test
    public void isValidCheckstyleClass() {
    ...
    @Test
    public void isFileFilterModule() {
    ...
    @Test
    public void isTreeWalkerFilterModule() {
        assertWithMessage(
