...
public class CheckUtilTest extends AbstractModuleTestSupport {
    ...
    @Test
    void equalsAvoidNullCheck() throws Exception {
    ...
    @Test
    void multipleVariableDeclarationsCheck() throws Exception {
        final String[] expected = {
    ...
    @Test
    void nestedIfDepth() throws Exception {
        final String[] expected = {
    ...
    @Test
    void javaDocMethod2() throws Exception {
        final String[] expected = {
