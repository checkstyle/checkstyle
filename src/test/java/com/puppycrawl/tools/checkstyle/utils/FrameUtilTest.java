...
import com.puppycrawl.tools.checkstyle.checks.coding.RequireThisCheckTest;
...
public class FrameUtilTest {
    ...
    @Test
    public void testCatchFrame() throws Exception {
    ...
    @Test
    public void testCodeExtractedFromRequireThisCheck() throws Exception {
        final RequireThisCheckTest checkTest = new RequireThisCheckTest();
        final Method[] methods = checkTest.getClass().getDeclaredMethods();
        for (Method m : methods) {
            if (m.getAnnotation(Test.class) != null) {
                assertDoesNotThrow(() -> m.invoke(checkTest, null));
            }
        }
    }
