...
public class XdocsUrlTest {
    ...
    public static final String PACKAGE_NAME = "src/main/java/com/puppycrawl/tools/checkstyle/checks";
    ...
    public void testXdocsUrl() throws Exception {
        ...
        for (List<String> sub : checkHandler.list) {
            ...
            final String errorMessage =String.format("URL in %s is inconsistent: %s %s %s",
                    AVAILABLE_CHECKS_PATH, moduleName, checkName1, checkName2);
