...
public class AllChecksTest extends AbstractModuleTestSupport {
    ...
    @Test
    public void allModulesWithDefaultConfiguration() throws Exception {
    ...
    @Test
    public void defaultTokensAreSubsetOfAcceptableTokens() throws Exception {
    ...
    @Test
    public void requiredTokensAreSubsetOfAcceptableTokens() throws Exception {
        for (Class<?> check : CheckUtil.getCheckstyleChecks()) {
            if (AbstractCheck.class.isAssignableFrom(check)) {
                final AbstractCheck testedCheck = (AbstractCheck) TestUtil.instantiate(check);
    ...
    @Test
    public void requiredTokensAreSubsetOfDefaultTokens() throws Exception {
        for (Class<?> check : CheckUtil.getCheckstyleChecks()) {
            if (AbstractCheck.class.isAssignableFrom(check)) {
                final AbstractCheck testedCheck = (AbstractCheck) TestUtil.instantiate(check);
                final int[] defaultTokens = testedCheck.getDefaultTokens();
    ...
    @Test
    public void allModulesHaveMultiThreadAnnotation() throws Exception {
        for (Class<?> module : CheckUtil.getCheckstyleModules()) {
            if (ModuleReflectionUtil.isRootModule(module)
    ...
    @Test
    public void allModulesAreReferencedInConfigFile() throws Exception {
    ...
    @Test
    public void allCheckTokensAreReferencedInCheckstyleConfigFile() throws Exception {
    ...
    @Test
    public void allCheckTokensAreReferencedInGoogleConfigFile() throws Exception {
        final Configuration configuration = ConfigurationUtil
    ...
    @Test
    public void allCheckstyleModulesHaveXdocDocumentation() throws Exception {
    ...
    @Test
    public void allCheckstyleModulesInCheckstyleConfig() throws Exception {
    ...
    @Test
    public void allCheckstyleChecksHaveMessage() throws Exception {
    ...
    @Test
    public void allCheckstyleMessages() throws Exception {
