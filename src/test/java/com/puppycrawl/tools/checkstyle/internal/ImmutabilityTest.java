...
public class ImmutabilityTest {
     ...
     */
    @Test
    public void utilClassesImmutability() {
     ...
     */
    @Test
    public void fieldsInStatelessChecksShouldBeImmutable() {
     ...
     */
    @Test
    public void classesWithImmutableFieldsShouldBeStateless() {
     ...
     */
    @Test
    public void classesWithMutableFieldsShouldBeStateful() {
        final ArchCondition<JavaClass> beSuppressedClass = new SuppressionArchCondition<>(
