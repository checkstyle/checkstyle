...
public class ImmutabilityTest {
    ...
    /**
     * List of fields not following {@link ImmutabilityTest#testUtilClassesImmutability()} rule.
     */
    ...
    /**
     * List of fields not following
     * {@link ImmutabilityTest#testFieldsInStatelessChecksShouldBeImmutable()} rule.
     */
     ...
     * {@link ImmutabilityTest#testClassesWithImmutableFieldsShouldBeStateless()} rule.
     */
    ...
    /**
     * List of classes not following
     * {@link ImmutabilityTest#testClassesWithMutableFieldsShouldBeStateful()} rule.
     */
    ...
    private static final JavaClasses CHECKSTYLE_CHECKS = new ClassFileImporter()
        ...
        .that(new DescribedPredicate<>("are checkstyle modules") {
            ...
            public boolean apply(JavaClass input) {
                return ModuleReflectionUtil.isCheckstyleModule(input.reflect());
            }
        });
        ...
        final ArchCondition<JavaField> bePrivateExceptMessageKeys =
            new ArchCondition<>("be private") {
                ...
                public void check(JavaField item, ConditionEvents events) {
                    if (!item.getName().startsWith("MSG_")
    ...
    private static final class ImmutableFieldArchCondition extends ArchCondition<JavaField> {
        ...
        /**
         * Whether a field is immutable or not. We can't check complete immutability, reference
         * immutability can't be achieved. According to this method a field is immutable if it
         * fulfills any one of these conditions:
         * <ol>
         *     <li>If raw type of a field is an enum.</li>
         *     <li>If the field is a zero size array. We have manually created a list of zero
         *     size arrays which is checked for containing that particular field.</li>
         *     <li>If the field is of a primitive type or one among the
         *     {@link ImmutabilityTest#IMMUTABLE_TYPES}.</li>
         *     <li>If the field is a parameterized field, it is checked that all the parameterized
         *     types are among {@link ImmutabilityTest#IMMUTABLE_TYPES}.</li>
         * </ol>
         *
        ...
        private static boolean isImmutable(JavaField javaField) {
            ...
            if (!isEnumConstantOrEmptyArray) {
                ...
                final boolean isImmutableType = !PRIMITIVE_TYPES.contains(rawTypeName)
