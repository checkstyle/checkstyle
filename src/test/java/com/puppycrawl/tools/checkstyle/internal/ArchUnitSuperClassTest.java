...
public class ArchUnitSuperClassTest {
    ...
    /**
     * Classes not abiding to {@code checksShouldExtendCorrectAbstractClass} rule.
     */
    ...
    /**
     * ArchCondition checking that a class has a particular super class.
     *
     * @param superclass the superclass
     * @return ArchCondition checking that a class has a particular super class
     */
    private static ArchCondition<JavaClass> haveSuperclass(Class<?> superclass) {
    ...
    public void testChecksShouldExtendAbstractCheckOrAbstractFileSetCheck() {
        ...
        final ArchRule checksShouldHaveCorrectSuperclass = classes()
            .that()
            .haveSimpleNameEndingWith("Check")
            .should(haveSuperclass(AbstractCheck.class)
                        .or(haveSuperclass(AbstractFileSetCheck.class))
                        .or(haveSuperclass(AbstractJavadocCheck.class)))
            .orShould(beSuppressedClass);

        checksShouldHaveCorrectSuperclass.check(checksPackage);
    }
