...
public class ArchUnitSuperClassTest {
    ...
    /**
     * ArchCondition checking that a class is a subclass of a given class.
     *
     * @param superclass the superclass
     * @return ArchCondition checking that a class is a subclass of a given class
     */
    private static ArchCondition<JavaClass> beSubclassOf(Class<?> superclass) {
    ...
    public void testChecksShouldExtendAbstractCheckOrAbstractFileSetCheck() {
        ...
        final ArchRule checksShouldExtendCorrectAbstractClass = classes()
            ...
            .should(beSubclassOf(AbstractCheck.class)
                        .or(beSubclassOf(AbstractFileSetCheck.class))
                        .or(beSubclassOf(AbstractJavadocCheck.class)))
            .orShould(beSuppressedClass);

        checksShouldExtendCorrectAbstractClass.check(checksPackage);
    }
