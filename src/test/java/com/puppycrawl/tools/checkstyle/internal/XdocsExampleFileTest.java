...
public class XdocsExampleFileTest {
    ...
    // This list is temporarily suppressed and should be removed once corresponding XDoc examples are added.
    // See: https://github.com/checkstyle/checkstyle/issues/XXXX
