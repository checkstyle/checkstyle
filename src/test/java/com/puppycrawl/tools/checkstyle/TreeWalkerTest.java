...
public class TreeWalkerTest extends AbstractModuleTestSupport {
    ...
    public void testAcceptableTokens()
        ...
        try {
            ...
            assertWithMessage("Failure for: " + errorMsg).that(errorMsgMatcher.matches()).isTrue();
        }
    }
    ...
    public void testWithCheckNotHavingTreeWalkerAsParent() throws Exception {
        ...
        try {
            ...
            assertWithMessage("Error message is unexpected").that(
    ...
    public void testCheckInitIsCalledInTreeWalker() throws Exception {
        ...
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verify(checkConfig, file.getPath(), expected);
        assertWithMessage("Init was not called").that(VerifyInitCheck.isInitWasCalled()).isTrue();
    }
    ...
    public void testCheckDestroyIsCalledInTreeWalker() throws Exception {
        ...
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verify(checkConfig, file.getPath(), expected);
        assertWithMessage("Destroy was not called").that(VerifyDestroyCheck.isDestroyWasCalled())
                .isTrue();
    }
