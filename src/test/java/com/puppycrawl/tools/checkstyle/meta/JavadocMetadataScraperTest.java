...
public class JavadocMetadataScraperTest {
    ...
    private static final String CHECK_PACKAGE_BASE =
            "com.puppycrawl.tools.checkstyle.meta.inputs.checks.";
    ...
    public static void fillModuleDetailsStore() throws Exception {
        MetadataGenerator.generate(System.getProperty("user.dir")
                + "/src/test/resources/com/puppycrawl/tools/checkstyle/meta/inputs");
        moduleDetailsStore = JavadocMetadataScraper.getModuleDetailsStore();
    }

    @Test
    public void testPropertyNameWithNoCodeTag() throws Exception {
        final String testCheck = "customchecks.PropertyWithNoCodeTagCheck";
