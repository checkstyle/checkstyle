...
public class PropertyCacheFileTest extends AbstractPathTestSupport {
    ...
    public void testCacheRemainsWhenExternalResourceTheSame() throws IOException {
        ...
        final PropertyCacheFile cache =
                getPropertyCacheFile(uniqueFileName, config, externalResourcePath);
    ...
    private @NonNull PropertyCacheFile getPropertyCacheFile(String uniqueFileName,
            Configuration config, File externalResourcePath) throws IOException {
        final File filePath = new File(temporaryFolder, uniqueFileName);
