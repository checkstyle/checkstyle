...
public class JavadocCommentsAstRegressionTest extends AbstractTreeTestSupport {
    ...
    @Test
    public void testXWikiUnclosedHref() throws Exception {
        verifyJavadocTree(getHtmlTagsPath("ExpectedXWikiUnclosedHref.txt"),
                getHtmlTagsPath("InputXWikiUnclosedHref.javadoc"));
    }
