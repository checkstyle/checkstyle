...
public class CommentsTest extends AbstractTreeTestSupport {
    ...
    public void testIntersects() {
        ...
        assertWithMessage("Invalid intersection result").that(comment.intersects(89, 9, 89, 41))
                .isTrue();
        assertWithMessage("Invalid intersection result").that(comment.intersects(89, 53, 90, 50))
                .isTrue();
        assertWithMessage("Invalid intersection result").that(comment.intersects(87, 7, 88, 9))
                .isTrue();
