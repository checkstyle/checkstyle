...
class MethodReferencesTest extends AbstractModuleTestSupport {
    ...
    @Test
    void genericInPostfixExpressionBeforeReference()
            throws Exception {
        final String[] expected = CommonUtil.EMPTY_STRING_ARRAY;
        verifyWithInlineConfigParser(
