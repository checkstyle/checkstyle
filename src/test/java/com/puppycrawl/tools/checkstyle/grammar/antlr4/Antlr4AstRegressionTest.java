...
public class Antlr4AstRegressionTest extends AbstractTreeTestSupport {
    ...
    public void testTrickyYield() throws Exception {
        verifyAst(getPath("InputAntlr4AstRegressionTrickyYield.txt"),
    ...
    public void testUncommon4() throws Exception {
        verifyAst(getPath("InputAntlr4AstRegressionUncommon4.txt"),
    ...
    public void testQualifiedConstructorParameter() throws Exception {
        verifyAst(getPath("InputAntlr4AstRegressionQualifiedConstructorParameter.txt"),
                getPath("InputAntlr4AstRegressionQualifiedConstructorParameter.java"));
    }
}
