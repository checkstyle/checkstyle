...
public class Java21AstRegressionTest extends AbstractTreeTestSupport {
    ...
    @Test
    @Disabled("until https://github.com/checkstyle/checkstyle/issues/14195")
    public void testCustomStringTemplate() throws Exception {
        verifyAst(
                getNonCompilablePath(
                        "ExpectedStringTemplateCustom.txt"),
                getNonCompilablePath(
                        "InputStringTemplateCustom.java"));
    }
}
