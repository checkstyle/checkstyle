...
public class Java19AstRegressionTest extends AbstractTreeTestSupport {
    ...
    @Test
    public void testPatternsInNullSwitch() throws Exception {
        verifyAst(getNonCompilablePath("ExpectedJava19PatternsInNullSwitch.txt"),
                getNonCompilablePath("InputJava19PatternsInNullSwitch.java"));
    }
