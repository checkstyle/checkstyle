...
public class GeneratedJavaTokenTypesTest {
    ...
    public void testTokenNumbering() {
        ...
        assertEquals(198, GeneratedJavaTokenTypes.PATTERN_DEF, message);
        assertEquals(199, GeneratedJavaTokenTypes.PATTERN_VARIABLE_DEF, message);

        // Read JavaDoc before changing
        assertEquals(198, GeneratedJavaTokenTypes.class.getDeclaredFields().length,
