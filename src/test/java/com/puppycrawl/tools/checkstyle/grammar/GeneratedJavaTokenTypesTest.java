...
public class GeneratedJavaTokenTypesTest {
    ...
    public void testTokenNumbering() {
        ...
        assertEquals(202, GeneratedJavaTokenTypes.RECORD_COMPONENT_DEF, message);
        ...
        assertEquals(212, GeneratedJavaTokenTypes.PERMITS_CLAUSE, message);

        // Read JavaDoc before changing
        assertEquals(212, GeneratedJavaTokenTypes.class.getDeclaredFields().length,
