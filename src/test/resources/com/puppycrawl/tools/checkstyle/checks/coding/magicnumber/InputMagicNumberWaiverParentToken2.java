...
public class InputMagicNumberWaiverParentToken2 {
    ...
    public final Integer DefaultInit = new Integer(27); // violation ''27' is a magic number'
    public final int SpecsPerDay = 24 * 60 * 60, SpecialRatio = 4 / 3;
    public final javax.swing.border.Border StdBorder =
            javax.swing.BorderFactory.createEmptyBorder(3, 3, 3, 3); // 4 violations ''3' is a magic number' and ''3' is a magic number' and ''3' is a magic number' and ''3' is a magic number'
