...
public class InputIndentationFromGuava1 {                                     //indent:0 exp:0
  ...
  enum Strength {                                                             //indent:2 exp:2
    /*                                                                        //indent:4 exp:4
     * (kevinb): If we ence the value and aren't loading,                     //indent:5 exp:5
     * we needn't wrap the value.                                             //indent:5 exp:5
     * This could sar entry.                                                  //indent:5 exp:5
     */                                                                       //indent:5 exp:5
    ...
    /**                                                                       //indent:4 exp:4
     * Creates a reference for the given value according                      //indent:5 exp:5
     * to this value strength.                                                //indent:5 exp:5
     */                                                                       //indent:5 exp:5
    abstract <K, V> Object referenceValue(                                    //indent:4 exp:4
        Segment<K, V> segment, ReferenceEntry<K, V> entry, V value,           //indent:8 exp:>=8
        int weight);                                                          //indent:8 exp:>=8
    /**                                                                       //indent:4 exp:4
     * Returns the default equivalence stcompare and                          //indent:5 exp:5
     * hash keys or values referenced at this strength                        //indent:5 exp:5
     * This strategy wiss the user explicitly specifies an                    //indent:5 exp:5
