...
public class InputMagicNumberIgnoreCheckHexSignedAndOctalValue {
    /**
     * test long hex
     */
    ...
    enum MyEnum2IgnoreCheckHexSignedAndOctalValue {
        A_2(3),
        B_2(54);

        private MyEnum2IgnoreCheckHexSignedAndOctalValue(int value) {
