...
public class InputIndentationTryChildOnSameLineStrict {                         //indent:0 exp:0
    ...
    void method3() {                                                            //indent:4 exp:4
        ...
        try { invokeAndWait(new Runnable() { public void run() { return; } },   //indent:8 exp:8
            c); } catch (Exception e) { handle(e); }                            //indent:12 exp:12
    }                                                                           //indent:4 exp:4
    ...
    void syncInline() {                                                         //indent:4 exp:4
        try { synchronized(x) { doSomething(); } } catch (Exception e) { }      //indent:8 exp:8
    }                                                                           //indent:4 exp:4
    Object x;                                                                   //indent:4 exp:4
    void method6() {                                                            //indent:4 exp:4
        synchronized (this) {                                                   //indent:8 exp:8
            doSomething();                                                      //indent:12 exp:12
        }                                                                       //indent:8 exp:8
    }                                                                           //indent:4 exp:4
}                                                                               //indent:0 exp:0
