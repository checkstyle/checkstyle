...
public class InputIndentationLambda6 { //indent:0 exp:0
    ...
    () -> "WHAT WHAT!"); //indent:4 exp:8 warn
        ...
        Function<String, String> someFunction3 = //indent:8 exp:8
            ...
            if (string.contains("abc")) { //indent:12 exp:16 warn
                return "SWEET!"; //indent:16 exp:20 warn
            } else if (string.contains("123")) { //indent:12 exp:16 warn
                return "COOL!"; //indent:16 exp:20 warn
            } else { //indent:12 exp:16 warn
                return "BOO!"; //indent:16 exp:20 warn
        ...
        (string) //indent:8 exp:8
    -> { //indent:4 exp:8 warn
            if (string.contains("abc")) { //indent:12 exp:8 warn
                return "SWEET!"; //indent:16 exp:12 warn
            } else if (string.contains("123")) { //indent:12 exp:8 warn
                return "COOL!"; //indent:16 exp:12 warn
            } else { //indent:12 exp:8 warn
                return "BOO!"; //indent:16 exp:12 warn
