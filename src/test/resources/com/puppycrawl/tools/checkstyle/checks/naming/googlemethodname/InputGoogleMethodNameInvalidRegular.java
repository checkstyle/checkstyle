...
public class InputGoogleMethodNameInvalidRegular {
    void Foo() {} // violation 'Method name 'Foo' must be .* start lowercase'

    void f() {} // violation 'Method name 'f' must be more than a character'
    ...
    // violation above, '.* 'transferMoney_deductsFromSource' has invalid underscore usage'
    ...
    void fO() {}
    // violation above 'Method name 'fO' must .* not have a single lowercase followed by uppercase'

    void xY_z() {} // violation 'Method name 'xY_z' has invalid underscore usage'

    void mName() {}
    // violation above ''mName' must .* not have a single lowercase followed by uppercase.'
