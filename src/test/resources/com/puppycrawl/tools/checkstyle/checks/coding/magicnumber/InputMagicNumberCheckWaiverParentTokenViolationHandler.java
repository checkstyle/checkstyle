 ...
 * @version 6-May-2003
 */
public class InputMagicNumberCheckWaiverParentTokenViolationHandler {
...
interface Blah2WaiverParentTokenViolationHandler
{
  int LOW = 5;
  int HIGH = 78;
}

class ArrayMagicTestWaiverParentTokenViolationHandler
{
