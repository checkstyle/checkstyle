...
public class InputCommentsIndentationSurroundingCode3Two {
    ...
    public void foo11() {
        // violation below '.* incorrect .* level 12, expected is 8, .* same .* as line 41.'
            /* some comment */
        hashCode();
    }

    public void foo12() {
        // violation below '.* incorrect .* level 4, expected is 8, .* same .* as line 47.'
    /* some comment */
        hashCode();
    }
    ...
    public void foo13() {
        hashCode();
        // violation below '.* incorrect .* level 4, expected is 8, .* same .* as line 51.'
    /* some comment */
    }
