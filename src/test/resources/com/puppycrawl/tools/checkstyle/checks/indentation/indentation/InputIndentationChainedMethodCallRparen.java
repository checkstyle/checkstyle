...
public class InputIndentationChainedMethodCallRparen {                              //indent:0 exp:0
    ...
    public static void test() {                                                     //indent:4 exp:4
        ...
        assertThat(strings).extracting("splitId", "rate")                           //indent:8 exp:8
                .usingRecursiveFieldByFieldElementComparator(                       //indent:16 exp:16
                        Dummy.builder()                                             //indent:24 exp:24
                                .withComparatorForType(                             //indent:32 exp:32
                                        BigDecimal::compareTo,                      //indent:40 exp:40
                                        BigDecimal.class                            //indent:40 exp:40
                                ).build()                                           //indent:32 exp:32
                )                                                                   //indent:16 exp:16
                .containsExactlyInAnyOrder(                                         //indent:16 exp:16
                        tuple("123-1", BigDecimal.valueOf(67.5)),                   //indent:24 exp:24
                        tuple("123-2", BigDecimal.valueOf(67.5))                    //indent:24 exp:24
                );                                                                  //indent:16 exp:16
    }                                                                               //indent:4 exp:4
