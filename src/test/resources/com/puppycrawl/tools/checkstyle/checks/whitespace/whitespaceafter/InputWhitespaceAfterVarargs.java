...
public class InputWhitespaceAfterVarargs {
    ...
    public <T> void anotherMethod
            (List<T>...args) { // violation ''...' is not followed by whitespace'
    }
    ...
    private void noWhitespaceBefore
            (boolean ...args) { // violation ''...' is not followed by whitespace'
    }
