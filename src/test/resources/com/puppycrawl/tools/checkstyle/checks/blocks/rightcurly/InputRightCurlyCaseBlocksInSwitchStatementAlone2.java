...
public class InputRightCurlyCaseBlocksInSwitchStatementAlone2 {
    ...
    public static void test16() {
        int mode = 0;
        switch (mode) {
            case 0: int x = 1; { } break;  // violation '}' at column 34 should be alone on a line'
            case 1: { } int y = 1; break;
            // violation above '}' at column 23 should be alone on a line'
            case 2: int t = 1; { }; // violation '}' at column 34 should be alone on a line'
        }
    }
    ...
    public static void test17() {
        ...
        switch (mode) {
            case 0:
            int x = 1;
            {  }  // violation '}' at column 16 should be alone on a line'
            case 1:
            mode++;
            {

            } int y; case 3: // violation '}' at column 13 should be alone on a line'
            {
