        ...
        outer: outer2: switch (a) {
            ...
            case 2:
                inner: for (int i = 0;i < 3;i++) {
                    // ok below as it terminates switch with 'outer2' scope label, avoiding fall-through
                    break outer2;
                }
            case 3:
                return 2;
            ...
            outer:switch (a) {
                ...
                case 10:  // violation 'Fall through from previous branch of the switch statement.'
                    inner1:
                    {
                        switch (a) {
                            case 1:
                                // ok below as it terminates switch with 'outer' scope label, avoiding fall-through
                                break outer;
