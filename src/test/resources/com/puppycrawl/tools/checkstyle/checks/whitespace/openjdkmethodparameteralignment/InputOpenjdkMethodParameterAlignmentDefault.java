...
public class InputOpenjdkMethodParameterAlignmentDefault {
    ...
    int twoOnTheFirstLineNotAligned(String aString, List<Integer> aList,
        Map<String, String> aMap) {
        // violation 2 lines above 'Align parameters vertically or wrap with eight extra spaces.'
        return 0;
    }

    int oneParameterPerLineNotAligned(String aString,
        List<Integer> aList,
        Map<String, String> aMap) {
        // violation 3 lines above 'Align parameters vertically or wrap with eight extra spaces.'
        return 0;
    ...
    int oneParameterPerLineOffByOneColumn(String aString,
                                         List<Integer> aList,
                                         Map<String, String> aMap) {
        // violation 3 lines above 'Align parameters vertically or wrap with eight extra spaces.'
        return 0;
