...
*/
  ...
  */
  ...
  // The expected level below is the one the Check reports without this property, see #20958.
  // It is not the level of the opening line asterisks, which sit at level 6.
  // violation 3 lines below 'Leading asterisk has .* indentation .* 1, expected is 4.'
  // violation 3 lines below 'Leading asterisk has .* indentation .* 1, expected is 4.'
  /**   ***
   * indentation is not applied when the opening line carries leading asterisks
   */
  private void openingLineAsterisks() {}
}
