...
public class InputMagicNumberIgnoreNone2 {
    ...
    private double mPlusDecimal = +3.5; // violation 'Magic number: 3.5'
    private double mMinusDecimal = -2.5; // violation 'Magic number: -2.5'

    /**
     * test octal and hex negative values
     */
    private int hexIntMinusOne = 0xffffffff; // violation 'Magic number: 0xffffffff'
    private long hexLongMinusOne = 0xffffffffffffffffL; // violation 'Magic number: 0xffffffffffffffffL'
    ...
    private int octalIntMinusOne = 037777777777;  // violation 'Magic number: 037777777777'
    private long octalLongMinusOne = 01777777777777777777777L;  // violation ''Magic number: 01777777777777777777777L'
