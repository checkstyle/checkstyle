...
public class InputEmptyLineSeparatorPreviousLineEmptiness {
    ...
    public InputEmptyLineSeparatorPreviousLineEmptiness(int base) { // violation 'There is more than 1 empty line after this line'
    ...
    public static int increment(int value) { // violation 'There is more than 1 empty line after this line'
