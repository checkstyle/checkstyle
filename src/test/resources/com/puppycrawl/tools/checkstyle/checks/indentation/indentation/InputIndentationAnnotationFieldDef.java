 ...
 */                                                                           //indent:1 exp:1
public class InputIndentationAnnotationFieldDef {                             //indent:0 exp:0
    ...
    InputIndentationAnnotationFieldDef.HasDefaultsAnnotation anno1;           //indent:4 exp:8 warn
    List<T>[] matrix1;                                                        //indent:4 exp:8 warn
        InputIndentationAnnotationFieldDef.HasDefaultsAnnotation anno2;       //indent:8 exp:8
