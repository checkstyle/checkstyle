...
public class InputInappropriateJavadocBlockTagsOnFieldDefault3 {
    ...
    enum InnerEnum {
        ...
        // violation 1 line above 'Invalid '@throws' tag for 'enumField'.'
    ...
    record InnerRecord(int x) {
        ...
        // violation 1 line above 'Invalid '@return' tag for 'RECORD_STATIC_FIELD'.'
    ...
    @interface InnerAnnotation {
        ...
        // violation 1 line above 'Invalid '@exception' tag for 'ANNOTATION_FIELD'.'
    }
    ...
    static class StaticNestedClass {
        ...
        // violation 1 line above 'Invalid '@param' tag for 'nestedField'.'
    }
    ...
    class InnerClass {
        ...
        // violation 1 line above 'Invalid '@return' tag for 'innerField'.'
    }
    ...
    public void anonymousClassMethod() {
        Object anonymous = new Object() {
            ...
            // violation 1 line above 'Invalid '@return' tag for 'anonField'.'
        };
    }
