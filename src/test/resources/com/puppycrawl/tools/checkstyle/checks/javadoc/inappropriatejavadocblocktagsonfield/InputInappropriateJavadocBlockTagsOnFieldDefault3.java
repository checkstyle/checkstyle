...
public class InputInappropriateJavadocBlockTagsOnFieldDefault3 {
    ...
    enum InnerEnum {
        ...
        // violation 3 lines above 'Invalid '@throws' tag for 'enumField'.'
    ...
    record InnerRecord(int x) {
        ...
        // violation 3 lines above 'Invalid '@return' tag for 'RECORD_STATIC_FIELD'.'
    ...
    @interface InnerAnnotation {
        ...
        // violation 3 lines above 'Invalid '@exception' tag for 'ANNOTATION_FIELD'.'
    }
    ...
    static class StaticNestedClass {
        ...
        // violation 3 lines above 'Invalid '@param' tag for 'nestedField'.'
    }
    ...
    class InnerClass {
        ...
        // violation 3 lines above 'Invalid '@return' tag for 'innerField'.'
    }
    ...
    public void anonymousClassMethod() {
        Object anonymous = new Object() {
            ...
            // violation 3 lines above 'Invalid '@return' tag for 'anonField'.'
        };
    }
