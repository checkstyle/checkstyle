...
// Java17
package com.puppycrawl.tools.checkstyle.checks.metrics.javancss;  // violation 'NCSS for this file is 45 (max allowed is 2).'

public class InputJavaNCSSRecordsAndCompactCtors {  // violation '.* is 44 (max allowed is 3).'
