...
public class InputJavadocUtilizingTrailingSpaceEdgeCases {
    ...
    // violation 2 lines below 'Line under-utilized (8/80). Words from below could be moved up'
    /**
     * a
     * b
     */
     ...
     * a b
     */
    public void correctedSingleCharLines() { }
    ...
    /**
     * Line ends off column 81 x x x x x x x x x x x x x x x x x x x x x x x x xx
     */
    public void justOverLimit() { }

    /**
     * Line ends at exactly column 80 x x x x x x x x x x x x x x x x x x x x xx
     */
    public void correctedJustOverLimit() { }
