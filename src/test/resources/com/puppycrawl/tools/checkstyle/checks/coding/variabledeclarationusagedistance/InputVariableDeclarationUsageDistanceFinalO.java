 ...
 * ignoreFinal = true
 */
public class InputVariableDeclarationUsageDistanceFinalO {
    ...
    public InputVariableDeclarationUsageDistanceFinalO(int test1) {
    ...
    public boolean testMethod() {
        ...
        new InputVariableDeclarationUsageDistanceFinalO(2);
