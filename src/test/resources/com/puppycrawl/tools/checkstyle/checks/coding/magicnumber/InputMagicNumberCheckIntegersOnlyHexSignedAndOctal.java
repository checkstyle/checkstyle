...
public class InputMagicNumberCheckIntegersOnlyHexSignedAndOctal {
    /**
     * test long hex
     */
    ...
    enum MyEnum2IntegersOnlyHexSignedAndOctal {
        A_2(3),
        B_2(54);

        private MyEnum2IntegersOnlyHexSignedAndOctal(int value) {
