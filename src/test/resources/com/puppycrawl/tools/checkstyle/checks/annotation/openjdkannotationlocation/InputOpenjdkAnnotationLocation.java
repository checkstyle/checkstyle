...
// violation above, 'Annotation 'Annotation2' must be on a separate line from target.'
    ...
    @Annotation2
    @Annotation2("bar") String value();
    // violation above, 'Annotation 'Annotation2' must be on a separate line from target.'

    // violation below, 'Annotation 'MyAnnotation2' must be on a separate line from target.'
    @MyAnnotation2 @MyAnnotation2("bar") String val();
    // violation above, 'Annotation 'MyAnnotation2' must be on a separate line from target.'

    @MyAnnotation2 @MyAnnotation2("bar")
    String values();
