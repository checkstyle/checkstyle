...
public class InputMagicNumberWithBitwiseOperatorsWithIgnoreFieldsFalse {

    public static final int BIT0 = 1 << 3; // ok, ignoreFieldDeclaration is true
    ...
    public static int bit0 = 1 << 3; // ok, ignoreFieldDeclaration is true
