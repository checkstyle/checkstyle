package com.example; //indent:0 exp:0
...
public class InputIndentationReturnStatementLineWrapping { //indent:0 exp:0
    ...
    public static int workingIndentationCheckWithMethodChain() { //indent:4 exp:4
    ...
    public static int failingIndentationCheckWithMethodChain() { //indent:4 exp:4
