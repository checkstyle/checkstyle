...
public class InputIndentationReturnStatementLineWrapping { //indent:0 exp:0
    ...
    public static Object returnWithNew() {                 //indent:4 exp:4
        return new Object();                               //indent:8 exp:8
    }                                                      //indent:4 exp:4

    public static int[] returnWithArrayInit() {            //indent:4 exp:4
        return new int[] {1, 2, 3};                        //indent:8 exp:8
    }                                                      //indent:4 exp:4
