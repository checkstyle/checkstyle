...
public class InputJavadocUtilizingTrailingSpaceSingleLine {
    ...
    // violation 1 lines below 'Line is longer than 80 characters (found 97).'
    /** This single-line Javadoc is quite long but should not exceed the eighty character limit. */
    public void longerSingleLine() { }

    /**
     * This single-line Javadoc is quite long but should not exceed the eighty
     * character limit.
     */
    public void correctedLongerSingleLine() { }

    // violation 1 lines below 'Line is longer than 80 characters (found 118).'
    ...
    /**
     * This single-line Javadoc is way too long and definitely exceeds the
     * eighty character limit that has been set.
     */
    public void correctedTooLongSingleLine() { }
