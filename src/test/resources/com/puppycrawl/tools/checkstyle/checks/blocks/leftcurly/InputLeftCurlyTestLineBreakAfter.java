    ...
    { // violation ''\{' at column 5 should be on the previous line'
        ...
        { // violation ''\{' at column 9 should be on the previous line'
            ...
            { // violation ''\{' at column 13 should be on the previous line'
                ...
                else { break; } // violation ''\{' at column 22 should have a line break after'
                switch (a)
                { // violation ''\{' at column 17 should be on the previous line'
                case 0:
                    break;
            ...
            catch (Exception e) { break; } // violation ''\{' at column 33 should have a line break after'
            finally { break; } // violation ''\{' at column 21 should have a line break after'
        }
        ...
        for (int k = 0; k < 1; k++) { String innerBlockVariable = ""; } // violation ''\{' at column 37 should have a line break after'

        for (int k = 0; k < 1; k++) {}
                return a;
    }

    static { int x = 1; } // violation ''\{' at column 12 should have a line break after'

    void method2()
    { // violation ''\{' at column 5 should be on the previous line'
        boolean flag = false;
        if (flag) { String.valueOf("foo"); } // violation ''\{' at column 19 should have a line break after'
    }
}
