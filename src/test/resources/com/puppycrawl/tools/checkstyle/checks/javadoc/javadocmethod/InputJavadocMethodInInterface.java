...
public interface InputJavadocMethodInInterface {
    ...
    /**
     * Method with 2-level qualified return type.
     */
    // violation below '@return tag should be present and have description.'
    InputJavadocMethodInInterface.Nested getNested();

    // No javadoc - method with 3-level qualified type to test DOT recursion false branch
