...
public class InputStringLiteralEquality
{
    ...
    {
        if (name == "Lars") // violation 'Literal Strings should be compared using equals(), not '=='.'
        {
            // flagged, should use equals
        }

        if ("Oleg" == name) // violation 'Literal Strings should be compared using equals(), not '=='.'
        {
            // flagged, should use equals
        }

        if ("Oliver" == "Oliver") // violation 'Literal Strings should be compared using equals(), not '=='.'
        {
