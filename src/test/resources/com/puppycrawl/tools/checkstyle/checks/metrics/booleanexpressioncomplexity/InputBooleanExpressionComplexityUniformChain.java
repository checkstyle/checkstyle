...
public class InputBooleanExpressionComplexityUniformChain {
    ...
    // uniform BOR chain of 5 operators: with ignoreUniformChains counts as 1, no violation
    // but negated-condition mutant would count 4 non-root BORs → violation (kills mutant)
