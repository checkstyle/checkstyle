...
RightCurly
option = (default)same
tokens = LITERAL_TRY, LITERAL_CATCH, LITERAL_FINALLY, LITERAL_IF, LITERAL_ELSE, METHOD_DEF, LITERAL_DO
...
public class InputRightCurlyWithEmoji {
    ...
    String method4(String a) {
        if (a.equals("🎄")) a = "😆🤩"; return "😆🤩gckh"; } // violation ''}' should have line break before.'
