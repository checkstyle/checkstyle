...
public class InputMissingJavadocMethodNewCasesAfterAstMigration {
    ...
    @TearDown(Level.Invocation) // violation 'Missing a Javadoc comment.'
    public void annotatedMethodWithAnnotationValue() { }

    private static class Nested {
        private static int mapper(int value) { return value + 1; } // violation 'Missing a Javadoc comment.'
    }
...
interface DiffReportInterfaceRegression {
    ...
    default Object oneLineDefaultMethod() { return new Object(); } // violation 'Missing a Javadoc comment.'
}
