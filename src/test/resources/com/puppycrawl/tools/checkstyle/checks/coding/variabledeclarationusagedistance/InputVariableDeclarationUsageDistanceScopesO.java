 ...
 * ignoreFinal = false
 */
public class InputVariableDeclarationUsageDistanceScopesO {
    ...
    public InputVariableDeclarationUsageDistanceScopesO(int test1) {
    ...
    public boolean testMethod() {
        ...
        new InputVariableDeclarationUsageDistanceScopesO(2);
