...
public class InputFinalPatternVariableCheck {
    ...
    public void run(Object o) {
        ...
        // else if branch
        if (o instanceof Integer i1) { // violation "Pattern variable 'i1' should be declared final."
            System.out.println(i1);
        }
        else if (o instanceof String s6) { // violation "Pattern variable 's6' should be declared final."
            System.out.println(s6);
        }

        // Ternary operator
        int len = (o instanceof String s7) ? s7.length() : 0; // violation "Pattern variable 's7' should be declared final."
