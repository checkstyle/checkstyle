...
public class InputLeftCurlyCommentBeforeLeftCurly {
    ...
    private class Node {
        ...
        /* comment */ { // violation ''{' at column 23 should be on the previous line'
            this.value = value;
            this.next = next;
        }
...
class checks
    ...
    public static Set<String> processJavadocTag(JavadocTag tag) {
    ...
    class C {
        ...
        void method3()
        /* checks */ /* 🥳🥳🥳🥳 */ { } // violation ''{' at column 33 should be on the previous line'
        }
