 ...
 * <p>
 * /^ WARN/   Some Javadoc.<p> // 2 violations 'Javadoc content should start from the next line after /\*\*.'
 *
 */
class InputJavadocParagraphIncorrect {
    ...
    /**<p>Some Javadoc.<p>  // 3 violations 'Javadoc content should start from the next line after /\*\*.'
     ...
     * <p>/^WARN/   Some Javadoc.<p>*/  // 2 violations 'Javadoc content should start from the next line after /\*\*.'
     class InnerInputJavadocParagraphIncorrect {

        /**
         * Some Javadoc./WARN/<p>  // 2 violations 'Javadoc content should start from the next line after /\*\*.'
         *
         * @since 8.0
         */
        public static final byte NUL = 0;
        ...
        /**<p>
         * /^WARN/ Some Javadoc. // 2 violations above 'Javadoc content should start from the next line after /\*\*.'
         *
    ...
    InnerInputJavadocParagraphIncorrect anon = new InnerInputJavadocParagraphIncorrect() {
         ...
         *
         * @see <a href="http://www.gwtproject.org/doc/latest/DevGuideOrganizingProjects.html#DevGuideModules">
         *     Documentation about <p> GWT emulated source</a> // 2 violations 'Javadoc content should start from the
         *     next line after /\*\*.'
         */
        boolean emulated() {return false;}
