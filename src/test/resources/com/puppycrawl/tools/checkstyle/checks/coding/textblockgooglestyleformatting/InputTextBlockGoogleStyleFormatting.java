...
public class InputTextBlockGoogleStyleFormatting {
    ...
    public static String textFun() {
        ...
        final String simpleScript2 = simpleScript + // violation 2 lines below 'Each line of text in the text block must be indented at least as much as the opening and closing quotes'
                simpleScript1 + """
        ...
        // violation 2 lines below 'Opening quotes (""") of text-block must be on the new line'
        final String simpleScript4 = simpleScript + // violation 2 lines below 'Each line of text in the text block must be indented at least as much as the opening and closing quotes'
    ...
    public void textFun2() {
        ...
        getData("""
            ...
            // violation 6 lines above 'Each line of text in the text block must be indented at least as much as the opening and closing quotes'
            // violation 6 lines above 'Text-block quotes are not vertically aligned'
        );
        final String coverageCase =
    """
