...
public class InputTextBlockGoogleStyleFormatting4 {
    ...
    private static String testMethod(
        final long processInstanceKey) {
            ...
            // violation 4 lines above 'Text is indented less than opening quotes indentation'
    ...
    private static String testMethod21() {
        ...
        return """
            def newInstance = params.instance;
            def existingInstance = ctx._source;
            """ + simpleProp // violation 'Text-block quotes are not vertically aligned'
                // violation 2 lines below 'Opening quotes (""") of text-block must be on the new'
                // violation below 'Text is indented less than opening quotes indentation'
            + """
    ...
    private static String testMethod4() {
        ...
        """ // violation 'Text-block quotes are not vertically aligned'
         ...
         +
         """
          def flowNodeIdByFlowNodeInstanceId =flowNodesById.values().collect(Collectors.toList());
           """; // violation 'Text-block quotes are not vertically aligned'
    }
