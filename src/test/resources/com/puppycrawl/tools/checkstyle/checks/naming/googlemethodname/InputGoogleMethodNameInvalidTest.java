...
public class InputGoogleMethodNameInvalidTest {
    ...
    // violation above, 'Test method name .* is not valid. Each segment must start with a lowercase'

    @Test
    void Testing_Foo() {}
    // violation above, ''Testing_Foo' is not valid. Each segment must start with a lowercase'
    ...
    @Test
    void TestingFooBad() {}
    // violation above, ''TestingFooBad' is not valid. Each segment must start with a lowercase'
    ...
    @Test
    void test_FOO_bar() {}
    // violation above, ''test_FOO_bar' is not valid. Each segment must start with a lowercase'

    @Test
    void testing_a() {}
    // violation above, ''testing_a' is not valid. Each segment must start with a lowercase'

    @Test
    void test_fO_bar() {}
    // violation above, ''test_fO_bar' is not valid. Each segment must start with a lowercase'
