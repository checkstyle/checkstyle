...
public class InputEqualsHashCodeEqualsParameter {
    ...
    public static class TestClass9 { // violation, no `equals` implementation
        public native int hashCode(); // violation 'Definition of 'hashCode()' without corresponding definition of 'equals()'.'
    }
    public static class TestClass10 { // violation, no `hashCode` implementation
        public native boolean equals(Object o); // violation 'Definition of 'equals()' without corresponding definition of 'hashCode()'.'
    }
    ...
    public static abstract class TestClass13 { // violation, no `hashCode` implementation
        public abstract int hashCode();
        public boolean equals(java.lang.Object o) { // violation 'Definition of 'equals()' without corresponding definition of 'hashCode()'.'
            return true;
        }
    }
