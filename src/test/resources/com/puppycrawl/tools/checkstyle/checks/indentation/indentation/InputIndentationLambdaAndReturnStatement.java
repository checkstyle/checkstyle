...
public class InputIndentationLambdaAndReturnStatement {                           //indent:0 exp:0
  ...
  Object identity(Object o) {                                                     //indent:2 exp:2
    return o;                                                                     //indent:4 exp:4
  }                                                                               //indent:2 exp:2

  Object testReturnNewArgCorrect() {                                              //indent:2 exp:2
    return identity(                                                              //indent:4 exp:4
        new IllegalStateException());                                             //indent:8 exp:8
  }                                                                               //indent:2 exp:2

  Object testReturnNewArgIncorrect() {                                            //indent:2 exp:2
    return identity(                                                              //indent:4 exp:4
    new IllegalStateException());                                                 //indent:4 exp:6,8 warn
  }                                                                               //indent:2 exp:2

  Object testReturnNestedCallArgIncorrect() {                                     //indent:2 exp:2
    return identity(                                                              //indent:4 exp:4
    identity(null));                                                              //indent:4 exp:6 warn
  }                                                                               //indent:2 exp:2
