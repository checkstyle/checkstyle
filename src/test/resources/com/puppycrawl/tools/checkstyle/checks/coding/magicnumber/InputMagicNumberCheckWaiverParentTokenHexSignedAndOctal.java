...
public class InputMagicNumberCheckWaiverParentTokenHexSignedAndOctal {
    /**
     * test long hex
     */
    ...
    enum MyEnum2WaiverParentTokenHexSignedAndOctal {
        A(3),
        B(54);

        private MyEnum2WaiverParentTokenHexSignedAndOctal(int value) {
