...
public class InputVariableDeclarationUsageDistanceGeneral {
    ...
    public void testMethod2() {
        int count; // violation 'Distance between .* declaration and its first usage is .'
        int a = 3;
        int b = 2;
        {
            a = a
    ...
    public void testMethod14() {
        ...
        A a = new A();
        E d1 = new E();
        C1 c = new C1(); // violation 'Distance .* is 3.'
        E d2 = new E(); // violation 'Distance .* is 3.'
        a.setForward(d1);
        d1.setReverse(a);
...
class New1 {
    ...
    void m() {
        final int a = 1; // violation 'Distance between .* declaration and its first usage is 2.'
        int b = 0;
    ...
    void methodTry() {
        String a = "a"; // violation 'Distance between .* declaration and its first usage is 2.'
        String b = "abc";
        n();
