...
public class
    InputWhitespaceAroundAllowEmptyTypesAndNonEmptyClasses2{ // violation ''{' is not .* whitespace'
    ...
    class NotEmptyClass{ public void foo1() { foo2(); } } // violation ''{' is not .* whitespace'
