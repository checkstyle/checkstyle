...
@InputIndentationAnnArrInit.Bar, //indent:0 exp:4,6,10,12,16,18,22,24,28,30,34,36 warn
}) //indent:0 exp:0

@InputIndentationAnnArrInit.Baz({ //indent:0 exp:0
    "Hello", //indent:4 exp:4
             "Checkstyle", //indent:13 exp:4,6,10,12,16,18,22,24,28,30,34,36 warn
...
class InputIndentationAnnArrInit { //indent:0 exp:0
  ...
  @interface Baz { //indent:2 exp:2
    String[] value() default { //indent:4 exp:4
      ...
      "Checkstyle" //indent:6 exp:8,10,14,16,20,22,26,28,31,33 warn
