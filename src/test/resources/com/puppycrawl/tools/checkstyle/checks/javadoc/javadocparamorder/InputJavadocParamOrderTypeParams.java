...
public class InputJavadocParamOrderTypeParams {
     ...
     *
     * @param <U> second type param // violation
     * @param <T> first type param  // violation
     * @param p1 first param
     */
     ...
     *
     * @param p2 the second param       // violation
     * @param p1 the first param        // violation
     * @param <U> the second type param // violation
     * @param <T> the first type param  // violation
     */
     ...
     *
     * @param p1 first param
     * @param <T> the type param // violation
     */
