...
class InputEmptyLineSeparator // violation ''CLASS_DEF' should be separated from previous line'
{
    ...
    private boolean flg = true; // violation ''VARIABLE_DEF' should be separated from previous line'
     ...
     *
     */
    InputEmptyLineSeparator() // violation ''CTOR_DEF' should be separated from previous line'
    {
        //empty
    }
    //separator blank line
    int comTo(Object aObject) // violation ''METHOD_DEF' should be separated from previous line'
    {
        int number = 0;
        return 0;
    }
     ...
     * @return
     */
    static <T> Callable<T> callable( // violation ''METHOD_DEF' .* separated from previous line'
