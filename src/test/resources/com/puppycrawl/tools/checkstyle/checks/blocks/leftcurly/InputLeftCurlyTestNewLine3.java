...
{ // ok
    ...
    { // ok
        ...
        if (flag) { String.CASE_INSENSITIVE_ORDER.equals("it is ok."); } // violation ''\{' at column 19 should be on a new line'
    }
}
 ...
 *
 */
class Absent_CustomFieldSerializer3TestNewLine3 { // violation ''\{' at column 49 should be on a new line'
