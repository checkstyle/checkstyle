...
import static javax.swing.WindowConstants.*; // violation, 'Using the '.*' form of import should be avoided - javax.swing.WindowConstants.*.'
import static javax.swing.WindowConstants.*; // violation, 'Using the '.*' form of import should be avoided - javax.swing.WindowConstants.*.'
import static java.io.File.createTempFile;
import static java.io.File.*; // violation, 'Using the '.*' form of import should be avoided - java.io.File.*.'
