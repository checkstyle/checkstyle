...
public class InputUnusedTryResourceShouldBeUnnamedHandlers {
    ...
    void subsequentResourceSkipped() {
        // violation 3 lines below 'Unused try resource 'r2' should be unnamed'
        // violation 3 lines below 'Unused try resource 'r3' should be unnamed'
        try (StringReader r1 = new StringReader("r1");
             StringReader r2 = new StringReader("r2");
             StringReader r3 = new StringReader(r1.toString())) {
            System.out.println("body");
        }
    }
}
