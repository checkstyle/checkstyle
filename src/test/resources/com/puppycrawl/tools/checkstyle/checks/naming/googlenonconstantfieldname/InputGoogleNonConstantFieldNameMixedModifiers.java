...
public class InputGoogleNonConstantFieldNameMixedModifiers {
    ...
    // violation above, 'Non-constant field name 'Public_Final' has invalid underscore usage'
    ...
    // violation above 'Non-constant field name 'f' must start with a lowercase letter, min 2 chars'
    ...
    // violation above, 'Non-constant field name 'Public_Bad' has invalid underscore usage'

    private int mField;
    // violation above, ''mField' .* avoid single lowercase letter followed by uppercase'

    protected int a;
    // violation above 'Non-constant field name 'a' must start with a lowercase letter, min 2 chars'
}
