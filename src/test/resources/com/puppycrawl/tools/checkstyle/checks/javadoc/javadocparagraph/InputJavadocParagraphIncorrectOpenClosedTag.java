...
public class InputJavadocParagraphIncorrectOpenClosedTag {
    ...
    *
    * <p>
    *   Some Javadoc. // false-negative until #15762
    * </p>
    */
    int d;
    ...
    *
    * <p>
    *   <ul> // false-negative until #15762
    *     <li>Item 1</li> // false-negative until #15762
    *     <li>Item 2</li> // false-negative until #15762
    *     <li>Item 3</li> // false-negative until #15762
    *   </ul> // false-negative until #15762
    * </p>
    */
    int e;
    ...
    *
    * <p>
    *     <b>testing....</b> // false-negative until #15762
    * </p>
    *
    * <p>
    *     <h1>testing....</h1> // false-negative until #15762
    * </p>
    */
