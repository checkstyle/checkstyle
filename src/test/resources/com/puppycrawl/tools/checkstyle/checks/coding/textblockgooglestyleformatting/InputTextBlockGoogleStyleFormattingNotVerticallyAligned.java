...
"""; // violation 'Text-block quotes are not vertically aligned'
    ...
    public String textFun2() {
        ...
        getData(
            ...
            """
         this is a multi-line message
            """); // violation above 'Text block content indentation is less than the opening quotes indentation'

        // violation 4 lines below 'Text block content indentation is less than the opening quotes indentation'
        getData(
            1,
                """
            this is a multi-line message
