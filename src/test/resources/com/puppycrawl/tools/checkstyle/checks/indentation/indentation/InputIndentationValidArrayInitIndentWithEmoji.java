...
public class InputIndentationValidArrayInitIndentWithEmoji { //indent:0 exp:0
  private static final String[] UNSECURED_PATHS = { //indent:2 exp:2
    "🧐 🥳", //indent:4 exp:4
     "2👆🏻", //indent:5 exp:4,6,52,54 warn
  }; //indent:2 exp:2

  String[] array3 = new String[] { //indent:2 exp:2
    " 1😆 🤛🏻", //indent:4 exp:4
        "2😂🎄", //indent:8 exp:4,6,35,37 warn
          "🎄👍3" //indent:10 exp:4,6,35,37 warn
  }; //indent:2 exp:2

  String[][] a = { //indent:2 exp:2
    {"😆 🤛🏻da sd", "d 👍 "  }, //indent:4 exp:4
          {"😂🎄 dwe", " 1😆 🤛🏻", //indent:10 exp:4,6,19,21,25 warn
      "2😂🎄", //indent:6 exp:6
      "🤛🏻👆e"} //indent:6 exp:6
  }; //indent:2 exp:2
