...
public class InputJavadocUtilizingTrailingSpaceMultiParagraph {
    ...
    // violation 2 lines below 'Line under-utilized (14/80). Words from below could be moved up'
    /**
     * A short
    ...
    /**
     * A short first paragraph that violates.
     *
     * <p>A proper second paragraph that uses space efficiently.
     */
    public void correctedMixedViolations() { }
}
