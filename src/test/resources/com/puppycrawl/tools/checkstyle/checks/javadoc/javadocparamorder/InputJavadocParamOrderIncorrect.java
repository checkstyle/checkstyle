...
class InputJavadocParamOrderIncorrect {
     ...
     * @param p1 Parameter 1 desc.
     * @param <T> Parameter T desc. // violation
     * @see Some javadoc. // ok
     * @param p3 Parameter 3 desc.
     * @return Some number. // ok
     */
    static <T> int test(String p1, String p2, T p3) { // violation
        return 2021;
    }
     ...
     * @param str Parameter str desc.
     */
    void test2(int i, String str) { // violation
    }
     ...
     * @param <E> Parameter E desc.
     * @param CCC Parameter CCC desc. // violation
     * @param array Parameter array desc.
     * @see Some javadoc. // OK
     * @param e Parameter e desc. // violation
     * @param str Parameter str desc. // violation
     * @return Some number. // OK
     */
    <T, E, C> int sampleMethod(T[] array, String str, E e ) { // violation
        return 2021;
    }
     ...
     *
     * @version Some javadoc.
     * @param <> Parameter T desc. // violation
     * @param array Parameter array desc.
     * @see Some javadoc. // OK
     * @return Some number. // OK
     */
