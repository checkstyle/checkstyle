...
class InputJavadocParamOrderIncorrect {
     ...
     */
    static <T> int test(String p1, String p2, T p3) {
        return 2021;
    }
     ...
     * @return Some number.
     */
    <T, E, C> int sampleMethod(T[] array, String str, E e ) {
        return 2021;
    }
     ...
     * @return Some number.
     */
    public static <T> int sampleMethod(T[] array) {
        return 2021;
    }
     ...
     * @return Some number.
     */
    public static <T> int sampleMethod2(T[] array) {
        return 2021;
    }
     ...
     * @param <i Parameter i desc. // ok, param does not exists
     */
    public InputJavadocParamOrderIncorrect (int i) {
    }
     ...
     * @param <T> Parameter T desc        // ok, param does not exists
     * @param <A> A type param            // violation
     * @param <C456>> Another type param  // ok
     * @param <C456>> Another type param  // ok, dublicate param
     */
    static class Inner<A,B1,C456 extends Comparable>  {

        /**
         * Description.
         *
         * @version Some javadoc.
         * @param p2 Parameter 2 desc.         // ok, param does not exists
         * @param <T> Parameter T desc.        // ok
         * @param <T> Parameter T desc.        // ok, dublicate param
         * @param p1 Parameter 1 desc.         // ok
         * @param <T> Parameter T desc.        // violation
         * @return Some number.
         */
        static <T> int test(String p1) {
            return 2021;
        }
   }
