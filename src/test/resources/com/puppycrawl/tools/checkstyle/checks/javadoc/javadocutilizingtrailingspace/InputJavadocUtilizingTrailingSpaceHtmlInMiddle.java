...
public class InputJavadocUtilizingTrailingSpaceHtmlInMiddle {
    ...
    // violation 2 lines below 'Line is longer than 80 characters (found 102).'
    /**
    ...
    /**
     * Very long line with <b>bold text</b> that makes it exceed the eighty
     * character line limit here.
     */
    public void correctedLongLineWithHtml() { }
