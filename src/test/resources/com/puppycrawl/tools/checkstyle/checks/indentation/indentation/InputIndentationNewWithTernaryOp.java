...
public class InputIndentationNewWithTernaryOp { //indent:0 exp:0
    Integer reslt = true ? //indent:4 exp:4
    ...
    Integer newResult = false ? //indent:4 exp:4
            new Integer(1) : //indent:12 exp:12
        new Integer(2); //indent:8 exp:12 warn
    Integer newResult2 = true ? //indent:4 exp:4
            new Integer(1) : //indent:12 exp:12
                    new Integer(2); //indent:20 exp:12 warn
    ...
    Integer newResult3 = true ? //indent:4 exp:4
    new Integer(1) : //indent:4 exp:12 warn
            new Integer(2); //indent:12 exp:12
    Integer newResult4 = true ? //indent:4 exp:4
        new Integer(1) : //indent:8 exp:12 warn
            new Integer(2); //indent:12 exp:12
    Integer newResult5 = true ? //indent:4 exp:4
                        new Integer(1) : //indent:24 exp:12 warn
            new Integer(2); //indent:12 exp:12
    Integer newResult6 = true ? //indent:4 exp:4
                                new Integer(1) : //indent:32 exp:12 warn
            new Integer(2); //indent:12 exp:12
    public void method3() { //indent:4 exp:4
        ...
        int z=79;  //indent:8 exp:8
        int largestNumber= (x < y) ? (//indent:8 exp:8
        new Integer(2) < z ? //indent:8 exp:16 warn
                x : //indent:16 exp:16
                  new Integer(2)) : (y > z ? //indent:18 exp:16 warn
                    new Integer(2) : //indent:20 exp:16 warn
                new Integer(3)); //indent:16 exp:16
    } //indent:4 exp:4
    Integer newResult7 = true ? //indent:4 exp:4
         new Integer(1) : //indent:9 exp:12 warn
            new Integer(2); //indent:12 exp:12
} //indent:0 exp:0
