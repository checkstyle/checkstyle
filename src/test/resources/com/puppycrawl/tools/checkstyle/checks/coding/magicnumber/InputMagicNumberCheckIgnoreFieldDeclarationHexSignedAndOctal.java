...
public class InputMagicNumberCheckIgnoreFieldDeclarationHexSignedAndOctal {
    /**
     * test long hex
     */
    long l = 0xffffffffL;
    ...
    enum MyEnum2IgnoreFieldDeclarationHexSignedAndOctal {
        A_7(3),
        B_7(54);

        private MyEnum2IgnoreFieldDeclarationHexSignedAndOctal(int value) {
