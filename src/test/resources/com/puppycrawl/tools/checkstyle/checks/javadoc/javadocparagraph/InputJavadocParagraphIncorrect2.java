 ...
 * /^ WARN/   Some Javadoc.<p> // violation 'Javadoc content should start from the next line
 * after /\*\*.'
 *
 */
class InputJavadocParagraphIncorrect2 {
     ...
     * <p>/^WARN/   Some Javadoc.<p>*/  // violation
     class InnerInputJavadocParagraphIncorrect {
        ...
        /**
         * Some Javadoc./WARN/<p>  // violation 'Javadoc content should start from the next line
         * after /\*\*.'
         *
         * @since 8.0
         */
         ...
         * /^WARN/
         * <p> // violation
         *  /^WARN/ Some Javadoc.<p> // violation 'Javadoc content should start from the next
         *  line after /\*\*.'
         * @see <a href="http://www.gwtproject.org/doc/latest/DevGuideOrganizingProjects.html#DevGuideModules">
         *     Documentation about GWT emulated source</a>
         */
    ...
    InnerInputJavadocParagraphIncorrect anon = new InnerInputJavadocParagraphIncorrect() {
         ...
         *
         * @see <a href="http://www.gwtproject.org/doc/latest/DevGuideOrganizingProjects.html#DevGuideModules">
         *     Documentation about <p> GWT emulated source</a> // violation 'Javadoc content
         ...
         *
         *
         * Some Javadoc. //DOUBLE WARN AT TWO PREVIOUS LINES // violation above 'Javadoc content
         * should start from the next line after /\*\*.'
         */
         void doubleNewline() {}
    };
