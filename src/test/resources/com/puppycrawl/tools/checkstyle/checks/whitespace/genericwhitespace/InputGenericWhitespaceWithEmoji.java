...
public class InputGenericWhitespaceWithEmoji {
 ...
 > { /*inner😆 enum*/} // violation ''>' is preceded with whitespace'
    ...
    Object notOkStart2 = new<String>Outer.Inner(); // violation ''<' is not preceded with whitespace'
    /* 😆asd*/ public static class
    IntEnumValueType3<E extends Enum<E>  & InputGenericWhitespaceDefault.IntEnum> {
