...
@interface InputEmptyLineWrappingInBlockInterfaceAnnotationEnumAnnot { // violation ''{' must have exactly one empty line after.'
    String value();
} // violation ''}' must have exactly one empty line before'

enum InputEmptyLineWrappingInBlockInterfaceAnnotationEnumEnum { // violation ''{' must have exactly one empty line after.'
    A,
    B
} // violation ''}' must have exactly one empty line before'
