...
public final class InputUnusedPrivateFieldNestedScopes {
    public final class Nested {
        ...
        private final Object source; // ok, as source is used

        private final String fileName; // ok, as fileName is used
    ...
    void outerMethod(String message, String testCase) {
        ...
        class Inner {
            ...
            private String message; // ok, used in run()
            private String testCase; // ok, used in getName()
