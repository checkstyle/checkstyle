...
public class InputUnusedImports3 extends java.awt.Robot {
    ...
    public static InputUnusedImports3 getRobot() {
        return getRobot(true);
    }


    public static InputUnusedImports3 getRobot(boolean enableDelays) {
        InputUnusedImports3 robot = null;
        try {
            robot = new InputUnusedImports3(enableDelays);
