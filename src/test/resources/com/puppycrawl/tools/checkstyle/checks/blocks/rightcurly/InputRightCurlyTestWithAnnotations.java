...
class InputRightCurlyTestWithAnnotations
{
    ...
    public InputRightCurlyTestWithAnnotations(int v1, int v2) {this.var1 = v1; this.var2 = v2; } // violation
    ...
    @Deprecated
    void foo17() { int v1 = 5; v2 = 6; } @Deprecated void foo18() {int v1 = 5; v2 = 6; } // 2 violations
    ...
    void doDoubleBraceInitialization() {
        ...
        new Object() { public int hashCode() { return 1; }  { int c = 5; } int d = 8; }; // 2 violations
