...
// comment within import group
import java.util.HashSet; // violation 'Extra separation in import group before .*HashSet''

// comment between import groups

import org.apache.tools.ant.*; // violation '.*ant.*' should be separated from previous import group by one line'
import org.apache.commons.beanutils.*;
// comment between import groups


import com.puppycrawl.tools.checkstyle.*; // violation '.*checkstyle.*' should be separated from previous import group by one line'
...
// comment within import group
import picocli.CommandLine; // violation 'Extra separation in import group before .*CommandLine''
