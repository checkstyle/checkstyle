...
public class InputJavadocUtilizingTrailingSpaceTooLong {
    ...
    /**
     * This is a very long line that definitely exceeds the eighty character
     * limit that has been configured.
     */
    public void correctedSingleLongLine() { }
    ...
    /**
     * This description starts off reasonably but then it goes on and on and on
     * and exceeds the limit significantly.
     */
    public void correctedLongDescription() { }

    // violation 3 lines below 'Line under-utilized (19/80). Words from below could be moved up'
    ...
    /**
     * Normal line. But this second line is extremely long and will definitely
     * trigger a too long violation because it exceeds eighty.
     */
    public void correctedSecondLineTooLong() { }
    ...
    /**
     * This is a line that is exactly eighty characters long including spaces
     * here and there word
     */
    public void correctedMoreEightyChars() { }
}
