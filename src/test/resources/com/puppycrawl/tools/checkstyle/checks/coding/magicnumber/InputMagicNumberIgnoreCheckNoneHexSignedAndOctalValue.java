...
public class InputMagicNumberIgnoreCheckNoneHexSignedAndOctalValue {
    /** test long hex */
    ...
    enum MyEnum2IgnoreNoneHexSignedAndOctalValue {
        A_3(3),
        B_3(54);

        private MyEnum2IgnoreNoneHexSignedAndOctalValue(int value) {
