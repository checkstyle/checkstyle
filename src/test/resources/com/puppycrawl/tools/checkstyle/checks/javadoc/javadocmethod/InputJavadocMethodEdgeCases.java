...
public class InputJavadocMethodEdgeCases {
     ...
     * @param value the value
     */
    /* package */ public <K, V> void methodWithMultipleGenerics(K key, V value) {
    }

    /** Method with non-javadoc before annotation. */
    /* not a javadoc */
    @Deprecated
    public void methodWithNonJavadocBeforeAnnotation() {
    }
}
