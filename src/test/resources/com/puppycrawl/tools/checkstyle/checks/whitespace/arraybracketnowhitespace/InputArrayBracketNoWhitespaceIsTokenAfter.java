...
public class InputArrayBracketNoWhitespaceIsTokenAfter {
    ...
    void testGetNextTokenFromParent(int[] arr) {
        // arr[0]++/-- are valid (POST_INC/POST_DEC need no whitespace before them).
        // Without getNextTokenFromParent, the sibling operand (e.g. '+ 1') wins,
        // giving a false MSG_WS_NOT_FOLLOWED since it is not a valid token type.
        int a = arr[0]++ + 1;
        int b = arr[0]-- + 1;
        int c = arr[0]++ - 1;
        int d = arr[0]-- - 1;
