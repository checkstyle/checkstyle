...
import java.io.ByteArrayOutputStream; // violation 'Line matches the illegal pattern '^import''
import java.io.File; // violation 'Line matches the illegal pattern '^import''
