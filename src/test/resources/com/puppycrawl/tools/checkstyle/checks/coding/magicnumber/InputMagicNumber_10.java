...
public class InputMagicNumber_10 {
    private static Set<Person> p1 = new HashSet<Person>(5); // ok
    public Object[] values = new Object[3]; // ok
    private String[] fStrings = new String[3]; // ok
    private Person p = new Person(8); // ok
    List<Integer> multisets = new ArrayList(0x10000); // ok
    int i = 78;
}
...
class Class1 {
    Person person2 = new Person(12) { // violation ''12' is a magic number'
        public void magicMethod() {
            double double_var1 = 0D;
            double_var1 = 1.0 + 2.0; // violation ''2.0' is a magic number'
            double double_magic1 = 1.5_0; // violation ''1.5_0' is a magic number'
