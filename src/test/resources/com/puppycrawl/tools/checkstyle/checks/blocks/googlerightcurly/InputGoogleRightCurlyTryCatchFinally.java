...
public class InputGoogleRightCurlyTryCatchFinally {
    ...
    public String processTransaction(String filePath, String dbUrl,
        ...
        // violation 9 lines below ''}' at column 9 should be on the same line as .*/catch'
        try {
            ...
            if (inputStream != null) {
                // violation 3 lines below ''}' at column 17 should be on the same line as .*/catch'
                try {
                    inputStream.close();
                }
                catch (IOException e) {
        ...
        // violation 5 lines below ''}' at column 9 should be on the same line as .*/catch'
        // violation 8 lines below ''}' at column 9 should be on the same line as .*/finally'
        try {
        ...
        // violation 9 lines above ''}' at column 9 should be on the same line as .*/catch'
        // violation 6 lines above ''}' at column 9 should be on the same line as .*/finally'
