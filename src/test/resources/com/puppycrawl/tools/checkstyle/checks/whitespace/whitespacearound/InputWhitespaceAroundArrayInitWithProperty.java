...
public class InputWhitespaceAroundArrayInitWithProperty {
    ...
    public void arrayInitTest() {
        ...
        final int[] colors2 = new int[]{ // missing whitespace before '{'
                                0, 1, 2, 3
                              };
        ...
        final int[][] colors4 = {{1,2,3},{4,5,6}}; // missing whitespace
                                                    // at various spaces, mentioned in test
        final int[][] colors5 = { { 1,2,3 } , { 4,5,6 } }; // ok
        final int[][] colors6 = {{1,2,3} ,{4,5,6 } }; // missing whitespace
                                                    // at various spaces, mentioned in test
        int[][][] colors7 = {
                {
                  {1, -2, 3}, // missing whitespace after '{' and before '}'
                  {2, 3, 4} // missing whitespace after '{' and before '}'
                },
                {
                  {-4, -5, 6, 9}, // missing whitespace after '{' and before '}'
                  {1}, // missing whitespace after '{' and before '}'
                  {2, 3} // missing whitespace after '{' and before '}'
                }
        };
