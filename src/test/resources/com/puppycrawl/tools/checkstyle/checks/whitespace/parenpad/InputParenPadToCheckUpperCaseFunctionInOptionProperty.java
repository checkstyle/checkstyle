...
public class InputParenPadToCheckUpperCaseFunctionInOptionProperty {

    public InputParenPadToCheckUpperCaseFunctionInOptionProperty ( int i ) // ok
    {
        this ();
        toString ();
    }
    protected InputParenPadToCheckUpperCaseFunctionInOptionProperty()
    {
        super ();
    }
