...
public class InputVariableDeclarationUsageDistanceScopes {
    ...
    public void testMethod5() {
        int arg = 7; // violation 'Distance .* is 2.'
        boolean b = true;
        boolean bb = false;
        if (b)
            if (!bb)
    ...
    public int[] getSelectedIndices() {
        // violation below, 'Distance between .* declaration and its first usage is 2.'
        int[] sel = new int[5];
...
class New4 {
    ...
    void test() {
        ...
        int c = 0; // violation 'Distance between .* declaration and its first usage is 4.'
        System.lineSeparator();
        System.lineSeparator();
        System.lineSeparator();
