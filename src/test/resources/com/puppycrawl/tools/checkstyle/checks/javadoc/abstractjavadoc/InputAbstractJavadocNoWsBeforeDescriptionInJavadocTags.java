...
public class InputAbstractJavadocNoWsBeforeDescriptionInJavadocTags implements Serializable{
     ...
     * @serialField Fieldname fieldtype-fielddescription
     */
    // violation 'Javadoc comment at column 39 has parse error.
    // Details: mismatched input '-' expecting <EOF> while parsing JAVADOC'
     ...
     */
    // violation 'Javadoc comment at column 34 has parse error.
    // Details: mismatched input '-' expecting <EOF> while parsing JAVADOC'
     ...
     */
    // violation 'Javadoc comment at column 31 has parse error.
    // Details: mismatched input '-' expecting <EOF> while parsing JAVADOC'
     ...
     * @param a-description
     */
    // violation 'Javadoc comment at column 15 has parse error. Details:
     ...
     */
    // violation 'Javadoc comment at column 33 has parse error.
    // Details: mismatched input '-' expecting <EOF> while parsing JAVADOC'
     ...
     */
    // violation 'Javadoc comment at column 17 has parse error.
    // Details: mismatched input '<' expecting <EOF> while parsing JAVADOC'
