...
tokens = EXPR, IDENT, NUM_DOUBLE, NUM_FLOAT, NUM_INT, NUM_LONG, \
         ...
         POST_INC, POST_DEC, INDEX_OP, DOT, LITERAL_NEW, LOR, TYPECAST
...
public class InputUnnecessaryParenthesesFieldMethodAccess {
    ...
    public static void main(String[] args) {
        ...
        // violation above 'Unnecessary parentheses around expression.'
        foo = (INSTANCE.check()) ? 1 : 2; // parentheses not needed, allowed for clarity
        foo = (INSTANCE.flag) ? 1 : 2; // parentheses not needed, allowed for clarity
