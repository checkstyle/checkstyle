...
public class InputUnnecessaryParenthesesFieldMethodAccess {
    ...
    public static void main(String[] args) {
        ...
        foo = (String.valueOf(foo)).length(); // violation 'Unnecessary parentheses around expression.'
        foo = (INSTANCE.name).length(); // violation 'Unnecessary parentheses around expression.'
        foo = (new StringBuilder()).length(); // violation 'Unnecessary parentheses around expression.'
        foo = args[0].length();
