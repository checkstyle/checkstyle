...
@InputIndentationAnnotationArrayInit.Foo({ //indent:0 exp:0
  @InputIndentationAnnotationArrayInit.Bar, //indent:2 exp:2
@InputIndentationAnnotationArrayInit.Bar, //indent:0 exp:2,4,43,45 warn
}) //indent:0 exp:0

@InputIndentationAnnotationArrayInit.Baz({ //indent:0 exp:0
    "Hello", //indent:4 exp:4
    "Checkstyle", //indent:4 exp:4
  }) //indent:2 exp:0,4 warn

class InputIndentationAnnotationArrayInit { //indent:0 exp:0
...
interface SomeInterface { //indent:0 exp:0
  ...
  @SomeAnnotation(values =  //indent:2 exp:2
      { //indent:6 exp:6
     Info.A, //indent:5 exp:4,6,8,10 warn
