...
public class InputArrayBracketNoWhitespaceDeclarations {
    ...
    void testArrayInitializationWithArrayAccess() {
        ...
        int[] values = { arr[0], arr[1], arr[2] };
        int[] invalid = { arr[0]}; // violation '']' is not followed by whitespace.'

        String[] expectedStringsArr = new String[] { "h", "v" };
        String[] invalidStringsArr = new String[]{ "h", "v" };
