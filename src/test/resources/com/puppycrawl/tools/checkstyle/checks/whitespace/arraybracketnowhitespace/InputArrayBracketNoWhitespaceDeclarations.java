...
public class InputArrayBracketNoWhitespaceDeclarations {
    ...
    // correct cases: brackets after type
    int[] afterType1;
    int[][] afterType2;

    // correct cases: brackets after variable
    int afterVar1[];
    int afterVar2[][];

    // correct cases: mixed (allowed in Java)
    int[] mixedStyle1[];
    int[][] mixedStyle2[];

    // wrong cases: space before brackets after variable
    int badAfterVar1 []; // violation ''\[' is preceded with whitespace.'
    int badAfterVar2 [][]; // violation ''\[' is preceded with whitespace.'

    // wrong cases: space in mixed style
    ...
    // wrong cases: space before [ in return type
    ...
    // correct cases: brackets after method name
    int method4()[] { return null; }
    int method5()[][] { return null; }

    // wrong cases: space before brackets after method name
    ...
    // wrong cases: space before [ in parameters
    ...
    // wrong cases: space before [ in constructor parameters
    InputArrayBracketNoWhitespaceDeclarations(byte [] arr) {} // violation ''\[' is preceded with whitespace.'
    InputArrayBracketNoWhitespaceDeclarations(short [][] matrix, char [] chars) {}
    // 2 violations above:
    // ''\[' is preceded with whitespace.'
    // ''\[' is preceded with whitespace.'
    ...
    void localVariables() {
        ...
        // correct cases: brackets after variable name
        int local4[] = new int[10];
        int local5[][] = new int[5][5];

        // wrong cases: space before brackets after variable name
    ...
    void anonymousArrays() {
        ...
        // wrong cases: space before [ in anonymous array
        ...
        // wrong cases: space after [ in anonymous array
    ...
    void castExpressions() {
        ...
        // wrong cases: space before [ in cast
