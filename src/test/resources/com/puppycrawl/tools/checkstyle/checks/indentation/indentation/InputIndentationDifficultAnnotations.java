...
@DifficultAnnotation({ //indent:0 exp:0
@MyType(value = Boolean.class, name = "boolean"), //indent:0 exp:4,8,12,16,20,23,25 warn
@MyType(value = String.class, name = "string") }) //indent:0 exp:4,8,12,16,20,23,25 warn
class IncorrectClass { //indent:0 exp:0
    ...
    @DifficultAnnotation({ //indent:4 exp:4
      @MyType(value = Boolean.class, name = "boolean"), //indent:6 exp:8,12,16,20,24,27,29 warn
        @MyType(value = String.class, name = "string") }) //indent:8 exp:8
    void foo() { //indent:4 exp:4
