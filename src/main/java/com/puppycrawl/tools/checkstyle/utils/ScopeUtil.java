...
public final class ScopeUtil {
     ...
     */
    public static Optional<Scope> getScopeFromMods(DetailAST aMods) {
        return getDeclaredScopeFromMods(aMods)
                .or(() -> Optional.of(getDefaultScope(aMods)));
    }
    ...
    public static Optional<Scope> getSurroundingScope(DetailAST node) {
        ...
        for (DetailAST token = node;
            ...
            if (TokenUtil.isTypeDeclaration(type)) {
                final Optional<Scope> tokenScope = getScope(token);
                if (returnValue.isEmpty() || returnValue.get().isIn(tokenScope.get())) {
    ...
    public static boolean isInScope(DetailAST ast, Scope scope) {
        ...
        return surroundingScopeOfAstToken.get() == scope;
    }
