...
public final class JavadocUtil {
    ...
    public ArrayList<String> getContentOfSummaryTag(DetailNode javadoc) {
    ...
    public ArrayList<String> getInlineTagContent(DetailNode node) {
