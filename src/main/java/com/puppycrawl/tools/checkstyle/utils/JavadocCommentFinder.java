...
public final class JavadocCommentFinder {
    ...
    public static DetailAST findJavadocComment(DetailAST ast) {
        ...
        DetailAST javadoc = findJavadocInModifiers(modifiers, firstAnnotationLine);
        if (javadoc == null) {
     ...
     * @return the javadoc comment node, or null if not found
     */
    private static DetailAST findJavadocInModifiers(DetailAST modifiers, int firstAnnotationLine) {
        DetailAST lastJavadoc = null;
