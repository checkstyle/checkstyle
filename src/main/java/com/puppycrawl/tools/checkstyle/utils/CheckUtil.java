...
public final class CheckUtil {
     ...
     * @param validateInAnonymousClasses check to validateInAnonymousClasses
    ...
    public static AccessModifierOption getSurroundingAccessModifier(DetailAST node,
        boolean validateInAnonymousClasses) {
        ...
        for (DetailAST token = node;
            ...
            else if (type == TokenTypes.LITERAL_NEW && !validateInAnonymousClasses) {
                break;
            }
        }
