...
public final class CheckUtil {
     ...
     */
    public static int classNameMatchingCount(String patternClass,
     ...
     */
    public static int typeDeclarationMatchingCountAnonSuperClass(String patternTypeDeclaration,
        ...
        for (int i = 0; i < length
            ...
            if (patternTypeDeclaration.charAt(i) == PACKAGE_SEPARATOR
                || i == length - 1
                && typeDeclarationToBeMatched.length() > i + 1
                && typeDeclarationToBeMatched.charAt(i + 1) == PACKAGE_SEPARATOR) {
                result = i;
            }
        }
        return result;
