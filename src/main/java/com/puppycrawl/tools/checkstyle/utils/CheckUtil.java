...
public final class CheckUtil {
     ...
     *
     * <p>
     * Only set {@code isSearchedClassSuperClassOfAnonInnerClass} to {@code true} if the class
     ...
     * @param isSearchedClassSuperClassOfAnonInnerClass Is the class being searched super
    ...
    public static int typeDeclarationNameMatchingCount(String patternClass,
            String classToBeMatched, boolean isSearchedClassSuperClassOfAnonInnerClass) {
        ...
        for (int i = 0; i < length && patternClass.charAt(i) == classToBeMatched.charAt(i); ++i) {
            if (patternClass.charAt(i) == PACKAGE_SEPARATOR
                || isSearchedClassSuperClassOfAnonInnerClass
                && i == length - 1
