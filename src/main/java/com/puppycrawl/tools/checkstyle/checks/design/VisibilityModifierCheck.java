...
public class VisibilityModifierCheck
    ...
    private final Set<String> ignoreAnnotationShortNames =
            getClassShortNames(DEFAULT_IGNORE_ANNOTATIONS);

    /** Set of immutable classes short names. */
    private final Set<String> immutableClassShortNames =
    ...
    public void beginTree(DetailAST rootAst) {
        ...
        final Set<String> classShortNames =
        ...
        final Set<String> annotationShortNames =
