 ...
 * {@code lineLimit} when content from the following line could have been moved
 * up.</li>
 * <li>It flags lines that exceed {@code lineLimit}, except when the line
 * contains
 * only an unbreakable element such as a Javadoc tag or URL that starts the
 * line.</li>
 * </ul>
 *
 * @since 13.4.0
        ...
        private void initContent(String trimmedText, Pattern urlPattern,
            ...
            if (urlPattern.matcher(trimmedText).lookingAt()) {
                ...
                if (trimmedText.contains(" ")) {
                    firstWord = trimmedText.substring(0, trimmedText.indexOf(' '));
                }
            }
        }
