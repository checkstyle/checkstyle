...
public class JavadocVariableCheck
    ...
    /** Map of access modifiers to their restrictiveness levels. */
    private static final Map<AccessModifierOption, Integer> RESTRICTIVENESS_LEVELS = Map.of(
        AccessModifierOption.PUBLIC, 0,
        AccessModifierOption.PROTECTED, 1,
        AccessModifierOption.PACKAGE, 2,
        AccessModifierOption.PRIVATE, 3
    );
     ...
     */
    private static int getRestrictiveLevel(AccessModifierOption modifier) {
