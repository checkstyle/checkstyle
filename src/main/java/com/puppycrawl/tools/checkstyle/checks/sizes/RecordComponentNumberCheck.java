 ...
 * <ul>
 * <li>
 * Property {@code maxInPrivateRecord} - Specify the maximum number of components allowed
 * in {@code private} records.
 * Type is {@code int}.
 * Default value is {@code 8}.
 * </li>
 * <li>
 * Property {@code maxInPackageRecord} - Specify the maximum number of components allowed
 * in {@code package} records.
 * Type is {@code int}.
 * Default value is {@code 8}.
 * </li>
 * <li>
 * Property {@code maxInProtectedRecord} - Specify the maximum number of components allowed
 * in {@code protected} records.
 * Type is {@code int}.
 * Default value is {@code 8}.
 * </li>
 * <li>
 * Property {@code maxInPublicRecord} - Specify the maximum number of components allowed
 * in {@code public} records.
 * Type is {@code int}.
 * Default value is {@code 8}.
 * </li>
 * </ul>
 ...
 * <pre>
 * &lt;module name="RecordComponentNumber"&gt;
 *   &lt;property name="maxInPrivateRecord" value="5"/&gt;
 *   &lt;property name="maxInPublicRecord" value="5"/&gt;
 *   &lt;property name="maxInPackageRecord" value="5"/&gt;
 *   &lt;property name="maxInProtectedRecord" value="5"/&gt;
 * &lt;/module&gt;
 * </pre>
 * <p>
 * Java code example:
 ...
 * <pre>
 * &lt;module name="RecordComponentNumber"&gt;
 *   &lt;property name="maxInPrivateRecord" value="3"/&gt;
 *   &lt;property name="maxInPublicRecord" value="10"/&gt;
 * &lt;/module&gt;
 * </pre>
 * <p>
 * Java code example:
...
public class RecordComponentNumberCheck extends AbstractCheck {
    ...
    /** Specify the maximum number of components allowed in {@code private} records. */
    private int maxInPrivateRecord = DEFAULT_MAX_COMPONENTS;
    /** Specify the maximum number of components allowed in {@code package} records. */
    private int maxInPackageRecord = DEFAULT_MAX_COMPONENTS;
    /** Specify the maximum number of components allowed in {@code protected} records. */
    private int maxInProtectedRecord = DEFAULT_MAX_COMPONENTS;
    /** Specify the maximum number of components allowed in {@code public} records. */
    private int maxInPublicRecord = DEFAULT_MAX_COMPONENTS;

    /**
     * Setter to specify the maximum number of components allowed in {@code private} records.
     *
     * @param value the maximum allowed.
     */
    public void setMaxInPrivateRecord(int value) {
        maxInPrivateRecord = value;
    }

    /**
     *  Setter to specify the maximum number of components allowed in {@code package} records.
     *
     * @param value the maximum allowed.
     */
    public void setmaxInPackageRecord(int value) {
        maxInPackageRecord = value;
    }

    /**
     *  Setter to specify the maximum number of components allowed in {@code protected} records.
     *
     * @param value the maximum allowed.
     */
    public void setmaxInProtectedRecord(int value) {
        maxInProtectedRecord = value;
    }

    /**
     *  Setter to specify the maximum number of components allowed in {@code public} records.
     *
     * @param value the maximum allowed.
     */
    public void setmaxInPublicRecord(int value) {
        maxInPublicRecord = value;
    }
    ...
    private void checkCounter(ComponentCounter counter, DetailAST ast) {
        ...
        if (scope == Scope.PRIVATE) {
            checkMax(maxInPrivateRecord, counter.getTotal(),
                    MSG_PRIVATE_COMPONENTS, ast);
        }
        else if (scope == Scope.PUBLIC) {
            checkMax(maxInPublicRecord, counter.getTotal(),
                    MSG_PUBLIC_COMPONENTS, ast);
        }
        else if (scope == Scope.PROTECTED) {
            checkMax(maxInProtectedRecord, counter.getTotal(),
                    MSG_PROTECTED_COMPONENTS, ast);
        }
        else {
            checkMax(maxInPackageRecord, counter.getTotal(),
