 ...
 * dependency would be to write the Javadoc comment as {@code {&#64;link java.util.Set}}.
 * </li>
 * </ul>
 *
 * <p>
...
public class UnusedImportsCheck extends AbstractJavadocCheck {
    ...
    private void processReference(DetailNode ast) {
        ...
        final DetailNode memberReference =
                JavadocUtil.findFirstToken(ast, JavadocCommentsTokenTypes.MEMBER_REFERENCE);
