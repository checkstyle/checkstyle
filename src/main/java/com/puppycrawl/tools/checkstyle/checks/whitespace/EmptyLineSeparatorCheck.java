        ...
        if (lineNo >= number) {
            ...
            if (token.findFirstToken(TokenTypes.TYPE) != null) {
                ...
                if (beginningCommentBlock != null) {
                    final String commentBlockPrePreviousLine = getLine(beginningCommentBlock.getLineNo() - 3);
                    if (commentBlockPrePreviousLine != null) {
    ...
    private boolean hasEmptyLineBefore(DetailAST token) {
        ...
        if (lineNo != 1) {
            ...
            if (token.findFirstToken(TokenTypes.TYPE) != null) {
                ...
                if (beginningCommentBlock != null) {
                    final String commentBlockLineBefore = getLine(beginningCommentBlock.getLineNo() - 2);
                    if (commentBlockLineBefore != null) {
