 ...
 * </pre>
 * <p>
 * Partial not supported for operator precedence includes cases of the following type:
 * </p>
 * <pre>
 * if ((a &amp; d) | b) {} // violation, unnecessary paren
 * if ((a | d) &amp; c) {} // ok
 * if(f&gt;= 0 &amp; (f&lt;=8 ^ g&lt;=11) &amp; g&gt;=8) { } // ok
 * if(f&gt;= 0 | (f&lt;=8 ^ g&lt;=11) | g&gt;=8) { } // violation, unnecessary paren
 * </pre>
 * <ul>
 * <li>
