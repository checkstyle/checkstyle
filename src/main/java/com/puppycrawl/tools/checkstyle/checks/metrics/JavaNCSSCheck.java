...
public class JavaNCSSCheck extends AbstractCheck {
    ...
    private static final int RECORD_MAX_NCSS = 500;
    ...
    public void visitToken(DetailAST ast) {
        ...
        if (tokenType == TokenTypes.CLASS_DEF
            ...
            || isMethodOrCtorDefinition(tokenType)) {
    ...
    public void leaveToken(DetailAST ast) {
        ...
        if (tokenType == TokenTypes.STATIC_INIT
            || tokenType == TokenTypes.INSTANCE_INIT
            || isMethodOrCtorDefinition(tokenType)) {
     ...
     */
    private static boolean isMethodOrCtorDefinition(int tokenType) {
