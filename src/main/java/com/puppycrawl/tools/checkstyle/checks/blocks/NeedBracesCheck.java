...
public class NeedBracesCheck extends AbstractCheck {
    ...
    private static boolean isSingleLineStatement(DetailAST statement) {
        ...
        switch (statement.getType()) {
            ...
            case TokenTypes.LITERAL_WHILE:
                ...
                break;
            case TokenTypes.LAMBDA:
                result = !isSwitchRuleLambda(statement)
    ...
    private static boolean isSingleLineSwitchMember(DetailAST statement) {
        final boolean isInSwitchRule =
            statement.getParent().getType() == TokenTypes.SWITCH_RULE;
        final boolean result;
    ...
    /**
     * Helper method to get last sibling of an ast.
     *
     * @param ast the ast to find the last sibling of
     * @return last sibling of the ast
     */
    public static DetailAST getLastSibling(DetailAST ast) {
        DetailAST lastSibling = ast.getNextSibling();
