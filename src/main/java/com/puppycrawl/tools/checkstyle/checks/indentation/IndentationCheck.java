 ...
 * <ul>
 * <li>
 * Property {@code arrayInitIndent} - Specify how far an array initialize
...
public class IndentationCheck extends AbstractCheck {
    ...
    /** Specify how far an array initialize should be indented when on next line. */
    ...
    /**
     * Setter to specify how far an array initialize should be indented when on next line.
     *
     * @param arrayInitIndent the array initialize indentation level
     * @since 5.8
     */
    ...
    /**
     * Getter to query how far an array initialize should be indented when on next line.
     *
     * @return the initialize indentation level
     */
