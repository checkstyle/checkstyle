...
public class ArrayBracketNoWhitespaceCheck extends AbstractCheck {
     ...
     * are visited: siblings on a later line are skipped and set an
     * {@code outOfLine} flag; siblings on the same line are passed to
     * {@link #findBestCandidate}. Once a later-line sibling is found at any
     * level the climb stops immediately, since no ancestor sibling can be on
     * the target line either. The candidate with the smallest qualifying
     * column is returned.
     *
    ...
    private static DetailAST findBestCandidate(DetailAST candidate,
