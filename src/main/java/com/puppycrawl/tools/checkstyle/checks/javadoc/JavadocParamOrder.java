...
public class JavadocParamOrder extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
        ...
        method1(methodParams, methodTypeParams, javadocParams);
    }
     ...
     */
    private void method1(final List<DetailAST> methodParams,
                                final List<DetailAST> params,
                         final List<JavadocTag> javadocParams) {

        final int totalMethodParamSize = methodParams.size() + params.size();
        //Merge both lists
