...
public class UnnecessaryFullyQualifiedTypeCheck extends AbstractCheck {
     ...
     * @return {@code true} if one of the matching references resolves to the same
     *     type an unqualified reference to this simple name would resolve to
     */
    private boolean addQualifiedReferenceIdentities(String simpleName, Set<String> identities) {
        ...
        return unqualifiedResolvedToReference;
    }
    ...
    private void addImplicitIdentities(String simpleName,
            boolean unqualifiedResolvedToReference, Set<String> identities) {
    ...
    private String resolveViaOnDemandImport(String simpleName) {
        ...
        for (String onDemandPackage : onDemandImportPackages) {
            try {
                final String candidate = onDemandPackage + "." + simpleName;
                Class.forName(candidate, false,
                        UnnecessaryFullyQualifiedTypeCheck.class.getClassLoader());
                resolved = candidate;
                break;
            }
