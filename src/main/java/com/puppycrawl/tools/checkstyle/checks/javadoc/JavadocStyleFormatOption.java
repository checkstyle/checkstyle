...
public enum JavadocStyleFormatOption {
    ...
    /**
     * Determines whether traditional {@code /**} Javadoc comments should be checked
     * for this format option.
     *
     * @return {@code true} when traditional comments should be checked.
     */
    public boolean shouldCheckTraditionalJavadocs() {
