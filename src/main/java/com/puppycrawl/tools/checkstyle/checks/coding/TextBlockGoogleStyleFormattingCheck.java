...
public final class TextBlockGoogleStyleFormattingCheck extends AbstractCheck {
    ...
    private static DetailAST createViolationAst(
        ...
        return new ViolationDetailAst(lineNo, columnNo);
    }
    ...
    /**
     * Minimal AST node used for synthetic logging locations.
     */
    private static final class ViolationDetailAst implements DetailAST {
        ...
        /**
         * Constructs a synthetic AST node.
         *
         * @param pLineNo the line number
         * @param pColumnNo the column number
         */
        private ViolationDetailAst(final int pLineNo, final int pColumnNo) {
            lineNo = pLineNo;
            columnNo = pColumnNo;
        }
