 ...
 * </p>
 * <p>
 * It is better to define custom messages for violations to explain what is not allowed and what to
 * use instead, default message might be too abstract. To customize a message you need to
 ...
 *  &lt;message key=&quot;matchxpath.match&quot;
 *  value=&quot;Parameterized constructors are not allowed, there should be only default ctor&quot;/&gt;
 * &lt;/module&gt;
 * </pre>
 * <p>
 * Example:
