...
public class RightCurlyCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
        ...
        if (rcurly != null) {
            ...
            if (!violation.isEmpty()) {
                if (MSG_KEY_LINE_BREAK_AFTER.equals(violation)) {
    ...
    private static final class Details {
        ...
        private static boolean checkIfAncestorIsVariableDef(DetailAST ast) {
            ...
            if (nextToken != null) {
                final DetailAST ancestorVariableDef = nextToken.getParent();
                conditionChecker = TokenTypes.SEMI == nextToken.getType()
                                    && TokenTypes.VARIABLE_DEF == ancestorVariableDef.getType();
            }
