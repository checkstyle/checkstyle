...
public class UnusedLocalMethodCheck extends AbstractCheck {
     ...
     */
    private final Map<String, DetailAST> definitions = new HashMap<>();

    /**
     * Overall calls.
     */
    private final Collection<String> calls = new ArrayList<>();
    ...
    public void visitToken(DetailAST ast) {
        if (ast.getType() == TokenTypes.METHOD_DEF
            ...
            definitions.put(ast.findFirstToken(TokenTypes.IDENT).getText(), ast);
        }
    ...
    public void finishTree(DetailAST ast) {
        for (Map.Entry<String, DetailAST> entry : definitions.entrySet()) {
            if (!calls.contains(entry.getKey())) {
