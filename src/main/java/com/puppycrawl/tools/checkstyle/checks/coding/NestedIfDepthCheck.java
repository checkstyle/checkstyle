 ...
 * if (true) {
 *     if (true) {
 *         if (true) { // Nested if-else depth is 2 (max allowed is 1)
 *         }
 *     }
 * }
 * </pre>
 ...
 *       if (true) {
 *          if (true) {
 *             if (true) { // Nested if-else depth is 4 (max allowed is 3).
 *                if (true) {} // Nested if-else depth is 5 (max allowed is 3).
 *                else {}
 *             }
 *          }
 *       }
