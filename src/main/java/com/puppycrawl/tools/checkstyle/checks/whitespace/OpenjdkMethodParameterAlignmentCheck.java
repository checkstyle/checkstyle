 ...
 *
 * <p>
 * Only the parameters that start a new line are checked, so a declaration in which no
 * parameter starts a new line is ignored, be it because every parameter fits on the line the
 * declaration starts on, or because the declaration is wrapped inside a parameter type rather
 * than between two parameters.
 * </p>
 *
 * @since 14.2.0
 */
