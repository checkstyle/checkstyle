...
public class PatternVariableAssignmentCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
        ...
        if (!patternVariablesArray.isEmpty()) {
            ...
            DetailAST ifStatementSlist = ast.getParent().getParent()
            ...
            for (DetailAST expressionToken = ifStatementSlist.findFirstToken(TokenTypes.EXPR);
                ...
                if (expressionToken.getType() == TokenTypes.EXPR) {
                    ...
                    if (assignToken != null) {
                        DetailAST assignedVariableIdent = assignToken.findFirstToken(TokenTypes.IDENT);
                        ...
                        for (DetailAST patternVariableAST : patternVariablesArray) {
                            ...
                            if (assignedVariableIdent.getText().equals(patternVariableIdent.getText())) {
                              log(assignedVariableIdent.getLineNo(), assignToken.getColumnNo(), MSG_KEY,
