...
public class PatternVariableAssignmentCheck extends AbstractCheck {
  ...
  public void visitToken(DetailAST ast) {
    ...
    if (patternVariableDefToken != null) {
      DetailAST comparedIndentName = patternVariableDefToken.findFirstToken(TokenTypes.IDENT);

    if (recordPatternDefToken != null) {
      DetailAST comparedRecord = recordPatternDefToken.findFirstToken(TokenTypes.RECORD_PATTERN_COMPONENTS);
