...
public class InappropriateJavadocBlockTagsOnFieldCheck extends AbstractJavadocCheck {
    ...
    public void visitJavadocToken(DetailNode ast) {
        ...
        switch (ast.getType()) {
            case JavadocCommentsTokenTypes.AUTHOR_BLOCK_TAG -> tagName = "author";
            case JavadocCommentsTokenTypes.VERSION_BLOCK_TAG -> tagName = "version";
            ...
            case JavadocCommentsTokenTypes.USES_BLOCK_TAG -> tagName = "uses";
            case JavadocCommentsTokenTypes.PROVIDES_BLOCK_TAG -> tagName = "provides";
