...
public class VariableDeclarationUsageDistanceCheck extends AbstractCheck {
     ...
     * @param isInitialMethodCalledWithInstance whether the initial method is called with an
     *                                          instance or not
    ...
    private static boolean isInitialMethodCalledWithInstance(boolean isFirstMethodCallToBeExamined,
        boolean isInitialMethodCalledWithInstance, DetailAST methodCallIdent) {
        boolean result = isInitialMethodCalledWithInstance;
