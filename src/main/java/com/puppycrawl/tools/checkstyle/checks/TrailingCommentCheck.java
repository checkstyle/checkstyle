...
public class TrailingCommentCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
        ...
        else if (!isAnotherCommentInSameLine(ast)) {
     ...
     */
    private static boolean isAnotherCommentInSameLine(DetailAST ast) {
     ...
     */
    private static boolean isAnotherSingleLineCommentOnSameLine(DetailAST ast) {
     ...
     */
    private static boolean isAnotherBlockCommentOnSameLine(DetailAST ast) {
