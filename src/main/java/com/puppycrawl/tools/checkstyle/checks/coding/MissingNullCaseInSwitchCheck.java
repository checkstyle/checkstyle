...
public class MissingNullCaseInSwitchCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
        ...
        if (!hasNullCaseLabel && (hasPatternCaseLabel || hasStringCaseLabel)) {
            log(ast, MSG_KEY);
        }
    }
    ...
    private static List<DetailAST> getAllCaseLabels(DetailAST detailAST) {
        ...
        DetailAST ast = detailAST.getFirstChild();
        while (ast != null) {
     ...
     */
    private static boolean hasLiteralNull(DetailAST caseLabel) {
        return Optional.ofNullable(caseLabel.findFirstToken(TokenTypes.EXPR))
     ...
     */
    private static boolean hasPatternCaseLabel(DetailAST caseLabel) {
       return caseLabel.findFirstToken(TokenTypes.RECORD_PATTERN_DEF) != null
     ...
     */
    private static boolean hasStringCaseLabel(DetailAST caseLabel) {
            return hasStringLiteral(caseLabel)
