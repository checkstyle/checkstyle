 ...
 * using lowercase letters (for example prefixes : {@code 0x, 0b},
 * infixes : {@code e, p}, suffixes : {@code f, d}).
 ...
 * <p><b>ATTENTION:</b></p>
 *
 * <p>This check ignores the {@code L} suffix for long literals,
 * as using an uppercase {@code L} is a widely accepted and recommended
 * practice to avoid confusion with the digit {@code 1}.</p>
 *
 * @since 13.2.0
 */
@StatelessCheck
public class NumericalPrefixesInfixesSuffixesCharacterCaseCheck extends AbstractCheck {
     ...
     * file.
     */
    public static final String MSG_PREFIX = "numerical.literal.prefix";

    /**
     * A key is pointing to the warning message text in "messages.properties"
     * file.
     */
    public static final String MSG_INFIX = "numerical.literal.infix";
    ...
    public void visitToken(DetailAST ast) {
        ...
        else if (!isHex && text.contains("E") || text.contains("P")) {
            log(ast, MSG_INFIX);
        }
