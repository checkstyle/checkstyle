        ...
        try {
            ...
            while (foundMatch) {
                ...
                if (currentMatches > options.getMaximum()) {
                    ...
                    // IMPORTANT: Message still shows the PATTERN, not captured text
