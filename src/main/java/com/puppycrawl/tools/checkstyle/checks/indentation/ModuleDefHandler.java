...
public class ModuleDefHandler extends BlockParentHandler {
    ...
    protected DetailAST getListChild() {
        return getMainAst().findFirstToken(TokenTypes.DIRECTIVE_BLOCK);
    }
    ...
    private void checkAnnotations() {
        ...
        final DetailAST firstAnnotation = annotations.getFirstChild();
        final int firstAnnotationLine = firstAnnotation.getLineNo();

        for (DetailAST annotation = firstAnnotation;
             annotation != null && annotation.getLineNo() == firstAnnotationLine;
