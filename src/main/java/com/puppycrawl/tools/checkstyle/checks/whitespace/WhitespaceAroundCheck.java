...
public class WhitespaceAroundCheck extends AbstractCheck {
     ...
     */
    private boolean isAnonymousInnerClassEnd(int currentType, char nextChar) {
        final boolean result;
        if (allowWhitespaceAroundArrayInit && currentType == TokenTypes.RCURLY
                && nextChar == ',') {
            result = false;
        }
        else if (currentType == TokenTypes.RCURLY && (nextChar == ')'
