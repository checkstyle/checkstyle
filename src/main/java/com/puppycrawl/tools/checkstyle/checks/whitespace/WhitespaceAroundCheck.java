 ...
 * and {@code allowEmptySwitchCase} properties.
 * </p>
 * <p>
 ...
 * </li>
 * <li>
 * Property {@code allowEmptySwitchCase} - Allow empty switch case and default bodies.
 * Type is {@code boolean}.
 * Default value is {@code false}.
 * </li>
 * <li>
...
public class WhitespaceAroundCheck extends AbstractCheck {
    ...
    private boolean allowEmptySwitchCase;
    /**
     ...
     * @since 10.18.2
     */
    public void setAllowEmptySwitchCase(boolean allow) {
        allowEmptySwitchCase = allow;
    }
    ...
    private boolean isEmptyBlock(DetailAST ast, int parentType) {
        return isEmptyMethodBlock(ast, parentType)
                ...
                || isEmptySwitchCaseOrDefault(ast);
    }
     ...
     */
    private boolean isEmptySwitchCaseOrDefault(DetailAST ast) {
        final DetailAST parent = ast.getParent();
        ...
        return allowEmptySwitchCase && (isEmptyCaseInSwitchRule
