...
public class WhitespaceAroundCheck extends AbstractCheck {
    ...
    private boolean isNotRelevantSituation(DetailAST ast, int currentType) {
        ...
        return starImportOrSlistInsideCaseGroup
                ...
                || isArrayInitWithoutWhitespaceAround(currentType, parentType);
    }
    ...
    /**
     * Is array initialization without whitespace around the array.
     *
     ...
     */
    private boolean isArrayInitWithoutWhitespaceAround(int currentType, int parentType) {
