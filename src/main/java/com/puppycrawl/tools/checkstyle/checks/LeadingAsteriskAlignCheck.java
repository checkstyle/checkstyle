...
public class LeadingAsteriskAlignCheck extends AbstractCheck {
    ...
    /** Sets the alignment direction of the asterisk. */
    private String option = LeadingAsteriskAlignOption.RIGHT.toString();

    /**
     * Setter to sets the alignment direction of the asterisk.
     *
     * @param alignment whether asterisk alignment should be left or right
     * @since 10.15
     */
    public void setOption(String alignment) {
        option = LeadingAsteriskAlignOption.valueOf(alignment.trim().toUpperCase(Locale.ENGLISH)).toString();
    }
     ...
     */
    private static int getColumnForCommentBegin(String line) {
        int columnNumber = -1;
        int spaces = 0;
        char[] charLine = line.toCharArray();
