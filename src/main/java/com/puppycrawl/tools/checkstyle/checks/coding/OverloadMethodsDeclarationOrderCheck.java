...
public class OverloadMethodsDeclarationOrderCheck extends AbstractCheck {
     ...
     * Immutable singleton.
     */
    private static final OverloadGroup DEFAULT_OVERLOAD_GROUP =
        new DefaultOverloadGroup();

    /**
     * An ordered by insertion set of {@link OverloadGroup}.
     */
    private Set<OverloadGroup> overloadGroups;
    ...
    /**
     * @return an ordered by insertion set of {@link OverloadGroup}.
     */
    ...
    public void setModifierGroups(String modifierGroupRegex) {
        Arrays.stream(modifierGroupRegex.split(",")).forEach(modifierGroup -> {
            final RegexOverloadGroup regexOverloadGroup =
                new RegexOverloadGroup(modifierGroup.trim());
            overloadGroups.add(regexOverloadGroup);
        });
    }
    ...
    private void checkOverloadMethodsGrouping(DetailAST objectBlock) {
        ...
        while (currentToken != null) {
            if (currentToken.getType() == TokenTypes.METHOD_DEF) {
                currentIndex++;
                final OverloadDescriptor methodKey = extractMethodName(currentToken, currentIndex);
     ...
     */
    private OverloadDescriptor extractMethodName(DetailAST currentToken, int index) {
     ...
     */
    private interface OverloadGroup {
        /**
         * @return pattern string by which the {@link OverloadGroup} is matched.
         */
        String pattern();

        /**
         * @param modifiers raw modifier text of candidate overloaded method to be tested.
         * @return true if belong to {@link OverloadGroup}
         */
        boolean matches(String modifiers);
    }

    /**
     * The default catch all overload group, Immutable and Stateless.
     */
    private static final class DefaultOverloadGroup implements OverloadGroup {

        @Override
        public String pattern() {
            return DEFAULT_OVERLOAD_GROUP_PATTERN;
        }
     ...
     */
    private static final class RegexOverloadGroup implements OverloadGroup {
        /**
         ...
         *                     to {@link Pattern} with which this {@link RegexOverloadGroup}
         *                     is defined.
         */
        ...
        public boolean equals(Object o) {
            ...
            final RegexOverloadGroup that = (RegexOverloadGroup) o;
    ...
    private static final class OverloadDescriptor {
        ...
        public boolean equals(final Object o) {
            ...
            final OverloadDescriptor that = (OverloadDescriptor) o;
            return Objects.equals(overloadGroup, that.overloadGroup)
     ...
     */
    private static final class LastInStore<T extends Object> {
        /**
