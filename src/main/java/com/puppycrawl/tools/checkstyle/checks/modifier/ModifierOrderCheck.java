...
public class ModifierOrderCheck
     ...
     * Based on: {@code https://cr.openjdk.org/~alundblad/styleguide/index-v6.html#toc-modifiers}
     */
     ...
     */
    private static final Set<String> ALL_VALID_MODIFIERS = Set.of(DEFAULT_ORDER);
