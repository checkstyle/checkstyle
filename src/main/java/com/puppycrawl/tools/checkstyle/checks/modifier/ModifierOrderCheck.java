...
public class ModifierOrderCheck
    ...
    /**
     * The resolved modifier order array based on the modifierOrder property.
     */
    private String[] modifierOrderArray = DEFAULT_ORDER;
    ...
    public void setModifierOrder(String modifierOrder) {
        this.modifierOrderArray = resolveModifierOrder(modifierOrder);
    }
    ...
    private DetailAST checkOrder(List<DetailAST> modifiers) {
        ...
        if (modifier.getType() != TokenTypes.ANNOTATION) {
            ...
            while (modifier != null
                ...
                while (index < modifierOrderArray.length
                       && !modifierOrderArray[index].equals(modifier.getText())) {
                    index++;
                }

                if (index == modifierOrderArray.length) {
                    offendingModifier = modifier;
                }
