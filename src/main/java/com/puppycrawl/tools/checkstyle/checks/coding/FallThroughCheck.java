...
public class FallThroughCheck extends AbstractCheck {
    ...
    private boolean hasFallThroughComment(DetailAST currentCase) {
        ...
        final boolean reliefComment = isReliefComment(reliefPattern, commentContent);
    ...
    private static boolean commentAsChildOfSameGroup(Pattern reliefPattern,
        ...
        return isReliefComment(reliefPattern, commentContent);
    }
     ...
     */
    private static boolean isReliefComment(Pattern reliefPattern, List<DetailAST> commentList) {
