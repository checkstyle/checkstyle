...
public class FallThroughCheck extends AbstractCheck {
    ...
    private boolean hasFallThroughComment(DetailAST currentCase) {
        ...
        final List<DetailAST> commentContent = getCommentContentNode(ast, lastAST);
    ...
    private static boolean commentAsChildOfSameGroup(Pattern reliefPattern,
        ...
        boolean reliefComment = false;
        final List<DetailAST> commentContent = getCommentContentNode(currentCase.getLastChild(),
     ...
     * @param lastNode last node to check
     * @return list of commentContent node
     */
    private static List<DetailAST> getCommentContentNode(DetailAST startNode, DetailAST lastNode) {
        final List<DetailAST> commentContentNode = new LinkedList<>();
        DetailAST node = startNode;
        while (true) {
