 ...
 * </ul>
 *
 * @noinspection HtmlTagCanBeJavadocTag, EscapedEntity
 * @noinspectionreason HtmlTagCanBeJavadocTag - we intentionally show {@code <code>} as example text
 * @noinspectionreason EscapedEntity - we intentionally show HTML entities as example text
 *
 * @since 13.4.0
 */
@StatelessCheck
@SuppressWarnings({"EscapedEntity", "UnrecognisedJavadocTag"})
