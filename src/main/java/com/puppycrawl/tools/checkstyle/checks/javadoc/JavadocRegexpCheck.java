...
public class JavadocRegexpCheck extends AbstractJavadocCheck {
     ...
     */
    private Pattern regexp = CommonUtil.createPattern(format);
    ...
    /**
     * Updates the regexp based on {@link #format} and {@link #ignoreCase}.
     */
    private void updateRegexp() {
        ...
        regexp = CommonUtil.createPattern(format, compileFlags);
    }
