...
*/
     ...
     * @param ast descr.
     */
    public void method(DetailAST ast) {
    ...
    private static boolean isEmptyTag(DetailNode tagNode) {
        final DetailNode tagDescription =
                JavadocUtil.findFirstToken(tagNode, JavadocTokenTypes.PARAM_LITERAL);
    ...
    */
    ...
    /**
     * Returns the tags in a javadoc comment. Only finds param tags.
     *
