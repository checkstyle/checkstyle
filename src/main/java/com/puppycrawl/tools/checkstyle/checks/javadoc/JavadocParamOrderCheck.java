...
public class JavadocParamOrderCheck extends AbstractJavadocCheck {
     ...
     * list itself before and returns hashMap of unique elements from javadoc param list.
     *
     * @param javadocParamsList list of javadoc parameters.
     * @param paramsList list of javadoc parameters.
     * @return hashMap of unique elements from javadoc param list with integer value.
     */
    ...
    private void checkParamOrder(DetailNode tagNode,
        ...
        final HashMap<String, Integer> intersectionMap = helperMethod(javadocParamsList,
            paramsList);
        checkAndLog(intersectionMap, javadocParamsList, javadocParamsLineNumList);
    }

    /**
     * Checks the order of method/type definitions and log violations.
     *
     * @param intersectionMap hashMap of unique elements from javadoc param list.
     * @param javadocParamsList list of method parameters.
     * @param javadocParamsLineNumList list of method type parameters.
     */
    private void checkAndLog(HashMap<String, Integer> intersectionMap,
                                               List<String> javadocParamsList,
