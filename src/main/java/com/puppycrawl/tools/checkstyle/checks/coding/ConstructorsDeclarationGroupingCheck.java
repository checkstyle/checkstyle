...
public class ConstructorsDeclarationGroupingCheck extends AbstractCheck {
     ...
     */
    private boolean ctorOccured;

    /**
     * Specifies the previous parent.
     */
    private DetailAST previousParent;
    ...
    public void visitToken(DetailAST ast) {
        ...
        if (!Objects.equals(parent, previousParent)) {
            ctorOccured = false;
        ...
        if (!isCtor && !isCompactCtor && ctorOccured) {
