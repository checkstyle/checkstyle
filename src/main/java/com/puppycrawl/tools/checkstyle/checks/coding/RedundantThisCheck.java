 ...
 * <ul>
 * <li>
 * {@code redundant.this.method}
 * </li>
 * <li>
 * {@code redundant.this.variable}
 * </li>
 * </ul>
 *
 * @since 8.32
...
public class RedundantThisCheck extends AbstractFrameCheck {
    ...
    private void processLiteralThis(DetailAST ast) {
        ...
        if (nextSibling != null && nextSibling.getType() == TokenTypes.IDENT) {
            ...
            if (parentType == TokenTypes.METHOD_CALL) {
                ...
                final String classFrameName = getNearestClassFrameName();
                final AbstractFrame shadowingFrame = findFrame(nextSibling, false);
                final AbstractFrame findClassFrame = findClassFrame(nextSibling, false);
    ...
    @Override
    public void collectDeclarations(Deque<AbstractFrame> frameStack, DetailAST ast) {
    ...
    @Override
    public void endCollectingDeclarations(Queue<AbstractFrame> frameStack, DetailAST ast) {
