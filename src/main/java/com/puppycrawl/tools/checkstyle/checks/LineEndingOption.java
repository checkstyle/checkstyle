...
public enum LineEndingOption {
     ...
     *
     * @param end the line separator, e.g. "\n"
     */
     ...
     * @return true if bytes is equal to the byte representation
     * of this line ending.
     */
    ...
    /**
     * Checks that value is equal to the byte representation of carriage return.
     * @param value a byte to check
     * @return true if value is equal to byte representation of carriage return.
     */
    public static boolean isCarriageReturn(byte value) {
        return value == CARRIAGE_RETURN;
    }
}
