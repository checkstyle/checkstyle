...
public class JavadocMethodCheck extends AbstractJavadocCheck {
    ...
    private static DetailAST getAttachedBlockCommentNode(final DetailAST ast) {
        ...
        final DetailAST annotation = modifier.findFirstToken(TokenTypes.ANNOTATION);
        final DetailAST typeParamenters = ast.findFirstToken(TokenTypes.TYPE_PARAMETERS);
        final DetailAST type = ast.findFirstToken(TokenTypes.TYPE);

        final DetailAST[] candidates = {
            modifier,
            annotation,
            typeParamenters,
            type,
        ...
        for (DetailAST candidate : candidates) {
            if (candidate != null) {
                final DetailAST comment = candidate.findFirstToken(TokenTypes.BLOCK_COMMENT_BEGIN);
