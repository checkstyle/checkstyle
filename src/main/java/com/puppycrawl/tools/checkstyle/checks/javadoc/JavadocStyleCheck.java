...
public class JavadocStyleCheck
    ...
    public TextBlock generateTextBlock(DetailAST comment) {
        ...
        if (comment == null) {
            ...
            final String lastSentence = comments[comments.length - 1].trim();
    ...
    public TextBlock getJavaDoc(DetailAST ast) {
        ...
        while (temp != null
                && (temp.getType() == TokenTypes.SINGLE_LINE_COMMENT
        ...
        while (temp != null) {
            ...
            if (temp.getType() == TokenTypes.COMMENT_CONTENT
                    && "/*".equals(temp.getParent().getText())) {
                final String commentText = temp.getText();
