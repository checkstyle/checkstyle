...
public class OperatorWrapCheck
     ...
     * <ul>
     *  <li>{@link TokenTypes#STAR} from wildcard imports</li>
     *  <li>{@link TokenTypes#COLON} from switch cases and defaults</li>
     * </ul>
     *
    ...
    private static boolean isOperatorNode(DetailAST node) {
        ...
        if (node.getType() == TokenTypes.COLON) {
            result = node.getParent().getType() == TokenTypes.QUESTION;
        }
