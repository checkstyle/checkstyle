...
public class NoWhitespaceBeforeCaseDefaultColonCheck
    ...
    public void visitToken(DetailAST ast) {
        ...
        if (isColonOfCase || isColonOfDefault) {
            final boolean areOnSameLine = TokenUtil.areOnSameLine(parent, ast);
            final boolean violation = !areOnSameLine
                    || isColonOfCase && checkWhitespaceBeforeColonOfCase(ast)
