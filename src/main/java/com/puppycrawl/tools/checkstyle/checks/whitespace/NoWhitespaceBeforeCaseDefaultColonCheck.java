...
public class NoWhitespaceBeforeCaseDefaultColonCheck
     ...
     */
    private boolean isWhiteSpaceBeforeColon(DetailAST colonAst) {
        ...
        return isColonOfCase && checkWhitespaceBeforeColonOfCase(colonAst)
                || isColonOfDefault && checkWhitespaceBeforeColonOfDefault(colonAst);
    }
