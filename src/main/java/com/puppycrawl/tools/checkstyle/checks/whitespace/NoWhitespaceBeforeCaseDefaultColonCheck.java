...
/**
 * <p>
 * Checks that there is no whitespace before the colon of a case/default.
 * </p>
 * <p>
...
public class NoWhitespaceBeforeCaseDefaultColonCheck
    ...
    /**
     * Checks if the colon is on different line as of case or default.
     *
     * @param colonAst DetailAST to check.
    ...
    private static boolean isOnDifferentLineWithPreviousToken(DetailAST colonAst) {
        ...
        if (parent.getType() == TokenTypes.LITERAL_CASE) {
            final DetailAST previousParent = colonAst.getPreviousSibling();
            previousSibling = previousParent.getLastChild();
        }
        else {
