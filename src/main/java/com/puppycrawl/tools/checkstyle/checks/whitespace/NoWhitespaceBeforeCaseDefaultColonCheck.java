...
public class NoWhitespaceBeforeCaseDefaultColonCheck
     ...
     */
    private static boolean whitespaceDetectedBeforeColonOfCase(DetailAST colonAst) {
     ...
     * @return whether there is a whitespace before colonAst or not.
     */
    private static boolean whitespaceDetectedBeforeColonOfDefault(DetailAST colonAst) {
