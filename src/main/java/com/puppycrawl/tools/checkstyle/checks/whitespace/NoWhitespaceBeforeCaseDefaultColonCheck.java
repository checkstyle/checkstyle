 ...
 *         switch (day) {
 *             case MONDAY,
 *                     FRIDAY: numLetters = 6; // OK
 *                             break;
 *             case TUESDAY : numLetters = 7; // violation, whitespace before ':' is not allowed
 *                        break;
 *             case THURSDAY, SATURDAY
 *                     : numLetters = 8; // violation, ':' should not be in separate line
 *                          break;
 *             case WEDNESDAY,
 *                     SUNDAY : numLetters = 9; // violation, whitespace before ':' is not allowed
 *                           break;
 *         };
 *         return numLetters;
 *     }
