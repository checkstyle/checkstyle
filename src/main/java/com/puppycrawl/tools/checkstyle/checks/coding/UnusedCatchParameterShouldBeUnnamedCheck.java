...
public class UnusedCatchParameterShouldBeUnnamedCheck extends AbstractCheck {
    ...
    public void leaveToken(DetailAST ast) {
        final CatchParameterDetails catchParameter = catchParameters.peekLast();
     ...
     * @return true if the given {@link TokenTypes#IDENT} is a catch parameter ident candidate
     */
    private static boolean isCatchParameterIdentifierCandidate(DetailAST identAST) {
    ...
    private static final class CatchParameterDetails {
        ...
        private CatchParameterDetails(DetailAST enclosingCatchClause) {
            ...
            parameterDefinition = enclosingCatchClause.findFirstToken(TokenTypes.PARAMETER_DEF);
            name = this.parameterDefinition.findFirstToken(TokenTypes.IDENT).getText();
        }
