...
public class UnusedCatchParameterShouldBeUnnamedCheck extends AbstractCheck {
    ...
    public void leaveToken(DetailAST ast) {
        final CatchParameterDetails catchParameter = catchParameters.peek();
    ...
    private static boolean isCatchParameterIdentifierCandidate(DetailAST identAST) {
        ...
        final boolean isCatchParameterDeclaration = identAST.getParent().getParent()
                                                .getType() == TokenTypes.LITERAL_CATCH;
        final boolean hasValidParentToken = !TokenUtil.isOfType(identAST.getParent(),
                                                    INVALID_CATCH_PARAM_IDENT_PARENTS);
        final boolean isMethodInvocation = shouldCheckDotChild(identAST);
