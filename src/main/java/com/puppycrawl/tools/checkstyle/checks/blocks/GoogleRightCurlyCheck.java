...
public class GoogleRightCurlyCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
        ...
        switch (ast.getType()) {
            case TokenTypes.CLASS_DEF, TokenTypes.INTERFACE_DEF,
                ...
                rightCurly = NullUtil.notNull(child.findFirstToken(TokenTypes.RCURLY));
            }
    ...
    private static boolean hasContentOnRightSide(DetailAST brace, DetailAST nextToken) {
        final boolean nextIsValid = TokenUtil.isOfType(nextToken.getPreviousSibling(),
                TokenTypes.EXPR, TokenTypes.VARIABLE_DEF, TokenTypes.ELIST, TokenTypes.LAMBDA)
