...
public class MagicNumberCheck extends AbstractCheck {
    ...
    /**
     * Tokens that are allowed in the AST path from the
     * number literal to the enclosing constant definition.
     */
    private static final int[] DEFAULT_CONSTANT_WAIVER_PARENT_TOKENS = {
        TokenTypes.ASSIGN,
    ...
    private final BitSet constantWaiverParentToken = new BitSet();
    ...
    public MagicNumberCheck() {
        Arrays.stream(DEFAULT_CONSTANT_WAIVER_PARENT_TOKENS)
                .forEach(constantWaiverParentToken::set);
    }
    ...
    public void setConstantWaiverParentToken(String... tokens) {
        constantWaiverParentToken.clear();
