 ...
 * <ul>
 * <li>
 * {@code First line} - Javadoc content starts from the first line:
 * <pre>
 * &#47;** Summary text.
 *   * More details.
 *   *&#47;
 ...
 * </li>
 * <li>
 * {@code Second line} - Javadoc content starts from the second line:
 * <pre>
 * &#47;**
 *   * Summary text.
 *   * More details.
 ...
 */
@StatelessCheck
public class JavadocContentLocationCheck extends AbstractJavadocCheck {
     ...
     */
    private JavadocContentLocation location = JavadocContentLocation.SECOND_LINE;
    ...
    public void visitJavadocToken(DetailNode ast) {
        if (isMultilineComment(ast)) {
            ...
            if (blankLines >= 0) {
                if (location == JavadocContentLocation.FIRST_LINE) {
                    if (blankLines != 0) {
                        log(ast.getLineNumber(), MSG_JAVADOC_CONTENT_FIRST_LINE);
                    }
                }
                else if (blankLines != 1) {
                    log(ast.getLineNumber(), MSG_JAVADOC_CONTENT_SECOND_LINE);
                }
            }
        }
    }
    ...
    public void setLocation(String value) {
        location = JavadocContentLocation.valueOf(value.trim().toUpperCase(Locale.ENGLISH));
    }
