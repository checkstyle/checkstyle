...
public class SummaryJavadocCheck extends AbstractJavadocCheck {
     ...
     * file.
     */
    public static final String MSG_INLINERETURN_JAVADOC = "inlineReturn.javaDoc";
    ...
    private boolean handleInlineTagNode(DetailNode ast, DetailNode inlineTagNode) {
        ...
        if (isSummaryTag(inlineTagNode)) {
            ...
            if (!allowInlineReturn) {
                log(ast.getLineNumber(), MSG_INLINERETURN_JAVADOC);
            }
    ...
    private void validateInlineReturnTag(DetailNode ast) {
        final String inlineReturn = getInlineTagContent(INLINE_RETURN_PATTERN);
