...
public class SummaryJavadocCheck extends AbstractJavadocCheck {
    ...
    /**
     * Whether node of type {@link JavadocTokenTypes#JAVADOC} is to be checked.
     */
    private boolean checkJavadocToken = true;
     ...
     *
     * @return true if node of type {@link JavadocTokenTypes#JAVADOC} should be checked
     */
    private boolean shouldCheckJavadocToken() {
        return checkJavadocToken;
    }

    /**
     * Set whether node of type {@link JavadocTokenTypes#JAVADOC} is to be checked.
     *
     * @param checkJavadocToken true if node of type {@link JavadocTokenTypes#JAVADOC}
     *                          is to be checked
     */
    private void setCheckJavadocToken(boolean checkJavadocToken) {
        this.checkJavadocToken = checkJavadocToken;
    }
    ...
    public void leaveJavadocToken(DetailNode ast) {
        if (ast.getType() == JavadocTokenTypes.JAVADOC
            ...
            if (shouldCheckJavadocToken()) {
                checkJavadocTokenWhileLeaving(ast);
            }
            setCheckJavadocToken(true);
        }
    }
     ...
     * @param ast ast
     */
    private void checkJavadocTokenWhileLeaving(DetailNode ast) {
