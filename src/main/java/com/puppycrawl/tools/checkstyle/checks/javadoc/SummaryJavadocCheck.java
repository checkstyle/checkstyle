...
public class SummaryJavadocCheck extends AbstractJavadocCheck {
    ...
    /**
     * Checks if inline return tag present.
     *
     * @param javadoc javadoc root node.
     * @return {@code true} if first sentence contains return tag.
     */
    ...
    private static boolean isSummaryTag(DetailNode javadoc) {
        return isInlineTagWithName(javadoc, SUMMARY_TEXT);
    }

    /**
     * Checks if the first tag inside ast is return tag.
     *
     * @param javadoc root node.
     * @return {@code true} if first tag is return tag.
     */
    private static boolean isInlineReturnTag(DetailNode javadoc) {
        return isInlineTagWithName(javadoc, RETURN_TEXT);
    }
    ...
    /**
     * Checks the inline return for non-empty content and forbidden fragments.
     *
     * @param ast javadoc root node.
     */
