...
public class SummaryJavadocCheck extends AbstractJavadocCheck {
    ...
    private static boolean containsSummaryTag(DetailNode javadoc) {
        ...
        return summaryNode != null && isSummaryTag(summaryNode);
    }
    ...
    private static boolean isSummaryTag(DetailNode javadoc) {
        final DetailNode[] summaryNode = javadoc.getChildren();
        ...
        // RCURLY and LCURLY.
        return summaryNode[1].getType() == JavadocTokenTypes.CUSTOM_NAME
                && SUMMARY_TEXT.equals(summaryNode[1].getText());
    }
    ...
    private static boolean isSummaryTagWithinHtmlTag(DetailNode javadoc) {
        ...
        if (summaryNode != null) {
            contains = isSummaryTag(summaryNode);
        }
        return contains;
    }
