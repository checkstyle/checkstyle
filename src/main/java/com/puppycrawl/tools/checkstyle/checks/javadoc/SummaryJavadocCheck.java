...
public class SummaryJavadocCheck extends AbstractJavadocCheck {
    ...
    private static String getInlineFirstSentence(DetailNode ast) {
        ...
        for (DetailNode node : ast.getChildren()) {
            if (node.getType() == JavadocTokenTypes.JAVADOC_INLINE_TAG) {
                returnInlineFirstSentence(node, result, periodSuffix);
            }
        }
        return result.toString();
    }
     ...
     * @param result Inline summaryFirstSentence.
     * @param periodSuffix Period end in summary sentence.
     */
    public static void returnInlineFirstSentence(DetailNode node, StringBuilder result,
                                    String periodSuffix) {
