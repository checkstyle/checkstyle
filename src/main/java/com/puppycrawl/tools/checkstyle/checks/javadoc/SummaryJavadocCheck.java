...
public class SummaryJavadocCheck extends AbstractJavadocCheck {
    ...
    public void visitJavadocToken(DetailNode ast) {
        DetailNode inlineSummaryTag = getInlineSummaryTag(ast);
     ...
     *
     * @param inlineJavadocTag node of type {@link JavadocTokenTypes#JAVADOC_INLINE_TAG}
     * @return {@code true} if first tag is summary tag.
     */
    private static boolean isSummaryTag(DetailNode inlineJavadocTag) {
        final DetailNode[] child = inlineJavadocTag.getChildren();
