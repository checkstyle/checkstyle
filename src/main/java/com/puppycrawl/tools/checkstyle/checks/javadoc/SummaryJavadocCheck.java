...
public class SummaryJavadocCheck extends AbstractJavadocCheck {
     ...
     * result. If no period is present, append the whole string to the result. The end of sentence
     * detection here could be replaced in the future by Java's built-in BreakIterator class.
     *
