...
public class WriteTagCheck
     ...
     * @param ast the DetailAST instance for which the java doc comment is associated
     ...
     * @param col the column number where the violation was found
     * @param tagName the javadoc tag to be logged
     * @param tagValue the contents of the tag
     *
     * @see java.text.MessageFormat
     */
    private void logTag(int line, int col, String tagName, String tagValue) {
        final String originalSeverity = getSeverity();
        setSeverity(tagSeverity.getName());

        log(line, col, MSG_WRITE_TAG, tagName, tagValue);
