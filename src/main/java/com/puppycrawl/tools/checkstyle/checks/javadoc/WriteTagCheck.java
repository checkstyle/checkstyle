 ...
 * to be presend on classes javadoc.
 * </p>
 * <pre>
 * &lt;module name="WriteTag"&gt;
 ...
 * <p>
 * To configure Check to demand some special tag (for example {@code &#64;since})
 * to be presend on method javadocs also in addition to default tokens.
 * </p>
 * <pre>
 * &lt;module name="WriteTag"&gt;
 *   &lt;property name="tag" value="@since"/&gt;
 ...
 * to be presend with digital value on method javadocs also in addition to default tokens.
