...
/**
 * <p>
 * Checks if unnecessary null check is used before <code>instanceof</code> expression.
 * </p>
 * <ul>
 * <li>
...
public class NullBeforeInstanceOfCheck extends AbstractCheck {
    ...
    private String getText(DetailAST ast) {
     ...
     */
    private boolean checkOnNextLine(DetailAST ast) {
