...
public class UnusedTryResourceShouldBeUnnamedCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
            ...
            if (resourceSpec != null) {
                ...
                while (resource != null) {
                    if (resource.getType() == TokenTypes.RESOURCE) {
                        final TryResourceDetails tryResource = new TryResourceDetails(resource);
        ...
        else if (isTryResourceIdentifierCandidate(ast) && isNotPartOfAssignment(ast)) {
    ...
    /**
     * Check if the given {@link TokenTypes#IDENT} is not part of an assignment.
     *
     * @param identAst token representing {@link TokenTypes#IDENT}
     * @return true if the given {@link TokenTypes#IDENT} is not part of an assignment.
     */
    public static boolean isNotPartOfAssignment(DetailAST identAst) {
        return identAst.getParent().getType() != TokenTypes.ASSIGN;
    }
    ...
    private static final class TryResourceDetails {
         ...
         */
        private TryResourceDetails(DetailAST resource) {
