...
public class UnusedTryResourceShouldBeUnnamedCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
        ...
        else if (isTryResourceIdentifierCandidate(ast) && !isLeftHandOfAssignment(ast)){
     ...
     * and is a candidate for try resource.
     *
     ...
     *     and a candidate for try resource.
     */
    ...
    private static final class TryResourceDetails {
        ...
        private TryResourceDetails(DetailAST enclosingResourceSpec) {
            final DetailAST resourcesDefinition = enclosingResourceSpec.findFirstToken(TokenTypes.RESOURCES);
