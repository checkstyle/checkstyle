...
/**
 * <div>
 * Checks the padding policy for type bodies. Ensures that at least one blank line
 * is present immediately after the opening brace and/or immediately before the
 * closing brace of type definitions ({@code class}, {@code interface}, {@code enum},
