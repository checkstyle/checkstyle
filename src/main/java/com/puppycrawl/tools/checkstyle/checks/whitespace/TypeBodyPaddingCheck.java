 ...
 * <ul>
 * <li>
 * Property {@code starting} - require a blank line after the opening brace.
 * Type is {@code boolean}.
 * Default value is {@code true}.
 * </li>
 * <li>
 * Property {@code ending} - require a blank line before the closing brace.
 * Type is {@code boolean}.
 * Default value is {@code false}.
 * </li>
 * <li>
 * Property {@code allowEmpty} - skip enforcement for completely empty type bodies ({@code {}}).
 * Type is {@code boolean}.
 * Default value is {@code true}.
 * </li>
 * <li>
 * Property {@code skipInner} - whether to skip checking of inner types
 * Type is {@code boolean}.
 * Default value is {@code true}.
 * </li>
 * <li>
