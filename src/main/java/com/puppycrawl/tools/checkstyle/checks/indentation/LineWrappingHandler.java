...
public class LineWrappingHandler {
    ...
    private boolean isPreviousToPreviousSiblingAccessModifier(final DetailAST parentNode) {
        return parentNode.getPreviousSibling() != null
            ...
            && Set.of(TokenTypes.LITERAL_PUBLIC, TokenTypes.LITERAL_PRIVATE, TokenTypes.LITERAL_PROTECTED)
     ...
     * @param lastAnnotationLine is the line number of lastAnnotationNode.
