...
public class LineWrappingHandler {
    ...
    public void checkIndentation(DetailAST firstNode, DetailAST lastNode, int indentLevel,
        ...
        for (DetailAST node : firstNodesOnLines.values()) {
            // ArrayInitIndentation is used for array elements
     ...
     */
    private boolean noAnnotationParameter(DetailAST node) {
        return node.getType() == TokenTypes.AT
                && node.getParent().getType() == TokenTypes.ANNOTATION
                && node.getParent().getParent().getType() == TokenTypes.MODIFIERS
    ...
    private void checkFirstNodeOnLine(DetailAST node, int indentLevel, DetailAST previousLine,
        ...
        if (currentType == TokenTypes.RPAREN) {
            ...
            if (previousLine == null || isAnnotationOrLineAfterAnnotation(node, previousLine)) {
    ...
    private static boolean isAnnotationOrLineAfterAnnotation(DetailAST node,
        ...
        if (node.getType() == TokenTypes.AT) {
            ...
            result = previousLineNode.getType() == TokenTypes.AT;
        }
        return result;
    }
