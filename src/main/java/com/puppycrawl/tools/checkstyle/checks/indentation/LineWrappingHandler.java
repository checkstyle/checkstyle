...
public class LineWrappingHandler {
    ...
    public void checkIndentation(DetailAST firstNode, DetailAST lastNode, int indentLevel,
        ...
        for (DetailAST node : firstNodesOnLines.values()) {
            ...
            if (checkForNullParameterChild(node)) {
                continue;
            }
    ...
    /**
     * Checks whether the method lparen starts from a new line and   parameter node has any child
     * or not.
     *
     * @param node the node for which to check there is a child or not.
     * @return true if method lparen starts from a new line and parameter has no child
     */
    public static boolean checkForNullParameterChild(DetailAST node) {
        ...
        else if (parentType == TokenTypes.METHOD_DEF
