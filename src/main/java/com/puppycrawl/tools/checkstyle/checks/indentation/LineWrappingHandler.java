...
public class LineWrappingHandler {
    ...
    private int checkNestedWrappingIndent(DetailAST node, int currentIndent,
        ...
        if (indentCheck.isForceStrictCondition()
                && previousLineIndent > firstNodeIndent) {
            // This node follows a validly-wrapped line.
            // Allow it at currentIndent (single-wrap) OR at
            // previousLineIndent + indentLevel (legitimate nested
            // continuation, e.g. && inside a wrapped method arg).
