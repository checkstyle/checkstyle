 ...
 * Default value is {@code "0x2190-0x27BF, 0x1F600-0x1F64F, 0x1F680-0x1F6FF, 0x1F700-0x1FFFF"}.
 * </li>
 * </ul>
 *
 * @since 13.4.0
...
public class IllegalSymbolCheck extends AbstractCheck {
    ...
    private static final String DEFAULT_ILLEGAL_CODES =
        "0x2190-0x27BF, 0x1F600-0x1F64F, 0x1F680-0x1F6FF, 0x1F700-0x1FFFF";
    ...
    public void visitToken(DetailAST ast) {
        ast.getText().codePoints()
            .filter(this::isIllegalSymbol)
            .findFirst()
            .ifPresent(codePoint -> log(ast, MSG_KEY, Character.toString(codePoint)));
    }
