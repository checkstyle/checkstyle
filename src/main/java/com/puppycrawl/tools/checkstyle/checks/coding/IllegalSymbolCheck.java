 ...
 * Default value is {@code "0x2190-0x27BF, 0x1F600-0x1F64F, 0x1F680-0x1F6FF, 0x1F700-0x10FFFFF"}.
 * </li>
 * </ul>
 *
 * @since 13.1.0
...
public class IllegalSymbolCheck extends AbstractCheck {
    ...
    public void setSymbolCodes(String symbols) {
        ...
        if (!symbols.isEmpty()) {
            final String[] parts = symbols.split(",", -1);
    ...
    private static final class CodePointRange {
         ...
         */
        /* package */ CodePointRange(int start, int end) {
            this.start = start;
            this.end = end;
        }
