...
public class RedundantModifierCheck
    ...
    private final String JDK_21 = "21";

    /**
     * Set the JDK version that you are using.
     *
     */
    private String jdkVersion = JDK_21;
     ...
     */
    private enum JavaLanguageLevel {
         ...
         *
         * @param other the language level to compare
         * @return true if the current language level is greater than or equal
         */
        private boolean isGreaterThanOrEqual(JavaLanguageLevel other) {
