...
public class RedundantModifierCheck
    ...
    public void setJdkVersion(String jdkVersion) {
        final String singleNumberVersion;
        if (jdkVersion.startsWith("1.")) {
            singleNumberVersion = jdkVersion.substring(2);
        }
        else {
            singleNumberVersion = jdkVersion;
        }

        this.jdkVersion = Integer.parseInt(singleNumberVersion);
    }
