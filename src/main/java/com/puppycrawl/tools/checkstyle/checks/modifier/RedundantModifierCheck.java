 ...
 * instance which would silently add state to the record class.</p>
 *
...
public class RedundantModifierCheck
    ...
    public void visitToken(DetailAST ast) {
        ...
        else if (type == TokenTypes.RECORD_DEF) {
            checkRecordDef(ast);
        }
        else {
    ...
    /**
     * Check whether record has proper modifiers.
     *
     * @param recordDefAst ast node of type {@link TokenTypes#RECORD_DEF}
     */
    private void checkRecordDef(DetailAST recordDefAst) {
        checkForRedundantModifier(recordDefAst, TokenTypes.LITERAL_STATIC);
    }
