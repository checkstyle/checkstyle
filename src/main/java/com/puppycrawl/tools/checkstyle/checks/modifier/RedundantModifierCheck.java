 ...
 * </li>
 * <li>
 * Type declarations nested under {@code interface} or {@code @interface} declaration that
 * are declared as {@code public} or {@code static}.
 * </li>
 * <li>
 * Class constructors.
 * </li>
 ...
 * </ol>
 * <p>
 * {@code interface} and {@code @interface} declarations by definition are abstract
 * so the {@code abstract} modifier is redundant on them.
 * </p>
 * <p>Type declarations nested under {@code interface} or {@code @interface} declaration
 * by definition are public and static, so the {@code public} and {@code static} modifiers
