...
public class NullTestAroundInstanceOfCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
        ...
        if (landNode == null) {
            ...
            if (notEqualNode != null && instanceOfNode != null
                    ...
                    && getIdentText(notEqualNode).equals(getIdentText(instanceOfNode))) {
                log(ast, MSG_KEY);
            }
        }
    }
     ...
     */
    private static String getIdentText(DetailAST ast) {
    ...
    private static Boolean isTextEqual(DetailAST instanceOfNode, DetailAST notEqualNode) {
        boolean error = false;
        if (getIdentText(instanceOfNode).equals(getIdentText(notEqualNode))) {
            error = true;
        }
        return error;
    }
