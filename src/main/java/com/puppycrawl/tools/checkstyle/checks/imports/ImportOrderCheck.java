 ...
 * (e.g. {@code /regexp/}). If an import matches two or more groups, the best match is selected.
 ...
 * slashes (e.g. {@code /regexp/}). If an import matches two or more groups, the best match is
 * selected. All static imports, which does not match any group, fall into
