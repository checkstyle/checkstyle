 ...
 * (e.g. {@code /regexp/}). If an import matches two or more groups, the best match is selected. All type imports, which does not match any group, falls into an
 ...
 * slashes (e.g. {@code /regexp/}). If an import matches two or more groups, the best match is selected. All static imports, which does not match any group, fall into
...
public class ImportOrderCheck
     ...
     * common prefix string, or by a regular expression enclosed in forward slashes
     * (e.g. {@code /regexp/}). If an import matches two or more groups, the best match is selected. All static imports, which does not match any group, fall into an
