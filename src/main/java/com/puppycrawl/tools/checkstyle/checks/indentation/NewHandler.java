...
public class NewHandler extends AbstractExpressionHandler {
     ...
     *
     * @return true if the new it is chained method calls and new keyword is directly follwed
     *         by assign or return
     */
    private boolean doesChainedMethodNeedsLineWrapping() {
        ...
        if (TokenUtil.isOfType(ast, TokenTypes.ASSIGN, TokenTypes.LITERAL_RETURN)) {
            returnValue = true;
        }
