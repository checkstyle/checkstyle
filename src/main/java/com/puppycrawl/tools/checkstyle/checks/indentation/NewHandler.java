...
public class NewHandler extends AbstractExpressionHandler {
    ...
    protected IndentLevel getIndentImpl() {
        ...
        if (getLineStart(mainAst) == mainAst.getColumnNo()) {
            ...
            final boolean isLineWrappedNew = TokenUtil.isOfType(mainAst.getParent().getParent(),
                                        TokenTypes.ASSIGN, TokenTypes.QUESTION, TokenTypes.COLON,
     ...
     * it checks if the new is directly followed by equal operator, ternary operator or
     * return operator.
     *
    ...
    private boolean doesChainedMethodNeedsLineWrapping() {
        ...
        return TokenUtil.isOfType(ast, TokenTypes.ASSIGN, TokenTypes.QUESTION, TokenTypes.COLON,
            TokenTypes.LITERAL_RETURN);
    }
