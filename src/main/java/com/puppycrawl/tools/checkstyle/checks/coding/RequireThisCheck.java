 ...
 * </pre>
 * <p>
 * To configure the check for fields only (with validateOnlyOverlapping set to false):
 * </p>
 * <pre>
 * &lt;module name=&quot;RequireThis&quot;&gt;
 ...
 * </pre>
 * <p>
 * To configure the check for fields only (with validateOnlyOverlapping set to true):
 * </p>
 * <pre>
 * &lt;module name=&quot;RequireThis&quot;&gt;
 *   &lt;property name=&quot;checkMethods&quot; value=&quot;false&quot;/&gt;
 ...
 * </pre>
 * <p>
 * To configure the check for methods only (with validateOnlyOverlapping set to false):
 * </p>
 * <pre>
 * &lt;module name=&quot;RequireThis&quot;&gt;
 ...
 *     foo(5);           // violation, method call to "foo" requires "this"
 *   }
 *
 *   public void foo(int c) {
 *     // overlapping by method argument
 ...
 * </pre>
 * <p>
 * To configure the check for methods only (with validateOnlyOverlapping set to true):
 * </p>
 * <pre>
 * &lt;module name=&quot;RequireThis&quot;&gt;
 *   &lt;property name=&quot;checkFields&quot; value=&quot;false&quot;/&gt;
