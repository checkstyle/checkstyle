...
public class JavadocParagraphCheck extends AbstractJavadocCheck {
    ...
    private void checkParagraphTag(DetailNode tag) {
        ...
        final String blockTag = checkIfFollowedByBlockTag(tag);
        if (blockTag != null) {
            log(tag.getLineNumber(), MSG_EXTRA_TAG, blockTag);
        }
     ...
     */
    private static String checkIfFollowedByBlockTag(DetailNode tag) {
