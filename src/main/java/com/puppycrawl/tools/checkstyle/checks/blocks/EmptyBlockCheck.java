...
public class EmptyBlockCheck
    ...
    private boolean hasText(final DetailAST slistAST) {
        ...
        if (slistLineNo == rcurlyLineNo) {
            ...
            final int[] txt = CodePointUtil.subArray(getLineCodePoints(slistLineNo - 1),
            ...
            final int[] codePointsFirst = getLineCodePoints(slistLineNo - 1);
            final int[] firstLine = CodePointUtil.subArray(codePointsFirst,
                    slistColNo + 1, codePointsFirst.length);
            final int[] codePointsLast = getLineCodePoints(rcurlyLineNo - 1);
            final int[] lastLine = CodePointUtil.subArray(codePointsLast, 0, rcurlyColNo);
