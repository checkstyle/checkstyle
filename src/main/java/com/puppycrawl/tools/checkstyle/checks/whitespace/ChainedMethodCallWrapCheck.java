 ...
 * Line wrapping means to insert line breaks in code to make it more readable and
 * adhere to line length standards.
 * </p>
 * <p>
 ...
 *     assertWithSomeMessage("ex")
 *         .that(1)
 *         .isEqualTo(1); // ok, every method call is wrapped, identifierPattern is also different
 *
 ...
 *
 *     Truth.assertWithSomeMessage("ex").that(1).isEqualTo(1);
 *     // ok above, identifierPattern is different, also 3 method calls &lt;= maxSingleLineCalls
 *
 *     Truth.assertWithSomeMessage("ex")
 *         .that(1).isEqualTo(1); // ok, identifierPattern is different
 * }
 ...
 *
 *     Truth.assertWithSomeMessage("ex")
 *         .that(1).isEqualTo(1); // ok above, identifierPattern is different, also
 *                                // 2 method calls on current line &lt;= maxCallsPerLine
 * }
 * </pre>
 * <p>
 ...
 *
 *     Truth.assertWithSomeMessage("ex")
 *         .that(1).isEqualTo(1); // ok, identifierPattern is different, also
 *                                // 2 method calls on current line &lt;= maxCallsPerLine
 * }
 * </pre>
 * <p>
