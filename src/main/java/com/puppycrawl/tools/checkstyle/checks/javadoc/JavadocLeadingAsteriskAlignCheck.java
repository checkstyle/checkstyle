...
public class JavadocLeadingAsteriskAlignCheck extends AbstractJavadocCheck {
    ...
    /** Specifies the last line of the javadoc comment. */
    ...
    public void visitJavadocToken(DetailNode ast) {
        if (ast.getType() == JavadocTokenTypes.JAVADOC) {
            ...
            createLastLine(ast, javadocEndToken);
     ...
     */
    private void createLastLine(DetailNode detailNode, DetailAST detailAST) {
