...
public class JavadocLeadingAsteriskAlignCheck extends AbstractJavadocCheck {
     ...
     * with expanded tabs.
     */
    private int expandedTabsParentColNumber;
    ...
    public void beginJavadocTree(DetailNode rootAst) {
        ...
        expandedTabsParentColNumber = CommonUtil.lengthExpandedTabs(
    ...
    private int getColumnForCommentText(String line) {
        ...
        if (matcher.find()) {
            final String lineWithoutTabs2 = tabMatcher.replaceAll(SPACE);
            final Matcher matcher2 = pattern.matcher(lineWithoutTabs2);
            matcher2.find();
            singleSpaceAsteriskColNumber = matcher2.group(1).length() + 1;
