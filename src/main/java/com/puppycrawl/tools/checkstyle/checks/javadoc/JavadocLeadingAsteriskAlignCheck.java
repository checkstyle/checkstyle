 ...
 * The default value of <code>tabWidth</code> is 8.
 * </p>
 * <ul>
 * <li>
...
public class JavadocLeadingAsteriskAlignCheck extends AbstractJavadocCheck {
    ...
    private int getColumnForCommentText(String line) {
        final String lineWithoutTabs = line.replaceAll(TAB, SPACE.repeat(getTabWidth()));
    ...
    private void checkAsteriskAlignment(int lineNumber,
        ...
        if (asteriskColumn != -1) {
            ...
            if (columnDifference != 1) {
                log(lineNumber, asteriskColumn, MSG_KEY, commentBeginColumn);
            }
        }
    }
}
