 ...
 * <ul>
 * <li>
 * Property {@code tabSize} - Specify the tab size.
 * Type is {@code int}.
...
public class JavadocLeadingAsteriskAlignCheck extends AbstractJavadocCheck {
    ...
    public int[] getRequiredJavadocTokens() {
		...
		/**
		 * Setter to specify the tab size.
		 * @param tabWidth tab size.
		 */
		public final void setTabSize(int tabWidth) {
			tabSize = tabWidth;
		}
    ...
    private static int getColumnForCommentText(String line) {
				line = line.replaceAll("\t", " ".repeat(tabSize));
