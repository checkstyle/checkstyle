...
public abstract class AbstractTreeWalker extends AbstractFileSetCheck
    ...
    /**
     * Creates a new {@code AbstractTreeWalker} instance.
     */
    ...
    /**
     * Visits the given token with a given list of visitors.
     * @param ast token to visit.
     * @param visitors list of token visitors.
     */
    abstract void doVisitToken(DetailAST ast, Collection<AbstractCheck> visitors);
