 ...
 * enclosing section element (i.e. the check or filter name).
 * It is used to build Doxia subsection anchor ids following the pattern
 * {@code SectionName_SubsectionToken}.</p>
 *
 ...
 * </ul>
 *
 * <p>Output is a plain div containing a ul of anchor links -
 * no JavaScript required, works on all devices including mobile.</p>
 */
