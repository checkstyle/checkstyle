...
/**
 * A macro that inserts the since version of module from its Javadoc.
 */
...
public class SinceMacro extends AbstractMacro {
    ...
    public void execute(Sink sink, MacroRequest request) throws MacroExecutionException {
        ...
        final String sinceVersion = SiteUtil.getModuleSinceVersion(moduleName, modulePath);

        sink.paragraph();
        sink.text("Since Checkstyle " + sinceVersion);
        sink.paragraph_();
