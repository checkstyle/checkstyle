...
public class XdocsTemplateParser extends AbstractXmlParser {
    /**
    ...
    private void handleParamStart(XmlPullParser parser) throws MacroExecutionException {
        if (!isSecondParsing()) {
            if (macroName != null && !macroName.isEmpty()) {
                ...
                if (paramName == null
                    ...
                    throw new MacroExecutionException(
                            "'" + Attribute.NAME + "' and '" + Attribute.VALUE
                                    + "' attributes for the '" + HtmlMarkup.PARAM.toString()
    ...
    private void handleMacroEnd(Sink sink) throws MacroExecutionException {
        if (!isSecondParsing() && macroName != null && !macroName.isEmpty()) {
            final MacroRequest request = new MacroRequest(sourceContent,
                    new XdocParser(), macroParameters, getBasedir());
