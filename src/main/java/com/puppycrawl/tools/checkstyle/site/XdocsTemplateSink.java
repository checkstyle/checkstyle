...
public class XdocsTemplateSink extends XdocSink {
     ...
     * Omitted the usage of tableCaptionXMLWriterStack,
     * tableCaptionXMLWriterStack and tableContentWriterStack because
     * of redundancy and non-compliance with PMD scan.
     *
