...
public class NotesMacro extends AbstractMacro {
    ...
    public void execute(Sink sink, MacroRequest request) throws MacroExecutionException {
        ...
        final String moduleNotes = NOTES_LINE_WITH_NEWLINE.matcher(
            JavadocMetadataScraper.constructSubTreeText(moduleJavadoc, notesStartIndex,
                notesEndIndex)).replaceAll("");
