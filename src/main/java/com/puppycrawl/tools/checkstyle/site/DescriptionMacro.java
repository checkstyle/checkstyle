...
public class DescriptionMacro extends AbstractMacro {
    ...
    public void execute(Sink sink, MacroRequest request) throws MacroExecutionException {
        ...
        final List<String> propertyNamesList = new ArrayList<>(propertyNames);
        ...
        final int descriptionEndIndex = getDescriptionEndIndex(propertyNamesList, moduleJavadoc);
     ...
     *
     * @param propertyNamesList list with property names.
     * @param moduleJavadoc javadoc of module.
     * @return the end index.
     */
    private static int getDescriptionEndIndex(List<String> propertyNamesList,
    ...
    private static void writeOutDescription(String description, Sink sink) {
        ...
        for (int index = 1; index < moduleDescriptionLinesSplit.length; index++) {
            ...
            else if (currentLine.startsWith("<") && !currentLine.startsWith("<code>")) {
