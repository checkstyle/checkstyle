...
public class DescriptionMacro extends AbstractMacro {
    ...
    public void execute(Sink sink, MacroRequest request) throws MacroExecutionException {
        ...
        final int descriptionEndIndex = getDescriptionEndIndex(propertyNames, moduleJavadoc);
     ...
     */
    private static int getDescriptionEndIndex(Set<String> propertyNamesSet,
        ...
        if (propertyNamesSet.isEmpty()) {
            ...
            final Optional<DetailNode> somePropertyModuleNode =
                SiteUtil.getPropertyJavadocNodeInModule(
                    propertyNamesSet.iterator().next(), moduleJavadoc);
