...
public final class ModuleJavadocParsingUtil {
    ...
    public static String getModuleNotes(DetailNode moduleJavadoc, Set<String> propertyNames) {
        ...
        if (notesStartIndex < 0) {
            ...
            result = JavadocMetadataScraper.constructSubTreeText(
    ...
    public static boolean propertyIsSpecialTokenProp(String propertyName, String moduleName) {
        return NON_BASE_TOKEN_PROPERTIES.stream()
                    .anyMatch(tokenProp -> tokenProp.equals(moduleName + " - " + propertyName));
    }
