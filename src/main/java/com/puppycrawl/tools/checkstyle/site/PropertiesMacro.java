...
public class PropertiesMacro extends AbstractMacro {
    ...
    public static final String SUBSET_TOKENS = "subset of tokens";
    ...
    */
    ...
    /** The constant represents 'TokenTypes'. */
    private static final String TOKEN_TYPES_PROPERTY = SiteUtil.TOKEN_TYPES;
    ...
    private static void writePropertyTypeCell(Sink sink, String propertyName,
        ...
        if (SiteUtil.TOKENS.equals(propertyName)) {
            ...
            if ((SUBSET_TOKENS + " " + TOKEN_TYPES_PROPERTY).equals(type)) {
