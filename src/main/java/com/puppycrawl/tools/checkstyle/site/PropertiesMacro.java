...
public class PropertiesMacro extends AbstractMacro {
    ...
    private static void writePropertyTypeCell(Sink sink, String propertyName,
        ...
        if (SiteUtil.TOKENS.equals(propertyName)) {
            ...
            final String type = simplifyTypeName(fullTypeName);
    ...
    private static void writePropertyDefaultValueCell(Sink sink, String propertyName,
        ...
        if (SiteUtil.TOKENS.equals(propertyName)) {
            ...
            if (ModuleJavadocParsingUtil
                .propertyIsSpecialTokenProp(propertyName, currentModuleName)
                ...
                final Class<?> fieldClass = SiteUtil.getFieldClass(field, propertyName, currentModuleName, instance);
                if (fieldClass == Pattern.class && !"null".equals(defaultValue)) {
