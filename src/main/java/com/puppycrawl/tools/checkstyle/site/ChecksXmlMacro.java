...
public class ChecksXmlMacro extends AbstractMacro {
    ...
    public void execute(Sink sink, MacroRequest request) throws MacroExecutionException {
        ...
        final String formatted = wrapText(summarySentence == null ? "" : summarySentence.trim(), 70);
     ...
     * This ensures total line length (including indentation and XML tags) ≤ 100 chars.
     *
