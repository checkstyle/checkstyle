...
public final class Violation
     ...
     * @noinspectionreason Class is immutable, we need large amount of arguments.
     */
     ...
     * @noinspectionreason Suppression on enumeration is needed so code stays consistent.
     */
