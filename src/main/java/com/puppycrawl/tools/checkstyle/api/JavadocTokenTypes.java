...
public final class JavadocTokenTypes {
    ...
    /** Rule types offset.
     * RULE_TYPES_OFFSET constant is used to split lexer tokens types и parser rules types.
     * We need unique numbers for all tokens,
     * ANTLR do not need this and that is why his types are mixed by used values.
