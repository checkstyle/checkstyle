...
public final class JavadocTokenTypes {
     ...
     * <pre>
     * {@code
     * JAVADOC_TAG &gt JAVADOC_TAG [1:3]
     *  |--SEE_LITERAL &gt @see [1:3]
     *  |--WS &gt   [1:7]
     *  |--REFERENCE &gt REFERENCE [1:8]
     *  |   |--PACKAGE_CLASS &gt org.apache.utils.Lists.Comparator [1:8]
     *  |   |--HASH &gt # [1:41]
     *  |   |--MEMBER &gt compare [1:42]
     *  |   `--PARAMETERS &gt PARAMETERS [1:49]
     *  |       |--LEFT_BRACE &gt ( [1:49]
     *  |       |--ARGUMENT &gt Object [1:50]
     *  |       `--RIGHT_BRACE &gt ) [1:56]
     * }
     * </pre>
     */
