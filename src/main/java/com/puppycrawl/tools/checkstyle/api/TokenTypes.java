...
public final class TokenTypes {
     ...
     * @see #LITERAL_DEFAULT
     **/
    public static final int MODIFIERS = CheckstyleJavaLexer.MODIFIERS;
     ...
     * @see #ANNOTATION_DEF
     **/
    public static final int OBJBLOCK = CheckstyleJavaLexer.OBJBLOCK;
    /**
     ...
     * @see #CASE_GROUP
     **/
    public static final int SLIST = CheckstyleJavaLexer.SLIST;
    /**
     ...
     * @see #CLASS_DEF
     **/
    public static final int CTOR_DEF = CheckstyleJavaLexer.CTOR_DEF;
    /**
     ...
     * @see #OBJBLOCK
     **/
    public static final int METHOD_DEF = CheckstyleJavaLexer.METHOD_DEF;
    /**
    ...
    public static final int VARIABLE_DEF =
        CheckstyleJavaLexer.VARIABLE_DEF;
    ...
    public static final int INSTANCE_INIT =
        CheckstyleJavaLexer.INSTANCE_INIT;
    ...
    public static final int STATIC_INIT =
        CheckstyleJavaLexer.STATIC_INIT;
     ...
     * @see #TYPE_ARGUMENTS
     **/
    public static final int TYPE = CheckstyleJavaLexer.TYPE;
    /**
     * A class declaration.
     *
     * <p>For example:</p>
     ...
     * @see #LITERAL_NEW
     **/
    public static final int CLASS_DEF = CheckstyleJavaLexer.CLASS_DEF;
    /**
    ...
    public static final int INTERFACE_DEF =
        CheckstyleJavaLexer.INTERFACE_DEF;
     ...
     * @see FullIdent
     **/
    public static final int PACKAGE_DEF = CheckstyleJavaLexer.PACKAGE_DEF;
    /**
    ...
    public static final int ARRAY_DECLARATOR =
        CheckstyleJavaLexer.ARRAY_DECLARATOR;
    ...
    public static final int EXTENDS_CLAUSE =
        CheckstyleJavaLexer.EXTENDS_CLAUSE;
    ...
    public static final int IMPLEMENTS_CLAUSE =
        CheckstyleJavaLexer.IMPLEMENTS_CLAUSE;
     ...
     * @see #CTOR_DEF
     **/
    public static final int PARAMETERS = CheckstyleJavaLexer.PARAMETERS;
    /**
    ...
    public static final int PARAMETER_DEF =
        CheckstyleJavaLexer.PARAMETER_DEF;
    ...
    public static final int LABELED_STAT =
        CheckstyleJavaLexer.LABELED_STAT;
     ...
     * @see #RPAREN
     **/
    public static final int TYPECAST = CheckstyleJavaLexer.TYPECAST;
    /**
     ...
     * @see #EXPR
     **/
    public static final int INDEX_OP = CheckstyleJavaLexer.INDEX_OP;
    /**
     ...
     * @see #INC
     **/
    public static final int POST_INC = CheckstyleJavaLexer.POST_INC;
    /**
     ...
     * @see #DEC
     **/
    public static final int POST_DEC = CheckstyleJavaLexer.POST_DEC;
    /**
     ...
     * @see FullIdent
     **/
    public static final int METHOD_CALL = CheckstyleJavaLexer.METHOD_CALL;
     ...
     * @see #DOUBLE_COLON
     */
    public static final int METHOD_REF = CheckstyleJavaLexer.METHOD_REF;
    /**
     ...
     * @see #RPAREN
     **/
    public static final int EXPR = CheckstyleJavaLexer.EXPR;
    /**
     ...
     * @see #COMMA
     **/
    public static final int ARRAY_INIT = CheckstyleJavaLexer.ARRAY_INIT;
    /**
     ...
     * @see FullIdent
     **/
    public static final int IMPORT = CheckstyleJavaLexer.IMPORT;
    /**
     ...
     * @see #EXPR
     **/
    public static final int UNARY_MINUS = CheckstyleJavaLexer.UNARY_MINUS;
    /**
     ...
     * @see #EXPR
     **/
    public static final int UNARY_PLUS = CheckstyleJavaLexer.UNARY_PLUS;
    /**
     ...
     * @see #LITERAL_YIELD
     **/
    public static final int CASE_GROUP = CheckstyleJavaLexer.CASE_GROUP;
    /**
     ...
     * @see #SUPER_CTOR_CALL
     **/
    public static final int ELIST = CheckstyleJavaLexer.ELIST;
    /**
     ...
     * @see #LITERAL_FOR
     **/
    public static final int FOR_INIT = CheckstyleJavaLexer.FOR_INIT;
    /**
    ...
    public static final int FOR_CONDITION =
        CheckstyleJavaLexer.FOR_CONDITION;
    ...
    public static final int FOR_ITERATOR =
        CheckstyleJavaLexer.FOR_ITERATOR;
     ...
     * @see #LITERAL_WHILE
     **/
    public static final int EMPTY_STAT = CheckstyleJavaLexer.EMPTY_STAT;
    /**
     ...
     * @see #MODIFIERS
     **/
    public static final int FINAL = CheckstyleJavaLexer.FINAL;
    /**
     ...
     * @see #MODIFIERS
     **/
    public static final int ABSTRACT = CheckstyleJavaLexer.ABSTRACT;
    /**
     ...
     * @see #MODIFIERS
     **/
    public static final int STRICTFP = CheckstyleJavaLexer.STRICTFP;
    /**
    ...
    public static final int SUPER_CTOR_CALL =
        CheckstyleJavaLexer.SUPER_CTOR_CALL;
     ...
     * @see #SUPER_CTOR_CALL
     **/
    public static final int CTOR_CALL = CheckstyleJavaLexer.CTOR_CALL;
     ...
     * @see #LITERAL_FOR
     **/
    public static final int SEMI = CheckstyleJavaLexer.SEMI;
     ...
     * @see #ARRAY_DECLARATOR
     **/
    public static final int RBRACK = CheckstyleJavaLexer.RBRACK;
    /**
    ...
    public static final int LITERAL_VOID =
        CheckstyleJavaLexer.LITERAL_VOID;
    ...
    public static final int LITERAL_BOOLEAN =
        CheckstyleJavaLexer.LITERAL_BOOLEAN;
    ...
    public static final int LITERAL_BYTE =
        CheckstyleJavaLexer.LITERAL_BYTE;
    ...
    public static final int LITERAL_CHAR =
        CheckstyleJavaLexer.LITERAL_CHAR;
    ...
    public static final int LITERAL_SHORT =
        CheckstyleJavaLexer.LITERAL_SHORT;
     ...
     * @see #TYPE
     **/
    public static final int LITERAL_INT = CheckstyleJavaLexer.LITERAL_INT;
    /**
    ...
    public static final int LITERAL_FLOAT =
        CheckstyleJavaLexer.LITERAL_FLOAT;
    ...
    public static final int LITERAL_LONG =
        CheckstyleJavaLexer.LITERAL_LONG;
     ...
     **/
    public static final int DOT = CheckstyleJavaLexer.DOT;
    /**
     ...
     * @see #IMPORT
     **/
    public static final int STAR = CheckstyleJavaLexer.STAR;
    /**
    ...
    public static final int LITERAL_PRIVATE =
        CheckstyleJavaLexer.LITERAL_PRIVATE;
    ...
    public static final int LITERAL_PUBLIC =
        CheckstyleJavaLexer.LITERAL_PUBLIC;
    ...
    public static final int LITERAL_PROTECTED =
        CheckstyleJavaLexer.LITERAL_PROTECTED;
    ...
    public static final int LITERAL_STATIC =
        CheckstyleJavaLexer.LITERAL_STATIC;
    ...
    public static final int LITERAL_TRANSIENT =
        CheckstyleJavaLexer.LITERAL_TRANSIENT;
    ...
    public static final int LITERAL_NATIVE =
        CheckstyleJavaLexer.LITERAL_NATIVE;
    ...
    public static final int LITERAL_SYNCHRONIZED =
        CheckstyleJavaLexer.LITERAL_SYNCHRONIZED;
    ...
    public static final int LITERAL_VOLATILE =
        CheckstyleJavaLexer.LITERAL_VOLATILE;
    ...
    public static final int LITERAL_CLASS =
        CheckstyleJavaLexer.LITERAL_CLASS;
    ...
    public static final int LITERAL_INTERFACE =
        CheckstyleJavaLexer.LITERAL_INTERFACE;
     ...
     * @see #SLIST
     **/
    public static final int LCURLY = CheckstyleJavaLexer.LCURLY;
    /**
     ...
     * @see #SLIST
     **/
    public static final int RCURLY = CheckstyleJavaLexer.RCURLY;
     ...
     * @see #IMPLEMENTS_CLAUSE
     **/
    public static final int COMMA = CheckstyleJavaLexer.COMMA;
     ...
     * @see #LITERAL_CATCH
     **/
    public static final int LPAREN = CheckstyleJavaLexer.LPAREN;
    /**
     ...
     * @see #LITERAL_CATCH
     **/
    public static final int RPAREN = CheckstyleJavaLexer.RPAREN;
    /**
    ...
    public static final int LITERAL_THIS =
        CheckstyleJavaLexer.LITERAL_THIS;
    ...
    public static final int LITERAL_SUPER =
        CheckstyleJavaLexer.LITERAL_SUPER;
     ...
     * @see #EXPR
     **/
    public static final int ASSIGN = CheckstyleJavaLexer.ASSIGN;
    /**
    ...
    public static final int LITERAL_THROWS =
        CheckstyleJavaLexer.LITERAL_THROWS;
     ...
     * @see #CASE_GROUP
     **/
    public static final int COLON = CheckstyleJavaLexer.COLON;
     ...
     * @see #METHOD_REF
     */
    public static final int DOUBLE_COLON = CheckstyleJavaLexer.DOUBLE_COLON;
    /**
     * The {@code if} keyword.
     *
     * <p>For example:</p>
     ...
     * @see #LITERAL_ELSE
     **/
    public static final int LITERAL_IF = CheckstyleJavaLexer.LITERAL_IF;
    /**
     ...
     * @see #EXPR
     **/
    public static final int LITERAL_FOR = CheckstyleJavaLexer.LITERAL_FOR;
    /**
    ...
    public static final int LITERAL_WHILE =
        CheckstyleJavaLexer.LITERAL_WHILE;
     ...
     * @see #SEMI
     **/
    public static final int LITERAL_DO = CheckstyleJavaLexer.LITERAL_DO;
    /**
     ...
     * @see #LITERAL_DO
     */
    public static final int DO_WHILE = CheckstyleJavaLexer.DO_WHILE;
    /**
    ...
    public static final int LITERAL_BREAK =
        CheckstyleJavaLexer.LITERAL_BREAK;
    ...
    public static final int LITERAL_CONTINUE =
        CheckstyleJavaLexer.LITERAL_CONTINUE;
    ...
    public static final int LITERAL_RETURN =
        CheckstyleJavaLexer.LITERAL_RETURN;
    ...
    public static final int LITERAL_SWITCH =
        CheckstyleJavaLexer.LITERAL_SWITCH;
    ...
    public static final int LITERAL_THROW =
        CheckstyleJavaLexer.LITERAL_THROW;
    ...
    public static final int LITERAL_ELSE =
        CheckstyleJavaLexer.LITERAL_ELSE;
    ...
    public static final int LITERAL_CASE =
        CheckstyleJavaLexer.LITERAL_CASE;
    ...
    public static final int LITERAL_DEFAULT =
        CheckstyleJavaLexer.LITERAL_DEFAULT;
     ...
     * @see #LITERAL_FINALLY
     **/
    public static final int LITERAL_TRY = CheckstyleJavaLexer.LITERAL_TRY;
    ...
    public static final int RESOURCE_SPECIFICATION =
        CheckstyleJavaLexer.RESOURCE_SPECIFICATION;
    ...
    public static final int LITERAL_CATCH =
        CheckstyleJavaLexer.LITERAL_CATCH;
    ...
    public static final int LITERAL_FINALLY =
        CheckstyleJavaLexer.LITERAL_FINALLY;
     ...
     * @see #EXPR
     **/
    public static final int PLUS_ASSIGN = CheckstyleJavaLexer.PLUS_ASSIGN;
    /**
    ...
    public static final int MINUS_ASSIGN =
        CheckstyleJavaLexer.MINUS_ASSIGN;
     ...
     * @see #EXPR
     **/
    public static final int STAR_ASSIGN = CheckstyleJavaLexer.STAR_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int DIV_ASSIGN = CheckstyleJavaLexer.DIV_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int MOD_ASSIGN = CheckstyleJavaLexer.MOD_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int SR_ASSIGN = CheckstyleJavaLexer.SR_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BSR_ASSIGN = CheckstyleJavaLexer.BSR_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int SL_ASSIGN = CheckstyleJavaLexer.SL_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BAND_ASSIGN = CheckstyleJavaLexer.BAND_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BXOR_ASSIGN = CheckstyleJavaLexer.BXOR_ASSIGN;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BOR_ASSIGN = CheckstyleJavaLexer.BOR_ASSIGN;
    /**
     ...
     * @noinspection HtmlTagCanBeJavadocTag
     **/
    public static final int QUESTION = CheckstyleJavaLexer.QUESTION;
    /**
     ...
     * @see #EXPR
     **/
    public static final int LOR = CheckstyleJavaLexer.LOR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int LAND = CheckstyleJavaLexer.LAND;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BOR = CheckstyleJavaLexer.BOR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BXOR = CheckstyleJavaLexer.BXOR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BAND = CheckstyleJavaLexer.BAND;
    /**
     ...
     * @noinspection HtmlTagCanBeJavadocTag
     **/
    public static final int NOT_EQUAL = CheckstyleJavaLexer.NOT_EQUAL;
    /**
     ...
     * @see #EXPR
     **/
    public static final int EQUAL = CheckstyleJavaLexer.EQUAL;
    /**
     ...
     * @see #EXPR
     **/
    public static final int LT = CheckstyleJavaLexer.LT;
    /**
     ...
     * @see #EXPR
     **/
    public static final int GT = CheckstyleJavaLexer.GT;
    /**
     ...
     * @see #EXPR
     **/
    public static final int LE = CheckstyleJavaLexer.LE;
    /**
     * The {@code >=} (greater than or equal) operator.
     *
     * @see #EXPR
     **/
    public static final int GE = CheckstyleJavaLexer.GE;
    /**
    ...
    public static final int LITERAL_INSTANCEOF =
        CheckstyleJavaLexer.LITERAL_INSTANCEOF;
     ...
     * @see #EXPR
     **/
    public static final int SL = CheckstyleJavaLexer.SL;
    /**
     ...
     * @see #EXPR
     **/
    public static final int SR = CheckstyleJavaLexer.SR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BSR = CheckstyleJavaLexer.BSR;
    /**
     ...
     * @see #EXPR
     **/
    public static final int PLUS = CheckstyleJavaLexer.PLUS;
    /**
     ...
     * @see #EXPR
     **/
    public static final int MINUS = CheckstyleJavaLexer.MINUS;
    /**
     ...
     * @see #EXPR
     **/
    public static final int DIV = CheckstyleJavaLexer.DIV;
    /**
     ...
     * @see #EXPR
     **/
    public static final int MOD = CheckstyleJavaLexer.MOD;
    /**
     ...
     * @see #POST_INC
     **/
    public static final int INC = CheckstyleJavaLexer.INC;
    /**
     ...
     * @see #POST_DEC
     **/
    public static final int DEC = CheckstyleJavaLexer.DEC;
    /**
     ...
     * @see #EXPR
     **/
    public static final int BNOT = CheckstyleJavaLexer.BNOT;
    /**
     ...
     * @noinspection HtmlTagCanBeJavadocTag
     **/
    public static final int LNOT = CheckstyleJavaLexer.LNOT;
    /**
    ...
    public static final int LITERAL_TRUE =
        CheckstyleJavaLexer.LITERAL_TRUE;
    ...
    public static final int LITERAL_FALSE =
        CheckstyleJavaLexer.LITERAL_FALSE;
    ...
    public static final int LITERAL_NULL =
        CheckstyleJavaLexer.LITERAL_NULL;
     ...
     * @see FullIdent
     **/
    public static final int LITERAL_NEW = CheckstyleJavaLexer.LITERAL_NEW;
    /**
     ...
     * @see #NUM_LONG
     **/
    public static final int NUM_INT = CheckstyleJavaLexer.NUM_INT;
    /**
    ...
    public static final int CHAR_LITERAL =
        CheckstyleJavaLexer.CHAR_LITERAL;
    ...
    public static final int STRING_LITERAL =
        CheckstyleJavaLexer.STRING_LITERAL;
     ...
     * @see #NUM_DOUBLE
     **/
    public static final int NUM_FLOAT = CheckstyleJavaLexer.NUM_FLOAT;
    /**
     ...
     * @see #NUM_INT
     **/
    public static final int NUM_LONG = CheckstyleJavaLexer.NUM_LONG;
    /**
     ...
     * @see #NUM_FLOAT
     **/
    public static final int NUM_DOUBLE = CheckstyleJavaLexer.NUM_DOUBLE;
     ...
     * </pre>
     **/
    public static final int LITERAL_ASSERT = CheckstyleJavaLexer.ASSERT;
    ...
    public static final int STATIC_IMPORT =
        CheckstyleJavaLexer.STATIC_IMPORT;
    ...
    public static final int ENUM_CONSTANT_DEF =
        CheckstyleJavaLexer.ENUM_CONSTANT_DEF;
    ...
    public static final int FOR_EACH_CLAUSE =
        CheckstyleJavaLexer.FOR_EACH_CLAUSE;
    ...
    public static final int ANNOTATION_DEF =
        CheckstyleJavaLexer.ANNOTATION_DEF;
    ...
    public static final int ANNOTATION_FIELD_DEF =
        CheckstyleJavaLexer.ANNOTATION_FIELD_DEF;
    ...
    public static final int ANNOTATIONS =
        CheckstyleJavaLexer.ANNOTATIONS;
    ...
    public static final int ANNOTATION =
        CheckstyleJavaLexer.ANNOTATION;
    ...
    public static final int ANNOTATION_MEMBER_VALUE_PAIR =
        CheckstyleJavaLexer.ANNOTATION_MEMBER_VALUE_PAIR;
    ...
    public static final int ANNOTATION_ARRAY_INIT =
        CheckstyleJavaLexer.ANNOTATION_ARRAY_INIT;
    ...
    public static final int TYPE_PARAMETERS =
        CheckstyleJavaLexer.TYPE_PARAMETERS;
    ...
    public static final int TYPE_PARAMETER =
        CheckstyleJavaLexer.TYPE_PARAMETER;
    ...
    public static final int TYPE_ARGUMENTS =
        CheckstyleJavaLexer.TYPE_ARGUMENTS;
    ...
    public static final int TYPE_ARGUMENT =
        CheckstyleJavaLexer.TYPE_ARGUMENT;
    ...
    public static final int WILDCARD_TYPE =
        CheckstyleJavaLexer.WILDCARD_TYPE;
    ...
    public static final int TYPE_UPPER_BOUNDS =
        CheckstyleJavaLexer.TYPE_UPPER_BOUNDS;
    ...
    public static final int TYPE_LOWER_BOUNDS =
        CheckstyleJavaLexer.TYPE_LOWER_BOUNDS;
     ...
     * JSR201</a>
     */
    public static final int AT = CheckstyleJavaLexer.AT;
     ...
     * JSR201</a>
     */
    public static final int ELLIPSIS = CheckstyleJavaLexer.ELLIPSIS;
    ...
    public static final int SINGLE_LINE_COMMENT =
            CheckstyleJavaLexer.SINGLE_LINE_COMMENT;
    ...
    public static final int BLOCK_COMMENT_BEGIN =
            CheckstyleJavaLexer.BLOCK_COMMENT_BEGIN;
    ...
    public static final int BLOCK_COMMENT_END =
            CheckstyleJavaLexer.BLOCK_COMMENT_END;
    ...
    public static final int COMMENT_CONTENT =
            CheckstyleJavaLexer.COMMENT_CONTENT;
    ...
    public static final int PATTERN_VARIABLE_DEF =
            CheckstyleJavaLexer.PATTERN_VARIABLE_DEF;
    ...
    public static final int LITERAL_RECORD =
            CheckstyleJavaLexer.LITERAL_RECORD;
    ...
    public static final int RECORD_DEF =
            CheckstyleJavaLexer.RECORD_DEF;
    ...
    public static final int RECORD_COMPONENTS =
            CheckstyleJavaLexer.RECORD_COMPONENTS;
    ...
    public static final int RECORD_COMPONENT_DEF =
            CheckstyleJavaLexer.RECORD_COMPONENT_DEF;
    ...
    public static final int COMPACT_CTOR_DEF =
            CheckstyleJavaLexer.COMPACT_CTOR_DEF;
    ...
    public static final int TEXT_BLOCK_LITERAL_BEGIN =
            CheckstyleJavaLexer.TEXT_BLOCK_LITERAL_BEGIN;
    ...
    public static final int TEXT_BLOCK_CONTENT =
            CheckstyleJavaLexer.TEXT_BLOCK_CONTENT;
    ...
    public static final int TEXT_BLOCK_LITERAL_END =
            CheckstyleJavaLexer.TEXT_BLOCK_LITERAL_END;
    ...
    public static final int LITERAL_YIELD =
            CheckstyleJavaLexer.LITERAL_YIELD;
    ...
    public static final int SWITCH_RULE =
            CheckstyleJavaLexer.SWITCH_RULE;
    ...
    public static final int LITERAL_NON_SEALED =
        CheckstyleJavaLexer.LITERAL_NON_SEALED;
    ...
    public static final int LITERAL_SEALED =
        CheckstyleJavaLexer.LITERAL_SEALED;
    ...
    public static final int LITERAL_PERMITS =
        CheckstyleJavaLexer.LITERAL_PERMITS;
    ...
    public static final int PERMITS_CLAUSE =
        CheckstyleJavaLexer.PERMITS_CLAUSE;
