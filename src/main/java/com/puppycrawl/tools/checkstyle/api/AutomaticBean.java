 ...
 * @noinspectionreason All files now use AbstractAutomaticBean. We will remove this class.
 * @deprecated since 10.8.1. Use {@code AbstractAutomaticBean} instead.
 */
// -@cs[AbstractClassName] We can not break compatibility with previous versions.
@Deprecated(since = "10.8.1")
