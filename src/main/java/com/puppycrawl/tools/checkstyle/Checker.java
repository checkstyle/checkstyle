...
public class Checker extends AbstractAutomaticBean implements MessageDispatcher, RootModule {
     ...
     * @noinspectionreason NestedTryStatement - the inner resource completes file notifications
     *      before the outer handlers remove failed files from the cache and wrap failures.
     * @noinspection BadExceptionThrown
     * @noinspectionreason BadExceptionThrown - preserve Error propagation while adding
