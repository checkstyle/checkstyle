...
public class Checker extends AbstractAutomaticBean implements MessageDispatcher, RootModule {
     ...
     * @noinspectionreason NestedTryStatement - the inner try-with-resources has no catch or
     *      finally to merge. It completes file notifications before the outer handlers remove
     *      failed files from the cache and wrap failures.
