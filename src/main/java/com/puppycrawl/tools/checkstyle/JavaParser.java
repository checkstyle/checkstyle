...
public final class JavaParser {
    ...
    public static DetailAST parse(FileContents contents)
        ...
        final JavaParserErrorListener errorListener = new JavaParserErrorListener();
     ...
     */
    private static class JavaParserErrorListener extends BaseErrorListener {
        @Override
        public void syntaxError(Recognizer<?, ?> recognizer, Object offendingSymbol,
                                int line, int charPositionInLine,
                                String msg, RecognitionException ex) {
            final String message = line + ":" + charPositionInLine + ": " + msg;
            throw new ParseCancellationException(message, ex.getCause());
        }
    }
