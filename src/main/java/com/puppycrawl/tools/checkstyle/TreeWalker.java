...
public final class TreeWalker extends AbstractFileSetCheck implements ExternalResourceHolder {
    ...
    private SeverityLevel parseExceptionSeverity = SeverityLevel.ERROR;
     ...
     *
     *  @param parseExceptionSeverity severity level to log parsing exceptions
     *                                when they are skipped.
     *  @since 10.16.1
     */
    public void setParseExceptionSeverity(SeverityLevel parseExceptionSeverity) {
        this.parseExceptionSeverity = parseExceptionSeverity;
    }
            ...
            try {
                ...
                if (skipFileOnJavaParseException) {
                    ...
                    violations.add(new Violation(1, Definitions.CHECKSTYLE_BUNDLE, EXCEPTION_MSG,
                            new Object[]{ex.getMessage()}, parseExceptionSeverity, null, getClass(),
                            getCustomMessages().get(EXCEPTION_MSG)));
