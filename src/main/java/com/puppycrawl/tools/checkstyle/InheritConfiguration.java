...
public final class InheritConfiguration extends DefaultConfiguration {
     ...
     */
    protected final void doMergeParent() {
     ...
     */
    protected static final void doMergeParent(final DefaultConfiguration parent,
    ...
    private static void mergeChildren(final DefaultConfiguration parent,
        ...
        if (parentHasChildren && currentChildren.isEmpty()) {
