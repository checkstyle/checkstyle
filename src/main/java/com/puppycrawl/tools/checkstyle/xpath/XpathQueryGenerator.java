...
public class XpathQueryGenerator {
    ...
    /**
     * Controls true escape characters. True escape characters need '&' before but it also
     ...
     */
    private static void testEscapeEncoding(char chr, StringBuilder string) {
        //
