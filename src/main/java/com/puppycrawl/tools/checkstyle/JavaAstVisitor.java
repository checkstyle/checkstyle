 ...
 */
public final class JavaAstVisitor extends CheckstyleJavaParserBaseVisitor<DetailAstImpl> {
    ...
    @Override
    public DetailAstImpl visitCompilationUnit(CheckstyleJavaParser.CompilationUnitContext ctx) {
    ...
    public DetailAstImpl visitPackageDeclaration(
            CheckstyleJavaParser.PackageDeclarationContext ctx) {
    ...
    @Override
    public DetailAstImpl visitImportDec(CheckstyleJavaParser.ImportDecContext ctx) {
    ...
    @Override
    public DetailAstImpl visitSingleSemiImport(CheckstyleJavaParser.SingleSemiImportContext ctx) {
        return create(ctx.SEMI());
    }

    @Override
    public DetailAstImpl visitTypeDeclaration(CheckstyleJavaParser.TypeDeclarationContext ctx) {
    ...
    @Override
    public DetailAstImpl visitModifier(CheckstyleJavaParser.ModifierContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitVariableModifier(CheckstyleJavaParser.VariableModifierContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitClassDeclaration(CheckstyleJavaParser.ClassDeclarationContext ctx) {
        return createTypeDeclaration(ctx, TokenTypes.CLASS_DEF, ctx.mods);
    }

    @Override
    public DetailAstImpl visitRecordDeclaration(CheckstyleJavaParser.RecordDeclarationContext ctx) {
        return createTypeDeclaration(ctx, TokenTypes.RECORD_DEF, ctx.mods);
    }

    @Override
    public DetailAstImpl visitRecordComponentsList(
            CheckstyleJavaParser.RecordComponentsListContext ctx) {
    ...
    @Override
    public DetailAstImpl visitRecordComponents(CheckstyleJavaParser.RecordComponentsContext ctx) {
        final DetailAstImpl firstRecordComponent = visit(ctx.children.get(0));
        final DetailAstImpl recordComponents =
                createImaginary(TokenTypes.RECORD_COMPONENTS);
    ...
    @Override
    public DetailAstImpl visitRecordComponent(CheckstyleJavaParser.RecordComponentContext ctx) {
        final DetailAstImpl recordComponent =
                createImaginary(TokenTypes.RECORD_COMPONENT_DEF);
    ...
    public DetailAstImpl visitLastRecordComponent(
            CheckstyleJavaParser.LastRecordComponentContext ctx) {
        final DetailAstImpl recordComponent =
                createImaginary(TokenTypes.RECORD_COMPONENT_DEF);
        recordComponent.addChild(visit(ctx.annotations()));
        final DetailAstImpl type = visit(ctx.type);
    ...
    @Override
    public DetailAstImpl visitRecordBody(CheckstyleJavaParser.RecordBodyContext ctx) {
    ...
    public DetailAstImpl visitCompactConstructorDeclaration(
            CheckstyleJavaParser.CompactConstructorDeclarationContext ctx) {
        final DetailAstImpl compactConstructor =
                createImaginary(TokenTypes.COMPACT_CTOR_DEF);
    ...
    @Override
    public DetailAstImpl visitClassExtends(CheckstyleJavaParser.ClassExtendsContext ctx) {
    ...
    @Override
    public DetailAstImpl visitImplementsClause(CheckstyleJavaParser.ImplementsClauseContext ctx) {
    ...
    @Override
    public DetailAstImpl visitTypeParameters(CheckstyleJavaParser.TypeParametersContext ctx) {
    ...
    @Override
    public DetailAstImpl visitTypeParameter(CheckstyleJavaParser.TypeParameterContext ctx) {
    ...
    @Override
    public DetailAstImpl visitTypeUpperBounds(CheckstyleJavaParser.TypeUpperBoundsContext ctx) {
    ...
    @Override
    public DetailAstImpl visitTypeBound(CheckstyleJavaParser.TypeBoundContext ctx) {
        final DetailAstImpl typeBoundType = visit(ctx.typeBoundType(0));
        final Iterator<CheckstyleJavaParser.TypeBoundTypeContext> typeBoundTypeIterator =
    ...
    @Override
    public DetailAstImpl visitTypeBoundType(CheckstyleJavaParser.TypeBoundTypeContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitEnumDeclaration(CheckstyleJavaParser.EnumDeclarationContext ctx) {
        return createTypeDeclaration(ctx, TokenTypes.ENUM_DEF, ctx.mods);
    }

    @Override
    public DetailAstImpl visitEnumBody(CheckstyleJavaParser.EnumBodyContext ctx) {
        final DetailAstImpl objBlock = createImaginary(TokenTypes.OBJBLOCK);
        processChildren(objBlock, ctx.children);
        return objBlock;
    }
    ...
    @Override
    public DetailAstImpl visitEnumConstants(CheckstyleJavaParser.EnumConstantsContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitEnumConstant(CheckstyleJavaParser.EnumConstantContext ctx) {
    ...
    public DetailAstImpl visitEnumBodyDeclarations(
            CheckstyleJavaParser.EnumBodyDeclarationsContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitInterfaceDeclaration(
            CheckstyleJavaParser.InterfaceDeclarationContext ctx) {
        return createTypeDeclaration(ctx, TokenTypes.INTERFACE_DEF, ctx.mods);
    }

    @Override
    public DetailAstImpl visitInterfaceExtends(CheckstyleJavaParser.InterfaceExtendsContext ctx) {
    ...
    @Override
    public DetailAstImpl visitClassBody(CheckstyleJavaParser.ClassBodyContext ctx) {
        final DetailAstImpl objBlock = createImaginary(TokenTypes.OBJBLOCK);
        processChildren(objBlock, ctx.children);
        return objBlock;
    }
    ...
    @Override
    public DetailAstImpl visitInterfaceBody(CheckstyleJavaParser.InterfaceBodyContext ctx) {
        final DetailAstImpl objBlock = createImaginary(TokenTypes.OBJBLOCK);
        processChildren(objBlock, ctx.children);
        return objBlock;
    }
    ...
    @Override
    public DetailAstImpl visitEmptyClass(CheckstyleJavaParser.EmptyClassContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitClassBlock(CheckstyleJavaParser.ClassBlockContext ctx) {
    ...
    @Override
    public DetailAstImpl visitMethodDeclaration(CheckstyleJavaParser.MethodDeclarationContext ctx) {
        ...
        processChildren(methodDef, ctx.children.stream()
                .filter(child -> !(child instanceof CheckstyleJavaParser.ArrayDeclaratorContext))
    ...
    @Override
    public DetailAstImpl visitMethodBody(CheckstyleJavaParser.MethodBodyContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitThrowsList(CheckstyleJavaParser.ThrowsListContext ctx) {
    ...
    public DetailAstImpl visitConstructorDeclaration(
            CheckstyleJavaParser.ConstructorDeclarationContext ctx) {
    ...
    @Override
    public DetailAstImpl visitFieldDeclaration(CheckstyleJavaParser.FieldDeclarationContext ctx) {
    ...
    public DetailAstImpl visitInterfaceBodyDeclaration(
            CheckstyleJavaParser.InterfaceBodyDeclarationContext ctx) {
    ...
    public DetailAstImpl visitInterfaceMethodDeclaration(
            CheckstyleJavaParser.InterfaceMethodDeclarationContext ctx) {
        final DetailAstImpl methodDef = createImaginary(TokenTypes.METHOD_DEF);
        methodDef.addChild(createModifiers(ctx.mods));
    ...
    public DetailAstImpl visitVariableDeclarators(
            CheckstyleJavaParser.VariableDeclaratorsContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitVariableDeclarator(
            CheckstyleJavaParser.VariableDeclaratorContext ctx) {
    ...
    public DetailAstImpl visitVariableDeclaratorId(
            CheckstyleJavaParser.VariableDeclaratorIdContext ctx) {
        final DetailAstImpl type = visit(ctx.type);
        final DetailAstImpl root = new DetailAstImpl();
        root.addChild(createModifiers(ctx.mods));
        root.addChild(type);
    ...
    @Override
    public DetailAstImpl visitArrayInitializer(CheckstyleJavaParser.ArrayInitializerContext ctx) {
    ...
    public DetailAstImpl visitSimpleTypeArgument(
            CheckstyleJavaParser.SimpleTypeArgumentContext ctx) {
    ...
    public DetailAstImpl visitWildCardTypeArgument(
            CheckstyleJavaParser.WildCardTypeArgumentContext ctx) {
    ...
    @Override
    public DetailAstImpl visitQualifiedNameList(CheckstyleJavaParser.QualifiedNameListContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitFormalParameters(CheckstyleJavaParser.FormalParametersContext ctx) {
        final DetailAstImpl lparen = create(ctx.LPAREN());
    ...
    public DetailAstImpl visitFormalParameterList(
            CheckstyleJavaParser.FormalParameterListContext ctx) {
    ...
    @Override
    public DetailAstImpl visitFormalParameter(CheckstyleJavaParser.FormalParameterContext ctx) {
    ...
    public DetailAstImpl visitLastFormalParameter(
            CheckstyleJavaParser.LastFormalParameterContext ctx) {
    ...
    public DetailAstImpl visitQualifiedName(CheckstyleJavaParser.QualifiedNameContext ctx) {
        DetailAstImpl ast = create(ctx.start);
        final DetailAstPair currentAst = new DetailAstPair();
    ...
    @Override
    public DetailAstImpl visitLiteral(CheckstyleJavaParser.LiteralContext ctx) {
        return flattenedTree(ctx);
    }
    ...
    @Override
    public DetailAstImpl visitTextBlockLiteral(CheckstyleJavaParser.TextBlockLiteralContext ctx) {
    ...
    @Override
    public DetailAstImpl visitAnnotations(CheckstyleJavaParser.AnnotationsContext ctx) {
    ...
    @Override
    public DetailAstImpl visitAnnotation(CheckstyleJavaParser.AnnotationContext ctx) {
    ...
    @Override
    public DetailAstImpl visitElementValuePairs(CheckstyleJavaParser.ElementValuePairsContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitElementValuePair(CheckstyleJavaParser.ElementValuePairContext ctx) {
    ...
    @Override
    public DetailAstImpl visitElementValue(CheckstyleJavaParser.ElementValueContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitElementValueArrayInitializer(
            CheckstyleJavaParser.ElementValueArrayInitializerContext ctx) {
    ...
    public DetailAstImpl visitAnnotationTypeElementDeclaration(
            CheckstyleJavaParser.AnnotationTypeElementDeclarationContext ctx) {
        final DetailAstImpl returnTree;
        if (ctx.SEMI() == null) {
    ...
    @Override
    public DetailAstImpl visitAnnotationField(CheckstyleJavaParser.AnnotationFieldContext ctx) {
        final DetailAstImpl dummyNode = new DetailAstImpl();
    ...
    @Override
    public DetailAstImpl visitAnnotationType(CheckstyleJavaParser.AnnotationTypeContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitAnnotationMethodRest(
            CheckstyleJavaParser.AnnotationMethodRestContext ctx) {
    ...
    @Override
    public DetailAstImpl visitDefaultValue(CheckstyleJavaParser.DefaultValueContext ctx) {
    ...
    @Override
    public DetailAstImpl visitConstructorBlock(CheckstyleJavaParser.ConstructorBlockContext ctx) {
        // Set SLIST as parent
    ...
    @Override
    public DetailAstImpl visitExplicitCtorCall(CheckstyleJavaParser.ExplicitCtorCallContext ctx) {
    ...
    @Override
    public DetailAstImpl visitPrimaryCtorCall(CheckstyleJavaParser.PrimaryCtorCallContext ctx) {
    ...
    @Override
    public DetailAstImpl visitBlock(CheckstyleJavaParser.BlockContext ctx) {
        // Set SLIST as parent
        final DetailAstImpl slist = create(TokenTypes.SLIST, ctx.start);
        // SLIST was child [0]
        processChildren(slist, ctx.children.subList(1, ctx.children.size()));
    ...
    @Override
    public DetailAstImpl visitLocalVar(CheckstyleJavaParser.LocalVarContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitBlockStat(CheckstyleJavaParser.BlockStatContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitAssertExp(CheckstyleJavaParser.AssertExpContext ctx) {
    ...
    @Override
    public DetailAstImpl visitIfStat(CheckstyleJavaParser.IfStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitForStat(CheckstyleJavaParser.ForStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitWhileStat(CheckstyleJavaParser.WhileStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitDoStat(CheckstyleJavaParser.DoStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitTryStat(CheckstyleJavaParser.TryStatContext ctx) {
    ...
    public DetailAstImpl visitTryWithResourceStat(
            CheckstyleJavaParser.TryWithResourceStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitSyncStat(CheckstyleJavaParser.SyncStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitReturnStat(CheckstyleJavaParser.ReturnStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitThrowStat(CheckstyleJavaParser.ThrowStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitBreakStat(CheckstyleJavaParser.BreakStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitContinueStat(CheckstyleJavaParser.ContinueStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitEmptyStat(CheckstyleJavaParser.EmptyStatContext ctx) {
        return create(TokenTypes.EMPTY_STAT, ctx.start);
    }

    @Override
    public DetailAstImpl visitExpStat(CheckstyleJavaParser.ExpStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitLabelStat(CheckstyleJavaParser.LabelStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitYieldStat(CheckstyleJavaParser.YieldStatContext ctx) {
    ...
    public DetailAstImpl visitSwitchExpressionOrStatement(
            CheckstyleJavaParser.SwitchExpressionOrStatementContext ctx) {
    ...
    @Override
    public DetailAstImpl visitSwitchRules(CheckstyleJavaParser.SwitchRulesContext ctx) {
    ...
    @Override
    public DetailAstImpl visitSwitchBlocks(CheckstyleJavaParser.SwitchBlocksContext ctx) {
        final DetailAstImpl dummyRoot = new DetailAstImpl();
    ...
    public DetailAstImpl visitSwitchLabeledExpression(
            CheckstyleJavaParser.SwitchLabeledExpressionContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitSwitchLabeledBlock(
            CheckstyleJavaParser.SwitchLabeledBlockContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitSwitchLabeledThrow(
            CheckstyleJavaParser.SwitchLabeledThrowContext ctx) {
    ...
    @Override
    public DetailAstImpl visitElseStat(CheckstyleJavaParser.ElseStatContext ctx) {
    ...
    @Override
    public DetailAstImpl visitCatchClause(CheckstyleJavaParser.CatchClauseContext ctx) {
    ...
    @Override
    public DetailAstImpl visitCatchParameter(CheckstyleJavaParser.CatchParameterContext ctx) {
        ...
        processChildren(catchParameterDef, ctx.children.stream()
                .filter(child -> !(child instanceof CheckstyleJavaParser.VariableModifierContext))
                .collect(Collectors.toList()));
        return catchParameterDef;
    }

    @Override
    public DetailAstImpl visitCatchType(CheckstyleJavaParser.CatchTypeContext ctx) {
    ...
    @Override
    public DetailAstImpl visitFinallyBlock(CheckstyleJavaParser.FinallyBlockContext ctx) {
    ...
    public DetailAstImpl visitResourceSpecification(
            CheckstyleJavaParser.ResourceSpecificationContext ctx) {
    ...
    @Override
    public DetailAstImpl visitResources(CheckstyleJavaParser.ResourcesContext ctx) {
    ...
    public DetailAstImpl visitResourceDeclaration(
            CheckstyleJavaParser.ResourceDeclarationContext ctx) {
        ...
        // 'RESOURCE' imaginary node takes position of first child
        resource.setColumnNo(resource.getFirstChild().getColumnNo());
        resource.setLineNo(resource.getFirstChild().getLineNo());
        return resource;
    }

    @Override
    public DetailAstImpl visitVariableAccess(CheckstyleJavaParser.VariableAccessContext ctx) {
    ...
    public DetailAstImpl visitSwitchBlockStatementGroup(
            CheckstyleJavaParser.SwitchBlockStatementGroupContext ctx) {
    ...
    @Override
    public DetailAstImpl visitCaseLabel(CheckstyleJavaParser.CaseLabelContext ctx) {
    ...
    @Override
    public DetailAstImpl visitDefaultLabel(CheckstyleJavaParser.DefaultLabelContext ctx) {
    ...
    @Override
    public DetailAstImpl visitCaseConstants(CheckstyleJavaParser.CaseConstantsContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitEnhancedFor(CheckstyleJavaParser.EnhancedForContext ctx) {
    ...
    @Override
    public DetailAstImpl visitForFor(CheckstyleJavaParser.ForForContext ctx) {
        final DetailAstImpl dummyRoot = new DetailAstImpl();
        ...
        if (ctx.forCond == null) {
            final DetailAstImpl imaginaryForCondParent =
                    createImaginary(TokenTypes.FOR_CONDITION);
        ...
        if (ctx.forUpdate == null) {
            final DetailAstImpl imaginaryForItParent =
                    createImaginary(TokenTypes.FOR_ITERATOR);
    ...
    @Override
    public DetailAstImpl visitForInit(CheckstyleJavaParser.ForInitContext ctx) {
    ...
    public DetailAstImpl visitEnhancedForControl(
            CheckstyleJavaParser.EnhancedForControlContext ctx) {
        final DetailAstImpl variableDeclaratorId =
    ...
    @Override
    public DetailAstImpl visitParExpression(CheckstyleJavaParser.ParExpressionContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitExpressionList(CheckstyleJavaParser.ExpressionListContext ctx) {
    ...
    @Override
    public DetailAstImpl visitMethodCall(CheckstyleJavaParser.MethodCallContext ctx) {
    ...
    @Override
    public DetailAstImpl visitMethodExp(CheckstyleJavaParser.MethodExpContext ctx) {
    ...
    @Override
    public DetailAstImpl visitExpression(CheckstyleJavaParser.ExpressionContext ctx) {
    ...
    @Override
    public DetailAstImpl visitPrimaryExp(CheckstyleJavaParser.PrimaryExpContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitParenPrimary(CheckstyleJavaParser.ParenPrimaryContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitTokenPrimary(CheckstyleJavaParser.TokenPrimaryContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitClassRefPrimary(CheckstyleJavaParser.ClassRefPrimaryContext ctx) {
        final DetailAstImpl dot = create(ctx.DOT());
    ...
    @Override
    public DetailAstImpl visitPrimitivePrimary(CheckstyleJavaParser.PrimitivePrimaryContext ctx) {
        final DetailAstImpl dot = create(ctx.DOT());
        final DetailAstImpl primaryTypeNoArray = visit(ctx.type);
        dot.addChild(primaryTypeNoArray);
    ...
    public DetailAstImpl visitPrimaryClassOrInterfaceTypeNoArray(
            CheckstyleJavaParser.PrimaryClassOrInterfaceTypeNoArrayContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitPrimaryPrimitiveTypeNoArray(
            CheckstyleJavaParser.PrimaryPrimitiveTypeNoArrayContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitRefOp(CheckstyleJavaParser.RefOpContext ctx) {
    ...
    @Override
    public DetailAstImpl visitBinOp(CheckstyleJavaParser.BinOpContext ctx) {
        final DetailAstImpl bop = create(ctx.bop);

        // To improve performance, we iterate through binary operations
        // since they are frequently deeply nested.
        final List<CheckstyleJavaParser.BinOpContext> binOpList = new ArrayList<>();
        ParseTree firstExpression = ctx.expr(0);
        while (firstExpression instanceof CheckstyleJavaParser.BinOpContext) {
            // Get all nested binOps
            binOpList.add((CheckstyleJavaParser.BinOpContext) firstExpression);
            firstExpression = ((CheckstyleJavaParser.BinOpContext) firstExpression).expr(0);
        }
     ...
     * @return binOp AST
     */
    private DetailAstImpl getInnerBopAst(CheckstyleJavaParser.BinOpContext descendant) {
        final DetailAstImpl innerBop = create(descendant.bop);
        if (!(descendant.expr(0) instanceof CheckstyleJavaParser.BinOpContext)) {
    ...
    @Override
    public DetailAstImpl visitInitExp(CheckstyleJavaParser.InitExpContext ctx) {
    ...
    @Override
    public DetailAstImpl visitSuperExp(CheckstyleJavaParser.SuperExpContext ctx) {
        final DetailAstImpl bop = create(ctx.bop);
    ...
    @Override
    public DetailAstImpl visitInvOp(CheckstyleJavaParser.InvOpContext ctx) {
        final DetailAstPair currentAst = new DetailAstPair();
    ...
    @Override
    public DetailAstImpl visitIndexOp(CheckstyleJavaParser.IndexOpContext ctx) {
    ...
    @Override
    public DetailAstImpl visitSimpleMethodExp(CheckstyleJavaParser.SimpleMethodExpContext ctx) {
        final DetailAstImpl root = visit(ctx.methodCall());
        root.getFirstChild().addPreviousSibling(visit(ctx.mCall.children.get(0)));
        return root;
    }

    @Override
    public DetailAstImpl visitNewExp(CheckstyleJavaParser.NewExpContext ctx) {
    ...
    @Override
    public DetailAstImpl visitCastExp(CheckstyleJavaParser.CastExpContext ctx) {
    ...
    @Override
    public DetailAstImpl visitBitShift(CheckstyleJavaParser.BitShiftContext ctx) {
    ...
    @Override
    public DetailAstImpl visitInstanceOfExp(CheckstyleJavaParser.InstanceOfExpContext ctx) {
    ...
    @Override
    public DetailAstImpl visitTernaryOp(CheckstyleJavaParser.TernaryOpContext ctx) {
    ...
    @Override
    public DetailAstImpl visitLambdaExp(CheckstyleJavaParser.LambdaExpContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitMethodRef(CheckstyleJavaParser.MethodRefContext ctx) {
    ...
    public DetailAstImpl visitTypeCastParameters(
            CheckstyleJavaParser.TypeCastParametersContext ctx) {
    ...
    @Override
    public DetailAstImpl visitLambdaExpression(CheckstyleJavaParser.LambdaExpressionContext ctx) {
    ...
    @Override
    public DetailAstImpl visitSingleLambdaParam(CheckstyleJavaParser.SingleLambdaParamContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitFormalLambdaParam(CheckstyleJavaParser.FormalLambdaParamContext ctx) {
        final DetailAstImpl lparen = create(ctx.LPAREN());
    ...
    @Override
    public DetailAstImpl visitMultiLambdaParam(CheckstyleJavaParser.MultiLambdaParamContext ctx) {
        final DetailAstImpl lparen = create(ctx.LPAREN());
    ...
    @Override
    public DetailAstImpl visitMultiLambdaParams(CheckstyleJavaParser.MultiLambdaParamsContext ctx) {
        final DetailAstImpl parameters = createImaginary(TokenTypes.PARAMETERS);
     ...
     */
    private DetailAstImpl createLambdaParameter(CheckstyleJavaParser.IdContext ctx) {
    ...
    @Override
    public DetailAstImpl visitCreator(CheckstyleJavaParser.CreatorContext ctx) {
        return flattenedTree(ctx);
    }
    ...
    public DetailAstImpl visitCreatedNamePrimitive(
            CheckstyleJavaParser.CreatedNamePrimitiveContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitInnerCreator(CheckstyleJavaParser.InnerCreatorContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitArrayCreatorRest(CheckstyleJavaParser.ArrayCreatorRestContext ctx) {
    ...
    @Override
    public DetailAstImpl visitBracketsWithExp(CheckstyleJavaParser.BracketsWithExpContext ctx) {
        final DetailAstImpl dummyRoot = new DetailAstImpl();
    ...
    @Override
    public DetailAstImpl visitClassCreatorRest(CheckstyleJavaParser.ClassCreatorRestContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitDiamond(CheckstyleJavaParser.DiamondContext ctx) {
    ...
    @Override
    public DetailAstImpl visitTypeArgs(CheckstyleJavaParser.TypeArgsContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitNonWildcardDiamond(
            CheckstyleJavaParser.NonWildcardDiamondContext ctx) {
        final DetailAstImpl typeArguments =
                createImaginary(TokenTypes.TYPE_ARGUMENTS);
        typeArguments.addChild(create(TokenTypes.GENERIC_START,
                (Token) ctx.LT().getPayload()));
    ...
    public DetailAstImpl visitNonWildcardTypeArguments(
            CheckstyleJavaParser.NonWildcardTypeArgumentsContext ctx) {
    ...
    public DetailAstImpl visitTypeArgumentsTypeList(
            CheckstyleJavaParser.TypeArgumentsTypeListContext ctx) {
    ...
    @Override
    public DetailAstImpl visitTypeList(CheckstyleJavaParser.TypeListContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitArrayDeclarator(CheckstyleJavaParser.ArrayDeclaratorContext ctx) {
        final DetailAstImpl arrayDeclarator = create(TokenTypes.ARRAY_DECLARATOR,
                (Token) ctx.LBRACK().getPayload());
        arrayDeclarator.addChild(create(ctx.RBRACK()));
    ...
    @Override
    public DetailAstImpl visitPrimitiveType(CheckstyleJavaParser.PrimitiveTypeContext ctx) {
        return create(ctx.start);
    }

    @Override
    public DetailAstImpl visitTypeType(CheckstyleJavaParser.TypeTypeContext ctx) {
        final DetailAstImpl type = createImaginary(TokenTypes.TYPE);
        processChildren(type, ctx.children);
    ...
    @Override
    public DetailAstImpl visitTypeArguments(CheckstyleJavaParser.TypeArgumentsContext ctx) {
        final DetailAstImpl typeArguments = createImaginary(TokenTypes.TYPE_ARGUMENTS);
        typeArguments.addChild(create(TokenTypes.GENERIC_START, (Token) ctx.LT().getPayload()));
        // Exclude '<' and '>'
    ...
    @Override
    public DetailAstImpl visitSuperSuffixDot(CheckstyleJavaParser.SuperSuffixDotContext ctx) {
        final DetailAstImpl root;
        if (ctx.LPAREN() == null) {
            root = create(ctx.DOT());
            root.addChild(visit(ctx.id()));
    ...
    @Override
    public DetailAstImpl visitArguments(CheckstyleJavaParser.ArgumentsContext ctx) {
        final DetailAstImpl lparen = create(ctx.LPAREN());
    ...
    public DetailAstImpl visitPatternVariableDefinition(
            CheckstyleJavaParser.PatternVariableDefinitionContext ctx) {
        final DetailAstImpl type = visit(ctx.type);
    ...
    public DetailAstImpl visitPermittedSubclassesAndInterfaces(
            CheckstyleJavaParser.PermittedSubclassesAndInterfacesContext ctx) {
    ...
    @Override
    public DetailAstImpl visitId(CheckstyleJavaParser.IdContext ctx) {
    ...
    private DetailAstImpl createTypeDeclaration(ParserRuleContext ctx, int type,
        ...
        // typeDeclaration imaginary node takes position of first child
        typeDeclaration.setColumnNo(typeDeclaration.getFirstChild().getColumnNo());
        typeDeclaration.setLineNo(typeDeclaration.getFirstChild().getLineNo());
        return typeDeclaration;
    }
    ...
    private DetailAstImpl createModifiers(List<? extends ParseTree> modifierList) {
        ...
        if (modifierList.isEmpty()) {
            ...
            mods = createImaginary(TokenTypes.MODIFIERS);
        }
        else {
            mods = createImaginary(TokenTypes.MODIFIERS);
