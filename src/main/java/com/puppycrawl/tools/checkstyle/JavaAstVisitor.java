...
public final class JavaAstVisitor extends JavaLanguageParserBaseVisitor<DetailAstImpl> {
    ...
    @Override
    public DetailAstImpl visitCompactMemberBeforeMethod(
            JavaLanguageParser.CompactMemberBeforeMethodContext ctx) {
    ...
    @Override
    public DetailAstImpl visitCompactFirstMethod(JavaLanguageParser.CompactFirstMethodContext ctx) {
        return visit(ctx.methodDeclaration());
    }

    @Override
    public DetailAstImpl visitCompactMemberAfterMethod(
            JavaLanguageParser.CompactMemberAfterMethodContext ctx) {
        final DetailAstImpl member;
        if (ctx.type == null) {
            member = create(ctx.semi.getFirst());
            ctx.semi.subList(1, ctx.semi.size())
    ...
    @Override
    public DetailAstImpl visitCompactMemberNoMethod(
            JavaLanguageParser.CompactMemberNoMethodContext ctx) {
        return flattenedTree(ctx);
    }

    @Override
    public DetailAstImpl visitCompactMember(JavaLanguageParser.CompactMemberContext ctx) {
        return flattenedTree(ctx);
    }
