...
public final class JavaAstVisitor extends CheckstyleJavaParserBaseVisitor<DetailAstImpl> {
    ...
    private DetailAstImpl createLambdaParameter(CheckstyleJavaParser.IdContext ctx) {
        ...
        final DetailAstImpl parameter = copy(TokenTypes.PARAMETER_DEF, ident);
     ...
     */
    private DetailAstImpl getStartToken(List<CheckstyleJavaParser.ModifierContext> modifierList,
                                        Token start) {
        final DetailAstImpl startToken;
        if (modifierList.isEmpty()) {
