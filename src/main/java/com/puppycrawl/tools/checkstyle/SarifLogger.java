...
public class SarifLogger extends AutomaticBean implements AuditListener {
    ...
    /** The upper limit for escaping unicode. */
    private static final char ESCAPE_UPPER_LIMIT = 0x1F;
    ...
    public void auditStarted(AuditEvent event) {
        ...
        writer.println("          \"guid\": \"1826873e-87b4-11eb-8dcd-0242ac130003\",");
    ...
    private static String escapeUnicode1F(char chr) {
        ...
        for (int k = 0; k < UNICODE_LENGTH - hexString.length(); k++) {
