 ...
 */
public class SuppressionFileGeneratorAuditListener
     ...
     */
    public SuppressionFileGeneratorAuditListener(OutputStream out,
    ...
    private void printXmlHeader() {
        if (!isXmlHeaderPrinted) {
            ...
            writer.println("    \"-//Checkstyle//DTD Checkstyle "
