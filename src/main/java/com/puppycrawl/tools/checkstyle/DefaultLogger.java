...
public class DefaultLogger extends AutomaticBean implements AuditListener {
    ...
    public void addException(AuditEvent event, Throwable throwable) {
        synchronized (errorWriter) {
            final LocalizedMessage addExceptionMessage = new LocalizedMessage(
                    new String[] {event.getFileName()}, ADD_EXCEPTION_MESSAGE);
    ...
    public void auditStarted(AuditEvent event) {
        final LocalizedMessage auditStartMessage = new LocalizedMessage(null,
    ...
    public void auditFinished(AuditEvent event) {
        final LocalizedMessage auditFinishMessage = new LocalizedMessage(null,
    ...
    /* package */ static class LocalizedMessage {
        ...
        /* package */LocalizedMessage(Object[] args, String key) {
            this.key = key;
            if (args == null) {
                this.args = null;
            }
