...
public class DefaultLogger extends AutomaticBean implements AuditListener {
     ...
     */
    /* package */ static class LocalizedMessage {
        ...
        /* package */LocalizedMessage(String key, Object... args) {
            this.key = key;
            if (args == null) {
                this.args = null;
            }
        ...
        private ResourceBundle getBundle(String bundleName) {
            return BUNDLE_CACHE.computeIfAbsent(bundleName, name -> {
                return ResourceBundle.getBundle(
                        name, locale, LocalizedMessage.class.getClassLoader(), new Utf8Control());
            });
        }
         ...
         * </p>
         */
        /* package */static class Utf8Control extends ResourceBundle.Control {

            @Override
            public ResourceBundle newBundle(String baseName, Locale bundleLocale, String format,
                                            ClassLoader loader, boolean reload) throws IOException {
                // The below is a copy of the default implementation.
                final String bundleName = toBundleName(baseName, bundleLocale);
                ...
                if (url != null) {
                    ...
                    if (connection != null) {
                        ...
                        try (Reader streamReader = new InputStreamReader(
