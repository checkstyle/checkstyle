...
//    'Annotation 'Deprecated' should be alone on line.'
//    'Annotation 'CheckReturnValue' should be alone on line.'
// violation 3 lines below 'Top-level class .* has to reside in its own source file.'
/** Somejavadoc data. */
@Deprecated @CheckReturnValue
...
// violation 5 lines below 'Top-level class InputClassAnnotation5 has to reside'
/** Some javadoc. */
@Deprecated
// testing
@CheckReturnValue
