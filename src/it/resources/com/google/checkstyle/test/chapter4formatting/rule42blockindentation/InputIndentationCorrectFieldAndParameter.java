...
class InputIndentationCorrectFieldAndParameter { // indent:0 exp:0
  ...
  boolean flag =
      conditionFirst(
          ...
          new // indent:2 exp:2
              SecondFieldLongNam2("Loooooooooooooooooog")
              . // indent:6 exp:6
  ...
  boolean secondFlag =
      conditionSecond(
              ...
              new // indent:2 exp:2
                  SecondFieldLongNam2(
                      "Looooooooooooo" // indent:6 exp:6
                          + "oooooooooooong")
                  .getString(
                      new FooFieldClass(), // indent:6 exp:6
                      new SecondFieldLongNam2("loooooooooong")
                          . // indent:6 exp:6
                          getInteger(new FooFieldClass(), "loooooooooooooong")),
              "loooooooooooong") // indent:6 exp:6
          || conditionThird(2048)
          || conditionFourth(
              new // indent:6 exp:6
                  SecondFieldLongNam2(
                      "Looooooooooooooo" // indent:6 exp:6
                          + "ooooooooooooong")
          ...
          conditionFifth(
              ...
              new SecondFieldLongNam2(
                  ...
                  .getBoolean( // indent:6 exp:6
                      new FooFieldClass(), true))
          || conditionSixth(
              false,
              new // indent:6 exp:6
              SecondFieldLongNam2(
                ...
                new // indent:4 exp:4
                    SecondFieldLongNam2(
                        "Looooooooooooo" // indent:8 exp:8
                            + "oooooooooooong")
                    .getString(
                        new FooFieldClass(), // indent:11 exp:>=8
                        new SecondFieldLongNam2("loooooooooong")
                            . // indent:10 exp:>=8
                            getInteger(new FooFieldClass(), "looooooooong")),
                "loooooooooooong") // indent:12 exp:>=8
            || conditionThird(2048)
            || conditionFourth(
                new // indent:13 exp:>=8
                    SecondFieldLongNam2(
                        "Looooooooooooooo" // indent:16 exp:>=8
                            + "ooooooooooooong")
                    .getBoolean(new FooFieldClass(), false))
            || // indent:12 exp:>=8
            conditionFifth(
                ...
                new SecondFieldLongNam2(
                        getString(
                            2048,
                            "Looo" // indent:11 exp:>=8
                                + "ooooooooooooooooooooooooooooooooooooooooooong"))
                    .getBoolean( // indent:15 exp:>=8
                        new FooFieldClass(), true))
            || conditionSixth(
                false,
                new // indent:12 exp:>=8
                SecondFieldLongNam2(
                    getString(
                        100000,
                        "Loooooong" // indent:12 exp:>=8
                            + "Fooooooo><")))
            || conditionNoArg() // indent:16 exp:>=8
            || conditionNoArg()
            || // indent:10 exp:>=8
            conditionNoArg()
              ...
              conditionSecond(
                      ...
                      new // indent:6 exp:6
                          SecondFieldLongNam2(
                              "Looooooooooooo" // indent:10 exp:10
                                  + "oooooooooooong")
                          .getString(
                              new FooFieldClass(), // indent:12 exp:>=10
                              new SecondFieldLongNam2("loooooooooong")
                                  . // indent:15 exp:>=10
                                  getInteger(new FooFieldClass(), "looooooong")),
                      "loooooooooooong") // indent:13 exp:>=10
                  || conditionThird(2048)
                  || conditionFourth(
                      new // indent:14 exp:>=10
                          SecondFieldLongNam2(
                              "Looooooooooooooo" // indent:17 exp:>=10
                                  + "ooooooooooooong")
                          .getBoolean(new FooFieldClass(), false))
                  || // indent:13 exp:>=10
                  conditionFifth(
                  ...
                  || conditionSixth(
                      ...
                      SecondFieldLongNam2(
                          getString(
                              100000,
                              "Loooooong" // indent:13 exp:>=10
                                  + "Fooooooo><")))
                  || conditionNoArg() // indent:17 exp:>=10
                  || conditionNoArg()
                  || // indent:11 exp:>=10
                  conditionNoArg()
...
class SecondFieldLongNam2 { // indent:0 exp:0
  ...
  SecondFieldLongNam2 getInstance() { // indent:2 exp:2
    return new SecondFieldLongNam2(
