...
sealed class Four extends InputModifierOrderSealed
    ...
    permits TransparentFour, FilledFour {
}

// violation below 'Top-level class TransparentFour has to reside in its own source file'
final class TransparentFour extends Four {
}
...
sealed class Three extends InputModifierOrderSealed
  ...
  sealed private class OtherSquare extends Three permits OtherSquare2 {
  }
