...
final class InputColumnLimit {
  ...
  /**
   * Some javadoc.
   * Very long url with https: https://github.com/checkstyle/checkstyle/blob/main/src/main/java/com/puppycrawl/tools/checkstyle/checks/AvoidEscapedUnicodeCharactersCheck.java
   */
  String https = "200 OK";

  /**
   * Some javadoc.
   * Very long url with http: http://github.com/checkstyle/checkstyle/blob/main/src/main/java/com/puppycrawl/tools/checkstyle/checks/AvoidEscapedUnicodeCharactersCheck.java
   */
  String http = "200 OK";
