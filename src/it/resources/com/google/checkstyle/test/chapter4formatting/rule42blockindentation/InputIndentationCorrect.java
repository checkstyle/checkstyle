...
public abstract class InputIndentationCorrect { // indent:0 exp:0
  ...
  public boolean veryLongLongLongCondition() { // indent:2 exp:2
    // indent:4 exp:4
    // indent:4 exp:4
    return veryLongLongLongCondition2(); // indent:6 exp:6
    // indent:4 exp:4
  } // indent:2 exp:2
  ...
  public void someFooMethod(
      String longString, // indent:2 exp:2
      String superLongString,
      String exraSuperLongString) {} // indent:6 exp:6
  ...
  public void doSmth() { // indent:2 exp:2
    for (int h // indent:4 exp:4
      ...
      someFooMethod(
          "longString",
          "veryLongString", // indent:6 exp:6
          "superVeryExtraLongString"); // indent:10 exp:10
    } // indent:4 exp:4
  } // indent:2 exp:2

  private abstract static class RangesMatcher { // indent:2 exp:2
    ...
    public static final InputIndentationCorrect JAVA_LETTER_OR_DIGIT = // indent:4 exp:4
        new InputIndentationCorrect() { // indent:8 exp:8
          @Override
          public boolean matches(char c) { // indent:10 exp:10
    ...
    public static final InputFastMatcher NONE = // indent:4 exp:4
        new InputFastMatcher() { // indent:12 exp:>=8
          @Override
          public boolean matches(char c) { // indent:6 exp:6
            return false; // indent:8 exp:8
          } // indent:6 exp:6

          @Override
          public String replaceFrom(CharSequence seq, CharSequence repl) { // indent:6 exp:6
          ...
          public String collapseFrom(
              CharSequence sequence, // indent:6 exp:6
