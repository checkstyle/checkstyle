...
public class InputLineLengthJsniMethods {
  ...
  public static native void alertMessage2(String msggggggggggggggggggggggggggggggggggggggggggggggggggg) /*- { // warn
    $wnd.alert(msg);
    console.log('a really long message here blah blah blah blah blah bruh bruh bruhhhhhhhhhhhhhhhhhhhhhhhhhhhh'); // warn
  }-*/;
}
