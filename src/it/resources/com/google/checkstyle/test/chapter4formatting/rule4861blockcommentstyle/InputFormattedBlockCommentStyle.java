...
class ExtraClass2 {
  ...
  public void foo7() {
    int a = 2;
    String s = "";
    // violation 4 lines below '.* indentation should be the same level as line 677.'
    switch (a) {
        // comment
        // comment
        // comment
  ...
  public void foo8() {
    int a = 2;
    String s = "";
    // violation 4 lines below '.* indentation should be the same level as line 710.'
    switch (a) {
        // comment
        // comment
        // comment
  ...
  public void foo12() {
    int a = 5;
    // violation 2 lines below '.* indentation should be the same level as line 768.'
    switch (a) {
        // comment
      case 1:
      default:
