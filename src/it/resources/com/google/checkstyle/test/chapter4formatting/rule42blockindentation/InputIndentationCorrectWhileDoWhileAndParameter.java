...
class InputIndentationCorrectWhileDoWhileAndParameter { // indent:0 exp:0
  ...
  void fooMethodWithIf() { // indent:2 exp:2
    ...
    while (conditionSecond(
            ...
            new // indent:4 exp:4
                SecondWhileLongNam1(
                    "Looooooooooooo" // indent:9 exp:>=8
                        + "oooooooooooong")
                .getString(
                    new FooWhileClass(), // indent:8 exp:8
                    new SecondWhileLongNam1("loooooooooong")
                        . // indent:11 exp:>=8
                        getInteger(new FooWhileClass(), "loooooooooooooong")),
            "loooooooooooong") // indent:8 exp:8
        || conditionThird(2048)
        || conditionFourth(
            new // indent:14 exp:>=8
                SecondWhileLongNam1(
                    "Looooooooooooooo" // indent:14 exp:>=8
                        + "ooooooooooooong")
                .getBoolean(new FooWhileClass(), false))
        || // indent:8 exp:8
        conditionFifth(
            true,
            new SecondWhileLongNam1( // indent:12 exp:>=8
                    getString(
                        2048,
                        "Looo" // indent:12 exp:>=8
                            + "ooooooooooooooooooooooooooooooooooooooooooong"))
                .getBoolean( // indent:8 exp:8
                    new FooWhileClass(), true))
        || conditionSixth(
            false,
            new // indent:8 exp:8
            SecondWhileLongNam1(
    ...
    do { // indent:4 exp:4
            ...
            new // indent:4 exp:4
                SecondWhileLongNam1(
                    "Looooooooooooo" // indent:10 exp:>=8
                        + "oooooooooooong")
                .getString(
                    new FooWhileClass(), // indent:10 exp:>=8
                    new SecondWhileLongNam1("loooooooooong")
                        . // indent:8 exp:8
                        getInteger(new FooWhileClass(), "loooooooong")),
            "loooooooooooong") // indent:13 exp:>=8
        || conditionThird(2048)
        || conditionFourth(
            new // indent:8 exp:8
                SecondWhileLongNam1(
                    "Looooooooooooooo" // indent:11 exp:>=8
                        + "ooooooooooooong")
                .getBoolean(new FooWhileClass(), false))
        || // indent:8 exp:8
        conditionFifth(
  ...
  private boolean conditionFirst(
      ...
      int // indent:2 exp:2
          integer,
      InnerClassFoo someInstance) { // indent:6 exp:6
    return false; // indent:4 exp:4
  } // indent:2 exp:2

  private boolean conditionSecond(
      double longLongLongDoubleValue, // indent:2 exp:2
      String longLongLongString,
      String secondLongLongString) { // indent:6 exp:6
    return false; // indent:4 exp:4
  } // indent:2 exp:2
  ...
  private boolean conditionSixth(
  ...
  class InnerClassFoo { // indent:2 exp:2
    ...
    FooWhileClass anonymousClass = new FooWhileClass() { // indent:4 exp:4
          ...
          void fooMethodWithIf(
              String stringStringStringStringLooooongString, // indent:6 exp:6
              int intIntIntVeryLongNameForIntVariable,
              boolean // indent:10 exp:10
            ...
            while (conditionSecond(
                    ...
                    new // indent:8 exp:8
                        SecondWhileLongNam1(
                            "Looooooooooooo" // indent:12 exp:12
                                + "oooooooooooong")
                        .getString(
                            new FooWhileClass(), // indent:12 exp:12
                            new SecondWhileLongNam1("loooooooooong")
                                . // indent:12 exp:12
                                getInteger(new FooWhileClass(), "loooooooooong")),
                    "loooooooooooong") // indent:12 exp:12
                || conditionThird(2048)
                || conditionFourth(
                    new // indent:12 exp:12
                        SecondWhileLongNam1(
                            "Looooooooooooooo" // indent:12 exp:12
                                + "ooooooooooooong")
                        .getBoolean(new FooWhileClass(), false))
                || // indent:14 exp:>=12
                conditionFifth(
                    ...
                    new SecondWhileLongNam1(
                            getString(
                                ...
                                "Lo" // indent:14 exp:>=12
                                    + "ooooooooooooooooooooooooooooooooooooooooooong"))
                        .getBoolean( // indent:14 exp:>=12
                            new FooWhileClass(), true))
                || conditionSixth(
                    false,
                    new // indent:14 exp:>=12
                    SecondWhileLongNam1(
                        getString(
                            100000,
                            "Loooooong" // indent:16 exp:>=12
                                + "Fooooooo><")))
                || conditionNoArg() // indent:16 exp:>=12
                || conditionNoArg()
                || // indent:16 exp:>=12
                conditionNoArg()
                || conditionNoArg() // indent:18 exp:>=12
    ...
    void fooMethodWithIf() { // indent:4 exp:4
      ...
      while (conditionSecond(
              ...
              new // indent:6 exp:6
                  SecondWhileLongNam1(
                      "Looooooooooooo" // indent:10 exp:10
                          + "oooooooooooong")
                  .getString(
                      new FooWhileClass(), // indent:10 exp:10
                      new SecondWhileLongNam1("loooooooooong")
                          . // indent:10 exp:10
                          getInteger(new FooWhileClass(), "loooooooooooong")),
              "loooooooooooong") // indent:10 exp:10
          || conditionThird(2048)
          || conditionFourth(
              new // indent:10 exp:10
                  SecondWhileLongNam1(
                      "Looooooooooooooo" // indent:10 exp:10
                          + "ooooooooooooong")
                  .getBoolean(new FooWhileClass(), false))
          || // indent:12 exp:>=10
          conditionFifth(
              ...
              new SecondWhileLongNam1(
                      getString(
                          2048,
                          "Looo" // indent:12 exp:>=10
                              + "ooooooooooooooooooooooooooooooooooooooooooong"))
                  .getBoolean( // indent:12 exp:>=10
                      new FooWhileClass(), true))
          || conditionSixth(
              false,
              new // indent:12 exp:>=10
              SecondWhileLongNam1(
                  getString(
                      100000,
                      "Loooooong" // indent:14 exp:>=10
                          + "Fooooooo><")))
...
class SecondWhileLongNam1 { // indent:0 exp:0
  ...
  SecondWhileLongNam1 getInstance() { // indent:2 exp:2
    return new SecondWhileLongNam1(
        "VeryLoooooooooo" // indent:4 exp:4
