...
// violation above ''implements' has incorrect indentation level 0, expected level should be 4.'
  ...
  public void run() { // indent:2 exp:2
    ...
    SecondClassWithLongLongLongLongName anon2 =
        new // indent:4 exp:4
  ...
  // violation above ''extends' has incorrect indentation level 2, expected level should be 6.'
...
// violation above ''extends' has incorrect indentation level 0, expected level should be 4.'
