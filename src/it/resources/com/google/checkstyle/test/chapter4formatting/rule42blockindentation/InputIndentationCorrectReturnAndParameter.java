            ...
            new // indent:4 exp:4
                SecondClassLongNam4(
                    "Looooooooooooo" // indent:8 exp:8
                        + "oooooooooooong")
                .getString(
                    new FooReturnClass(), // indent:8 exp:8
    ...
    FooReturnClass anonymousClass = new FooReturnClass() { // indent:4 exp:4
                    ...
                    new // indent:8 exp:8
                        SecondClassLongNam4(
                            "Looooooooooooo" // indent:12 exp:12
                                + "oooooooooooong")
                        .getString(
                            new FooReturnClass(), // indent:12 exp:12
                            new SecondClassLongNam4("loooooooooong")
                                . // indent:12 exp:12
          ...
          boolean fooReturn() { // indent:6 exp:6
            return conditionFirst(
                ...
                new // indent:8 exp:8
                    SecondClassLongNam4("Loooooooooooooooooog")
                    . // indent:12 exp:12
              ...
              new // indent:6 exp:6
                  SecondClassLongNam4(
                      "Looooooooooooo" // indent:10 exp:10
                          + "oooooooooooong")
                  .getString(
                      new FooReturnClass(), // indent:10 exp:10
                      new SecondClassLongNam4("loooooooooong")
                          . // indent:10 exp:10
...
class SecondClassLongNam4 { // indent:0 exp:0
  ...
  SecondClassLongNam4 getInstance() { // indent:2 exp:2
    return new SecondClassLongNam4(
