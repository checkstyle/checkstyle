...
abstract strictfp class InputFormattedModifierOrder {
  ...
  // violation above ''@MyAnnotationFormatted' .* does not precede non-annotation modifiers.'
  ...
  // violation above ''@MyAnnotationFormatted2' .* does not precede non-annotation modifiers.'
