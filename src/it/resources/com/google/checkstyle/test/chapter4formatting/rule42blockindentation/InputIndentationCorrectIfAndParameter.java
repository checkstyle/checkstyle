...
class InputIndentationCorrectIfAndParameter { // indent:0 exp:0
  ...
  void fooMethodWithIf() { // indent:2 exp:2
    ...
    if (conditionFirst(
        ...
        new // indent:4 exp:4
            SecondClassLongNam3("Loooooooooooooooooog")
            . // indent:8 exp:8
    ...
    if (conditionSecond(
            ...
            new // indent:4 exp:4
                SecondClassLongNam3(
                    "Looooooooooooo" // indent:8 exp:8
                        + "oooooooooooong")
                .getString(
                    new FooIfClass(), // indent:8 exp:8
                    new SecondClassLongNam3("loooooooooong")
                        . // indent:8 exp:10,12 warn
        ...
        || conditionFourth(
            new // indent:8 exp:8
                SecondClassLongNam3(
                    "Looooooooooooooo" // indent:8 exp:8
                        + "ooooooooooooong")
        ...
        || conditionSixth(
            false,
            new // indent:8 exp:10,12 warn
            SecondClassLongNam3(
                getString(
                    100000,
                    "Loooooong" // indent:8 exp:8
                        + "Fooooooo><")))
                    ...
                    new // indent:8 exp:8
                        SecondClassLongNam3(
                            "Looooooooooooo" // indent:12 exp:12
                                + "oooooooooooong")
                        .getString(
                            new FooIfClass(), // indent:12 exp:12
                            new SecondClassLongNam3("loooooooooong")
                                . // indent:12 exp:14,16 warn
              ...
              new // indent:6 exp:6
                  SecondClassLongNam3(
                      "Looooooooooooo" // indent:10 exp:10
                          + "oooooooooooong")
                  .getString(
                      new FooIfClass(), // indent:10 exp:10
                      new SecondClassLongNam3("loooooooooong")
                          . // indent:10 exp:12,14 warn
                          getInteger(new FooIfClass(), "loooooooooooooong")),
...
class SecondClassLongNam3 { // indent:0 exp:0
  ...
  SecondClassLongNam3 getInstance() { // indent:2 exp:2
    return new SecondClassLongNam3(
