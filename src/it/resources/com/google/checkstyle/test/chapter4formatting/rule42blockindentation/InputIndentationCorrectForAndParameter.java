...
class InputIndentationCorrectForAndParameter { // indent:0 exp:0
  ...
  void fooMethodWithIf() { // indent:2 exp:2
    ...
    for (int i =
            new SecondForClassWithLongName1(
                    "Loooooooooooooooooooo" // indent:4 exp:4
                        + "oong")
                .getInteger(
                    new FooForClass(), // indent:8 exp:8
                    getString(1000000000, "Loooooooooooooooong"));
        i < 10;
        i++) {} // indent:10 exp:>=8
    ...
    for (Map.Entry<String, String> entry :
        new SecondForClassWithLongName1(
            ...
            .getMap(
                new // indent:8 exp:8
                FooForClass(),
                10000000, // indent:8 exp:8
                getString(
                    10000,
                    "Loooooooooo" // indent:8 exp:8
                        + "ooooong"))
            .entrySet()) {} // indent:8 exp:8
    ...
    for (Map.Entry<String, String> entry :
        new SecondForClassWithLongName1(
            ...
            .getMap(
                new // indent:8 exp:8
                FooForClass(),
                10000000, // indent:12 exp:>=8
                getString(
                    10000,
                    "Loooooooooo" // indent:10 exp:>=8
                        + "ooooong"))
            .entrySet()) {} // indent:15 exp:>=8
  ...
  class InnerClassFoo { // indent:2 exp:2
    ...
    void fooMethodWithIf() { // indent:4 exp:4
      ...
      for (int i =
              new SecondForClassWithLongName1(
                      "Loooooooooooooooooooo" // indent:6 exp:6
                          + "oong")
                  .getInteger(
                      new FooForClass(), // indent:10 exp:10
                      getString(1000000000, "Loooooooooooooooong"));
          i < 10;
          i++) {} // indent:12 exp:>=10
      ...
      for (Map.Entry<String, String> entry :
          new SecondForClassWithLongName1(
              ...
              .getMap(
                  ...
                  FooForClass(),
                  10000000, // indent:10 exp:10
                  getString(
                      10000,
                      "Loooooooooo" // indent:10 exp:10
                          + "ooooong"))
              .entrySet()) {} // indent:10 exp:10
      ...
      for (Map.Entry<String, String> entry :
          new SecondForClassWithLongName1(
              ...
              .getMap(
                  ...
                  FooForClass(),
                  10000000, // indent:13 exp:>=10
                  getString(
                      10000,
                      "Loooooooooo" // indent:18 exp:>=10
                          + "ooooong"))
              .entrySet()) {} // indent:15 exp:>=10
...
implements Iterable<String> { // indent:8 exp:>=4
  // violation above ''implements' has incorrect indentation level 0, expected level should be 4.'
