  ...
  public ClassWithChainedMethodsCorrect() { // indent:2 exp:2
    ...
    String chained1 = // indent:4 exp:4
        doNothing( // indent:8 exp:8
            someString // indent:12 exp:12
                .concat(
                    "zyx" // indent:16 exp:16
                    ) // indent:16 exp:16
                .concat(
                    "255, 254, 253" // indent:16 exp:16
                    ) // indent:16 exp:16
            ); // indent:8 exp:8
    ...
    doNothing( // indent:4 exp:4
        someString // indent:8 exp:8
            .concat(
                "zyx" // indent:12 exp:12
                ) // indent:12 exp:12
            .concat(
                "255, 254, 253" // indent:12 exp:12
                ) // indent:12 exp:12
        ); // indent:4 exp:4
    // violation above ''method call rparen' has incorrect indentation level 8, expected level should be 4.'
  } // indent:2 exp:2
