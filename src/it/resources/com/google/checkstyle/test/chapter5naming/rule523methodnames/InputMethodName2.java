...
public class InputMethodName2 {
  ...
  @Test // violation below, 'Test method name.* not valid. Each segment must start lowercase'
  public void transferMoney_DeductsFromSource() {}
  ...
  @Test
  public void test_General_Logic() {}
  // violation above, ''test_General_Logic' is not valid. Each segment must start lowercase'
}
