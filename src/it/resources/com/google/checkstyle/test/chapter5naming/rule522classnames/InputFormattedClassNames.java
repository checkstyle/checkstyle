...
class inputHeaderClass2 {
  ...
  //  'Type name 'inputHeaderClass2' must match pattern'
  ...
  // violation 2 lines above 'Type name 'NoValid\$Name' must match pattern'

  class $NoValidName {}

  // violation 2 lines above 'Type name '\$NoValidName' must match pattern'
  ...
  // violation 2 lines above 'Type name '_Annotation' must match pattern'

  @interface Annot_ation {}

  // violation 2 lines above 'Type name 'Annot_ation' must match pattern'

  @interface Annotation_ {}

  // violation 2 lines above 'Type name 'Annotation_' must match pattern'

  @interface $Annotation {}

  // violation 2 lines above 'Type name '\$Annotation' must match pattern'

  @interface Annot$ation {}

  // violation 2 lines above 'Type name 'Annot\$ation' must match pattern'
