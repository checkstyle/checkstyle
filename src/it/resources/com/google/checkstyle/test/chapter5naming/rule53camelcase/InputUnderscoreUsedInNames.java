...
public class InputUnderscoreUsedInNames {
  ...
  class InnerBad {
    int guava_33_4_7; // violation, due to '_' between digit and letter, 'must match pattern'
    int guava33_4_7;

    int guava33_4_8_; // violation, underscore at the end, 'must match pattern'
    int guava33_4_8;

    int jdk_8_90; // violation, due to '_' between digit and letter, 'must match pattern'
    int jdk8_90;

    int jdk8_91_; // violation, underscore at the end, 'must match pattern'
    int jdk8_91;

    int kotlin_1_9_24; // violation, due to '_' between digit and letter, 'must match pattern'
    int kotlin1_9_24;

    // violation below, underscore not allowed between lowercase character sequences, 'pattern'
    int kotlin_version1_9_24;

    int kotlinVersion1_9_24; // violation, false-positive, 'must match pattern'

    int kotlin1_9_25_; // violation, underscore at the end, 'must match pattern'
    int kotlin1_9_25;
  }
