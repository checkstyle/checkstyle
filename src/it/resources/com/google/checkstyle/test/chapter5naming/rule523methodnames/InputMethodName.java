...
public class InputMethodName {
  ...
  // violation 2 lines above 'Abbreviation in name 'testing_123FOO' must contain no more than '1''
  // violation 3 lines above 'Method name 'testing_123FOO' must match pattern'
  ...
  // violation 2 lines above 'Method name 'testing_Foo123' must match pattern'

  @Test
  public void testing_FOO123() {}

  // violation 2 lines above 'Abbreviation in name 'testing_FOO123' must contain no more than '1''
  // violation 3 lines above 'Method name 'testing_FOO123' must match pattern'

  @Test
  public void testing_Foo_123() {}

  // violation 2 lines above 'Method name 'testing_Foo_123' must match pattern'

  @Test
  public void testing_123_Foo() {}

  // violation 2 lines above 'Method name 'testing_123_Foo' must match pattern'
  ...
  // violation 2 lines above 'Method name 'testing_124Foo' must match pattern'

  @ParameterizedTest
  @ValueSource(strings = {"racecar", "radar", "level", "madam", "noon"})
  void testing_124FOO() {}

  // violation 2 lines above 'Abbreviation in name 'testing_124FOO' must contain no more than '1''
  // violation 3 lines above 'Method name 'testing_124FOO' must match pattern'
  ...
  // violation 2 lines above 'Method name 'testing_Foo124' must match pattern'

  @ParameterizedTest
  @ValueSource(strings = {"racecar", "radar", "level", "madam", "noon"})
  void testing_FOO124() {}

  // violation 2 lines above 'Abbreviation in name 'testing_FOO124' must contain no more than '1''
  // violation 3 lines above 'Method name 'testing_FOO124' must match pattern'

  @ParameterizedTest
  @ValueSource(strings = {"racecar", "radar", "level", "madam", "noon"})
  void testing_Foo_124() {}

  // violation 2 lines above 'Method name 'testing_Foo_124' must match pattern'

  @ParameterizedTest
  @ValueSource(strings = {"racecar", "radar", "level", "madam", "noon"})
  void testing_124_Foo() {}

  // violation 2 lines above 'Method name 'testing_124_Foo' must match pattern'
