...
public class InputMethodName {
  ...
  // violation below, 'Method name 'fOo' must.* avoid single lowercase letter followed by uppercase'
  void fOo() {}

  void f0o() {}

  // violation below, 'Method name 'f\$o' must .* contain only letters, digits, or underscores.'
  void f$o() {}
  ...
  @Test
  // violation below 'Each segment .* contain at least one uppercase letter for multi-segment names'
  void testing_foo() {
    class LocalFoo {
      void foo() {}
  ...
  @Test // violation below, ''testing_Foo' is not valid. Each segment must start lowercase'
  void testing_Foo() {}

  @Test // violation below, ''testing_fOo' .* avoid single lowercase letter followed by uppercase'
  void testing_fOo() {}
  ...
  @Test // violation below, ''TestingFooBad' is not valid. Each segment must start lowercase'
  void TestingFooBad() {}
  ...
  @Test // violation below ''testing_Foo123' is not valid. Each segment must start lowercase'
  ...
  @ParameterizedTest
  @ValueSource(strings = {"racecar", "radar", "level", "madam", "noon"})
  // violation below, ''testing_Foo1' is not valid. Each segment must start lowercase'
  void testing_Foo1(String str) {}

  @ParameterizedTest
  @ValueSource(strings = {"racecar", "radar", "level", "madam", "noon"})
  // violation below, ''testing_fOo1' .* avoid single lowercase letter followed by uppercase'
  void testing_fOo1(String str) {}
  ...
  @ParameterizedTest
  @ValueSource(strings = {"racecar", "radar", "level", "madam", "noon"})
  // violation below, ''testing_Foo124' is not valid. Each segment must start lowercase'
  void testing_Foo124() {}
  ...
  //    ''testing_FOO124' is not valid. Each segment must start lowercase'
  void testing_FOO124() {}
  ...
  @RepeatedTest(2)
  // violation below, ''testing_Foo2' is not valid. Each segment must start lowercase'
  void testing_Foo2() {}

  @RepeatedTest(2)
  // violation below, ''testing_fOo2' .* avoid single lowercase letter followed by uppercase'
  void testing_fOo2() {}
  ...
  @RepeatedTest(2)
  // violation below, ''Testing_Foo3' is not valid. Each segment must start lowercase'
  void Testing_Foo3() {}
  ...
  @RepeatedTest(2)
  // violation below, ''TestingFooBad2' is not valid. Each segment must start lowercase'
  void TestingFooBad2() {}
