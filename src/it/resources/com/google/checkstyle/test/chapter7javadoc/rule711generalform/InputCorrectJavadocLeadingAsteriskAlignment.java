...
public class InputCorrectJavadocLeadingAsteriskAlignment {
  ...
  /**
    Not sure if missing leading asterisk is allowed or not.
  ...
  /** Title // Not sure if this is allowed or not, it is addressed at: #17778, Subproblem 1.
   * This method does nothing.
   */
  private void foo2() {}
