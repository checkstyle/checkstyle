...
public class InputFormattedCorrectJavadocLeadingAsteriskAlignment {
  ...
  /**
   * Not allowed, leading asterisk should always be present. It is addressed at: #17778, Subproblem
   * 2
   */
  ...
  /**
   * Title // "/**" should be alone on the line, it is addressed at: #17778, Subproblem 1. This
   * method does nothing.
   */
  private void foo2() {}

  /** Javadoc for foo3. This is allowed */
  // "*/" should be alone on the line, it is addressed at #17778, Subproblem 3
  private void foo3() {
    // foo2 code goes here
  }
