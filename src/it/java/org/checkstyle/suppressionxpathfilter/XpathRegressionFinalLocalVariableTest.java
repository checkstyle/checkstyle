...
public class XpathRegressionFinalLocalVariableTest extends AbstractXpathTestSupport {
    ...
    public void testFive() throws Exception {
        ...
        final List<String> expectedXpathQueries = List.of(
            "/COMPILATION_UNIT/CLASS_DEF[./IDENT[@text='SuppressionXpathRegressionFinalLocalVariable5']]"
                    + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='method']]"
                    + "/SLIST/VARIABLE_DEF[./IDENT[@text='aArg']"
        );
    ...
    public void testSix() throws Exception {
        ...
        final List<String> expectedXpathQueries = List.of(
            "/COMPILATION_UNIT/CLASS_DEF[./IDENT[@text='SuppressionXpathRegressionFinalLocalVariable6']]"
