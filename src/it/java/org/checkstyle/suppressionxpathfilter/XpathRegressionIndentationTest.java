...
public class XpathRegressionIndentationTest extends AbstractXpathTestSupport {
    ...
    public void testDefault() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathIndentationTestDefault.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
            "/COMPILATION_UNIT/CLASS_DEF"
                    + "[./IDENT[@text='InputXpathIndentationTestDefault']]"
    ...
    public void testBasicOffset() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathIndentationTestBasicOffset.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
            "/COMPILATION_UNIT/CLASS_DEF"
                    + "[./IDENT[@text='InputXpathIndentationTestBasicOffset']]"
    ...
    public void testCaseIndent() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathIndentationTestSwitchCase.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
            "/COMPILATION_UNIT/CLASS_DEF"
                    + "[./IDENT[@text='InputXpathIndentationTestSwitchCase']]"
    ...
    public void testLambdaOne() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathIndentationLambdaTestOne.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/COMPILATION_UNIT/CLASS_DEF"
                    + "[./IDENT[@text='InputXpathIndentationLambdaTestOne"
    ...
    public void testLambdaTwo() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathIndentationLambdaTestTwo.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/COMPILATION_UNIT/CLASS_DEF"
                    + "[./IDENT[@text='InputXpathIndentationLambdaTestTwo']]"
                    + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='test']]/SLIST/VARIABLE_DEF["
