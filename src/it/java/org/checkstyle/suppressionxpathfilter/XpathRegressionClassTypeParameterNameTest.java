...
public class XpathRegressionClassTypeParameterNameTest extends AbstractXpathTestSupport {
    ...
    public void testDefault() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathClassTypeParameterNameDefault.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/CLASS_DEF"
                        + "[./IDENT[@text='InputXpathClassTypeParameterNameDefault']]"
    ...
    public void testUpperCase() throws Exception {
        ...
        final File fileToProcess =
                new File(getPath("InputXpathClassTypeParameterNameUpperCase.java"));
        ...
        final String[] expectedViolation = {
            "4:20: " + getCheckMessage(ClassTypeParameterNameCheck.class,
                        AbstractClassNameCheck.MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "aBc", pattern),
        };

        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/CLASS_DEF"
                        + "[./IDENT[@text='InputXpathClassTypeParameterNameUpperCase']]"
                        + "/OBJBLOCK/CLASS_DEF[./IDENT[@text='MyClass1']]"
                        + "/TYPE_PARAMETERS/TYPE_PARAMETER[./IDENT[@text='aBc']]",
                "/COMPILATION_UNIT/CLASS_DEF"
                        + "[./IDENT[@text='InputXpathClassTypeParameterNameUpperCase']]"
                        + "/OBJBLOCK/CLASS_DEF[./IDENT[@text='MyClass1']]/TYPE_PARAMETERS"
                        + "/TYPE_PARAMETER/IDENT[@text='aBc']"
        );
        runVerifications(moduleConfig, fileToProcess, expectedViolation,
                expectedXpathQueries);
    ...
    public void testCamelCase() throws Exception {
        ...
        final File fileToProcess =
                new File(getPath("InputXpathClassTypeParameterNameCamelCase.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/CLASS_DEF"
                        + "[./IDENT[@text='InputXpathClassTypeParameterNameCamelCase']]"
                        + "/OBJBLOCK/CLASS_DEF[./IDENT[@text='MyClass2']]"
                        + "/TYPE_PARAMETERS/TYPE_PARAMETER[./IDENT[@text='ABC']]",
                "/COMPILATION_UNIT/CLASS_DEF"
                        + "[./IDENT[@text='InputXpathClassTypeParameterNameCamelCase']]"
