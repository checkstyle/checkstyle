...
public class XpathRegressionDefaultComesLastTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathDefaultComesLastOne.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
            "/COMPILATION_UNIT/CLASS_DEF[./IDENT"
                + "[@text='InputXpathDefaultComesLastOne']]/OBJBLOCK"
    ...
    public void testTwo() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathDefaultComesLastTwo.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/COMPILATION_UNIT/CLASS_DEF[./IDENT"
                + "[@text='InputXpathDefaultComesLastTwo']]/OBJBLOCK"
                + "/METHOD_DEF[./IDENT[@text='test']]/SLIST/LITERAL_SWITCH/CASE_GROUP"
                + "/LITERAL_DEFAULT"
        );
