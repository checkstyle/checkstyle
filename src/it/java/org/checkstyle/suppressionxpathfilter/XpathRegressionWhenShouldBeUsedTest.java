...
public class XpathRegressionWhenShouldBeUsedTest
    ...
    public void testNested() throws Exception {
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                ...
                + "/SWITCH_RULE/SLIST/VARIABLE_DEF[./IDENT[@text='z']]/ASSIGN/EXPR/"
                + "LITERAL_SWITCH/CASE_GROUP[./LITERAL_CASE/PATTERN_VARIABLE_DEF/"
                + "IDENT[@text='_']]",
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT[@text='InputXpathWhenShouldBeUsedNested']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='test']]/SLIST/VARIABLE_DEF"
                + "[./IDENT[@text='x']]/ASSIGN/EXPR/LITERAL_SWITCH/"
                + "SWITCH_RULE/SLIST/VARIABLE_DEF[./IDENT[@text='z']]"
                + "/ASSIGN/EXPR/LITERAL_SWITCH/CASE_GROUP/LITERAL_CASE"
        );
        runVerifications(moduleConfig, fileToProcess, expectedViolation, expectedXpathQueries);
    }
}
