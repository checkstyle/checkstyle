...
public class XpathRegressionBooleanExpressionComplexityTest
    ...
    public void testMethodOne() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathBooleanExpressionComplexityOne.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT"
                        + "[@text='InputXpathBooleanExpressionComplexityOne']]"
    ...
    public void testMethodTwo() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathBooleanExpressionComplexityTwo.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT["
                        + "@text='InputXpathBooleanExpressionComplexityTwo']]"
    ...
    public void testMethodThree() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathBooleanExpressionComplexityThree.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT["
                        + "@text='InputXpathBooleanExpressionComplexityThree']]"
