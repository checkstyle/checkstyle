...
public class XpathRegressionBooleanExpressionComplexityTest
    ...
    public void testMethodOne() throws Exception {
        ...
        final String[] expectedViolationMessages = {
            "9:19: " + getCheckMessage(BooleanExpressionComplexityCheck.class,
                    BooleanExpressionComplexityCheck.MSG_KEY, 7, 3),
        };

        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT"
                        + "[@text='SuppressionXpathRegressionBooleanExpressionComplexityOne']]"
                        + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='methodOne']]/SLIST/VARIABLE_DEF"
                        + "[./IDENT[@text='d']]/ASSIGN"
        );
    ...
    public void testMethodThree() throws Exception {
        ...
        final String[] expectedViolationMessages = {
            "9:19: " + getCheckMessage(BooleanExpressionComplexityCheck.class,
                    BooleanExpressionComplexityCheck.MSG_KEY, 13, 3),
        };

        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT["
                        + "@text='SuppressionXpathRegressionBooleanExpressionComplexityThree']]"
                        + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='methodThree']]/SLIST/VARIABLE_DEF"
                        + "[./IDENT[@text='d']]/ASSIGN"
        );
