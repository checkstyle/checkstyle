...
public class XpathRegressionTypeBodyPaddingTest extends AbstractXpathTestSupport {
    ...
    public void testStarting() throws Exception {
        ...
        final List<String> expectedXpathQueries = List.of(
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathTypeBodyPaddingStarting']]"
                + "/OBJBLOCK",
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathTypeBodyPaddingStarting']]"
                + "/OBJBLOCK/LCURLY"
    ...
    public void testInner() throws Exception {
        final File fileToProcess = new File(
                getPath("InputXpathTypeBodyPaddingInner.java"));
        final DefaultConfiguration moduleConfig =
                createModuleConfig(TypeBodyPaddingCheck.class);
        ...
        final List<String> expectedXpathQueries = List.of(
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathTypeBodyPaddingInner']]"
    ...
    public void testLocal() throws Exception {
        final File fileToProcess = new File(
                getPath("InputXpathTypeBodyPaddingLocal.java"));
        final DefaultConfiguration moduleConfig =
                createModuleConfig(TypeBodyPaddingCheck.class);
        moduleConfig.addProperty("skipLocal", "false");

        final String[] expectedViolation = {
            "6:26: " + getCheckMessage(TypeBodyPaddingCheck.class,
                    TypeBodyPaddingCheck.MSG_START_REQUIRED),
        };
        final List<String> expectedXpathQueries = List.of(
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathTypeBodyPaddingLocal']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='myMethod']]"
                + "/SLIST/CLASS_DEF[./IDENT[@text='LocalClass']]"
                + "/OBJBLOCK",
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathTypeBodyPaddingLocal']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='myMethod']]"
