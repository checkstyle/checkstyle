...
public class XpathRegressionMethodParamPadTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[@firstIdentText='SuppressionXpathRegressionMethodParamPadOne']/OBJBLOCK"
                + "/METHOD_DEF[@firstIdentText='InputMethodParamPad']/LPAREN"
        );
    ...
    public void testTwo() throws Exception {
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[@firstIdentText='SuppressionXpathRegressionMethodParamPadTwo']/OBJBLOCK"
                + "/METHOD_DEF[@firstIdentText='sayHello']/LPAREN"
        );
    ...
    public void testThree() throws Exception {
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[@firstIdentText='SuppressionXpathRegressionMethodParamPadThree']/OBJBLOCK"
                + "/METHOD_DEF[@firstIdentText='sayHello']/LPAREN"
        );
