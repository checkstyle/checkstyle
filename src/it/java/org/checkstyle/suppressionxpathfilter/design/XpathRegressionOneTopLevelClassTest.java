...
public class XpathRegressionOneTopLevelClassTest extends AbstractXpathTestSupport {
    ...
    public String getPackageLocation() {
        return "org/checkstyle/suppressionxpathfilter/design/onetoplevelclass";
    }
    ...
    public void testThree() throws Exception {
        ...
        final String[] expectedViolation = {
            "7:1: " + getCheckMessage(OneTopLevelClassCheck.class,
                                      OneTopLevelClassCheck.MSG_KEY, "ViolatingThirdClass"),
        };

        final List<String> expectedXpathQueries = Arrays.asList(
            "/COMPILATION_UNIT/INTERFACE_DEF[./IDENT[@text='ViolatingThirdClass']]",
            "/COMPILATION_UNIT/INTERFACE_DEF[./IDENT[@text='ViolatingThirdClass']]/MODIFIERS",
            "/COMPILATION_UNIT/INTERFACE_DEF[./IDENT[@text='ViolatingThirdClass']]/LITERAL_INTERFACE"
        );
