...
public class XpathRegressionIllegalImportTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        ...
        final String[] expectedViolation = {
            "3:8: " + getCheckMessage(IllegalImportCheck.class,
                        IllegalImportCheck.MSG_KEY, "java.io.*"),
        };
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT"
                        + "/CLASS_DEF[./IDENT[@text='SuppressionXpathRegressionIllegalImportTwo']]"
                        + "/LITERAL_CLASS"
        );
    ...
    public void testTwo() throws Exception {
        ...
        moduleConfig.addProperty("import", "LITERAL_CLASS");

        final String[] expectedViolation = {
            "3:8: " + getCheckMessage(IllegalImportCheck.class,
                        IllegalImportCheck.MSG_KEY, "java.lang.ArithmeticException"),
        };
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT"
                        + "/CLASS_DEF[./IDENT[@text='SuppressionXpathRegressionIllegalImportTwo']]"
