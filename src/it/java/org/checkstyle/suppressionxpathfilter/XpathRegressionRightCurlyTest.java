...
public class XpathRegressionRightCurlyTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[@firstIdentText='SuppressionXpathRegressionRightCurlyOne']/OBJBLOCK"
                + "/METHOD_DEF[@firstIdentText='test']/SLIST/LITERAL_IF/SLIST/RCURLY"
        );
    ...
    public void testTwo() throws Exception {
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[@firstIdentText='SuppressionXpathRegressionRightCurlyTwo']/OBJBLOCK"
                + "/METHOD_DEF[@firstIdentText='fooMethod']/SLIST/LITERAL_TRY/SLIST/RCURLY"
        );
    ...
    public void testThree() throws Exception {
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[@firstIdentText='SuppressionXpathRegressionRightCurlyThree']/OBJBLOCK"
                + "/METHOD_DEF[@firstIdentText='sample']/SLIST/LITERAL_IF/SLIST/RCURLY"
        );
    ...
    public void testFour() throws Exception {
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[@firstIdentText='SuppressionXpathRegressionRightCurlyFour']/OBJBLOCK"
                + "/METHOD_DEF[@firstIdentText='sample']/SLIST/LITERAL_IF/SLIST/RCURLY"
        );
