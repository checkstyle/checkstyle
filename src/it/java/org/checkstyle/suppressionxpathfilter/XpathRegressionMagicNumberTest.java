...
public class XpathRegressionMagicNumberTest extends AbstractXpathTestSupport {
    ...
    public void testAnotherVariable() throws Exception {
        ...
        final String[] expectedViolation = {
            "28:17: " + getCheckMessage(MagicNumberCheck.class, MagicNumberCheck.MSG_KEY, "20"),
        };

        final List<String> expectedXpathQueries = List.of(
                "/COMPILATION_UNIT/CLASS_DEF"
                        + "[./IDENT[@text='SuppressionXpathRegressionMagicNumberAnotherVariable']]"
                        + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='handleException']]"
                        + "/SLIST/LITERAL_IF/LITERAL_ELSE/SLIST/EXPR/ASSIGN"
