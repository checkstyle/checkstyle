...
public class XpathRegressionRecordComponentNumberTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        ...
        final String[] expectedViolation = {
            "11:1: " + getCheckMessage(RecordComponentNumberCheck.class,
                    RecordComponentNumberCheck.MSG_PUBLIC_COMPONENTS,
                    15, 8),
        };
    ...
    public void testTwo() throws Exception {
        ...
        final DefaultConfiguration moduleConfig =
                createModuleConfig(RecordComponentNumberCheck.class);
        moduleConfig.addAttribute("maxInPrivateRecord", "1");
        moduleConfig.addAttribute("maxInPackageRecord", "1");
        moduleConfig.addAttribute("maxInProtectedRecord", "1");
        moduleConfig.addAttribute("maxInPublicRecord", "1");

        final String[] expectedViolation = {
            "12:5: " + getCheckMessage(RecordComponentNumberCheck.class,
                    RecordComponentNumberCheck.MSG_PUBLIC_COMPONENTS,
                    2, 1),
        };
