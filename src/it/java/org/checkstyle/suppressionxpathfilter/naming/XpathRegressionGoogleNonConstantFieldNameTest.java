...
public class XpathRegressionGoogleNonConstantFieldNameTest extends AbstractXpathTestSupport {
    ...
    public void testInvalidUnderscore() throws Exception {
        final File fileToProcess = new File(
            getPath("InputXpathGoogleNonConstantFieldNameInvalidUnderscore.java"));
        final DefaultConfiguration moduleConfig = createModuleConfig(CLASS);
        final String[] expectedViolation = {
            "5:9: " + getCheckMessage(CLASS,
                    GoogleNonConstantFieldNameCheck.MSG_KEY_INVALID_FORMAT, "gradle_9_5_1"),
        };
        final List<String> expectedXpathQueries = List.of(
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathGoogleNonConstantFieldNameInvalidUnderscore']]"
    ...
    @Test
    public void testSingleCharFieldName() throws Exception {
        final File fileToProcess = new File(
            getPath("InputXpathGoogleNonConstantFieldNameSingleChar.java"));
        final DefaultConfiguration moduleConfig = createModuleConfig(CLASS);
        final String[] expectedViolation = {
            "5:9: " + getCheckMessage(CLASS,
                    GoogleNonConstantFieldNameCheck.MSG_KEY_INVALID_FORMAT, "a"),
        };
        final List<String> expectedXpathQueries = List.of(
            "/COMPILATION_UNIT/CLASS_DEF"
