...
public class XpathRegressionUnusedCatchParameterShouldBeUnnamedTest
    ...
    private final String checkName =
            UnusedCatchParameterShouldBeUnnamedCheck.class.getSimpleName();
    ...
    public void testSimple() throws Exception {
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                ...
                "/COMPILATION_UNIT/CLASS_DEF["
                + "./IDENT[@text='InputXpathUnusedCatchParameterShouldBeUnnamedSimple']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='test']]/SLIST/LITERAL_TRY/LITERAL_CATCH/"
                + "PARAMETER_DEF[./IDENT[@text='e']]/TYPE[./IDENT[@text='Exception']]",
                "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathUnusedCatchParameterShouldBeUnnamedSimple']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='test']]/SLIST/LITERAL_TRY/LITERAL_CATCH/"
                + "PARAMETER_DEF[./IDENT[@text='e']]/TYPE/IDENT[@text='Exception']"
    ...
    public void testNested() throws Exception {
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                ...
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='test']]/SLIST/LITERAL_TRY/LITERAL_CATCH"
                + "/SLIST/LITERAL_TRY/LITERAL_CATCH/PARAMETER_DEF["
