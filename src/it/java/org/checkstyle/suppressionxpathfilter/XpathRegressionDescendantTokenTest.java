...
public void testNestedSwitch() throws Exception {
    ...
    final String[] expected = {
        "13:9: " + getCheckMessage(DescendantTokenCheck.class,
                DescendantTokenCheck.MSG_KEY_MAX,
                2, 1, "LITERAL_CASE", "LITERAL_SWITCH"),
    };

    final List<String> expectedXpathQueries = List.of(
        "/COMPILATION_UNIT/CLASS_DEF"
        + "[./IDENT[@text='InputXpathDescendantTokenNestedSwitch']]"
        + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='testMethod1']]"
        + "/SLIST/LITERAL_SWITCH[./LPAREN/EXPR/IDENT[@text='y']]"
