...
public class XpathRegressionSealedShouldHavePermitsListTest extends AbstractXpathTestSupport {
    ...
    public void testTopLevel() throws Exception {
        final File fileToProcess =
                new File(getNonCompilablePath("InputXpathSealedShouldHavePermitsListTopLevel.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                ...
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT"
                + "[@text='InputXpathSealedShouldHavePermitsListTopLevel']]/MODIFIERS/LITERAL_PUBLIC"
        );
