...
public class XpathRegressionRedundantModifierCompactSourceTest
    ...
    public void testPublicMethod() throws Exception {
        verifyMethodModifierXpath("InputXpathRedundantModifierCompactSourcePublicMethod.java",
                "publicMethod", "public", TokenTypes.LITERAL_PUBLIC);
    }

    @Test
    public void testProtectedMethod() throws Exception {
        verifyMethodModifierXpath("InputXpathRedundantModifierCompactSourceProtectedMethod.java",
                "protectedMethod", "protected", TokenTypes.LITERAL_PROTECTED);
    }

    private void verifyMethodModifierXpath(String fileName, String methodName, String modifier,
                                           int modifierTokenType) throws Exception {
        ...
        final String methodXpath = "/COMPACT_COMPILATION_UNIT/METHOD_DEF"
                + "[./IDENT[@text='" + methodName + "']]";
        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPACT_COMPILATION_UNIT",
                methodXpath,
                methodXpath + "/MODIFIERS",
                methodXpath + "/MODIFIERS/" + TokenUtil.getTokenName(modifierTokenType));
        runVerifications(moduleConfig, fileToProcess, expected, expectedXpathQueries);
    }
