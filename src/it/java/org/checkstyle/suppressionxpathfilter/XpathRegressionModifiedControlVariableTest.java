...
public class XpathRegressionModifiedControlVariableTest extends AbstractXpathTestSupport {
    ...
    public void testDefault1() throws Exception {
        final File fileToProcess = new File(
                getPath("InputXpathModifiedControlVariableDefault1.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                ...
                + "[./IDENT[@text='InputXpathModifiedControlVariableDefault1']]"
    ...
    public void testDefault2() throws Exception {
        final File fileToProcess = new File(
                getPath("InputXpathModifiedControlVariableDefault2.java"));
        final DefaultConfiguration moduleConfig = createModuleConfig(checkClass);
        final String[] expectedViolation = {
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathModifiedControlVariableDefault2']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='test']]/SLIST/LITERAL_FOR/SLIST/EXPR",
                "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathModifiedControlVariableDefault2']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='test']]"
    ...
    public void testDefaultNested() throws Exception {
        final File fileToProcess = new File(
                getPath("InputXpathModifiedControlVariableNestedDefault1.java"));
        final DefaultConfiguration moduleConfig = createModuleConfig(checkClass);
        final String[] expectedViolation = {
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathModifiedControlVariableNestedDefault1']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='test']]"
    ...
    @Test
    public void testDefaultEnhancedForLoopNested() throws Exception {
        final File fileToProcess = new File(
                getPath("InputXpathModifiedControlVariableNestedDefault2.java"));
        final DefaultConfiguration moduleConfig = createModuleConfig(checkClass);
        final String[] expectedViolation = {
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathModifiedControlVariableNestedDefault2']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='test']]"
                + "/SLIST/LITERAL_FOR/SLIST/LITERAL_FOR/SLIST/EXPR",
                "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathModifiedControlVariableNestedDefault2']]"
