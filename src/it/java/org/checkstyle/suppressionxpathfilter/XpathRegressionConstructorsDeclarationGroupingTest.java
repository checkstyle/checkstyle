...
public class XpathRegressionConstructorsDeclarationGroupingTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        final File fileToProcess = new File(
                getPath("InputXpathConstructorsDeclarationGroupingOne.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT"
                        + "[@text='InputXpathConstructorsDeclarationGroupingOne']]"
    ...
    public void testTwo() throws Exception {
        final File fileToProcess = new File(
                getPath("InputXpathConstructorsDeclarationGroupingTwo.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                ...
                + "[@text='InputXpathConstructorsDeclarationGroupingTwo']]"
                + "/OBJBLOCK/CTOR_DEF"
                + "[./IDENT[@text='InputXpathConstructorsDeclarationGroupingTwo']]",
