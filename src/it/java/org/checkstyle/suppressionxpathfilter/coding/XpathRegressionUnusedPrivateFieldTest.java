...
public class XpathRegressionUnusedPrivateFieldTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        final File fileToProcess = new File(getPath(
                "InputXpathUnusedPrivateField.java"));

        final DefaultConfiguration moduleConfig =
                createModuleConfig(UnusedPrivateFieldCheck.class);

        final String[] expectedViolation = {
            "9:5: " + getCheckMessage(UnusedPrivateFieldCheck.class,
                    UnusedPrivateFieldCheck.MSG_UNUSED_PRIVATE_FIELD, "unused"),
        };

        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/CLASS_DEF"
                        + "[./IDENT[@text='InputXpathUnusedPrivateField']]"
