...
public class XpathRegressionUnusedPrivateFieldTest extends AbstractXpathTestSupport {
    ...
    @Test
    public void testprivatefieldone() throws Exception {
        ...
        final String[] expectedViolation = {
                "4:17: " + getCheckMessage(UnusedPrivateFieldCheck.class,
                    UnusedPrivateFieldCheck.MSG_PRIVATE_FIELD, "unused"),
        };

        final List<String> expectedXpathQueries = List.of(
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT[@text='InputXpathUnusedPrivateFieldOne']]/OBJBLOCK/VARIABLE_DEF/IDENT[@text='unused']"
        );
    ...
    public void testFullCoverage() throws Exception {
        ...
        final String[] expectedViolation = {
            "5:17: " + getCheckMessage(UnusedPrivateFieldCheck.class,
                    UnusedPrivateFieldCheck.MSG_PRIVATE_FIELD, "unusedPrivate"),
        };

        final List<String> expectedXpathQueries = List.of(
            "/COMPILATION_UNIT/CLASS_DEF[./IDENT[@text='InputXpathUnusedPrivateFieldTwo']]/OBJBLOCK/VARIABLE_DEF/IDENT[@text='unusedPrivate']"
        );
