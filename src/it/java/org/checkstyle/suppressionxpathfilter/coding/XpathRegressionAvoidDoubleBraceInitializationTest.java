...
public class XpathRegressionAvoidDoubleBraceInitializationTest extends AbstractXpathTestSupport {
    ...
    public void testInnerClassFields() throws Exception {
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathAvoidDoubleBraceInitializationInnerClassFields']]/OBJBLOCK/CLASS_DEF"
                + "[./IDENT[@text='InnerClass']]/OBJBLOCK/METHOD_DEF[./IDENT[@text='doInitialize']]/SLIST/EXPR/"
                + "LITERAL_NEW[./IDENT[@text='InputXpathAvoidDoubleBraceInitializationInnerClassFields']]/OBJBLOCK",
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathAvoidDoubleBraceInitializationInnerClassFields']]/OBJBLOCK/CLASS_DEF"
                + "[./IDENT[@text='InnerClass']]/OBJBLOCK/METHOD_DEF[./IDENT[@text='doInitialize']]/SLIST/EXPR/"
                + "LITERAL_NEW[./IDENT[@text='InputXpathAvoidDoubleBraceInitializationInnerClassFields']]/OBJBLOCK/LCURLY"
        );
