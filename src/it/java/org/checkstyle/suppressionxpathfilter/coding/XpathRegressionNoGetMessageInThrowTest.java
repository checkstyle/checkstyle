...
public class XpathRegressionNoGetMessageInThrowTest extends AbstractXpathTestSupport {
    ...
    public void testThree() throws Exception {
        final File fileToProcess = new File(
            getPath("InputXpathNoGetMessageInThrowThree.java")
        );
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/COMPILATION_UNIT/CLASS_DEF[./IDENT[@text='InputXpathNoGetMessageInThrowThree']]"
                + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='process']]/SLIST/LITERAL_TRY"
                + "/LITERAL_CATCH/SLIST/LITERAL_THROW"
        );
