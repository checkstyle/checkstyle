...
public class XpathRegressionMatchXpathTest extends AbstractXpathTestSupport {
    ...
    @Test
    public void encodedQuoteString() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedLessString() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedNewLineString() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void greaterString() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedAmpString() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedAposString() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedCarriageString() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedAmpersandChars() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedQuoteChar() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedLessChar() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedAposChar() throws Exception {
        final File fileToProcess =
    ...
    @Test
    public void encodedGreaterChar() throws Exception {
        final File fileToProcess =
