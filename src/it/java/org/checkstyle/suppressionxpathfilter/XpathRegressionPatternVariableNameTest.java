...
public class XpathRegressionPatternVariableNameTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        ...
        final String[] expectedViolation = {
            "8:30: " + getCheckMessage(PatternVariableNameCheck.class,
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[./IDENT[@text='SuppressionXpathRegressionPatternVariableName1']]"
                    + "/OBJBLOCK/INSTANCE_INIT/SLIST/LITERAL_IF/EXPR/LITERAL_INSTANCEOF"
                    + "[./IDENT[@text='o1']]/PATTERN_VARIABLE_DEF/IDENT[@text='STRING1']"
        );
    ...
    public void testTwo() throws Exception {
        ...
        final String[] expectedViolation = {
            "8:34: " + getCheckMessage(PatternVariableNameCheck.class,
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[./IDENT[@text='SuppressionXpathRegressionPatternVariableName2']]"
                    + "/OBJBLOCK/INSTANCE_INIT/SLIST/LITERAL_IF/EXPR/LITERAL_INSTANCEOF"
                    + "[./IDENT[@text='o1']]/PATTERN_VARIABLE_DEF/IDENT[@text='s']"
        );
    ...
    public void testThree() throws Exception {
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/CLASS_DEF[./IDENT[@text='SuppressionXpathRegressionPatternVariableName3']]"
                        + "/OBJBLOCK/INSTANCE_INIT/SLIST/LITERAL_IF/EXPR/LITERAL_INSTANCEOF"
                        + "[./IDENT[@text='o1']]/PATTERN_VARIABLE_DEF/IDENT[@text='STR']"
        );
    ...
    public void testFour() throws Exception {
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/CLASS_DEF[./IDENT[@text='SuppressionXpathRegressionPatternVariableName1']]"
                        + "/OBJBLOCK/INSTANCE_INIT/SLIST/LITERAL_IF/EXPR/LITERAL_INSTANCEOF"
                        + "[./IDENT[@text='o1']]/PATTERN_VARIABLE_DEF/IDENT[@text='st']"
        );
