...
public class XpathRegressionPatternVariableNameTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        final File fileToProcess =
                new File(getNonCompilablePath(
                        "InputXpathPatternVariableName1.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathPatternVariableName1']]"
    ...
    public void testTwo() throws Exception {
        final File fileToProcess =
                new File(getNonCompilablePath(
                        "InputXpathPatternVariableName2.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/COMPILATION_UNIT/CLASS_DEF"
                + "[./IDENT[@text='InputXpathPatternVariableName2']]"
                + "/OBJBLOCK/CTOR_DEF[./IDENT[@text='MyClass']]/SLIST/LITERAL_IF/EXPR/"
    ...
    public void testThree() throws Exception {
        final File fileToProcess =
                new File(getNonCompilablePath(
                        "InputXpathPatternVariableName3.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT/CLASS_DEF"
                    + "[./IDENT[@text='InputXpathPatternVariableName3']]"
    ...
    public void testFour() throws Exception {
        final File fileToProcess =
                new File(getNonCompilablePath(
                        "InputXpathPatternVariableName4.java"));
