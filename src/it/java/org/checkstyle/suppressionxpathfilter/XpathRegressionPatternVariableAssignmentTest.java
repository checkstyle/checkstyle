...
public class XpathRegressionPatternVariableAssignmentTest extends AbstractXpathTestSupport {
    ...
    public void testMethod() throws Exception {
        ...
        final List<String> expectedXpathQueries = Arrays.asList("/COMPILATION_UNIT/CLASS_DEF[./IDENT["
        + "@text='InputXpathPatternVariableAssignmentMethod']]/OBJBLOCK/METHOD_DEF[" +
    ...
    public void testLambda() throws Exception {
        ...
        final List<String> expectedXpathQueries = Arrays.asList("/COMPILATION_UNIT/CLASS_DEF[./IDENT[" +
            "@text='InputXpathPatternVariableAssignmentLambda']]/OBJBLOCK/METHOD_DEF[" +
    ...
    public void testClass() throws Exception {
        ...
        final List<String> expectedXpathQueries = Arrays.asList("/COMPILATION_UNIT/CLASS_DEF[./IDENT[" +
            "@text='InputXpathPatternVariableAssignmentClass']]/OBJBLOCK/METHOD_DEF[" +
            "./IDENT[@text='foo']]/SLIST/VARIABLE_DEF[./IDENT[@text='annClass']]/ASSIGN/EXPR/LITERAL_NEW[" +
            "./IDENT[@text='AnonymousClass']]/OBJBLOCK/METHOD_DEF[" +
