...
public class XpathRegressionAnnotationLocationTest extends AbstractXpathTestSupport {
    ...
    public void testEnum() throws Exception {
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/ENUM_DEF[./IDENT[@text='InputXpathAnnotationLocationEnum"
                        + "']]",
    ...
    public void testConstructor() throws Exception {
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT[@text='InputXpathAnnotationLocationCTOR"
                        + "']]/OBJBLOCK/CTOR_DEF"
                        + "[./IDENT[@text='"
                ...
                "/COMPILATION_UNIT/CLASS_DEF[./IDENT[@text='InputXpathAnnotationLocationCTOR"
                        + "']]/OBJBLOCK/CTOR_DEF"
                        + "[./IDENT[@text='InputXpathAnnotationLocationCTOR"
                        + "']]/"
