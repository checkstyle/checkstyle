...
public class XpathRegressionParameterNameTest extends AbstractXpathTestSupport {
    ...
    public void test1() throws Exception {
        final File fileToProcess =
                new File(getPath("SuppressionXpathRegressionParameterName1.java"));
        ...
        final String[] expectedViolation = {
            "4:20: " + getCheckMessage(ParameterNameCheck.class,
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT"
                        ...
                        + "='SuppressionXpathRegressionParameterName1']]"
    ...
    public void test2() throws Exception {
        final File fileToProcess =
                new File(getPath("SuppressionXpathRegressionParameterName2.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT"
                        + "/CLASS_DEF[./IDENT[@text"
                        + "='SuppressionXpathRegressionParameterName2']]"
    ...
    public void test3() throws Exception {
        final File fileToProcess =
                new File(getPath("SuppressionXpathRegressionParameterName3.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT"
                        + "/CLASS_DEF[./IDENT[@text"
                        + "='SuppressionXpathRegressionParameterName3']]"
                        + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='method2']]"
                        + "/PARAMETERS/PARAMETER_DEF/IDENT[@text='V2']"
        );
        runVerifications(moduleConfig, fileToProcess, expectedViolation,
    ...
    public void test4() throws Exception {
        final File fileToProcess =
                new File(getPath("SuppressionXpathRegressionParameterName4.java"));
        ...
        final String[] expectedViolation = {
            "5:27: " + getCheckMessage(ParameterNameCheck.class,
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT"
                        + "/CLASS_DEF[./IDENT[@text"
                        + "='SuppressionXpathRegressionParameterName4']]"
                        + "/OBJBLOCK/METHOD_DEF[./IDENT[@text='method2']]"
