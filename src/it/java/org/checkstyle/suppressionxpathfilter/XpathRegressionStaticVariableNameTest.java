...
public class XpathRegressionStaticVariableNameTest extends AbstractXpathTestSupport {
    ...
    public void test2() throws Exception {
        final File fileToProcess =
                new File(getPath("SuppressionXpathRegressionStaticVariableName2.java"));
        ...
        final String[] expectedViolation = {
            "6:27: " + getCheckMessage(StaticVariableNameCheck.class,
                        AbstractNameCheck.MSG_INVALID_PATTERN, "NUM2", pattern),
        };
    ...
    public void test3() throws Exception {
        final File fileToProcess =
                new File(getPath("SuppressionXpathRegressionStaticVariableName3.java"));
        ...
        final String[] expectedViolation = {
            "6:58: " + getCheckMessage(StaticVariableNameCheck.class,
                        AbstractNameCheck.MSG_INVALID_PATTERN, "VariableName", pattern),
        };

        final List<String> expectedXpathQueries = Collections.singletonList(
                "/COMPILATION_UNIT"
                        + "/CLASS_DEF[./IDENT[@text"
                        + "='SuppressionXpathRegressionStaticVariableName3']]"
                        + "/OBJBLOCK/VARIABLE_DEF/IDENT[@text='VariableName']"
