...
public class XpathRegressionBlockCommentEndPositionTest extends AbstractXpathTestSupport {
    ...
    public void testThree() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathBlockCommentEndPositionThree.java"));
        ...
        final String[] expectedViolation = {
            "6:14: " + getCheckMessage(BlockCommentEndPositionCheck.class,
                    BlockCommentEndPositionCheck.MSG_BLOCK_COMMENT_END,
                    "BLOCK_COMMENT_END"),
        };

        final List<String> expectedXpathQueries = Collections.singletonList(
            "/COMPILATION_UNIT/CLASS_DEF[./IDENT[@text='InputXpathBlockCommentEndPositionThree']]"
                    + "/OBJBLOCK/VARIABLE_DEF[./IDENT[@text='a']]/TYPE/BLOCK_COMMENT_BEGIN"
                    + "[./COMMENT_CONTENT[@text='*\\n     * Text. ']]/BLOCK_COMMENT_END"
        );
