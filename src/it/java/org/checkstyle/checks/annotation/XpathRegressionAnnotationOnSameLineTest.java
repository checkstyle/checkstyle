...
package org.checkstyle.checks.annotation;

import java.io.File;
import java.util.Arrays;
import java.util.List;

import org.checkstyle.checks.suppressionxpathfilter.AbstractXpathTestSupport;
...
public class XpathRegressionAnnotationOnSameLineTest extends AbstractXpathTestSupport {
    ...
    protected String getPackageLocation() {
        return "org/checkstyle/checks/annotation/annotationonsameline";
    }
