...
package com.sun.checkstyle.test.chapter5comments.rule511blockcomments;
...
public class CommentsIndentationTest extends AbstractSunModuleTestSupport {

    @Override
    protected String getPackageLocation() {
        return "com/sun/checkstyle/test/chapter5comments/rule511blockcomments";
    }
