...
package com.doccomments.checkstyle.test.base;
...
public abstract class AbstractDocCommentsModuleTestSupport extends AbstractItModuleTestSupport {

    private static final String XML_NAME = "/doc_comments_checks.xml";
