...
public class ThrowsTagTest extends AbstractDocCommentsModuleTestSupport {

    @Override
    public String getPackageLocation() {
        return "com/doccomments/checkstyle/test/writingdoccomments/tagconventions/throwstag";
    }

    @Test
    public void testCorrect() throws Exception {
        verifyWithWholeConfig(getPath("InputCorrectThrowsTag.java"));
    }
