...
public class ParamTagTest extends AbstractDocCommentsModuleTestSupport {

    @Override
    public String getPackageLocation() {
        return "com/doccomments/checkstyle/test/writingdoccomments/tagconventions/paramtag";
    }

    @Test
    public void testCorrect() throws Exception {
        verifyWithWholeConfig(getPath("InputCorrectParamTag.java"));
    }
