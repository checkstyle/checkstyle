...
public class AtclauseOrderTest extends AbstractOpenJdkModuleTestSupport {

    @Override
    public String getPackageLocation() {
        return "com/doccomments/checkstyle/test/chapter2writingdoccomments/rule25tagconventions";
    }
