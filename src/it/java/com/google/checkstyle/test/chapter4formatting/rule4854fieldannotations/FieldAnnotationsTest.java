...
public class FieldAnnotationsTest extends AbstractGoogleModuleTestSupport {
    ...
    public void testAnnotations() throws Exception {
        final Class<InvalidJavadocPositionCheck> clazz = InvalidJavadocPositionCheck.class;
        ...
        final String[] expected = {
            "33:5: " + getCheckMessage(clazz, invalidJavadocPositionMsg),
            "40:5: " + getCheckMessage(clazz, invalidJavadocPositionMsg),
        };
