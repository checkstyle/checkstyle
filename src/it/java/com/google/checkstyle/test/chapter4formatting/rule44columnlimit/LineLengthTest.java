...
public class LineLengthTest extends AbstractGoogleModuleTestSupport {
    ...
    public void testLineLength() throws Exception {
        final String[] expected = {
            ...
            "201: " + getCheckMessage(LineLengthCheck.class, "maxLineLen", 100, 120),
            "204: " + getCheckMessage(LineLengthCheck.class, "maxLineLen", 100, 116),
            "207: " + getCheckMessage(LineLengthCheck.class, "maxLineLen", 100, 149),
        };
