...
import com.puppycrawl.tools.checkstyle.checks.javadoc.RequireEmptyLineBeforeBlockTagsGroupCheck;
import com.puppycrawl.tools.checkstyle.utils.CommonUtil;

public class RequireEmptyLineBeforeBlockTagsGroupTest extends AbstractGoogleModuleTestSupport {
    ...
    public void testJavadocParagraphCorrect() throws Exception {
        ...
        final String filePath = getPath(
                "InputCorrectRequireEmptyLineBeforeBlockTagsGroupCheck.java");
    ...
    public void testJavadocParagraphIncorrect() throws Exception {
        ...
        final Configuration checkConfig = getModuleConfig(
                "RequireEmptyLineBeforeBlockTagsGroup");
        final String filePath = getPath(
                "InputIncorrectRequireEmptyLineBeforeBlockTagsGroupCheck.java");
    ...
    private static String getTagCheckMessage(String tag) throws IOException {
        return getCheckMessage(RequireEmptyLineBeforeBlockTagsGroupCheck.class,
