...
public class VariablesTest extends AbstractOpenJdkModuleTestSupport {

    @Override
    public String getPackageLocation() {
        return "com/openjdk/checkstyle/test/chapternaming/rulevariables";
    }

    @Test
    public void testVariablesInvalid() throws Exception {
        verifyWithWholeConfig(getPath("InputVariablesInvalid.java"));
    }
