...
public class NamingTest extends AbstractOpenJdkModuleTestSupport {

    @Override
    public String getPackageLocation() {
        return "com/openjdk/checkstyle/test/chapternaming/rulenaming";
    }

    @Test
    public void testNamingOne() throws Exception {
        verifyWithWholeConfig(getPath("InputNamingOne.java"));
    }
