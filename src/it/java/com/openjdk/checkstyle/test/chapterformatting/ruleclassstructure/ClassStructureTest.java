...
public class ClassStructureTest extends AbstractOpenJdkModuleTestSupport {

    @Override
    public String getPackageLocation() {
        return "com/openjdk/checkstyle/test/chapterformatting/ruleclassstructure";
    }

    @Test
    public void testClassStructureValidOrder() throws Exception {
        verifyWithWholeConfig(getPath("InputClassStructureValidOrder.java"));
    }
