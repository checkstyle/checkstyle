...
public class OrderOfConstructorsAndOverloadedMethodsTest extends AbstractOpenJdkModuleTestSupport {
    ...
    @Test
    public void testOrderOfConstructorsAndOverloadedMethodsOne() throws Exception {
        verifyWithWholeConfig(getPath("InputOrderOfConstructorsAndOverloadedMethodsOne.java"));
    }

    @Test
    public void testOrderOfConstructorsAndOverloadedMethodsTwo() throws Exception {
