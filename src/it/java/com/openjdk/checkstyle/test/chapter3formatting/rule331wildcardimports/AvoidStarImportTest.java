...
public class AvoidStarImportTest extends AbstractOpenJdkModuleTestSupport {
    ...
    @Test
    public void avoidStarImportTest() throws Exception {
        verifyWithWholeConfig(getPath("InputWildcardImports.java"));
    }
