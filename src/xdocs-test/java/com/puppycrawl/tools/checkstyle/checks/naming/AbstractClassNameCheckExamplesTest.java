...
public class AbstractClassNameCheckExamplesTest extends AbstractModuleTestSupport {
    ...
    public void testXdocExample1() throws Exception {
        final String[] expected = {
            "14:5: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "SecondClass",
                DEFAULT_PATTERN),
            "15:5: " + getCheckMessage(MSG_NO_ABSTRACT_CLASS_MODIFIER, "AbstractThirdClass",
                DEFAULT_PATTERN),
        };
    ...
    public void testXdocExample4() throws Exception {
        ...
        final String[] expected = {
            "14:5: " + getCheckMessage(MSG_ILLEGAL_ABSTRACT_CLASS_NAME, "SecondClass",
                format),
            "15:5: " + getCheckMessage(MSG_NO_ABSTRACT_CLASS_MODIFIER, "GeneratorThirdClass",
                format),
        };
