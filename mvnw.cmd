...
if ($distributionSha256Sum) {
  if ($USE_MVND) {
    Write-Error "Checksum validation is not supported for maven-mvnd.`nPlease disable validation by " +
  ...
  (Get-FileHash "$TMP_DOWNLOAD_DIR/$distributionUrlName" -Algorithm SHA256).Hash.ToLower() -ne
    ...
    Write-Error "Error: Failed to validate Maven distribution SHA-256, your Maven distribution might " +
    "be compromised. If you updated your Maven version, you need to update the specified " +
