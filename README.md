...
- [AppVeyor 🏗️ ![][appveyor img]][appveyor]
- [Azure ☁️ ![][azure img]][azure]
- [Checker Framework ✅ ![][checker framework img]][checker framework]
- [Circle CI 🔵 ![][circleci img]][circleci]
- [Cirrus CI ❄️ ![][cirrusci img]][cirrusci]
- [Closed Issues 🔒 ![][closed issues img]][closed issues]
- [Dependabot 🤖 ![][dependabot img]][dependabot]
- [Link Check ☑️ ![][link check img]][link check]
- [Milestone Automation 🗓️ ![][milestone img]][milestone]
...
- [OpenRewrite ♻️ ![][rewrite img]][rewrite]
- [PIT 🧬 ![][pitest img]][pitest]
- [PMD 🔍 ![][pmd img]][pmd]
- [Semaphore CI 🚦 ![][semaphoreci img]][semaphoreci]
- [Snyk 🛡️ ![][snyk img]][snyk]
- [SpotBugs 🪲 ![][spotbugs img]][spotbugs]
...
- [Apache Commons 🏛️](https://commons.apache.org/)
- [Google Guava 🟡](https://github.com/google/guava/)
- [Picocli ⚡️](https://github.com/remkop/picocli/)
...
- [AppVeyor 🏗️](https://ci.appveyor.com/project/checkstyle/checkstyle)
- [Azure ☁️](https://dev.azure.com/checkstyle/checkstyle/_build)
- [Circle CI 🔵](https://circleci.com/gh/checkstyle/checkstyle)
- [Cirrus CI ❄️](https://cirrus-ci.com/github/checkstyle/checkstyle)
- [Dependabot 🤖](https://github.com/dependabot)
- [Link Check ☑️](https://github.com/checkstyle/checkstyle/actions/workflows/run-link-check.yml)
- [Milestone Automation 🗓️](https://github.com/checkstyle/checkstyle/actions/workflows/set-milestone-on-referenced-issue.yml)
...
- [OpenRewrite ♻️](https://docs.openrewrite.org)
- [PIT 🧬](https://pitest.org)
- [PMD 🔍](https://pmd.github.io)
- [Snyk 🛡️](https://app.snyk.io/org/checkstyle)
...
[pmd img]:https://github.com/checkstyle/checkstyle/actions/workflows/pmd.yml/badge.svg
[pmd]:https://github.com/checkstyle/checkstyle/actions/workflows/pitest.yml
...
[spotbugs img]:https://github.com/checkstyle/checkstyle/actions/workflows/spotbugs.yml/badge.svg
[spotbugs]:https://github.com/checkstyle/checkstyle/actions/workflows/spotbugs.yml
