...
no-error-xwiki)
  ...
  "$PROJECT_DIR/mvnw" -e --no-transfer-progress checkstyle:check@default \
    -Dcheckstyle.version="${CS_POM_VERSION}"
  # Install various required poms and extensions
  "$PROJECT_DIR/mvnw" -e --no-transfer-progress install:install-file -Dfile=pom.xml -DpomFile=pom.xml
  "$PROJECT_DIR/mvnw" -e --no-transfer-progress install:install-file -Dfile=xwiki-commons-tools/pom.xml \
    -DpomFile=xwiki-commons-tools/pom.xml
  "$PROJECT_DIR/mvnw" -e --no-transfer-progress install:install-file \
    -Dfile=xwiki-commons-tools/xwiki-commons-tool-pom/pom.xml \
    -DpomFile=xwiki-commons-tools/xwiki-commons-tool-pom/pom.xml
  "$PROJECT_DIR/mvnw" -e --no-transfer-progress install:install-file -Dfile=xwiki-commons-pom/pom.xml \
  ...
  "$PROJECT_DIR/mvnw" -e --no-transfer-progress \
    -f xwiki-commons-tools/xwiki-commons-tool-webjar-node-handlers/pom.xml \
    install -Dmaven.test.skip -Dcheckstyle.version="${CS_POM_VERSION}"
  "$PROJECT_DIR/mvnw" -e --no-transfer-progress -f xwiki-commons-tools/xwiki-commons-tool-xar/pom.xml \
    install -Dmaven.test.skip -Dcheckstyle.version="${CS_POM_VERSION}"
  cd ..
  ...
  "$PROJECT_DIR/mvnw" -e --no-transfer-progress checkstyle:check@default -Dcheckstyle.version="${CS_POM_VERSION}"
  cd ..
