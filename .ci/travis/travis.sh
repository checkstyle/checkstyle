...
nondex)
  ...
  mvn --fail-never clean nondex:nondex -Dtest='*,!ConfigurationLoaderTest' -Xms1024m -Xmx2048m
...
cobertura-check)
  mvn clean compile cobertura:check cobertura:cobertura -Xms1024m -Xmx2048m
