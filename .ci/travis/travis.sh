...
no-error-xwiki)
  ...
  mvn install:install-file -Dfile=xwiki-commons-tools/pom.xml -DpomFile=xwiki-commons-tools/pom.xml
  mvn install:install-file -Dfile=xwiki-commons-tools/xwiki-commons-tool-pom/pom.xml -DpomFile=xwiki-commons-tools/xwiki-commons-tool-pom/pom.xml
  mvn install:install-file -Dfile=xwiki-commons-pom/pom.xml -DpomFile=xwiki-commons-pom/pom.xml
