...
TWITTER_TEMPLETE=contribution/releasenotes-builder/src/main/resources/com/github/checkstyle/templates/twitter.template
...
java -jar contribution/releasenotes-builder/target/releasenotes-builder-1.0-all.jar \
        ...
        -generateTwit -twitterTemplate "$TWITTER_TEMPLETE" \
         -publishTwit \
