...
RELASENOTES_BUILDER="contribution/releasenotes-builder"
TEMPLATE_DIR="/src/main/resources/com/github/checkstyle/templates/"

java -jar $RELASENOTES_BUILDER/target/releasenotes-builder-1.0-all.jar \
     ...
     -generateXdoc \
     -xdocTemplate $RELASENOTES_BUILDER/$TEMPLATE_DIR/xdoc_freemarker.template \
