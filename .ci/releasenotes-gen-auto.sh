...
java -jar contribution/releasenotes-builder/target/releasenotes-builder-1.0-all.jar \
        ...
        -githubAuthToken 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 \
        -generateXdoc \
        -xdocTemplate contribution/releasenotes-builder/src/main/resources/com/github/checkstyle/\
/templates/xdoc_freemarker.template \
