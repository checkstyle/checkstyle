...
java -jar contribution/releasenotes-builder/target/releasenotes-builder-1.0-all.jar \
        ...
        -githubAuthToken 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 \
        -generateXdoc \
        -xdocTemplate contribution/releasenotes-builder/src/main/resources/com/github/checkstyle/templates/xdoc_freemarker.template \
