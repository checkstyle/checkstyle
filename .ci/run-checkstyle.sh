...
mvn -e --no-transfer-progress checkstyle:check \
  -Dcheckstyle.config.location=config/checkstyle-checks.xml \
  -Dcheckstyle.cache.file=target/cachefile \
  -Dcheckstyle.header.file=config/java.header \
  -Dcheckstyle.regexp.header.file=config/java-regexp.header \
  -Dcheckstyle.importcontrol.file=config/import-control.xml \
  -Dcheckstyle.importcontroltest.file=config/import-control-test.xml \
  -Dcheckstyle.suppressions.file=config/suppressions.xml \
  -Dcheckstyle.suppressions-xpath.file=config/suppressions-xpath.xml \
