...
pitest-javadoc)
  ...
  "AbstractJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>                    final String message = String.format(Locale.ROOT, &#34;Javadoc Token \&#34;%s\&#34; was &#34;</span></pre></td></tr>"
  "AbstractJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>                    final String message = String.format(Locale.ROOT,</span></pre></td></tr>"
  ...
  "AtclauseOrderCheck.java.html:<td class='covered'><pre><span  class='survived'>    @XdocsPropertyType(PropertyType.TOKEN_ARRAY)</span></pre></td></tr>"
  "BlockTagUtil.java.html:<td class='covered'><pre><span  class='survived'>                final String remainder = line.substring(tagMatcher.end(1));</span></pre></td></tr>"
  ...
  "InlineTagUtil.java.html:<td class='covered'><pre><span  class='survived'>        final StringBuilder builder = new StringBuilder(1024);</span></pre></td></tr>"
  "InvalidJavadocPositionCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(ast, MSG_KEY);</span></pre></td></tr>"
  ...
  "JavadocContentLocationCheck.java.html:<td class='covered'><pre><span  class='survived'>                        log(ast, MSG_JAVADOC_CONTENT_FIRST_LINE);</span></pre></td></tr>"
  "JavadocContentLocationCheck.java.html:<td class='covered'><pre><span  class='survived'>                    log(ast, MSG_JAVADOC_CONTENT_SECOND_LINE);</span></pre></td></tr>"
  ...
  "JavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>        final String lFin = multilineCont.group(1);</span></pre></td></tr>"
  ...
  "JavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>                .forEach(javadocTag -&#62; log(javadocTag.getLineNo(), MSG_UNUSED_TAG_GENERAL));</span></pre></td></tr>"
  ...
  "JavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(ast, MSG_INVALID_INHERIT_DOC);</span></pre></td></tr>"
  "JavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>                    log(exceptionInfo.getAst(),</span></pre></td></tr>"
  "JavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(lineNo, MSG_RETURN_EXPECTED);</span></pre></td></tr>"
  "JavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(param, MSG_EXPECTED_TAG,</span></pre></td></tr>"
  "JavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(tag.getLineNo(), tag.getColumnNo(), MSG_UNUSED_TAG,</span></pre></td></tr>"
  "JavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(typeParam, MSG_EXPECTED_TAG,</span></pre></td></tr>"
  "JavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>    private AccessModifierOption[] accessModifiers = {</span></pre></td></tr>"
  ...
  "JavadocMissingLeadingAsteriskCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(nextSibling.getLineNumber(), MSG_MISSING_ASTERISK);</span></pre></td></tr>"
  "JavadocMissingLeadingAsteriskCheck.java.html:<td class='covered'><pre><span  class='survived'>        while (TokenUtil.isOfType(nextSibling.getType(),</span></pre></td></tr>"
  "JavadocMissingWhitespaceAfterAsteriskCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(textNode.getLineNumber(), textNode.getColumnNumber(), MSG_KEY);</span></pre></td></tr>"
  ...
  "JavadocPackageCheck.java.html:<td class='covered'><pre><span  class='survived'>                    log(1, MSG_LEGACY_PACKAGE_HTML);</span></pre></td></tr>"
  "JavadocPackageCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(1, MSG_PACKAGE_INFO);</span></pre></td></tr>"
  ...
  "JavadocParagraphCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(newline.getLineNumber(), MSG_TAG_AFTER);</span></pre></td></tr>"
  "JavadocParagraphCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(tag.getLineNumber(), MSG_LINE_BEFORE);</span></pre></td></tr>"
  "JavadocParagraphCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(tag.getLineNumber(), MSG_MISPLACED_TAG);</span></pre></td></tr>"
  "JavadocParagraphCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(tag.getLineNumber(), MSG_REDUNDANT_PARAGRAPH);</span></pre></td></tr>"
  ...
  "JavadocParagraphCheck.java.html:<td class='covered'><pre><span  class='survived'>        return new int[] {</span></pre></td></tr>"
  ...
  "JavadocStyleCheck.java.html:<td class='covered'><pre><span  class='survived'>        final StringBuilder builder = new StringBuilder(1024);</span></pre></td></tr>"
  ...
  "JavadocStyleCheck.java.html:<td class='covered'><pre><span  class='survived'>        int index = 0;</span></pre></td></tr>"
  "JavadocStyleCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(ast, MSG_JAVADOC_MISSING);</span></pre></td></tr>"
  "JavadocStyleCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(comment.getStartLineNo(), MSG_EMPTY);</span></pre></td></tr>"
  "JavadocStyleCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(comment.getStartLineNo(), MSG_NO_PERIOD);</span></pre></td></tr>"
  ...
  "JavadocTagContinuationIndentationCheck.java.html:<td class='covered'><pre><span  class='survived'>        else if (!CommonUtil.isBlank(text.substring(1, offset + 1))) {</span></pre></td></tr>"
  ...
  "JavadocTypeCheck.java.html:<td class='covered'><pre><span  class='survived'>                        log(ast, MSG_TAG_FORMAT, tagPrefix + tagName, formatPattern.pattern());</span></pre></td></tr>"
  "JavadocTypeCheck.java.html:<td class='covered'><pre><span  class='survived'>                    log(tag.getLineNo(), tag.getColumnNo(),</span></pre></td></tr>"
  ...
  "JavadocVariableCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(ast, MSG_JAVADOC_MISSING);</span></pre></td></tr>"
  ...
  "MissingJavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(ast, MSG_JAVADOC_MISSING);</span></pre></td></tr>"
  "MissingJavadocMethodCheck.java.html:<td class='covered'><pre><span  class='survived'>            numberOfLines = 1;</span></pre></td></tr>"
  ...
  "MissingJavadocPackageCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(ast, MSG_PKG_JAVADOC_MISSING);</span></pre></td></tr>"
  "MissingJavadocTypeCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(ast, MSG_JAVADOC_MISSING);</span></pre></td></tr>"
  ...
  "NonEmptyAtclauseDescriptionCheck.java.html:<td class='covered'><pre><span  class='survived'>        return new int[] {</span></pre></td></tr>"
  "RequireEmptyLineBeforeBlockTagGroupCheck.java.html:<td class='covered'><pre><span  class='survived'>        while (count &#60;= 1</span></pre></td></tr>"
  "SingleLineJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(ast.getLineNumber(), MSG_KEY);</span></pre></td></tr>"
  ...
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>        boolean previousWhitespace = true;</span></pre></td></tr>"
  ...
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>        final int indexOfContentOfSummaryTag = 3;</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>        final StringBuilder customTagContent = new StringBuilder(256);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>        final StringBuilder result = new StringBuilder(256);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>        final StringBuilder result = new StringBuilder(256);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>        final StringBuilder result = new StringBuilder(256);</span></pre></td></tr>"
  ...
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>            if (endOfSentence != -1</span></pre></td></tr>"
  ...
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(ast.getLineNumber(), MSG_SUMMARY_FIRST_SENTENCE);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(ast.getLineNumber(), MSG_SUMMARY_JAVADOC_MISSING);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(ast.getLineNumber(), MSG_SUMMARY_JAVADOC);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(inlineReturnTag.getLineNumber(), MSG_SUMMARY_JAVADOC_MISSING);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(inlineReturnTag.getLineNumber(), MSG_SUMMARY_JAVADOC);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>            log(inlineSummaryTag.getLineNumber(), MSG_SUMMARY_JAVADOC_MISSING);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(inlineSummaryTag.getLineNumber(), MSG_SUMMARY_JAVADOC);</span></pre></td></tr>"
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>                log(inlineSummaryTag.getLineNumber(), MSG_SUMMARY_MISSING_PERIOD);</span></pre></td></tr>"
  ...
  "SummaryJavadocCheck.java.html:<td class='covered'><pre><span  class='survived'>                result.append(text, 0, text.indexOf(periodSuffix) + 1);</span></pre></td></tr>"
  ...
  "TagParser.java.html:<td class='covered'><pre><span  class='survived'>            column = 0;</span></pre></td></tr>"
  "TagParser.java.html:<td class='covered'><pre><span  class='survived'>        if (incompleteTag) {</span></pre></td></tr>"
  "TagParser.java.html:<td class='covered'><pre><span  class='survived'>            int position = 0;</span></pre></td></tr>"
  ...
  "WriteTagCheck.java.html:<td class='covered'><pre><span  class='survived'>            for (int i = 0; i &#60; comment.length; i++) {</span></pre></td></tr>"
  "WriteTagCheck.java.html:<td class='covered'><pre><span  class='survived'>        log(line, MSG_WRITE_TAG, tagName, tagValue);</span></pre></td></tr>"
  "WriteTagCheck.java.html:<td class='covered'><pre><span  class='survived'>                        log(lineNo + i - comment.length, MSG_TAG_FORMAT, tag, tagFormat.pattern());</span></pre></td></tr>"
  "WriteTagCheck.java.html:<td class='covered'><pre><span  class='survived'>        return new int[] {</span></pre></td></tr>"
  "WriteTagCheck.java.html:<td class='covered'><pre><span  class='survived'>        return new int[] {</span></pre></td></tr>"
