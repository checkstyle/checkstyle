...
"$IDEA_PATH" format -r -s "$FORMAT_PATH" -m "*.java" "$PROJECT_DIR/src/it/java"
"$IDEA_PATH" format -r -s "$FORMAT_PATH" -m "*.java" "$PROJECT_DIR/src/main/java"
"$IDEA_PATH" format -r -s "$FORMAT_PATH" -m "*.java" "$PROJECT_DIR/src/test/java"
"$IDEA_PATH" format -r -s "$FORMAT_PATH" -m "*.java" "$PROJECT_DIR/src/xdocs-examples/java"
