...
pitest-common)
  ...
  "DefaultLogger.java.html:<td class='uncovered'><pre><span  class='survived'>        return errorWriter;</span></pre></td></tr>"
  "DefaultLogger.java.html:<td class='uncovered'><pre><span  class='survived'>        return infoWriter;</span></pre></td></tr>"
