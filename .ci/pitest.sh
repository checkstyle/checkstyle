...
pitest-javadoc)
  ...
  "AbstractTypeAwareCheck.java.html:<td class='covered'><pre><span  class='survived'>            loadable = clazz != null;</span></pre></td></tr>"
  "AbstractTypeAwareCheck.java.html:<td class='covered'><pre><span  class='survived'>            logLoadError(ident);</span></pre></td></tr>"
  "AbstractTypeAwareCheck.java.html:<td class='covered'><pre><span  class='survived'>        if (clazz == null) {</span></pre></td></tr>"
