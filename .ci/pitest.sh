...
pitest-common)
  ...
  "PropertiesExpander.java.html:<td class='covered'><pre><span  class='survived'>                    if (varPv != null) {</span></pre></td></tr>"
  "PropertiesExpander.java.html:<td class='covered'><pre><span  class='survived'>            if (val != null) {</span></pre></td></tr>"
